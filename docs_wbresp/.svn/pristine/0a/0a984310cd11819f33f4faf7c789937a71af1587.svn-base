...
Inserisci il codice fiscale e la password che hai ricevuto via mail:</p>
                 <div class="row">
...
<script>
	$(function() {
		$('#salvataggiKo').modal('show');
	});
</script>
    

    <!-- Modal ERRORE APERTURA CONTO -->
<div class="modal fade" id="salvataggiKo" role="dialog">
    <div class="modal-dialog">
				...
				<div class="row">
                  <div class="col-md-12 col-sm-12 light-thankyou-block">
					<div class="title-content">
					   <strong>Codice fiscale o/e password errata/i.</strong>
					</div>
                  </div>
                </div>
			</div>
      ...
      <!-- Modal ERRORE APERTURA CONTO fine -->
