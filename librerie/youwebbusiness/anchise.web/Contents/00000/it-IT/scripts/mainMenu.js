...
function waitingMessagePdf(windowOpened) {
    ...
    bufferHTML += "<link type='text/css' rel='STYLESHEET' href='css/stile.css'>"
    ...
    bufferHTML += "<OBJECT classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' codebase='./flash/swflash5r42.cab#version=5,0,0,0' WIDTH='390' HEIGHT='290' id='attesa' ALIGN=''>"
    bufferHTML += "<PARAM NAME='movie' VALUE='./flash/attesa.swf'/>"
    bufferHTML += "<PARAM NAME='menu' VALUE='false'/>"
    bufferHTML += "<PARAM NAME='quality' VALUE='high'/>"
    bufferHTML += "<PARAM NAME='bgcolor' VALUE='#ffffff'/>"
    bufferHTML += "<EMBED src='./flash/attesa.swf' loop='false' menu='false' quality='high' bgcolor='#ffffff'WIDTH='480' HEIGHT='300' NAME='attesa' ALIGN='' TYPE='application/x-shockwave-flash' PLUGINSPAGE='http://www.macromedia.com/go/getflashplayer'></EMBED>"
    bufferHTML += "</OBJECT>"
    bufferHTML += "</td>"
    bufferHTML += "</tr></table>"
    bufferHTML += "</body>"
...
function waitingMessage(windowOpened, abi) {
    ...
    var bufferHTML = "<head><title>Attendere</title>"
    bufferHTML += "<link type='text/css' rel='STYLESHEET' href='css/" + abi + "/stile.css'>"
    bufferHTML += "<meta http-equiv='Content-Type' content='text/html; charset=iso-8859-1'/>"
    bufferHTML += "</head>"
    bufferHTML += "<body background='img/" + abi + "/background5.gif'>"
    ...
    //bufferHTML += "<EMBED src='./flash/attesa.swf' loop='false' menu='false' quality='high' wmode='transparent' WIDTH='480' HEIGHT='300' NAME='attesa' ALIGN='' TYPE='application/x-shockwave-flash' PLUGINSPAGE='http://www.macromedia.com/go/getflashplayer'></EMBED>"
    //bufferHTML += "</OBJECT>"

    bufferHTML += "<img src='/anchise.web/Contents/00000/it-IT/images/attesa.gif'/>"
    bufferHTML += "</td>"
    bufferHTML += "</tr></table>"
    bufferHTML += "</body>"
...
function collaps(id) {
    if (document.all) {
        ...
        if (document.getElementById(id).style.display == 'none') {
            ...
            document.all(nomeImg).src = "img/asc.gif";
        }
        else {
            document.getElementById(id).style.display = 'none';
            document.all(nomeImg).src = "img/desc.gif";
        }
    }
}
