...
(function (sdk, $, args) {
    ...
    sdk.print = (function (print, $, args) {
                ...
                create: function (options) {
                    ...
                    try {
                        ...
                        if (_scope.element.prop('tagName') != 'DIV' && _scope.element.prop('tagName') != 'SPAN') {
                            ...
                            //1 - creiamo la select (se non esiste già)
                            if ($('div.tm-print', __element) != undefined && $('div.tm-print', __element).length > 0) {
                                $('div.tm-print', __element).remove();
                            }
        ...
        var _download = function (data, eventHandler, element, eventType) {
            ...
            var __parameter = data.resourceForm.parameter;
            if (typeof data.resourceForm.parameter == 'function') {

                __parameter = data.resourceForm.parameter();
                if (__parameter == undefined || typeof __parameter == 'function') {

                    __parameter = {};
                }
            }

            data.resourceForm.parameter = __parameter;

            eventHandler('fixParameter', element, data.resourceForm.parameter);
    ...
    })(sdk.print || {}, $, args && args.print ? args.print : {});
