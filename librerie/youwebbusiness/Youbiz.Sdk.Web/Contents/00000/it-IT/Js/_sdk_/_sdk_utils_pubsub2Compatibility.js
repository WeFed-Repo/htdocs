...
(function (sdk, $, args) {
    ...
    sdk.utils = (function (utils, $, args) {
        ...
        utils.pubsub2 = (function (pubsub2, $, args) {
...
pubsub2["subscribe"] = _subscribe;
pubsub2["publish"] = _publish;
pubsub2["unsubscribe"] = _unsubscribe;


// event mode
pubsub2["register"] = _subscribe;
pubsub2["unregister"] = _unsubscribe;
pubsub2["send"] = _publish;
pubsub2["sendNoop"] = _sendNoop;
pubsub2["isNoop"] = _isNoop;

// unicast events
/* ricevo eventi solo da uno specifico sender*/
pubsub2["receiveAll"] = _subscribeUnicastAndBroadcast;
/* ricevo eventi solo da uno specifico sender*/
pubsub2["receiveOnly"] = _subscribeUnicastOnly;
/* invio messaggi broadcast con rispetto degli unicast*/
pubsub2["sendAll"] = _publishUnicastAndBroadcast;
/* invio solo a chi ha richiesto unicast degli unicast*/   
pubsub2["sendOnly"] = _publishUnicastOnly;           


         
            
            return pubsub2;
        })(utils.pubsub2 || {}, $, args && args.pubsub2 ? args.pubsub2 : {});
        // end namespace sdk.utils.pubsub2
        return utils;
