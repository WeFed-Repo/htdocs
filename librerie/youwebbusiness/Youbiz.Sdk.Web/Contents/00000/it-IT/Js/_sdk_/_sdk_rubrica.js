...
(function (sdk, $, args) {
    ...
    sdk.rubrica = (function (rubrica, $, args) {
        ...
        var create = function (baseUrl, element) {
            ...
            return {
                fornitore: _init(baseUrl, element, 'fornitore', sdk.resource.get('sdk.rubrica.title.fornitore')),
                cliente: _init(baseUrl, element, 'cliente', sdk.resource.get('sdk.rubrica.title.cliente')),
                dipendente: _init(baseUrl, element, 'dipendente', sdk.resource.get('sdk.rubrica.title.dipendente')),
                fornitoreEstero: _init(baseUrl, element, 'fornitoreEstero', sdk.resource.get('sdk.rubrica.title.fornitoreEstero')),
                clienteEstero: _init(baseUrl, element, 'clienteEstero', sdk.resource.get('sdk.rubrica.title.clienteEstero')),
            }
        };
        ...
        var _list = function (baseUrl, element, action, options, description) {
            ...
            var scope = {
                ...
                getFilters: function () {
                    return {
                        denominazione: $('.tm-modal-filters input[for="ragione-sociale"]'),
                        codice: $('.tm-modal-filters input[for="codice"]'),
            ...
            var popupOptions = {
                html: function () {
                    return ''
                        ...
                        + '             <label id="ragione-sociale">' + sdk.resource.get('sdk.rubrica.filters.denominazione') + '</label>'
                        + '             <input type="text" class="form-control popup-filter-denominazione" for="ragione-sociale" />'
                        + '         </div>'
                        + ''
                        + '         <div class="col-sm-3 col-xs-12">'
                        + '             <label id="codice">' + sdk.resource.get('sdk.rubrica.filters.codice') + '</label>'
                        + '             <input type="text" class="form-control popup-filter-codice" for="codice" />'
                        + '         </div>'
                        + ''
                        /*
                        + '         <div class="col-sm-4 col-xs-12">'
                        ...
                        columns: [
                            {
                                ...
                                orderable: true,
                                width: '50%',
                                title: sdk.resource.get('sdk.rubrica.datatable.column.denominazione')
                            }, {
                                data: 'Indirizzo.Comune',
                                orderable: true,
                                width: '20%',
                                title: sdk.resource.get('sdk.rubrica.datatable.column.indirizzo.comune')
                            }, {
                                data: 'Rapporto.Iban',
                                orderable: true,
                                width: '30%',
                                title: sdk.resource.get('sdk.rubrica.datatable.column.iban')
                            }
                        ],
                        processing: false,
                        isFilterable: false,
