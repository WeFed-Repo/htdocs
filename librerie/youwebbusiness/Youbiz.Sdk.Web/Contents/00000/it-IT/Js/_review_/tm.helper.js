...
//var getHelpLocalUrl = "/_wk/HelpController/GetHelp"; //'/YouBiz.Web/Help/Help/GetHelp';

function showHelpSDK(parameter, jTarget) {
...
var _fixedParameter = function (inputParameter) {
    ...
    if (inputParameter) {
        Logger.debugMessage('tm.helper - *** start initialize parameters ***');

        if (inputParameter.searchUrl == null || inputParameter.searchUrl == undefined || inputParameter.searchUrl.length == 0) {
            Logger.debugMessage('tm.helper - inputParameter.searchUrl = ' + inputParameter.searchUrl);
            toretparameter.searchUrl = '/YouBiz.Web/Help/Help/GetHelp';
            Logger.debugMessage('tm.helper - fixed inputParameter.searchUrl = ' + toretparameter.searchUrl);
        } else {
            toretparameter.searchUrl = inputParameter.searchUrl;
        }
        if (inputParameter.functionId == null || inputParameter.functionId == undefined || inputParameter.functionId.length == 0) {
            Logger.debugMessage('tm.helper - inputParameter.functionId = ' + inputParameter.functionId);
            toretparameter.functionId = 'help_notFound';
            Logger.debugMessage('tm.helper - fixed inputParameter.functionId = ' + toretparameter.functionId);
        } else {
            toretparameter.functionId = inputParameter.functionId;
        }
        
        if (inputParameter.anchorId == undefined) {
            Logger.debugMessage('tm.helper - inputParameter.anchorId = ' + inputParameter.anchorId);
            toretparameter.anchorId = true;
            Logger.debugMessage('tm.helper - fixed inputParameter.anchorId = ' + toretparameter.anchorId);
        } else {
            toretparameter.anchorId = inputParameter.anchorId;
        }

        if (inputParameter.isPopup == undefined) {
            Logger.debugMessage('tm.helper - inputParameter.isPopup = ' + inputParameter.isPopup);
            toretparameter.isPopup = true;
            Logger.debugMessage('tm.helper - fixed inputParameter.isPopup = ' + toretparameter.isPopup);
        } else {
            toretparameter.isPopup = inputParameter.isPopup;
        }

        if (inputParameter.isModal == undefined) {
            Logger.debugMessage('tm.helper - inputParameter.isModal = ' + inputParameter.isModal);
            toretparameter.isModal = true;
            Logger.debugMessage('tm.helper - fixed inputParameter.isModal = ' + toretparameter.isModal);
        } else {
            toretparameter.isModal = inputParameter.isModal;
        }

        Logger.debugMessage('tm.helper - *** stop initialize parameters ***');

    } else {
        toretparameter.searchUrl = '/YouBiz.Web/Help/Help/GetHelp';
        toretparameter.searchUrl = '';
        toretparameter.isPopup = true;
        toretparameter.isModal = true;
        toretparameter.anchorId = null;
        toretparameter.functionId = 'help_notFound';
    ...
    Logger.debugMessage('tm.helper - *** outputParameter ***');
