...
//            url: '_wk/PinPad',
//            urlImgCancella: 'Contents/00000/it-IT/images/pp/imgPPGeneric2.jpg',
...
//TODO commentato David portato codice sotto come da YBW
//function initPinpad(initParam) {
...
//    var localParam = $.extend({}, defaultParam, initParam);
//    localParam.inputJPanel = $("#" + localParam.inputPanelName);

//    // fix grafico
//    localParam.inputJPanel.attr("maxlength", "6").attr("readonly", true).css("cursor", "pointer").addClass("form-control").css("margin-left", "20px").width(60).attr("value", "");
    
//    var strName = "tm_divPP_" + localParam.inputPanelName;
//    var strFieldName = localParam.inputPanelName;
//    var strImgCancella = localParam.settings.ApplicationPath + "/" + localParam.urlImgCancella;
//    var imgUrl = localParam.settings.ApplicationPath + "/" + localParam.url + '?d=' + $.now();
//            var authInput = '<div id="' + strName + '"><table> \
//                            <tr> \
//                                <td align="left"> \
//                                    <table style="border-collapse: separate !important; border-spacing: 10px !important;padding: 1px !important;"> \
...
//            localParam.inputJPanel.attr("data-toggle", "popover").attr("data-placement", "bottom");
//            localParam.inputJPanel.popover({
//                content: authInput,
//                html: true
//            });
//}

//TODO nuovo codice come da YBW
...
function openPinpadNew(executionParam) {
    Logger.debugMessage('tm.pinpad.js - openPinpadNew ');
...
function openPinpadOld(executionParam) {
    //debugger;
    Logger.debugMessage('tm.pinpad.js - openPinpadOld ');
...
var _GetImgToken = function (executionParamInternal) {
    ...
    try {
        ...
        Logger.debugMessage('tm.pinpad - error in GetTagImgToken: ' + e);
    }
    return imgToken;
}
