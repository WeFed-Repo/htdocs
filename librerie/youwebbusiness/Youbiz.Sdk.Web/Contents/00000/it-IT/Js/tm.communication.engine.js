            ...
            // success
                .success(function (data, textStatus, jqXHR) {
                    try {
                        ...
                        sdk.utils.log.errorMessage("Error in comunication engine (success)", err);
                    }
                })
            // error
                .error(function (jqXHR, textStatus, errorThrown) {
                    try {
                        ...
                        sdk.utils.log.errorMessage("Error in comunication engine (error)", err);
                    }
