...
<div class="container-fluid">
	...
	<section class="no-margin-section">
		<div class="bordered pt-0 d-none d-lg-block">
			<table data-bootstrap-table cellspacing="0" cellpadding="0" border="0" class="table azioni-tabella" data-table-mobilized-desktop="doconlineTable">
				<thead>
					<tr>
		...
		<div class="bordered p-0 d-block d-lg-none">
			<div class="mobile-data" data-table-mobilized-mobile="doconlineTable"></div>
		</div>
