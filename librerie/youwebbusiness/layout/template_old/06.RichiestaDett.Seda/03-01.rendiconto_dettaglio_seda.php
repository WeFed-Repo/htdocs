...
<!-- /ko -->
    ...
    <div class="messagePanel alert" style="display: block">
        ...
        <div data-bind="visible: CurrentSection() == Sections.PREVISIONALE" style="">
    ...
    <div data-bind="with: Esito" class="col-xs-12 white-block">
        ...
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="text: $component.ComutedAbi">05034 - BANCO BPM S.P.A.</label>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="col-xs-6">
    ...
    <div data-bind="with: Esito" class="col-xs-12 white-block">
        ...
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="text: $component.LocalizationTrimestre(TrimestreDiRiferimento())">Ottobre-Novembre-Dicembre</label>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="text: AnnoDiRiferimento">2018</label>
                </div>
            </div>
        </div>
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="text: Debitore.Bic">EUBAITM1XXX</label>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="numericTextSeparator: ImportoTotaleTrimestre">0,00</label>
                </div>
            </div>
        </div>
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="text: CodicePrevisionale">201840000000000022750NEVEUBAITM1XXX</label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div data-bind="with: Esito" class="col-xs-12 white-block">
        ...
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="text: NumMandatiCred">1</label>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="numericTextSeparator: PrezzoMandatoCred">0,00</label>
                </div>
            </div>
        </div>
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="numericTextSeparator: ImportoTotMandatiCred">0,00</label>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="numericTextSeparator: PrezzoFlatMandatoCred">0,00</label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div data-bind="with: Esito" class="col-xs-12 white-block">
        ...
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="text: NumMandatiPag">0</label>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="numericTextSeparator: PrezzoMandatoPag">0,00</label>
                </div>
            </div>
        </div>
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="numericTextSeparator: ImportoTotMandatiPag">0,00</label>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="numericTextSeparator: PrezzoFlatMandatoPag">0,00</label>
                </div>
            </div>
        </div>
        <div class="col-xs-12 no-padding">
            <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label data-bind="numericTextSeparator: ImportoTotFlat">0,00</label>
                </div>
            </div>
        </div>
    </div>
...
<!-- /ko -->
    ...
    <div class="margin-bottom20 text-right">
        <div id="export-esito-dettaglio-richiesta-rendiconto-seda" value="Esporta" style="display: inline-block; vertical-align: top;"> <div class="tm-print">     <div class="btn-group undefined">         <button type="button" class="dropdown-toggle btn btn-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">             Esporta <span class="caret" style="margin-left: 12px;"></span>         </button>         <ul class="dropdown-menu">                      <li>                 <a class="link-button Pdf-0" title="Export" style="padding: 10px; padding-right: 30px; padding-top: 5px; padding-bottom: 5px; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: bold;">                     <div class="icon anchise-icon anchise-icon-export-Pdf"></div>                     <span style="margin-left: 12px;">Pdf</span>                 </a>             </li></ul>     </div>     <div class="print-popup"></div> </div></div>
        <input type="button" class="btn btn-primary" value="Indietro" data-bind="singleClick: Back">
    </div>
</rendiconto-mandati>
        </div>
    ...
    <div class="margin-bottom20 text-right">
        <div id="export-esito-negativo-richiesta-rendiconto-seda" value="Esporta" style="display: inline-block; vertical-align: top;"> <div class="tm-print">     <div class="btn-group undefined">         <button type="button" class="dropdown-toggle btn btn-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">             Esporta <span class="caret" style="margin-left: 12px;"></span>         </button>         <ul class="dropdown-menu">                      <li>                 <a class="link-button Pdf-0" title="Export" style="padding: 10px; padding-right: 30px; padding-top: 5px; padding-bottom: 5px; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: bold;">                     <div class="icon anchise-icon anchise-icon-export-Pdf"></div>                     <span style="margin-left: 12px;">Pdf</span>                 </a>             </li></ul>     </div>     <div class="print-popup"></div> </div></div>
        <input type="button" class="btn btn-primary" value="Indietro" data-bind="singleClick: Back">
    </div>
</richiesta-rendiconto-mandati-rifiutata>
        </div>
