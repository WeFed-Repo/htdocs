        ...
        viewModel: function (params) {
            ...
            self.IdentificativoPrevisionaleSearch = function () {
                    if (App.Common.IdentifierIsNotValid(self.disposizioneSeda().Ordinante.Identifier)) {
                        self.Validation.removeAll();
                        self.Validation.push(new App.Core.ValidationMessage({ ErrorMessage: 'Per poter accedere alla funzionalità di ricerca è necessario selezionare prima una banca.' }));
                    } else {
