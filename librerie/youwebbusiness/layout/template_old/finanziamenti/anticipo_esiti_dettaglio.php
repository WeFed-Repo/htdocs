...
<div id="88876c31bdba407f92489205ce32f511_4" style="">


    <div id="dettaglio" class="riquadro clearfix" style="">
...
<div id="88876c31bdba407f92489205ce32f511_6" style="">
    ...
    <script type="text/javascript">
        ...
        <div id="listFatture" class="clearfix" style="">
...
<div class="col-xs-12 white-block" id="subArea-datiesito">
    ...
    <div id="dettaglioBtn" style="display: block;">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            <div>
                <button class="btn btn-primary pull-right" id="btnCloseDettaglio" type="button" style="visibility: hidden;">Torna a Elenco</button>
                <div class="pull-right margin-bottom20">
