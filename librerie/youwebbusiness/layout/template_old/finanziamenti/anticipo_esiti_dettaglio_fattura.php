...
<script type="text/javascript">
    ...
    <div id="88876c31bdba407f92489205ce32f511_1" style="">
        ...
        <div id="esitoMain" style="display: none;">
...
<div id="88876c31bdba407f92489205ce32f511_3" style="">
    ...
    $(function () {
                    ...
                    <div id="">
                        <div class="dataTables_wrapper listTable">
                            <div id="tblElencoEsiti_wrapper" class="dataTables_wrapper no-footer"><table id="tblElencoEsiti" class="table table-striped no-footer dataTable" role="grid" aria-describedby="tblElencoEsiti_info">
                                <tbody><tr tmindex="0" role="row" class="odd selectedRow"><td class="hidden col-sm-1">&nbsp;</td><td class="center col-sm-1 sorting_1" data-order="2014-03-10T10:12:50Z">10/03/2014</td> <td class="col-sm-1" data-order="3">3</td> <td class="money col-sm-1" data-order="101529.8">101.529,80&nbsp;EUR</td> <td class="money col-sm-1" data-order="79193.24">79.193,24&nbsp;EUR</td> <td class="center col-sm-1" data-order="2014-03-17T00:00:00+01:00">17/03/2014</td> <td class="center col-sm-1">Anticipata </td> <td class="center col-sm-1"><div class="dropdown opera"><button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></button><ul class="dropdown-menu " aria-labelledby="dropdownMenuButton"><li><a id="viewAction" class="dropdown-item " href="#">Dettaglio</a></li><li><a id="downloadPropostaAction" class="dropdown-item disabledDiv" href="#">Proposta</a></li></ul></div></td> </tr></tbody>
        ...
        <div id="dettaglioDistinta" style="">
            <div>
...
<div id="88876c31bdba407f92489205ce32f511_4" style="display: block;">
...
<div id="88876c31bdba407f92489205ce32f511_6" style="">
    <div class="row">
        ...
        <div class="col-xs-6 white-block">
            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-6">
                    <label class="control-label" id="areadatidistinta-numerofatture" style="padding:0">3</label>
                </div>
            </div>
            <div class="col-xs-12">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label class="control-label label-anfastato stato-6" id="areadatidistinta-statodistinta">Anticipata</label>
            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-6">
                    <label class="control-label" id="areadatidistinta-dtcreazione" style="padding:0">10/03/2014</label>
                </div>
            </div>
            <div class="col-xs-12">
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                    <label class="control-label" id="areadatidistinta-importototale" style="padding:0">101.529,80 EUR</label>
                </div>
            </div>
        ...
        <div class="col-xs-12 white-block" id="anticipoOk" style="">
            <div class="col-xs-12">
                <div class="text-center">
                    <h1>
                        Dati Anticipo
            ...
            <div class="col-xs-12">
                <div class="col-xs-6">
                    ...
                    <div class="col-xs-7"><label class="control-label" id="areadatidistintadatianticipo-totalefinanziato" style="padding:0">79.193,24 EUR</label></div>
                </div>
                <div class="col-xs-6">
                    <div class="col-xs-5">Data accredito</div>
                    <div class="col-xs-7"><label class="control-label" id="areadatidistintadatianticipo-dataaccredito" style="padding:0">17/03/2014</label></div>
                </div>
            </div>
            <div class="col-xs-12">
                <div class="col-xs-6">
                    <div class="col-xs-5">Percentuale finanziamento</div>
                    <div class="col-xs-7"><label class="control-label" id="areadatidistintadatianticipo-percentualefinanziamento" style="padding:0">78 %</label></div>
                </div>
                <div class="col-xs-6">
                    <div class="col-xs-5">Data addebito</div>
                    <div class="col-xs-7"><label class="control-label" id="areadatidistintadatianticipo-dataaddebito" style="padding:0">10/03/2014</label></div>
                </div>
            </div>
            <div class="col-xs-12">
                <div class="col-xs-6">
                    <div class="col-xs-5">N. Fatture finanziate</div>
                    <div class="col-xs-7"><label class="control-label" id="areadatidistintadatianticipo-nfatturefinanziate" style="padding:0">3</label></div>
                </div>
                <div class="col-xs-6">
    ...
    <script type="text/javascript">
        ...
        <div id="listFatture" class="clearfix" style="display: none;">
            ...
            <div id="">
                <div class="dataTables_wrapper listTable">
                    <div id="tblElencoFatture_wrapper" class="dataTables_wrapper no-footer"><table id="tblElencoFatture" class="table table-striped no-footer dataTable" role="grid" aria-describedby="tblElencoFatture_info">
                        <tbody><tr tmindex="0" role="row" class="odd selectedRow"><td class="hidden"></td> <td class="sorting_1">COMUNE DI SAN MARTINO BUON ALBERGO</td><td>13</td><td class="center" data-order="2014-02-25T00:00:00+01:00">25/02/2014</td><td class="center" data-order="2014-04-30T00:00:00+02:00">30/04/2014</td><td class="center">-</td><td class="center" data-order="0">-</td><td class="money" data-order="7295.8">7.295,80 EUR</td><td class="center"><div class=""><a id="viewAction" class="" href="#"><button class="btn btn-secondary" type="button" id="dropdownMenuButton"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button></a></div></td> </tr><tr tmindex="1" role="row" class="even"><td class="hidden"></td> <td class="sorting_1">COMUNE DI SAN MARTINO BUON ALBERGO</td><td>15</td><td class="center" data-order="2014-02-25T00:00:00+01:00">25/02/2014</td><td class="center" data-order="2014-04-30T00:00:00+02:00">30/04/2014</td><td class="center">-</td><td class="center" data-order="0">-</td><td class="money" data-order="38645">38.645,00 EUR</td><td class="center"><div class=""><a id="viewAction" class="" href="#"><button class="btn btn-secondary" type="button" id="dropdownMenuButton"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button></a></div></td> </tr><tr tmindex="2" role="row" class="odd"><td class="hidden"></td> <td class="sorting_1">COMUNE DI SAN MARTINO BUON ALBERGO</td><td>16</td><td class="center" data-order="2014-02-25T00:00:00+01:00">25/02/2014</td><td class="center" data-order="2014-04-30T00:00:00+02:00">30/04/2014</td><td class="center">-</td><td class="center" data-order="0">-</td><td class="money" data-order="55589">55.589,00 EUR</td><td class="center"><div class=""><a id="viewAction" class="" href="#"><button class="btn btn-secondary" type="button" id="dropdownMenuButton"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button></a></div></td> </tr></tbody>
                        <thead>
                        <tr role="row"><th class="hidden sorting" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="&amp;nbsp;: ordinamento crescente" style="width: 0px;">&nbsp;</th><th class="sorting_asc" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="Debitore: ordinamento decrescente" style="width: 0px;" aria-sort="ascending">Debitore</th><th class="sorting" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="N. Fattura: ordinamento crescente" style="width: 0px;">N. Fattura</th><th class="sorting" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="Emissione: ordinamento crescente" style="width: 0px;">Emissione</th><th class="sorting" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="Scadenza: ordinamento crescente" style="width: 0px;">Scadenza</th><th class="sorting" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="Split Payment: ordinamento crescente" style="width: 0px;">Split Payment</th><th class="sorting" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="Imponibile: ordinamento crescente" style="width: 0px;">Imponibile</th><th class="sorting" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="Totale Fattura: ordinamento crescente" style="width: 0px;">Totale Fattura</th><th class="dt-nosort dt-nofilter sorting_disabled" tabindex="0" aria-controls="tblElencoFatture" rowspan="1" colspan="1" aria-label="&amp;nbsp;" style="width: 0px;">&nbsp;</th></tr>
                        </thead>
...
<div id="88876c31bdba407f92489205ce32f511_7" style="">
<div class="row">
...
<div class="col-xs-6 white-block">
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-6">
            <label class="control-label" id="areadatidistinta-statodistinta" style="padding: 0">Anticipata</label>
        </div>
    </div>
    <div class="col-xs-12">
        <div class="col-xs-6">
...
<div class="col-xs-12 white-block">
    ...
    <div class="col-xs-12">
        <div class="col-xs-6">
            ...
            <div class="col-xs-7"><label class="control-label" id="datidebitore-RagioneSociale" style="padding: 0">COMUNE DI SAN MARTINO BUON ALBERGO</label></div>
        </div>
        <div class="col-xs-6">
            <div class="col-xs-5">Indirizzo</div>
            <div class="col-xs-7"><label class="control-label" id="datidebitore-Indirizzo" style="padding: 0">PIAZZA DEL POPOLO 36</label></div>
        </div>
    </div>
    ...
    <div class="col-xs-12">
        <div class="col-xs-6">
            ...
            <div class="col-xs-7"><label class="control-label" id="datidebitore-CodiceFiscalePiva" style="padding: 0">00333790236</label></div>
        </div>
        <div class="col-xs-6">
            <div class="col-xs-5">Comune</div>
            <div class="col-xs-7"><label class="control-label" id="datidebitore-Comune" style="padding: 0">SAN MARTINO BUON ALBERGO</label></div>
        </div>
    </div>
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-6">
            ...
            <div class="col-xs-7"><label class="control-label" id="datidebitore-CapProvincia" style="padding: 0">37036 - VR</label></div>
        </div>
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-6">
            ...
            <div class="col-xs-7"><label class="control-label" id="datidebitore-Nazione" style="padding: 0">IT</label></div>
        </div>
...
<div class="col-xs-12 white-block" id="subArea-datiemittente" style="display: none;visibility: hidden">
    ...
    <div class="col-xs-12">
        <div class="col-xs-6">
            <div class="col-xs-5">Ragione Sociale</div>
            <div class="col-xs-7"><label class="control-label" id="datiemittente-RagioneSociale" style="padding: 0">ARCHIMEDE SERVIZI S.R.L.</label></div>
        </div>
        <div class="col-xs-6">
            <div class="col-xs-5">Indirizzo</div>
            <div class="col-xs-7"><label class="control-label" id="datiemittente-Indirizzo" style="padding: 0">VIA FRATELLI CERVI 10</label></div>
        </div>
    </div>
    ...
    <div class="col-xs-12">
        <div class="col-xs-6">
            <div class="col-xs-5">CF/PIva</div>
            <div class="col-xs-7"><label class="control-label" id="datiemittente-CodiceFiscalePiva" style="padding: 0">03605080237</label></div>
        </div>
        <div class="col-xs-6">
            <div class="col-xs-5">Comune</div>
            <div class="col-xs-7"><label class="control-label" id="datiemittente-Comune" style="padding: 0">SAN MARTINO BUON ALBERGO</label></div>
        </div>
    </div>
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-6">
            <div class="col-xs-5">Provincia</div>
            <div class="col-xs-7"><label class="control-label" id="datiemittente-CapProvincia" style="padding: 0">37036 - VR</label></div>
        </div>
    </div>
    <div class="col-xs-12">
        <div class="col-xs-6">
        ...
        <div class="col-xs-6">
            <div class="col-xs-5">Nazione</div>
            <div class="col-xs-7"><label class="control-label" id="datiemittente-Nazione" style="padding: 0">IT</label></div>
        </div>
    </div>
</div>
...
<div class="col-xs-12 white-block">
    ...
    <div class="col-xs-12">
        <div class="col-xs-6">
            ...
            <div class="col-xs-7"><label class="control-label" id="datifattura-NumeroFattura" style="padding: 0">13</label></div>
        </div>
        <div class="col-xs-6">
            <div class="col-xs-5">Data Emissione</div>
            <div class="col-xs-7"><label class="control-label" id="datifattura-DataEmissione" style="padding: 0">25/02/2014</label></div>
        </div>
    ...
    <div class="col-xs-12">
        <div class="col-xs-6">
            ...
            <div class="col-xs-7"><label class="control-label" id="datifattura-ImportoFattura" style="padding: 0">7.295,80 EUR</label></div>
        </div>
        <div class="col-xs-6">
            <div class="col-xs-5">Data Scadenza</div>
            <div class="col-xs-7"><label class="control-label" id="datifattura-DataScadenza" style="padding: 0">30/04/2014</label></div>
        </div>
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-6">
            ...
            <div class="col-xs-7"><label class="control-label" id="datifattura-IbanCreditorFattura" style="padding: 0">IT11I0503459791000000000399</label></div>
        </div>
    ...
    <div class="col-xs-12">
        <div class="col-xs-6">
            ...
            <div class="col-xs-7"><label class="control-label" id="datifattura-TipoPagamento" style="padding: 0">Bonifico</label></div>
        </div>
        <div class="col-xs-6">
            <div class="col-xs-5"></div>
            <div class="col-xs-7"><label class="control-label" style="padding: 0"></label></div>
    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-6" style="visibility: hidden;display:none">
            ...
            <div class="col-xs-7"><label class="control-label" id="datifattura-Status" style="padding: 0">Anticipata</label></div>
        </div>
    </div>
...
<div class="col-xs-12 white-block" id="subArea-datiesito">
    ...
    <div class="col-xs-12" id="datiesito-statounknown" style="display: none;">
        <div class="col-xs-12">
            <div class="col-xs-6">
    ...
    <div class="col-xs-12" id="datiesito-statoinlavorazione" style="display: none;">
        <div class="col-xs-12">
            <div class="col-xs-6">
    ...
    <div class="col-xs-12" id="datiesito-statononaccettata" style="display: none;">
        <div class="col-xs-12">
            <div class="col-xs-6">
    ...
    <div class="col-xs-12" id="datiesito-statoanticipata" style="display: block;">
        <div class="row">
            <div class="col-xs-6">
                <div class="col-xs-5">Percentuale Finanziata</div>
                <div class="col-xs-7"><label class="control-label" id="datiesito-PercentualeFinanziata" style="padding: 0">78 %</label></div>
            </div>
            <div class="col-xs-6">
                <div class="col-xs-5">Data Radiazione</div>
                <div class="col-xs-7"><label class="control-label" id="datiesito-DataRadiazione" style="padding: 0">10/05/2014</label></div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-6">
                <div class="col-xs-5">Totale Finanziato</div>
                <div class="col-xs-7"><label class="control-label" id="datiesito-TotaleFinanziato" style="padding: 0">5.690,72 EUR</label></div>
            </div>
            <div class="col-xs-6">
            </div>
        </div>
    ...
    <div id="dettaglioBtn" style="display: none;">
        ...
        <div class="pull-right margin-bottom20">
            <div class="" id="btnPrintDettaglio" value="Esporta"> <div class="tm-print">     <div class="btn-group ">         <button type="button" class="dropdown-toggle btn btn-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">             Esporta <span class="caret" style="margin-left: 12px;"></span>         </button>         <ul class="dropdown-menu">                      <li>                 <a class="link-button pdf-0" title="documenti pdf" style="padding: 10px; padding-right: 30px; padding-top: 5px; padding-bottom: 5px; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: bold;">                     <div class="icon icon-pdf-x"></div>                     <span style="margin-left: 12px;">PDF</span>                 </a>             </li>             <li>                 <a class="link-button xls-1" title="documenti excel" style="padding: 10px; padding-right: 30px; padding-top: 5px; padding-bottom: 5px; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: bold;">                     <div class="icon icon-xls"></div>                     <span style="margin-left: 12px;">Excel</span>                 </a>             </li></ul>     </div>     <div class="print-popup"></div> </div></div>
        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            <div>
                <button class="btn btn-primary pull-right" id="btnCloseDettaglio" type="button" style="visibility: hidden; display: none;">Torna a Elenco</button>
                <div class="pull-right margin-bottom20">
