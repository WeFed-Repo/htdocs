...
<div class="row" id="873d1fd6_7e9f_420c_ab22_9df58a929f70">
...
<script type="text/javascript">
    $(function () {
        ...
        $.each($('.nav-dynamic', '#873d1fd6_7e9f_420c_ab22_9df58a929f70'), function (index, item) {
            var jItem = $(item);
        ...
        var maxHeight = 0;
        $.each($('.heightSelect', '#873d1fd6_7e9f_420c_ab22_9df58a929f70'), function (index, item) {
            var thisObj = $(item);
        ...
        $('.heightSelect', '#873d1fd6_7e9f_420c_ab22_9df58a929f70').height(maxHeight);
