...
<option value="YST">Esiti Stipendi SEPA</option>
 ...
 <table class="filter-toolbar" style="border-collapse: collapse;" cellpadding="0" cellspacing="0">
     <tbody>
         ...
         <tr>
             <td><a id="tool-refresh" class="ank-icon-filter-apply inactive" title="Applica Filtro Rapido" data-bind="singleClick: function() { rootViewModel.EsitiPagamentiViewModel.PiazzaturaPagamento.FilterRefresh(); }, css:{ inactive: EsitiPagamentiViewModel.PiazzaturaPagamento.piazzaturaUnChanged}, enable: EsitiPagamentiViewModel.PiazzaturaPagamento.piazzaturaChanged"><img src="/librerie/youwebbusiness/anchise.web/Contents/00000/it-IT/alten-anchise-images/i_quick-filter.png" border="0" width="20" height="20"></a></td>
             <td><a id="tool-goto" class="ank-icon-filter-go" title="Filtri" data-bind="singleClick: function(){ rootViewModel.EsitiPagamentiViewModel.PiazzaturaPagamento.FilterGoTo(); }, css:{ advanced: rootViewModel.EsitiPagamentiViewModel.PiazzaturaPagamento.isFilterAdvanceSet}"><img src="/librerie/youwebbusiness/anchise.web/Contents/00000/it-IT/alten-anchise-images/i_filter.png" border="0" width="20" height="20"></a></td>
             <td><a id="tool-reset" class="ank-icon-filter-reset" title="Azzera filtri" data-bind="singleClick: function(){ rootViewModel.EsitiPagamentiViewModel.PiazzaturaPagamento.FilterReset(); }"><img src="/librerie/youwebbusiness/anchise.web/Contents/00000/it-IT/alten-anchise-images/i_remove-filter.png" border="0" width="20" height="20"></a></td>
         </tr>
     </tbody>
 </table>
                        ...
                        <table class="export-toolbar" style="border-collapse: collapse;" cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width:20px">
                                            <a title="Stampa" class="ank-icon-export-Pdf" data-bind="singleClick: function(){ rootViewModel.EsitiPagamentiViewModel.GoToRicercaPerPDF();}"><img src="/librerie/youwebbusiness/anchise.web/Contents/00000/it-IT/alten-anchise-images/i_pdf.png" border="0" width="20" height="20"></a>
...
<script type="text/javascript">
    ...
    <img src="/librerie/youwebbusiness/anchise.web/Contents/00000/it-IT/Images/tipo_elaborazione_utente.gif?v=75" alt="Esito Incrociato con dispositivo" title="Esito Incrociato con dispositivo"> 
    <img src="/librerie/youwebbusiness/anchise.web/Contents/00000/it-IT/Images/tipo_elaborazione_banca.gif?v=75" alt="Esito Incrociato con dispositivo" title="Esito Incrociato con dispositivo">
                    ...
                    <img src="/librerie/youwebbusiness/anchise.web/Contents/00000/it-IT/Images/esito_ordinante_unchecked.jpg?v=75" alt="NO" title="NO">
    ...
    <img src="/librerie/youwebbusiness/anchise.web/Contents/00000/it-IT/Images/tipo_elaborazione_utente.gif?v=75" alt="Dispositivo" title="Dispositivo">
