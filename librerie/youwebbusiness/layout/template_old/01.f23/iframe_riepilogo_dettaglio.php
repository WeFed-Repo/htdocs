...
<!-- 			Inizio Anagrafica 1 -->
			<div class="form-group">
				<div class="form-field-input col-lg-5 col-md-5 col-sm-5 col-xs-5">
					...
					<div class="form-field">
						<div class="form-field-input col-lg-10 col-md-10 col-sm-10 col-xs-10">
							<input type="text" name="contribuente.cognome1" tabindex="2" size="30" maxlength="60" value="PROVA DEMO UNO DUE TREC" class="form-control" readonly="readonly">
				...
				<div class="form-field-input col-lg-5 col-md-5 col-sm-5 col-xs-4">
					...
					<div class="form-field">
						<div class="form-field-input col-lg-10 col-md-10 col-sm-10 col-xs-10">
							<input type="text" name="contribuente.nome1" tabindex="3" size="30" maxlength="20" class="form-control" readonly="readonly">
				...
				<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-3">
					...
					<div class="form-field">						
							...
							<input type="text" name="contribuente.dataNascita1Html" tabindex="4" value="" style="width:120px" class="dataNascitaHtml datepicker form-control w-auto hasDatepicker" readonly="readonly" disabled="disabled" id="dp1568750727474"><img class="ui-datepicker-trigger" src="/sapef23/f23/images/calendar.png" alt="Calendario" title="Calendario">
					...
					<label class="control-label">Sesso:</label>
						<div class="form-field">
							<div class="form-field-input col-lg-8 col-md-8 col-sm-8 col-xs-6">						
									...
									<input type="text" name="contribuente.sesso1" tabindex="5" size="1" maxlength="1" class="form-control" readonly="readonly">
				...
				<div class="form-field-input col-lg-3 col-md-3 col-sm-3 col-xs-3">
						...
						<div class="form-field">
							<div class="form-field-input col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<input type="text" name="contribuente.codFis1" tabindex="8" size="30" maxlength="16" value="00503971202" class="form-control" readonly="readonly">
							</div>
						</div>
					</div>
		...
		<div class="form-group">
			...
			<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-3">
				...
				<div class="form-field">						
						...
						<input type="text" name="contribuente.dataNascita2Html" tabindex="11" value="" style="width:120px" class="dataNascitaHtml datepicker form-control w-auto hasDatepicker" readonly="readonly" disabled="disabled" id="dp1568750727475"><img class="ui-datepicker-trigger" src="/sapef23/f23/images/calendar.png" alt="Calendario" title="Calendario">
	...
	<div class="bs-example">
		<div class="form-group">
			...
			<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">				 
				...
				<div class="form-field">
					...
					<input type="text" name="versamento.subCodice" tabindex="17" size="3" maxlength="2" style="width:40px;" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" readonly="&quot;readonly&quot;">
				</div>
			</div>
			<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
			...
			<div class="form-group">				
				...
				<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
					...
					<div class="form-field"> 
						<input type="text" name="versamento.tributi.interiImporto[0]" tabindex="24" size="9" maxlength="13" value="400" class="form-control numerico importoFieldClass puliziaImportiAZero" id="importoInt" onblur="deselezionato(this); getTot(this);" onfocus="selezionato(this)" readonly="&quot;readonly&quot;">
						,
		...
		<div class="form-group">				
			...
			<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2 margin-top22">				   
				  <input id="interiSaldoVers" type="text" class="form-control numerico solaLettura puliziaImportiAZero" style="text-align: right" size="9" maxlength="13" readonly="true" onfocus="blur" value="400">
				  ,
		...
		<div class="form-group">
			<div class="form-field-input col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<input type="hidden" name="saldo" value="400.00"> 
		...
		<div class="bs-example">
			<div class="form-group">
						...
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-2">
							...
							<div class="form-field">						
								<input type="text" readonly="readonly" value="13/03/2018" class="form-control">												
							</div>
						</div>
				...
				<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
					...
					<div class="form-field">						
							...
							<input type="text" name="dataIncassoHtml" tabindex="55" size="15" maxlength="10" value="31/07/2019" class="form-control" onfocus="javascript: this.style.backgroundColor = 0xFFFFFF;" readonly="readonly">
				...
				<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
					...
					<div class="form-field">
						<input type="text" name="interiSaldo" maxlength="13" value="400" class="form-control numerico puliziaImportiAZero" id="interiSaldo" readonly="readonly">
						,
					...
					<div class="form-group">
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
							...
							<div class="form-field">						
								<input type="text" class="form-control" readonly="readonly" value="602">
							</div>
						</div>
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
							...
							<div class="form-field">				
									...
									<input type="text" class="form-control" readonly="readonly" value="Revocata da Cliente
">
