...
<head>
	...
	<body>
			<div class="wrapper"> 
	<form name="f23MainForm" method="post" action="/sapef23/f23/spedisciModello.do"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="InvalidToken">
	...
	<input type="hidden" name="tipoRiepilogo" value="riepilogo_f23_deleghe">
		...
		<div class="messagePanel alert" style="display: block;" id="erroreRiepilogo">
			
			<h3 class="titleSection">Messaggio al cliente</h3>
			<p>
				<strong>
						
									Non sono stati trovati elementi corrispondenti alla sua richiesta.La preghiamo di raffinare la ricerca e ritentare.<br>
					...
					<div class="form-field-input col-lg-4 col-md-5 col-sm-5 col-xs-5">
						...
						<div class="form-field">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								dal&nbsp;&nbsp;
								<input type="text" name="dataDa" maxlength="10" size="10" value="01/08/2019" onblur="blurDate(this);" onfocus="focusDate(this);" class="datepicker form-control dataRiep hasDatepicker" id="dp1568750596698"><img class="ui-datepicker-trigger" src="/librerie/youwebbusiness/sapef23/f23/images/calendar.png" alt="Calendario" title="Calendario">
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
								al&nbsp;&nbsp;
								<input type="text" name="dataA" maxlength="10" size="10" value="30/09/2019" onblur="blurDate(this);" onfocus="focusDate(this);" class="datepicker form-control dataRiep hasDatepicker" id="dp1568750596699"><img class="ui-datepicker-trigger" src="/librerie/youwebbusiness/sapef23/f23/images/calendar.png" alt="Calendario" title="Calendario">
							</div>
						</div>
					</div>
