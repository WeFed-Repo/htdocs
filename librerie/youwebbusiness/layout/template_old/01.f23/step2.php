	...
	<div class="selezioneCC tabellaSelezioneCC">
		<div class="CCselezionato clearfix">
			...
			<span class="col-md-4 col-lg-4 col-sm-4 col-xs-4" id="label-intestazione" style="clear:both;">Intestato a:</span>
				...
				<div isvisible="true" class="col-md-4 col-lg-4 col-sm-4 col-xs-4" id="numeri">
			...
			<div class="form-group">
				...
				<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-3">
					...
					<div class="form-field">						
							...
							<input type="text" name="contribuente.dataNascita1Html" tabindex="4" value="11/05/1976" style="width:120px" class="dataNascitaHtml datepicker form-control w-auto hasDatepicker" readonly="readonly" disabled="disabled" id="dp1570521640492"><img class="ui-datepicker-trigger" src="/sapef23/f23/images/calendar.png" alt="Calendario" title="Calendario">
...
<script type="text/javascript">
		  	  ...
		  	  function conferma() {
			  	funzioniRiepilogoJS('/sapef23/f23/spedisciModello.do');
		      }
	...
	<div class="pull-right margin-bottom20">
		<input type="button" class="btn btn-primary" value="Stampa" href="#" onclick="javascript: stampa();">
					...
					&nbsp;
			<input type="button" class="btn btn-primary" value="indietro" href="#" onclick="javascript: indietro('riepilogoMod');">
		
		
		
			
				
				<input type="button" class="btn btn-primary execute" value="Conferma" href="#" onclick="javascript: conferma();">
