                    ...
                    <div class="col-xs-12 white-block">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: RagioneSocialeCreditore">AUTOMOBILE CLUB MODENA</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: CodiceSiaOrdinante">AVLC9</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: CodiceCucOrdinante">0748872E</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: $component.AbiBanca">05034 - BANCO BPM S.P.A.</label><!--RapportoAbiOrdinante-->
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: IbanOrdinante">IT05K0503412900000000047659</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 no-padding">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: CodiceIdOrdinante">IT280010000000179340369</label>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-12 white-block">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: RagioneSocialeDebitore">FRANCHINI FABRIZIO</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: IbanDebitore">IT65Y0200812920000104009387</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                    ...
                    <div class="col-xs-12 white-block">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: Localization.TipologieDispositive.GetLabel(TipoDisposizione())">Esiti Incassi Sepa Direct Debit</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: TipoIncasso">CORE - Ordinario</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="numericTextSeparator: Importo">77,06</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: CausaleIncassoId">OTHR - Other</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="dateText: DataFlusso">27/12/2018</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="dateText: DataScadenza">08/01/2019</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: IdUnivocoPag">TESSERA ACI FA132BC</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: DescrizioneRiconciliazione"> 99371</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 white-block">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: NomeSupportoDistinta">XDD00106609/181227/00032837734</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 no-padding">
                        ...
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: CodiceMandato">AVLC94FA132BC</label>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="col-xs-4">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="dateText: DataSottoscrizione">03/08/2015</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: $component.LocalizationEsito(StatoEsito())">Scartata</label>
                                </div>
                            </div>
                            <!-- 2263 - revisione esiti sdd TODO: verificare valore -->
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="text: CodStatoErrore">AM04 - Il denaro disponibile per coprire l'importo della transazione non è sufficiente</label>
                                </div>
                            </div>
                            <!-- 2263 - end -->
                        </div>
            ...
            <div class="table-responsive">
                <div class="dataTables_wrapper" style="margin-top: 10px">
                    <table class="dataTable table">
                        ...
                        <tbody data-bind="foreach: Page">
                            <tr>
                                <td style="text-align: center;" data-bind="dateText: DataCreazione">27/12/2018</td>
                                <td style="text-align: center;" data-bind="dateText: DataCaricamento">27/12/2018</td>
                                <td style="text-align: center; cursor: pointer;" data-bind="click: $component.SubDetailEsito">
                                    <a href="#" style="text-decoration: underline" data-bind="text: $component.LocalizationEsito(StatoMessaggio)">Confermata</a>
                                </td>
                                <td data-bind="text: $component.LocalizationEsito(StatoMessaggio,true)">La richiesta di pagamento è stata presa in carico dalla Banca</td>
                            </tr>
                        
                            <tr>
                                <td style="text-align: center;" data-bind="dateText: DataCreazione">10/01/2019</td>
                                <td style="text-align: center;" data-bind="dateText: DataCaricamento">10/01/2019</td>
                                <td style="text-align: center; cursor: pointer;" data-bind="click: $component.SubDetailEsito">
                                    <a href="#" style="text-decoration: underline" data-bind="text: $component.LocalizationEsito(StatoMessaggio)">Scartata</a>
                                </td>
                                <td data-bind="text: $component.LocalizationEsito(StatoMessaggio,true)">La richiesta di pagamento è stata rifiutata per motivi formali o controlli sostanziali</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
