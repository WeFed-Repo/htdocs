                    ...
                    <table class="dataTable table">
                        <thead>
                            <tr>
                                ...
                                <!-- Campi rimossi perchè non esistenti nelle Grandi Distinte (ReadOnly)-->
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="form-field-input col-xs-3">
                                    ...
                                    <div class="form-field">
                                        <select class="form-control" data-bind="options: Banche, optionsCaption: 'Tutti', optionsText: 'Descrizione', optionsValue: 'CodiceAbi', value: List.PagingFilter.CodiceAbi"><option value="">Tutti</option></select>
                                    </div>
                                </div>
        ...
        <div data-bind="with: Esito" style="font-size: 12px;">
            <div class="section">
                <div class="row">
                    ...
                    <!--Esito per flussi SEDAC-->
                    <div data-bind="visible: (EsitoFlusso() || CodiceScarto() || MotivoAggiuntivoScarto())" class="col-xs-12 white-block" style="display: none;">
                        <div class="col-xs-12 text-center">
                            <h1>
                                Esito per flussi sedac
                            </h1>
