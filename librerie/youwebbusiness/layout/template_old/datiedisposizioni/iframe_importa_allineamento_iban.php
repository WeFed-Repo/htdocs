...
<div id="progressbar" style="position: absolute; visibility: hidden; padding: 5px; text-align: center; width: 500px; height: 250px; bottom: 284px; left: 414px;">
<table align="center" border="0" class="sfondoTabelle" style="border: 1px;">
<tbody><tr>
<td class="old-sectionTitle" id="messaggio"><h3 class="new-titleSection">Importazione distinta in corso, attendere prego...</h3></td>
</tr>
<tr align="center">
...
<tbody><tr>
<td>
<form enctype="multipart/form-data" action="uploadfilealvarmain" method="POST" name="uploadfilealvar" onsubmit="return controlla(this)">
<input name="dialog_message_title" type="hidden" value="Allineamento Iban">
<table width="100%">
<tbody><tr valign="top">
<td>
...
<td align="left" class="old-pageTitle titoloTabella" height="20"><div class="new-flag"></div><h1>
                                          Allineamento Iban
																			...
																			&nbsp;
																		<a class="old-pageHelp" href="#" onclick="popHelp('./html/help/AreaDispositiva/AllineamentoArchivi/ImportaAllineamentoIBAN.htm','NewWin1','toolbar=no,scrollbars=yes,status=no,width=534,height=240',534, 240);"><img src="./newstyle/images/i_help.png" class="imgSrv" alt="Help On Line"></a></h1></td>
</tr>
<tr>
<td>
...
<td align="left" width="125">
																						&nbsp;&nbsp;&nbsp;File
																						<span class="testoRedSmallBold">*</span></td><td align=""><input class="bottomFileUpload rigaScura" name="extfile" size="95" type="file" value="seleziona..."></td>
</tr>
