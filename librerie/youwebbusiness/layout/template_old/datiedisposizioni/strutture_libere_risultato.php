...
<select data-bind="value: StruttureLibereViewModel.PiazzaturaStruttureLibere.ABIBanca" id="StruttureLibereViewModel_PiazzaturaStruttureLibere_ABIBanca" name="StruttureLibereViewModel.PiazzaturaStruttureLibere.ABIBanca" style="width: 350px" class="new-form-control banca"><option value="">TUTTI</option><option value="05584">05584 - BANCA POPOLARE DI MILANO S.P.A.</option><option value="05034">05034 - BANCO BPM S.P.A.</option></select>                    </span>
 ...
 <table class="filter-toolbar" style="border-collapse: collapse;" cellpadding="0" cellspacing="0">
     <tbody>
         ...
         <tr>
             <td><a id="tool-refresh" class="ank-icon-filter-apply inactive" title="Applica Filtro Rapido" data-bind="singleClick: function() { rootViewModel.StruttureLibereViewModel.PiazzaturaStruttureLibere.FilterRefresh(); }, css:{ inactive: StruttureLibereViewModel.PiazzaturaStruttureLibere.piazzaturaUnChanged}, enable: StruttureLibereViewModel.PiazzaturaStruttureLibere.piazzaturaChanged"><img src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/i_quick-filter.png" border="0" width="20" height="20"></a></td>
             <td><a id="tool-goto" class="ank-icon-filter-go" title="Filtri" data-bind="singleClick: function(){ rootViewModel.StruttureLibereViewModel.PiazzaturaStruttureLibere.FilterGoTo(); }, css:{ advanced: rootViewModel.StruttureLibereViewModel.PiazzaturaStruttureLibere.isFilterAdvanceSet}"><img src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/i_filter.png" border="0" width="20" height="20"></a></td>
             <td><a id="tool-reset" class="ank-icon-filter-reset" title="Azzera filtri" data-bind="singleClick: function(){ rootViewModel.StruttureLibereViewModel.PiazzaturaStruttureLibere.FilterReset(); }"><img src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/i_remove-filter.png" border="0" width="20" height="20"></a></td>
         </tr>
     </tbody>
 </table>
...
<!-- div class="export-toolbar" style="border: chocolate 1px solid;" -->
   ...
   <table class="export-toolbar" style="border-collapse: collapse;" cellpadding="0" cellspacing="0">
       <tbody>
           <tr><td>&nbsp;</td></tr>
           <tr>
                   <td style="width:20px;cursor:pointer;"><a title="Stampa" class="ank-icon-export-Pdf" onclick="javascript:KoExport('/anchise.web/SL/StruttureLibere/ExportAsPdf?trk=empty');"><img src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/i_pdf.png" border="0" width="20" height="20"></a></td>
           </tr>
       </tbody>
   </table>
<!-- /div -->
...
<script type="text/javascript">
        ...
        */
        ...
        var piazz = rootViewModel.StruttureLibereViewModel.PiazzaturaStruttureLibere;
        piazz.piazzaturaUnChanged = ko.computed(
            function() {
                return rootViewModel.StruttureLibereViewModel.PiazzaturaStruttureLibere.IdAzienda() == '' &&
                    rootViewModel.StruttureLibereViewModel.PiazzaturaStruttureLibere.ABIBanca() == '';
            }
        );
        ...
        piazz.FilterRefresh = function() {
            KoGoTo('/anchise.web/SL/StruttureLibere/FilterApply?trk=empty');
        };
        
        piazz.FilterGoTo = function() {
            KoGoTo('/anchise.web/SL/StruttureLibere/FilterGoTo?trk=empty');
        };
        
        piazz.FilterReset = function() {
            KoGoTo('/anchise.web/SL/StruttureLibere/FilterReset?trk=empty');
        };
