...
<div id="progressbar" style="position: absolute; visibility: hidden; padding: 5px; text-align: center; width: 500px; height: 250px; bottom: 164px; left: 414px;">
<table align="center" border="0" class="sfondoTabelle" style="border: 1px;">
<tbody><tr>
<td class="titoloTabella old-pageTitle" id="messaggio"><div class="new-flag"></div><h1>Importazione distinta in corso, attendere prego...<a class="old-pageHelp" href="#" onclick="popHelp('./html/help/AreaDispositiva/IncassiEstero/ImportaIncassiEstero.htm','NewWin1','toolbar=no,scrollbars=yes,status=no,width=534,height=240',534, 240);"><img src="./newstyle/images/i_help.png" class="imgSrv" alt="Help On Line"></a></h1></td>
</tr>
<tr align="center">
...
<div id="main-div">
<form enctype="multipart/form-data" action="uploadfilerb" method="POST" name="uploadfilerb" onsubmit="return controlla(this)">
<input name="dialog_message_title" type="hidden" value="
			Importa Incassi Estero
		">
...
<tbody><tr>
<td class="testoRedSmall" valign="top">Questa videata consente l'importazione del file generato tramite il software 'YouBusiness Web - incassi estero'.<br>Ad importazione avvenuta accedere alla sezione 'elenco distinte' (area dispositiva &gt; gestione distinte &gt; elenco distinte) per autorizzare la trasmissione alla banca<br>
</td>
</tr>
<tr>
<td width="100%">
...
<tr>
<td>
<table border="0" cellpadding="3" cellspacing="0" class="rigachiara" width="100%">
<tbody><tr class="rigaScura" height="20">
<td colspan="2" class="oRight">
																						&nbsp;
																					</td>
</tr>
<tr class="rigaScura">
<td align="left" class="col-1" width="125" style="width: 15%; text-align: left;">
																						&nbsp;&nbsp;&nbsp;File
																						<span class="testoRedSmallBold">*</span></td><td class="col-2" style="width: 50%;"><input class="bottomFileUpload rigaScura" name="extfile" size="95" type="file" value="seleziona..."></td>
</tr>
<input name="verify" type="hidden" value="false">
...
<tr align="center" class="rigaScura old-buttons">
<td colspan="2">
<br>
																						&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr class="rigaScura">
<td align="left" class="testoRedSmallBold" colspan="2">
																						* campi obbligatori
																					</td>
</tr>
</tbody></table>
...
</div><div class="new-buttons"><input class="btn" style="cursor:Hand" type="submit" value="Importa"></div>
</div>
</td>
</tr>
</tbody></table>
