...
<div id="0679b1f7cb1a4fb3aa2e8ff9d525b26c_6">
...
<script type="text/javascript">
    var UiViewModel = function () {
        ...
        // Initialize
        self.Init = function () {
            $('.hide', $('#0679b1f7cb1a4fb3aa2e8ff9d525b26c_6')).removeClass('hide');
        };
    };
    ...
    $(document).ready(function () {
        ko.applyBindings(uiHelper, document.getElementById('0679b1f7cb1a4fb3aa2e8ff9d525b26c_6'));
...
<div id="0679b1f7cb1a4fb3aa2e8ff9d525b26c_4">
    ...
    <div data-bind="with: Distinta">
        <div class="section">
            ...
            <div class="text-right">
                <input type="button" class="btn btn-primary" value="Sintetico" data-bind="singleClick: ChangeRowView">
            ...
            <div>
                ...
                <div class="row">
                    <div class="table-responsive">
                        <div class="dataTables_wrapper" style="margin-top: 10px">
                            <table class="dataTable table">
                                <thead data-bind="visible: $component.TemplateRiga() == 'sintetico'" style="display: none;">
                                    <tr>
                                ...
                                <tbody data-bind="foreach: Page">
                                    <tr data-bind="visible: $component.TemplateRiga() != 'sintetico'" style="">
                                        <th colspan="9">
            ...
            <div class="col-xs-12 white-block">
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: Ordinante.Abi() + '-' + Ordinante.Cab() + '-' + Ordinante.Conto()">05034-33473-000000011905</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: Beneficiario.Denominazione">COMUNE DI SAN  MARTINO B.A. TESORERIA</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: Beneficiario.Iban">IT39W0521659790000000000730</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 no-padding">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="numericTextSeparator: Importo">300,00</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: Divisa">EUR</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: CodiceUnivoco">0796765T0503425/10/2017T095310</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: DescrizioneRiconcilazione">terzo bonifico</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: HasEsitoAlBeneficiario() ? 'Si' : 'No'">No</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 white-block">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: Beneficiario.Denominazione">parodi annamaria</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: Beneficiario.Iban">IT08H0558432440000000015900</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 no-padding">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="numericTextSeparator: Importo">100,00</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: CodiceUnivoco">0796765T0503425/10/2017T095212</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: DescrizioneRiconcilazione">primo bonifico</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 no-padding">
            ...
            <div class="col-xs-12 white-block">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: Beneficiario.Denominazione">simona piontini</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: Beneficiario.Iban">IT10B0558485220000000042865</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 no-padding">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="numericTextSeparator: Importo">200,00</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                ...
                <div class="col-xs-12 no-padding">
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: CodiceUnivoco">0796765T0503425/10/2017T095241</label>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8 textTruncate">
                            <label data-bind="text: DescrizioneRiconcilazione">secondo bonifico</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 no-padding">
...
<script type="text/javascript">
    var jDistinta = {"IdDivisa":"EUR","EsitoOrdinante":false,"AddebitoCumulativo":"NR","DataEsecuzione":"2017-10-25T00:00:00","IsUrgP":false,"Disposizioni":null,"TipoConto":{"Codice":null,"DescrizioneLibera":null},"Beneficiario":null,"Identifier":{"Id":33586852,"Version":499502178,"IdAzienda":588536,"IdRapporto":2455525,"ClasseServizio":1,"Crypt":"Hyj9GK9hIZjoXdBoBFZ41Ta9/nglGnmkjzDdimreC2zvazM3rbIRmqJB8GUQ9/izE1uIDlndDfVv47C8T6xoQ+CSvTnwZlgREuuwcTanTrSJibFtPYNTk3tkvkDqsD4eAkYO0uCpIymunQVSCDBiTr1gIbauNgDywrSOm+FOnq4=","Hash":"02C6B99F9457FA1D798B808C9AE5D759F173808EAC69F06B04698138E3DDB25F"},"NumeroOrdini":3,"NomeSupporto":"XBN00588536/171025/00033586852","StatoDistinta":1,"Firmatari":null,"DataCreazione":"2017-10-25T09:53:54.263","DataSpedizione":null,"DataDisponibilita":null,"DataConferma":null,"Intestatario":{"Identifier":{"Id":null,"Version":null,"IdAzienda":588536,"IdRapporto":2455525,"ClasseServizio":0,"Crypt":"kMrk9g8ZmzDTtKCnNXipQw52hIdXfNUsZ3MSjVoG5ZEggc6Z9BjHVhYZX6WWBvwEX9TSuyAUnNseB4H+J42m1Z0AWB7dLXmENl1dgcCvmOBwpzH7GJy3hN6/qXGzP2w2e/VmwuWIVO5Ro4pALd8yEQ==","Hash":"965AA916692C3474F18952F40E152B13D996D688A528B2F0DCD98830BA2B9254"},"RagioneSociale":"C.P.C. INOX SPA","Cuc":"VANTAGGT","IdentificativoFiscale":"13336550150","Conto":"000000011905                                      ","Iban":"IT38V0503433473000000011905","Abi":"05034","Cab":"33473","Sia":"73586","StatoRapporto":1},"Flow":{"Id":{"Id":-2114000064,"Version":null,"IdAzienda":null,"IdRapporto":null,"ClasseServizio":0,"Crypt":"6LtZqrJQG9yqjK0rXTZ1ZWxCoDcwiki4vVwSIfQwhYIL9HLup4RkqEhBnb8aTUUIKYG53yVdRHbQi7UTUEXlok2EZ0BxLA3R42KSheg7bn9dNWdc3JW4UzO8Ei5WTVjHggH2ItWT3Qb7sojZEIoipg==","Hash":"0012601CB8B665D7EA27B41DAACD559CA8D5EE3891A2B6BCC9A3040E54D09021"},"DataCreazione":null,"DataInvio":null,"Content":null},"PotereFirma":0,"Certificato":0,"Importo":600.00,"Esito":false,"Tipo":0,"CheckIban":1};
    ...
    function rootViewModel(distinta) {
        ...
        self.Init = function () {
            $('#0679b1f7cb1a4fb3aa2e8ff9d525b26c_5').load('/anchise2.web/Widget/LinkRapidi');
        }
        self.Init();
    }
    ...
    $(document).ready(function () {
        ko.applyBindings(viewModel, document.getElementById('0679b1f7cb1a4fb3aa2e8ff9d525b26c_4'));
    });
</script>
