            ...
            <tbody>
                ...
                <tbody><tr>
                    ...
                    <td class="Valore200" style="width: 66%;">
                        <span data-bind="enable: EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.PiazzaturaIdAziendaEnabled">
<select data-bind="value: EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdAzienda" id="EstrazioneAllineamentiArchiviIbanViewModel_PiazzaturaAllinementoArchiviIban_IdAzienda" name="EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdAzienda" style="width: 350px" class="new-form-control azienda"><option value="">TUTTI</option><option value="588536">C.P.C. INOX SPA</option></select>                        </span>
                    </td>
                    <td style="width: 8%;">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="Valore200">
                        <span data-bind="enable: EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.PiazzaturaAbiBancaEnabled">
<select data-bind="value: EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.ABIBanca" id="EstrazioneAllineamentiArchiviIbanViewModel_PiazzaturaAllinementoArchiviIban_ABIBanca" name="EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.ABIBanca" style="width: 350px" class="new-form-control banca"><option value="">TUTTI</option><option value="05584">05584 - BANCA POPOLARE DI MILANO S.P.A.</option><option value="05034">05034 - BANCO BPM S.P.A.</option></select>                        </span>
                    </td>
                </tr>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" class="old-inputForm">
                                <tbody><tr>
                                    ...
                                    <td class="Valore100" style="width: 60%;"><input data-bind="value: EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.CodiceSia" id="EstrazioneAllineamentiArchiviIbanViewModel_PiazzaturaAllinementoArchiviIban_CodiceSia" name="EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.CodiceSia" readonly="readonly" type="text" value="" class="new-form-control"></td>
                                    <td width="1%;">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td class="LabelWrap">Righe per pagina</td>
                                    <td class="Valore100"><select data-bind="value: EstrazioneAllineamentiArchiviIbanViewModel.NumeroRighePerPagina" id="EstrazioneAllineamentiArchiviIbanViewModel_NumeroRighePerPagina" name="EstrazioneAllineamentiArchiviIbanViewModel.NumeroRighePerPagina" class="new-form-control"><option value="10">10</option>
...
<input data-bind="datetime: EstrazioneAllineamentiArchiviIbanViewModel.DataCreazione.From" id="EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_From" name="EstrazioneAllineamentiArchiviIbanViewModel.DataCreazione.From" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_From_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_From").datepicker({
                    onSelect: function (dateText) {
                        $("#EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_From").datepicker('hide');
                ...
                $("#EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_From_imgcalendar").click(function(){
                    $("#EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_From").datepicker('show');
                });
            ...
            <td class="Valore200" style="width: 25%">
<input data-bind="datetime: EstrazioneAllineamentiArchiviIbanViewModel.DataCreazione.To" id="EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_To" name="EstrazioneAllineamentiArchiviIbanViewModel.DataCreazione.To" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_To_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            $.datepicker.regional['it'] = {
                closeText: 'Chiudi',
                prevText: '&#x3c;Prec',
            ...
            $.datepicker.setDefaults($.datepicker.regional['it']);
            $(document).ready(function () {
                $("#EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_To").datepicker({
                    onSelect: function (dateText) {
                        $("#EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_To").datepicker('hide');
                ...
                $("#EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_To_imgcalendar").click(function(){
                    $("#EstrazioneAllineamentiArchiviIbanViewModel_DataCreazione_To").datepicker('show');
                });
    ...
    <table cellpadding="0" cellspacing="0" class="old-inputForm">
        ...
        <tbody><tr>
            ...
            <td class="Valore200" style="width: 25%">
<input data-bind="datetime: EstrazioneAllineamentiArchiviIbanViewModel.DataRicezione.From" id="EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_From" name="EstrazioneAllineamentiArchiviIbanViewModel.DataRicezione.From" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_From_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            $.datepicker.regional['it'] = {
                closeText: 'Chiudi',
                prevText: '&#x3c;Prec',
            ...
            $.datepicker.setDefaults($.datepicker.regional['it']);
            $(document).ready(function () {
                $("#EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_From").datepicker({
                    onSelect: function (dateText) {
                        $("#EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_From").datepicker('hide');
                ...
                $("#EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_From_imgcalendar").click(function(){
                    $("#EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_From").datepicker('show');
                });
            ...
            <td class="Valore200" style="width: 25%">
<input data-bind="datetime: EstrazioneAllineamentiArchiviIbanViewModel.DataRicezione.To" id="EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_To" name="EstrazioneAllineamentiArchiviIbanViewModel.DataRicezione.To" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_To_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            $.datepicker.regional['it'] = {
                closeText: 'Chiudi',
                prevText: '&#x3c;Prec',
            ...
            $.datepicker.setDefaults($.datepicker.regional['it']);
            $(document).ready(function () {
                $("#EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_To").datepicker({
                    onSelect: function (dateText) {
                        $("#EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_To").datepicker('hide');
                ...
                $("#EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_To_imgcalendar").click(function(){
                    $("#EstrazioneAllineamentiArchiviIbanViewModel_DataRicezione_To").datepicker('show');
                });
            ...
            <td style="width: 8%">
                &nbsp;
                     ...
                     <tr id="FiltriAvanzati1" style="height: 1pt; display: none;" class="section"><td colspan="2"></td></tr>
    ...
    </div><div class="new-buttons"><input id="ank-btn-search" type="button" value="Visualizza" data-bind="singleClick: function(){ KoGoTo('/anchise.web/ESITI/EstrazioneALIBAN/Ricerca?trk=empty');}" class="btn"></div></div>
    <script type="text/javascript">
        $(document).ready(function () {
...
<script type="text/javascript">
                                            $(function () { RegisterViewModel("EstrazioneAllineamentiArchiviIbanViewModel",{"PiazzaturaAllinementoArchiviIban":{"IdAzienda":null,"ABIBanca":null,"IdRapporto":null},"DataCreazione":{"From":null,"To":null},"DataRicezione":{"From":null,"To":null},"PaginaRichiesta":1,"NumeroRighePerPagina":10,"OrdinamentoColonna":3,"OrdinamentoDirezione":2}, true);
             var root = rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban; 
             ...
             initializePiazzatura(
                rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdAzienda(),
                rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.ABIBanca(),
                rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdRapporto());
    
             var cmbAzienda = $('#EstrazioneAllineamentiArchiviIbanViewModel_PiazzaturaAllinementoArchiviIban_IdAzienda');
             var cmbBanca = $('#EstrazioneAllineamentiArchiviIbanViewModel_PiazzaturaAllinementoArchiviIban_ABIBanca');
             ...
             */
             function registerChangeCombo() {
                 cmbAzienda.change(function () {
                     var selectedAzienda = rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdAzienda();
                 ...
                 cmbBanca.change(function () {
                     var selectedAzienda = rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdAzienda();
                     var selectedBanca = rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.ABIBanca();
        ...
        */
             function initializeComboBoxFromPiazzaturaRapporto(piazzaturaRapporto) {
                 ...
                 var emptySIA = '';
                 var emptyIdBanca = '';
                 rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.CodiceSia(emptySIA);
                 rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdBanca(emptyIdBanca);
                 ...
                 $.each(aziende, function (index, azienda) {
                     ...
                     if (azienda.IdAzienda == piazzatura.IdAzienda) {
                         rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.CodiceSia(azienda.CodiceSIA);
                     }
                 });
                 ...
                 $.each(banche, function (index, banca) {
                     ...
                     if (banca.ABI == piazzatura.ABIBanca) {
                        rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdBanca(banca.Id);
                    }
                 });
                 // bug ie7
                 cmbBanca.removeClass("banca").addClass("banca");
            
                 rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdAzienda(piazzatura.IdAzienda);
                 rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.ABIBanca(piazzatura.ABIBanca);
                 rootViewModel.EstrazioneAllineamentiArchiviIbanViewModel.PiazzaturaAllinementoArchiviIban.IdRapporto(piazzatura.IdRapporto);
