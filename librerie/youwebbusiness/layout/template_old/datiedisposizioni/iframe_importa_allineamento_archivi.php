...
<div id="progressbar" style="position: absolute; visibility: hidden; padding: 5px; text-align: center; width: 500px; height: 250px; bottom: 190.5px; left: 220.5px;">
<table align="center" border="0" class="sfondoTabelle" style="border: 1px;">
<tbody><tr>
<td class="titoloTabella old-pageTitle" id="messaggio"><div class="new-flag"></div><h1>Importazione distinta in corso, attendere prego...<a class="old-pageHelp" href="#" onclick="popHelp('./html/help/AreaDispositiva/AllineamentoArchivi/ImportaDistinteAL.htm','NewWin1','toolbar=no,scrollbars=yes,status=no,width=534,height=240',534, 240);"><img src="./newstyle/images/i_help.png" class="imgSrv" alt="Help On Line"></a></h1></td>
</tr>
<tr align="center">
...
<tr>
<td class="rigaScura"><img id="pb_img2" name="pb_img2" src="img/semaforogrigio.gif"></td><td class="rigaScura">Controllo CC.</td>
</tr>
<tr>
<td class="rigaScura"><img id="pb_img3" name="pb_img3" src="img/semaforogrigio.gif"></td><td class="rigaScura">Controllo validità.</td>
</tr>
<tr>
...
<tbody><tr>
<td>
<form enctype="multipart/form-data" action="uploadfilealmain" method="POST" name="uploadfileal" onsubmit="return controlla(this)">
<input name="dialog_message_title" type="hidden" value="
			Importa Allineamento Archivi
		">
<table width="100%">
<tbody><tr valign="top">
<td>
...
<td align="left" width="125">
																						&nbsp;&nbsp;&nbsp;File
																						<span class="testoRedSmallBold">*</span></td><td><input class="bottomFileUpload rigaScura" name="extfile" size="95" type="file" value="seleziona..."></td>
</tr>
...
<tr align="center" class="rigaScura">
<td class="old-buttons" colspan="2">
<br>
																						&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr class="rigaScura">
