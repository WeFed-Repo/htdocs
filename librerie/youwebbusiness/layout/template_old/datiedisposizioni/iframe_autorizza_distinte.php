...
<script type="text/javascript">
    ...
    <div class="container"><div class="new-riquadro">
        <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    <td colspan="2" class="page-title"><div class="search-flag"></div><h1>Autorizza Distinte
                    </h1></td>
                </tr>
            </thead>
            <tbody>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" class="old-inputForm">
                                <tbody><tr>
                                    ...
                                    <td class="Valore100" style="width: 60%"><input data-bind="value: RicercaFirmaDistintaViewModel.PiazzaturaRicercaDistinta.CodiceSia" id="RicercaFirmaDistintaViewModel_PiazzaturaRicercaDistinta_CodiceSia" name="RicercaFirmaDistintaViewModel.PiazzaturaRicercaDistinta.CodiceSia" readonly="readonly" type="text" value="" class="new-form-control">
                                    </td>
                                    <td style="width: 1%">
                                        &nbsp;
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="Valore100"><select data-bind="value: RicercaFirmaDistintaViewModel.NumeroRighePerPagina" id="RicercaFirmaDistintaViewModel_NumeroRighePerPagina" name="RicercaFirmaDistintaViewModel.NumeroRighePerPagina" class="new-form-control"><option value="10">10</option>
                    ...
                    <tr class="section">
                        <td><table cellpadding="0" cellspacing="0" class="old-inputForm">
                                <tbody><tr>
                                    ...
                                    <td class="Valore200" style="width: 66%;">
<select data-bind="value: RicercaFirmaDistintaViewModel.IdTipoDispositivo" id="RicercaFirmaDistintaViewModel_IdTipoDispositivo" name="RicercaFirmaDistintaViewModel.IdTipoDispositivo" style="width: 350px" class="new-form-control"><option value="">TUTTI</option>
...
<option value="8">Variazioni Coordinate RID</option>
                                ...
                                <tr>
                                    ...
                                    <td class="Valore200">
<select data-bind="value: RicercaFirmaDistintaViewModel.IdStatoDistinta" id="RicercaFirmaDistintaViewModel_IdStatoDistinta" name="RicercaFirmaDistintaViewModel.IdStatoDistinta" style="width: 350px" class="new-form-control"><option value="">TUTTI</option>
...
<input data-bind="numeric: RicercaFirmaDistintaViewModel.Importo.From" id="RicercaFirmaDistintaViewModel_Importo_From" name="RicercaFirmaDistintaViewModel.Importo.From" type="text" value="" class="new-form-control">            </td>
            <td style="width: 16%;">
                &nbsp;
            </td>
            <td class="Valore200" style="width: 25%;">
<input data-bind="numeric: RicercaFirmaDistintaViewModel.Importo.To" id="RicercaFirmaDistintaViewModel_Importo_To" name="RicercaFirmaDistintaViewModel.Importo.To" type="text" value="" class="new-form-control">            </td>
            <td style="width: 8%;">
                &nbsp;
            </td>
        </tr>
    ...
    <table cellpadding="0" cellspacing="0" class="old-inputForm">
        ...
        <tbody><tr>
            ...
            <td class="Valore200" style="width: 25%">
<input data-bind="datetime: RicercaFirmaDistintaViewModel.DataCreazione.From" id="RicercaFirmaDistintaViewModel_DataCreazione_From" name="RicercaFirmaDistintaViewModel.DataCreazione.From" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="RicercaFirmaDistintaViewModel_DataCreazione_From_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#RicercaFirmaDistintaViewModel_DataCreazione_From").datepicker({
                    onSelect: function (dateText) {
                        $("#RicercaFirmaDistintaViewModel_DataCreazione_From").datepicker('hide');
                ...
                $("#RicercaFirmaDistintaViewModel_DataCreazione_From_imgcalendar").click(function(){
                    $("#RicercaFirmaDistintaViewModel_DataCreazione_From").datepicker('show');
                });
            ...
            <td class="Valore200" style="width: 25%">
<input data-bind="datetime: RicercaFirmaDistintaViewModel.DataCreazione.To" id="RicercaFirmaDistintaViewModel_DataCreazione_To" name="RicercaFirmaDistintaViewModel.DataCreazione.To" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="RicercaFirmaDistintaViewModel_DataCreazione_To_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            $.datepicker.regional['it'] = {
                closeText: 'Chiudi',
                prevText: '&#x3c;Prec',
            ...
            $.datepicker.setDefaults($.datepicker.regional['it']);
            $(document).ready(function () {
                $("#RicercaFirmaDistintaViewModel_DataCreazione_To").datepicker({
                    onSelect: function (dateText) {
                        $("#RicercaFirmaDistintaViewModel_DataCreazione_To").datepicker('hide');
                ...
                $("#RicercaFirmaDistintaViewModel_DataCreazione_To_imgcalendar").click(function(){
                    $("#RicercaFirmaDistintaViewModel_DataCreazione_To").datepicker('show');
                });
...
<script type="text/javascript">
        ...
        */
             ...
             function initializePiazzatura(selectedAzienda, selectedBanca, selectedRapporto) {
                 ...
                 communicationSendObject('/anchise.web/DISTINTE/RicercaAutorizzaDistinte/InitializeByPiazzatura?trk=empty', piazzatura, initializeFromPiazzatura);
             }
        ...
        */
             ...
             $(document).ready(function() {
                 ...
                 root.GoToRicercaAutorizzaDistinta = function(idStatoDistinta) {
                     if (idStatoDistinta == ''){
                         KoGoTo('/anchise.web/DISTINTE/SommarioAutorizzaDistinte/Ricerca?trk=empty');
                     } else {
                         KoGoTo('/anchise.web/DISTINTE/RicercaAutorizzaDistinte/Ricerca?trk=empty');
                     }
                 };
         ...
         UpdateViewModelBinding();}); </script></div>
                        <script type="text/javascript">
    $(document).ready(function () {
        communicationLoad('/anchise.web/DISTINTE/RicercaAutorizzaDistinte?trk=empty');
    });
</script>
                    </td>
                </tr>
