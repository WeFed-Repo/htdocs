            ...
            <tbody>
                ...
                <tbody><tr>
                    ...
                    <td class="Valore200" style="width: 66%;">
                        <span data-bind="enable: EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.PiazzaturaIdAziendaEnabled">
<select data-bind="value: EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdAzienda" id="EstrazioneAllineamentiArchiviViewModel_PiazzaturaEstrazioneAllinementoArchivi_IdAzienda" name="EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdAzienda" style="width: 350px" class="new-form-control azienda"><option value="">TUTTI</option><option value="588536">C.P.C. INOX SPA</option></select>                        </span>
                    </td>
                    <td style="width: 8%;">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td class="Valore200">
                        <span data-bind="enable: EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.PiazzaturaAbiBancaEnabled">
<select data-bind="value: EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.ABIBanca" id="EstrazioneAllineamentiArchiviViewModel_PiazzaturaEstrazioneAllinementoArchivi_ABIBanca" name="EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.ABIBanca" style="width: 350px" class="new-form-control banca"><option value="">TUTTI</option><option value="05584">05584 - BANCA POPOLARE DI MILANO S.P.A.</option><option value="05034">05034 - BANCO BPM S.P.A.</option></select>                        </span>
                    </td>
                </tr>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" class="old-inputForm">
                                <tbody><tr>
                                    ...
                                    <td class="Valore100" style="width: 60%;"><input data-bind="value: EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.CodiceSia" id="EstrazioneAllineamentiArchiviViewModel_PiazzaturaEstrazioneAllinementoArchivi_CodiceSia" name="EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.CodiceSia" readonly="readonly" type="text" value="" class="new-form-control"></td>
                                    <td width="1%;">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td class="LabelWrap">Righe per pagina</td>
                                    <td class="Valore100"><select data-bind="value: EstrazioneAllineamentiArchiviViewModel.NumeroRighePerPagina" id="EstrazioneAllineamentiArchiviViewModel_NumeroRighePerPagina" name="EstrazioneAllineamentiArchiviViewModel.NumeroRighePerPagina" class="new-form-control"><option value="10">10</option>
...
<input data-bind="datetime: EstrazioneAllineamentiArchiviViewModel.DataCreazione.From" id="EstrazioneAllineamentiArchiviViewModel_DataCreazione_From" name="EstrazioneAllineamentiArchiviViewModel.DataCreazione.From" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="EstrazioneAllineamentiArchiviViewModel_DataCreazione_From_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#EstrazioneAllineamentiArchiviViewModel_DataCreazione_From").datepicker({
                    onSelect: function (dateText) {
                        $("#EstrazioneAllineamentiArchiviViewModel_DataCreazione_From").datepicker('hide');
                ...
                $("#EstrazioneAllineamentiArchiviViewModel_DataCreazione_From_imgcalendar").click(function(){
                    $("#EstrazioneAllineamentiArchiviViewModel_DataCreazione_From").datepicker('show');
                });
            ...
            <td class="Valore200" style="width: 25%">
<input data-bind="datetime: EstrazioneAllineamentiArchiviViewModel.DataCreazione.To" id="EstrazioneAllineamentiArchiviViewModel_DataCreazione_To" name="EstrazioneAllineamentiArchiviViewModel.DataCreazione.To" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="EstrazioneAllineamentiArchiviViewModel_DataCreazione_To_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            $.datepicker.regional['it'] = {
                closeText: 'Chiudi',
                prevText: '&#x3c;Prec',
            ...
            $.datepicker.setDefaults($.datepicker.regional['it']);
            $(document).ready(function () {
                $("#EstrazioneAllineamentiArchiviViewModel_DataCreazione_To").datepicker({
                    onSelect: function (dateText) {
                        $("#EstrazioneAllineamentiArchiviViewModel_DataCreazione_To").datepicker('hide');
                ...
                $("#EstrazioneAllineamentiArchiviViewModel_DataCreazione_To_imgcalendar").click(function(){
                    $("#EstrazioneAllineamentiArchiviViewModel_DataCreazione_To").datepicker('show');
                });
    ...
    <table cellpadding="0" cellspacing="0" class="old-inputForm">
        ...
        <tbody><tr>
            ...
            <td class="Valore200" style="width: 25%">
<input data-bind="datetime: EstrazioneAllineamentiArchiviViewModel.DataRicezione.From" id="EstrazioneAllineamentiArchiviViewModel_DataRicezione_From" name="EstrazioneAllineamentiArchiviViewModel.DataRicezione.From" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="EstrazioneAllineamentiArchiviViewModel_DataRicezione_From_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            $.datepicker.regional['it'] = {
                closeText: 'Chiudi',
                prevText: '&#x3c;Prec',
            ...
            $.datepicker.setDefaults($.datepicker.regional['it']);
            $(document).ready(function () {
                $("#EstrazioneAllineamentiArchiviViewModel_DataRicezione_From").datepicker({
                    onSelect: function (dateText) {
                        $("#EstrazioneAllineamentiArchiviViewModel_DataRicezione_From").datepicker('hide');
                ...
                $("#EstrazioneAllineamentiArchiviViewModel_DataRicezione_From_imgcalendar").click(function(){
                    $("#EstrazioneAllineamentiArchiviViewModel_DataRicezione_From").datepicker('show');
                });
            ...
            <td class="Valore200" style="width: 25%">
<input data-bind="datetime: EstrazioneAllineamentiArchiviViewModel.DataRicezione.To" id="EstrazioneAllineamentiArchiviViewModel_DataRicezione_To" name="EstrazioneAllineamentiArchiviViewModel.DataRicezione.To" type="text" value="" class="hasDatepicker new-form-control">    <img style="position:relative;top:3px;cursor:pointer;" id="EstrazioneAllineamentiArchiviViewModel_DataRicezione_To_imgcalendar" src="/anchise.web/Contents/00000/it-IT/alten-anchise-images/calendar.png" alt="Apri calendario" title="Apri calendario" border="0" height="20" width="20">
<script type="text/javascript">
            $.datepicker.regional['it'] = {
                closeText: 'Chiudi',
                prevText: '&#x3c;Prec',
            ...
            $.datepicker.setDefaults($.datepicker.regional['it']);
            $(document).ready(function () {
                $("#EstrazioneAllineamentiArchiviViewModel_DataRicezione_To").datepicker({
                    onSelect: function (dateText) {
                        $("#EstrazioneAllineamentiArchiviViewModel_DataRicezione_To").datepicker('hide');
                ...
                $("#EstrazioneAllineamentiArchiviViewModel_DataRicezione_To_imgcalendar").click(function(){
                    $("#EstrazioneAllineamentiArchiviViewModel_DataRicezione_To").datepicker('show');
                });
    ...
    </div><div class="new-buttons"><input id="ank-btn-search" type="button" value="Visualizza" data-bind="singleClick: function(){ KoGoTo('/anchise.web/ESITI/EstrazioneAL/Ricerca?trk=empty');}" class="btn"></div></div>
    <script type="text/javascript">
        $(document).ready(function () {
...
<script type="text/javascript">
                                            $(function () { RegisterViewModel("EstrazioneAllineamentiArchiviViewModel",{"PiazzaturaEstrazioneAllinementoArchivi":{"IdAzienda":null,"ABIBanca":null,"IdRapporto":null},"DataCreazione":{"From":null,"To":null},"DataRicezione":{"From":null,"To":null},"PaginaRichiesta":1,"NumeroRighePerPagina":10,"OrdinamentoColonna":3,"OrdinamentoDirezione":2}, true);
             var root = rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi; 
             ...
             initializePiazzatura(
                rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdAzienda(),
                rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.ABIBanca(),
                rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdRapporto());
    
             var cmbAzienda = $('#EstrazioneAllineamentiArchiviViewModel_PiazzaturaEstrazioneAllinementoArchivi_IdAzienda');
             var cmbBanca = $('#EstrazioneAllineamentiArchiviViewModel_PiazzaturaEstrazioneAllinementoArchivi_ABIBanca');
             ...
             */
             function registerChangeCombo() {
                 cmbAzienda.change(function () {
                     var selectedAzienda = rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdAzienda();
                 ...
                 cmbBanca.change(function () {
                     var selectedAzienda = rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdAzienda();
                     var selectedBanca = rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.ABIBanca();
        ...
        */
             function initializeComboBoxFromPiazzaturaRapporto(piazzaturaRapporto) {
                 ...
                 var emptySIA = '';
                 var emptyIdBanca = '';
                 rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.CodiceSia(emptySIA);
                 rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdBanca(emptyIdBanca);
                 ...
                 $.each(aziende, function (index, azienda) {
                     ...
                     if (azienda.IdAzienda == piazzatura.IdAzienda) {
                         rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.CodiceSia(azienda.CodiceSIA);
                     }
                 });
                 ...
                 $.each(banche, function (index, banca) {
                     ...
                     if (banca.ABI == piazzatura.ABIBanca) {
                        rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdBanca(banca.Id);
                    }
                 });
                 // bug ie7
                 cmbBanca.removeClass("banca").addClass("banca");
            
                 rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdAzienda(piazzatura.IdAzienda);
                 rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.ABIBanca(piazzatura.ABIBanca);
                 rootViewModel.EstrazioneAllineamentiArchiviViewModel.PiazzaturaEstrazioneAllinementoArchivi.IdRapporto(piazzatura.IdRapporto);
