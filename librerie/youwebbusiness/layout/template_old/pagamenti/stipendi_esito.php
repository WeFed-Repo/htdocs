...
<div id="60d131c3624941b98e205667e7a7ef52_5" data-bind="visible: IsVisible">
    ...
    <!-- SUCCESS MESSAGES -->
    <div data-bind="visible: SuccessMessagesVisible" style="">
            ...
            <div class="row">
                <div class="col-xs-6 white-block">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: Ordinante.Iban">IT38V0503433473000000011905</label>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: $component.DettaglioBanca().Debitore.DescrizioneBanca">BANCO BPM S.P.A.</label>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: $component.DettaglioBanca().Debitore.DescrizioneFiliale">AG.72</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 white-block">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8  textTruncate">
                            <label data-bind="text: Beneficiario.Denominazione">Burus Taeld</label>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: Beneficiario.Iban">IT03E0300203280151678644992</label>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: $component.DettaglioBanca().Creditore.DescrizioneBanca">UNICREDIT BANCA DI ROMA SPA</label>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: $component.DettaglioBanca().Creditore.DescrizioneFiliale">ROMA 80 - PIAZZA MONTE</label>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xs-12 no-padding">
                        <div class="col-xs-6 no-padding">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="numericTextSeparator: Importo">500,00</label><label>&nbsp;EUR</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
            ...
            <div data-bind="visible: App.Common.IdentifierIsValid(Identifier)" style="margin-top: 10px">
                <div class="row">
                    ...
                    <div class="col-xs-6" data-bind="visible: Conto() != null">
                        ...
                        <div class="col-xs-9 no-padding">
                            <strong data-bind="text: Conto">000000011905</strong>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="col-xs-9 no-padding">
                            <strong data-bind="text: Cab">33473</strong>
                            <!--ko if: Iban() != null-->
                            <span>-</span>
                            <strong data-bind="text: Iban">IT38V0503433473000000011905</strong>
                            <!--/ko-->
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="table-responsive tabSelezioneCC margin-top10">
                    <table class="dataTable table table-striped">
                        ...
                        <tbody data-bind="foreach: Page">
                            <tr data-bind="click: $component.UpdateSelectedItem">
                                <td data-bind="text: Denominazione">ROSSI</td>
                                <td data-bind="text: Indirizzo.Comune"></td>
                                <td data-bind="text: Iban"></td>
                            </tr>
                        </tbody>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="col-sm-3 col-xs-12" style="padding: 0">
                                <div class="col-sm-5" style="padding-left: 0">
                                    <label class="control-label">Modalità</label>
                                    <select class="form-control" data-bind="enable: $component.EsitoAlBeneficiarioEnable, options: $component.ModalitaEsito, optionsCaption: 'Seleziona', optionsText: 'V', optionsValue: 'K', value: Esito.ModalitaEsito" disabled=""><option value="">Seleziona</option><option value="EMAL">E-Mail</option></select>
                                </div>
                                <div class="col-sm-7" style="padding-right: 0">
                                    <label class="control-label">CUC/E-mail</label>
