            ...
            <div class="row">
                <div class="col-xs-6 white-block">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: $component.DettaglioBanca().Debitore.DescrizioneFiliale">MILANO AG. 36</label>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 white-block">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-8  textTruncate">
                            <label data-bind="text: Beneficiario.Denominazione">fsdf</label>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-4">
                        ...
                        <div class="col-xs-8">
                            <label data-bind="text: Beneficiario.Iban">IT92J0300203280751623534334</label>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <div class="col-xs-4">
                    ...
                    <div class="col-xs-12 no-padding">
                        <div class="col-xs-6 no-padding">
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-8">
                                    <label data-bind="numericTextSeparator: Importo">10,00</label><label>&nbsp;EUR</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
...
<!-- /ko -->
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="col-sm-3 col-xs-12" style="padding: 0">
                <label class="control-label">Comune</label>
                <input type="text" class="form-control no-placeholder-italic" data-bind="enable: (ComuneActive() || DatiIndirizzoActive()), value: Indirizzo.Comune, attr: {placeholder: comunePlaceholder}" placeholder="opzionale">
            </div>
            <div class="col-sm-1 col-xs-12"></div>
            <div class="col-sm-2 col-xs-12">
                <label class="control-label">Cap</label>
