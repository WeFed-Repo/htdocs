   ...
   <td valign="top">
    <table style="width: 100%; height: 100%">
     <tbody>
      <tr>
       <td valign="top">
        <div class="container"><div class="container"><div class="old-pageContent new-riquadro">
                ...
                <div id="riepilogoPanel">
                    <form action="#" id="input_form" name="input_form">
                     ...
                     <div id="riepilogoFilterPanel" style="visibility: hidden; display: none;">
                         <!-- from function -->
                        <div class="panel-group vnt-filter" id="accordion">
                             <div class="panel vnt-filter" id="youBizWhiteBackground" style="background-color: rgb(255, 255, 255); overflow: visible;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><select style="width: 285px" class="new-form-control" id="selAzienda" name="Piazzatura.IdAzienda"><option value="588536">C.P.C. INOX SPA</option></select></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                            ...
                                            <table>
                                                <tbody><tr>
                                                    <td>
                                                        ...
                                                        <input type="hidden" id="fieldDataFromHidden" name="dataDa" value="06 17 2019 00:00:00 am">
                                                    </td>
                                                    <td>&nbsp;&nbsp;</td>
                                                    <td>
                                                        <a class="icon-replace icon-calendar active" onclick="$('.datepicker.fieldDataFromYBW').datepicker('show');" href="javascript:void(0);">
                                        <img class="old-fieldCalendar fieldDataFromYBW" src="/resources/YouBiz/images/calendar.png" border="0" height="20" width="20" id="dp1569401922588"></a>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="hidden" id="fieldDataToHidden" name="dataA" value="09 26 2019 00:00:00 am">
                                                    </td>
                                                    <td>&nbsp;&nbsp;</td>
                                                    <td>
                                                        <a class="icon-replace icon-calendar active" onclick="$('.datepicker.fieldDataToYBW').datepicker('show');" href="javascript:void(0);">
                                        <img class="old-fieldCalendar fieldDataToYBW" src="/resources/YouBiz/images/calendar.png" border="0" height="20" width="20" id="dp1569401922589"></a>
                     ...
                     <div id="riepilogoSubFilterPanel" style="display: block;">
                            <table class="testoBlackSmall" style="width: 55%;padding-right:200px; border-spacing: 2px; border-collapse: separate;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><select style="width: 300px;text-align: left;" class="new-form-control" id="selAziendaFiltroLista" name="Piazzatura.IdAzienda"><option value="588536">C.P.C. INOX SPA</option></select></td>
                                        <td><select style="width: 300px;text-align: left;" class="new-form-control" id="selRapportoFiltroLista" name="Piazzatura.CodiceRapporto"><option value="-1">Tutti</option></select></td>
    ...
    <!--<LINK href="/resources/05034/it-IT/TMSecWebNet/style/main.css" type="text/css" rel="stylesheet">-->
...
<link href="/resources/YouBiz/css/main.css?v=10" rel="stylesheet" type="text/css">
    ...
    <div>
	<!--pagina da includere nel body per menu ibbweb 2-->
    ...
    <form name="Form1" method="post" action="ErrorPage.aspx?tmiderror=2b0a54bf-f9ce-4f65-81b5-b4c2fa7855d5" id="Form1">
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJMjEyNzk4NjEzZGRD2hRi5qAZe/6Ai9dgCvC3ZIexJQ==">
</div>

<div>

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="EDDC88CF">
</div>
    </form>
	
    <table border="0" width="80%" height="100%" align="center" class="old-container">
		...
		<td>
			...
			<tbody><tr>
				<td>
                            ...
                            <table border="0" width="50%" height="100%" align="center" cellpadding="0" cellspacing="0">
                        
						<tbody><tr>
                            
                            <td>
                    <div class="col-xs-12 messagePanel alert" style="display: block;height: auto !important;height: 100px;">
	                    <h3 class="titleSection">Attenzione</h3>
	                    <p>
		                    <strong>Errore nel caricamento della pagina</strong>
	                    </p>
                    </div>        
	...
	<tr height="30%"><td colspan="3">&nbsp;</td></tr>
        ...
        </div><div class="new-buttons"></div></div><div class="new-buttons"><input id="btnVisualizza" type="button" class="btn1" value="Visualizza" style="visibility: hidden; display: none;"></div></div>
       </td>
      </tr>
     </tbody>
    </table>
