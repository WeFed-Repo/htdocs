...
<div style="POSITION: absolute; TOP: 0px;VISIBILITY: hidden;" onmouseover="parent.tm_middle.clearTimeOut();" onmouseout="parent.tm_middle.layerTimeOut('menu2','onmouseoutDalLayer');" id="menu2"></div>
    <table class="larghezzaEsterna old-container" cellspacing="0" cellpadding="0" border="0" align="center" height="100%">
	    <tbody><tr>
		    ...
		    <form name="Form1" method="post" action="jobschedDispo.aspx" id="Form1">
<div>
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKMTAyMDAyNTUwMWRkAAnHPuxGNlXs6x7Ji6sIG8EnLkI=">
</div>

<div>

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="C2D79962">
</div>
			    ...
			    <table width="100%" align="center">
					    ...
					    <td>
						    <table class="sfondoTabelle old-table table" cellspacing="0" cellpadding="0" border="0">
							    ...
							    <tbody><tr class="titoloTabella">
								    <td class="old-pageTitle page-title"><div class="new-flag"></div><h1>Dettaglio Job Dispositivo<a class="old-pageHelp" href="#" onclick="goTMHelp('jobschedDispo.aspx','0','7')"><img src="/resources/YouBiz/images/i_help.png" class="imgSrv" alt="Help On Line"></a></h1></td>
							    </tr>
															    ...
															    <td valign="top">
																    <table cellspacing="0" cellpadding="0" border="0" height="100%">
																	    <tbody><tr>
																		    ...
																		    <td height="19" width="150" class="link_tabCliccabile" nowrap=""><a class="link_tabCliccabile" href="javascript:goTab(0)">Quando</a></td>
																		    <td class="tabSpacer" width="14">&nbsp;&nbsp;&nbsp;</td>
																		    
																		    <td height="19" width="150" class="link_tabAttiva" nowrap="">Dove</td>
																		    <td class="tabSpacer" width="14">&nbsp;&nbsp;&nbsp;</td>
															    ...
															    <tbody><tr height="350px">
																    ...
																    <table cellspacing="1" cellpadding="0" border="0" height="350px" class="sfondotabelle">
																	    ...
																	    <td colspan="2" class="rigascura even">
																		    <iframe id="iframesched" name="iframesched" width="100%" frameborder="0" height="100%" scrolling="yes" src="strutt_iframe.php?iframe=configura/schedulatore_configura_nuovo_job_dispositivo_dove_iframe.php&cantiere=tm" class="rigascura even" style="height: 350px;"></iframe>
																	    </td>
																	    </tr>
																    </tbody></table>
																    </td>
				    ...
				    <tr>
					    <td class="old-buttons left">
		                       ...
		                       <!--a href="javascript:EditJob()"><img src="/resources/05034/it-IT/TMIBBWEBScheduler/img/edit.gif" border="0" alt="Modifica descrizione"/></a--> 
		                           &nbsp;
		    ...
		    <form name="frmSalvaJob" action="../common/eseguioperazione.aspx" method="post">
			    ...
			    <input type="hidden" name="tm_tipo_operazione" value="tmsavejobdispo_new">
			    <input type="hidden" name="description" value="">
			    <input type="hidden" name="pkJob" value="20010">
			    <input type="hidden" name="idApplicazione" value="4">
                <input type="hidden" name="idRobot" value="390271">
                <input type="hidden" name="dsRobot" value="RU8AJ">
		    </form>

		    <form name="frmRefreshJobSched" action="jobschedDispo.aspx" method="post">
			    <input type="hidden" name="pkSchedSel" value="850"> 
			    <input type="hidden" name="goTipo" value="edit_sched_new">
			    <input type="hidden" name="idTab" value="2">
			    <input type="hidden" name="pkJobSel" value="20010">
		    ...
		    <form name="frmReloadFrame" method="post" action="jobWhereDispo.aspx?pkSchedSel=850&amp;pkJobSel=20010&amp;idApplicazione=4" target="iframesched">
			    <input type="hidden" name="pkSchedSel" value="850"> 
			    <input type="hidden" name="goTipo" value="edit_sched_new">
			    <input type="hidden" name="idTab" value="2">
			    <input type="hidden" name="pkJobSel" value="20010">
