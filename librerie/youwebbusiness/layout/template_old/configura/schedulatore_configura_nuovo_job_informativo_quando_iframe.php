...
<div style="POSITION: absolute; TOP: 0px;VISIBILITY: hidden;" onmouseover="parent.tm_middle.clearTimeOut();" onmouseout="parent.tm_middle.layerTimeOut('menu2','onmouseoutDalLayer');" id="menu2"></div><form name="Form1" method="post" action="jobWhen.aspx?pkSchedSel=864&amp;pkJobSel=20011&amp;idApplicazione=3" id="Form1">
<div>
					        ...
					        <td>
						        <table width="100%" class="rigascura" cellspacing="1" cellpadding="1" border="0">
							        ...
							        <tr>
                                        ...
                                        <img class="old-fieldCalendar StartDateYBW" src="/resources/YouBiz/images/calendar.png" border="0" height="20" width="20" id="dp1570456285471"></a>
                                        ...
                                        <img class="old-fieldCalendar EndDateYBW" src="/resources/YouBiz/images/calendar.png" style="display: none;" border="0" height="20" width="20" id="dp1570456285472"></a>
                                        <script language="javascript" type="text/javascript">
