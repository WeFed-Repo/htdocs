...
<div>
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="95D3556D">
															...
															<td valign="top">
																<table cellspacing="0" cellpadding="0" border="0" height="100%">
																	<tbody><tr>
																		...
																		<td height="19" width="150" class="link_tabAttiva" nowrap="">Cosa</td>
																		<td class="tabSpacer" width="14">&nbsp;&nbsp;&nbsp;</td>
															...
															<tbody><tr height="350px">
																...
																<table cellspacing="1" cellpadding="0" border="0" height="350px" class="sfondotabelle">
																	...
																	<td colspan="2" class="rigascura even">
																		<iframe id="iframesched" name="iframesched" width="100%" frameborder="0" height="100%" scrolling="yes" src="strutt_iframe.php?iframe=configura/schedulatore_configura_nuovo_job_informativo_cosa_iframe.php&cantiere=tm" class="rigascura even" style="height: 350px;"></iframe>
																	</td>
																	</tr>
																</tbody></table>
																</td>
		...
		<form name="frmReloadFrame" method="post" action="jobWhat.aspx?pkSchedSel=864&amp;pkJobSel=20011&amp;idApplicazione=3" target="iframesched">
			<input type="hidden" name="pkSchedSel" value="864"> 
			<input type="hidden" name="goTipo" value="edit_sched_new">
			<input type="hidden" name="idTab" value="1">
			<input type="hidden" name="pkJobSel" value="20011">
