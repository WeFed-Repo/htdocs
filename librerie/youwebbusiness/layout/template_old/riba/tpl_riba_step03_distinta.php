...
<div class="old-pageTitle titoloTabella"><div class="new-flag"></div><h1>
															Creazione distinte
														<a class="old-pageHelp" href="#" onclick="NewWin1=window.open(tranformNewHelp('./html/help/AreaDispositiva/GestioneDistinte/CreazioneDistinte.htm'),'NewWin1','toolbar=no,scrollbars=yes,status=no,width=534,height=240');"><img src="./newstyle/images/i_help.png" class="imgSrv" alt="Help On Line"></a></h1></div>
...
<tr height="20">
<td align="left" width="235"><select name="intestatario" onchange="fillBanche(createParameterObjectFromCombos(null, accounteerCombo, null), '*', stringa_tutti, NO_ALL, NO_ALL, bankCombo, true, false); enableRefreshButton();" style="width:230" class="new-form-control"><option value="*">TUTTI</option><option value="106609">AUTOMOBILE CLUB MODENA</option></select><script>
							...
							</script></td><td width="245"><select name="banca" onchange="enableRefreshButton();" style="width:240px" class="new-form-control"><option value="">TUTTI</option><option value="3422">05034 - BANCO BPM S.P.A.</option><option value="1325">05188 - BANCA POPOLARE DI VERONA - S. GEMINIANO E S. PROSPERO S.P.A.</option></select><script>
...
<tbody><tr>
<td class="titoloTabella old-sectionTitle" colspan="17" height="20"><h3 class="new-titleSection">Ritiro Effetti (Pagamento Riba)</h3></td>
</tr>
...
<tr>
<th class="oRight"><a href="javascript:orderbyASC('importo');"><img alt="ordina per importo crescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciaup-gialla.gif" title="ordina per importo crescente"></a></th><th align="left"><a href="javascript:orderbyDESC('importo');"><img alt="ordina per importo decrescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciadown-blu.gif" title="ordina per importo decrescente"></a></th>
</tr>
</tbody></table>
</th><th class=""></th><th align="center" class="" height="20">
						Div
					</th><th class=""></th><th align="center" class="" height="20" title="">
<table border="0" cellpadding="1" cellspacing="0">
<tbody><tr>
<th align="center" class="" colspan="2">
									ABI</th>
...
<tr>
<th class="oRight"><a href="javascript:orderbyASC('cod_abi_assuntrice');"><img alt="ordina per ABI crescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciaup-blu.gif" title="ordina per ABI crescente"></a></th><th align="left"><a href="javascript:orderbyDESC('cod_abi_assuntrice');"><img alt="ordina per ABI decrescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciadown-blu.gif" title="ordina per ABI decrescente"></a></th>
</tr>
</tbody></table>
</th><th class=""></th><th align="center" class="" height="20" title="">
<table border="0" cellpadding="1" cellspacing="0">
...
<tr>
<th class="oRight"><a href="javascript:orderbyASC('cod_cab_assuntrice');"><img alt="ordina per CAB crescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciaup-blu.gif" title="ordina per CAB crescente"></a></th><th align="left"><a href="javascript:orderbyDESC('cod_cab_assuntrice');"><img alt="ordina per CAB decrescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciadown-blu.gif" title="ordina per CAB decrescente"></a></th>
</tr>
</tbody></table>
</th><th class=""></th><th align="center" class="" height="20">
<table border="0" cellpadding="1" cellspacing="0">
...
<tr>
<th class="oRight"><a href="javascript:orderbyASC('num_cc_ricevente');"><img alt="ordina per conto corrente crescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciaup-blu.gif" title="ordina per conto corrente crescente"></a></th><th align="left"><a href="javascript:orderbyDESC('num_cc_ricevente');"><img alt="ordina per conto corrente decrescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciadown-blu.gif" title="ordina per conto corrente decrescente"></a></th>
</tr>
</tbody></table>
</th><th class=""></th><th align="left" class="" height="20">
<table border="0" cellpadding="1" cellspacing="0">
<tbody><tr>
<th align="center" class="" colspan="2">
									Creditore
...
<tr>
<th class="oRight"><a href="javascript:orderbyASC('descrizione_anagrafica');"><img alt="ordina per descrizione creditore crescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciaup-blu.gif" title="ordina per descrizione creditore crescente"></a></th><th align="left"><a href="javascript:orderbyDESC('descrizione_anagrafica');"><img alt="ordina per descrizione creditore decrescente" border="0" src="./anchise2.web/Contents/00000/it-IT/images/frecciadown-blu.gif" title="ordina per descrizione creditore decrescente"></a></th>
</tr>
</tbody></table>
...
<tr class="odd">
<td class="oRight" height="25">1,00</td><td class="" height="25"></td><td align="center" class="" height="25">EUR</td><td class="" height="25"></td><td align="center" class="" height="25"><span id="abi_345322177">05034</span></td><td class="" height="25"></td><td align="center" class="" height="25">11701</td><td class="" height="25"></td><td align="center" class="" height="25">000000002407</td><td class="" height="25"></td><td align="left" class="" height="25"></td><td class="" height="25"></td><td align="center" class="" height="25" style="text-align:center; vertical-align:center"><input name="cambio_345322177" type="hidden" value="true"><input name="divisa_345322177" type="hidden" value="EUR"><input name="itc_flag_urgente_345322177" type="hidden" value=""><input name="itc_flag_urgente" type="hidden" value="U"><input name="provenienzaEffetto_345322177" type="hidden" value="000000002407"><script language="javascript">calcolaPriorita('345322177');</script><input name="345322177" onclick="if(checked==1) clearCheckBox2(masterform,'345322177',1)" type="checkbox" value="aggregate"></td><td class="" height="25"></td><td align="center" class="" height="25" style="text-align:center; vertical-align:center"><input name="345322177" onclick="if(checked==1) clearCheckBox2(masterform,'345322177',0)" type="checkbox" value="delete"></td><td class="" height="25"></td><td align="center" class="" height="25"><a class="tabella" href="javascript:doModify(345322177,28,'true');">Modifica</a></td>
</tr>
</tbody></table>
</td>
</tr>
...
<script language="JavaScript">
		...
		</script><input name="max_items_number" type="hidden" value="10"><input name="first_item_count" type="hidden" value="1"><input name="filter_defined" type="hidden" value="false"><input name="order_by_option" type="hidden" value="importo=asc"><input name="previous_option" type="hidden" value=""><input name="next_option" type="hidden" value=""><input name="DA_IMPORTO" type="hidden" value=""><input name="A_IMPORTO" type="hidden" value=""><input name="TIPO" type="hidden" value="28"><input name="filtro_causale" type="hidden" value=""><input name="filtro_codice_individuale" type="hidden" value=""><input name="filtro_codice_fiscale_piva" type="hidden" value=""><input name="intestatario" type="hidden" value="106609"><input name="banca" type="hidden" value="3422"><input name="rapporto" type="hidden" value="">
<tr>
<td>&nbsp;</td>
</tr>
<tr>
