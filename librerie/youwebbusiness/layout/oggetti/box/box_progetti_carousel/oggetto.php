					...
					<div class="text-center pl-md-3 pr-md-3 pl-xl-5 pr-xl-5">
						...
						<div class="font-size-small">
							<p>
								...
								<span class="text"><strong>150.000,00 &euro;</strong></span>
							</p>
							<p>
								<span class="text-alert">Budget prefissato</span>
								<span class="text font-size-20 color-gray1"><strong>140.000,00 &euro;</strong></span>
							</p>
						</div>
					</div>
					...
					<div class="text-center pl-md-3 pr-md-3 pl-xl-5 pr-xl-5">
						...
						<div class="font-size-small">
							<p>
								...
								<span class="text"><strong>98.000,00 &euro;</strong></span>
							</p>
							<p>
								<span class="text-alert">Budget prefissato</span>
								<span class="text font-size-20 color-gray1"><strong>100.000,00 &euro;</strong></span>
							</p>
						</div>
					</div>
					<div class="d-flex justify-content-between align-items-center cta-wrapper">
					...
					<div class="text-center pl-md-3 pr-md-3 pl-xl-5 pr-xl-5">
						...
						<div class="font-size-small">
							<p>
								...
								<span class="text"><strong>8.000,00 &euro;</strong></span>
							</p>
							<p>
								<span class="text-alert">Budget prefissato</span>
								<span class="text font-size-20 color-gray1"><strong>100.000,00 &euro;</strong></span>
...
<!--casistica scaduto + casistica nuovo -->
<section>
	 <div class="row">
			<div class="col-12 col-md-4">
				<!--scaduto -->
				...
				<div class="box-progetti bordered box-with-shadow">
					...
					<div class="text-center pl-md-3 pr-md-3 pl-xl-5 pr-xl-5">
						...
						<div class="font-size-small">
							<p>
								<span class="text-alert">Totale spese effettuate</span>
								<span class="text"><strong>0,00 &euro;</strong></span>
							</p>
							<p>
								<span class="text-alert">Budget prefissato</span>
								<span class="text font-size-20 color-gray1"><strong>100.000,00 &euro;</strong></span>
