  ...
  <form class="form-grid">
    ...
    <!-- NOTE: la struttura di radiobuttons e checkbox è identica, ad eccezione
     ...
     <div class="form-row">
       ...
       <!-- per invertire label e campo usare la classe left-label -->
       <div class="form-group col-sm-3">
         <div class="form-check  checkbox switch left-label">
           <input class="form-check-input" type="checkbox" id="switch12" name="notifica1">
           <label class="form-check-label" for="switch12">Input</label>
         </div>
       </div>
     </div>
     ...
     <div class="form-row">
       ...
       <div class="form-group col-sm-3">
         <div class="form-check  checkbox switch left-label">
           <input class="form-check-input" type="checkbox" id="switch22" name="notifica2" checked>
           <label class="form-check-label" for="switch22">Input checked</label>
         </div>
       </div>
     </div>
     ...
     <div class="form-row">
       ...
       <div class="form-group col-sm-3">
         <div class="form-check  checkbox switch left-label">
           <input class="form-check-input" type="checkbox" id="switch33" name="notifica3" disabled>
           <label class="form-check-label" for="switch33">Input disabled</label>
         </div>
       </div>
     </div>
     ...
     <div class="form-row">
       ...
       <div class="form-group col-sm-3">
         <div class="form-check  checkbox switch left-label">
           <input class="form-check-input is-invalid" type="checkbox" id="switch44" name="notifica1">
           <label class="form-check-label" for="switch44">Input</label>
           <!-- messaggio d'errore personalizzabile -->
           <div class="invalid-feedback">Lorem Ipsum dolor sit amet</div>
         </div>
       </div>
