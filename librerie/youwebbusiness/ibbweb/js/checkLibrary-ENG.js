 ...
 */
		...
		var mandatoryFieldMsg="The field is compulsory";
        var invalidBoundsMessage="Error in form definition: the minimum value of characters is higher than the maximun value!"; 
        var minCharMsg="The value to be entered should be at least";
        var maxCharMsg="The value to be entered must not be more than";
        var charMsg="characters";
        var integerMsg="Please enter an integer number";
        var realMsg="You must enter a real value!";
        var currencyMsg="You must enter a correct value";
        var dateSyntaxMsg="Incorrect syntax";
        var dateNotValidYearMsg="The Year must be comprised between";
        var dateNotValidYearAndMsg="and";
        var dateNotValidMsg="the entered date is invalid";
	    var MSG_Num_Conto="Account nr:\n\n";
        var MSG_Controllo_Soluzione="Check the proposed solution";
        var MSG_Caratteri_Non_Validi="Invalid characters are present";
        var MSG_Lunghezza_Codice_Fiscale="Wrong length of Fiscal code:\n Fiscal code must be exactly 16 characters long.\n\n";
        var MSG_Codice_Fiscale_Caratt_Non_Valido_Head="The Fiscal code contains an invalid character";
        var MSG_Codice_Fiscale_Caratt_Non_Valido_Tail="'.\nThe valid characters are letters and figures.\n";
        var MSG_Err_CodiceControllo_Cod_Fisc="The Fiscal code is not correct:\ the check code does not correspond.\n";
        var MSG_Err_Lungh_Partita_Iva="Wrong length of VAT code:\n VAT code must be exactly 11 characters long.\n\n";
        var MSG_Err_Carattere_Partita_Iva_Head="The VAT code contains an invalid character";
        var MSG_Err_Carattere_Partita_Iva_Tail="'.\nThe valid characters are figures.\n";
        var MSG_Err_CodiceControllo_Partita_Iva="The VAT code is not correct:\ the check code does not correspond.\n";
        var MSG_Err_checkCFPIVA="The length of the entered item is wrong:\n the VAT code must be exactly 11\n characters long, \n the Fiscal code must be exactly 16\n characters long.\n The VAT code is not valid:\n the check code does not correspond.\n";
        var MSG_Err_checkABICAB="The length of the entered code is\n wrong: it must exactly 5 figures\n long.\n";
        var MSG_Err_checkBIC="Length must be 8 or 11 characters";
        var MSG_Err_Carattere_AbiCab_Head="The code contains an invalid character";
        var MSG_Err_Carattere_AbiCab_Tail="'.\nThe valid characters are figures.\n";
        var MSG_Alert_LunghIban="The IBAN code must be 27 characters (letters and figures) long.";
        var MSG_Alert_checkIban_2="The IBAN code must match the Bank/branch codes and the A/C nr.";
        var MSG_warnDate_Head="The enter date is prior to today's date (";
        var MSG_warnDate_Tail=").";
        var MSG_Alert_chekCorrect_Date_1="The entered date (";
        var MSG_Alert_chekCorrect_Date_2=") must be between \n";
        var MSG_Alert_chekCorrect_Date_3="and";
        var MSG_Alert_chekCorrect_Date_4="The entered date (";
        var MSG_Alert_chekCorrect_Date_5=") must be later than";
        var MSG_Alert_chekCorrect_Date_6=".\nSi consiglia sia compresa tra";
        var MSG_Alert_chekCorrect_Date_7="and";
        var MSG_Alert_chekCorrect_Date_8=".";
        
        var MSG_Err_FormatoImportoCorretto_Head="contains more than";
        var MSG_Err_FormatoImportoCorretto_Tail="integer digits";
        var MSG_Err_FormatoImportoCorretto_1="and";
        var MSG_Err_FormatoImportoCorretto_2="contains";
        var MSG_Err_FormatoImportoCorretto_3="more than";
        var MSG_Err_FormatoImportoCorretto_4="decimal digits.";
        var MSG_Err_FormatoImportoCorretto_5="contains more than";
        var MSG_Err_FormatoImportoCorretto_6="integer digits";
        var MSG_Err_Lungh_AbiCabWithName="The length of the entered code is\n wrong: it must exactly 5 figures\n long.\n";
        var MSG_Err_Carattere_AbiCabWithName_Head="The code contains an invalid character";
        var MSG_Err_Carattere_AbiCabWithName_Tail="'.\nThe valid characters are figures.\n";
        var MSG_Err_Caratter_Alfanum_Head="The number must have";
        var MSG_Err_Caratter_Alfanum_Tail="characters (letters and digits).\n";
        var MSG_Err_Caratter_Num_Tail="characters (digits).\n";
		var MSG_Confirm_checkIban="Warning: the supplied IBAN code is not correct!\nDo you want to continue?";
		var MSG_Confirm_checkCountryAndIban="#Attenzione il codice IBAN non è congruente con il paese selezionato!\nSi desidera procedere?#";

		var MSG_number_1_ITEC="one";
		var MSG_number_2_ITEC="two";
		var MSG_number_3_ITEC="three";
		var MSG_number_4_ITEC="four";
		var MSG_number_5_ITEC="five";
		var MSG_number_6_ITEC="six";
		var MSG_number_7_ITEC="seven";
		var MSG_number_8_ITEC="eight";
		var MSG_number_9_ITEC="nine";
