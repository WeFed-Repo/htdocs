...
*/
function addAccounteer(location, code, description, cf, tipocf, sia, signature, descrizione_tot, indirizzo, piazza, cap, provincia, localita, abi, cab, dispoDefaultElcos, flagIntestazioneContoElcos, paeseDefaultElcos, codiceEsteroCedenteElcos)
{
...
*/
function addCC(bank, code, description, cab, divisa, info_dispo)
{
    var cc = new Object();
    cc.codice = code;
...
*/
function addCC(bank, code, description, cab, divisa, info_dispo, desc_cc)
{
    var cc = new Object();
    cc.codice = code;
    cc.descrizione = description;
...
*/
function addCC(bank, code, description, cab, divisa, info_dispo, desc_cc, stato_cc)
{
    var cc = new Object();
    cc.codice = code;
    cc.descrizione = description;
