...
function adeguaDir(arrayOggetti,dirToAdd){
	...
	var dirIMG = "img/" + dirToAdd + "/"
	var dirCSS = "css/" + dirToAdd + "/";
	for( var i=0;i < arrayOggetti.length; i++ ){
		var urlImgTMP = arrayOggetti[i].src;
		var immagine = urlImgTMP.split("img/");
	...
	var foglioStile = urlFoglioDiStile.split("css/");
...
//	// cambio dir alle immagini di sfondo nelle tabelle
	...
	for (var i=0; i<allTABLE.length; i++){;
		...
		if (urlImgBCKGR){
			var immagine = urlImgBCKGR.split("img/");
