 ...
 */
		...
		var mandatoryFieldMsg="Il campo e\' obbligatorio";
        var invalidBoundsMessage="Errore nella definizione del form: il valore minimo di caratteri e\' superiore al valore massimo!"; 
        var minCharMsg="Il valore da inserire deve avere almeno";
        var maxCharMsg="Il valore da inserire non puo avere piu di";
        var charMsg="caratteri";
        var integerMsg="Inserire un valore intero!";
        var realMsg="Inserire un valore reale!";
        var currencyMsg="Inserire un valore corretto!";
        var dateSyntaxMsg="La sintassi non e\' corretta";
        var dateNotValidYearMsg="L'Anno deve essere compreso tra il";
        var dateNotValidYearAndMsg="e il";
        var dateNotValidMsg="La data inserita non e\' valida";
	    var MSG_Num_Conto="N. conto:\n\n";
        var MSG_Controllo_Soluzione="\nControllare la soluzione proposta.";
        var MSG_Caratteri_Non_Validi="Sono presenti dei caratteri non validi.\n";
        var MSG_Lunghezza_Codice_Fiscale="La lunghezza del codice fiscale non è\n corretta: il codice fiscale dovrebbe essere lungo\n esattamente 16 caratteri.\n";
        var MSG_Codice_Fiscale_Caratt_Non_Valido_Head="Il codice fiscale contiene un carattere non valido";
        var MSG_Codice_Fiscale_Caratt_Non_Valido_Tail="'.\nI caratteri validi sono le lettere e le cifre.\n";
        var MSG_Err_CodiceControllo_Cod_Fisc="Il codice fiscale non è corretto:\n il codice di controllo non corrisponde.\n";
        var MSG_Err_Lungh_Partita_Iva="La lunghezza della partita IVA non è\n corretta: la partita IVA dovrebbe essere lunga\n esattamente 11 caratteri.\n";
        var MSG_Err_Carattere_Partita_Iva_Head="La partita IVA contiene un carattere non valido `";
        var MSG_Err_Carattere_Partita_Iva_Tail="'.\nI caratteri validi sono le cifre.\n";
        var MSG_Err_CodiceControllo_Partita_Iva="La partita IVA non e\' valida:\n il codice di controllo non corrisponde.\n";
        var MSG_Err_checkCFPIVA="La lunghezza del dato inserito non e\' corretta:\n la partita IVA dovrebbe essere lunga\n esattamente 11 caratteri, \n il codice fiscale dovrebbe essere lungo\n esattamente 16 caratteri.\n La partita IVA non e\' valida:\n il codice di controllo non corrisponde.\n";
        var MSG_Err_checkABICAB="La lunghezza del codice immesso non e\'\n corretta: dovrebbe essere lungo\n esattamente 5 cifre.\n";
        var MSG_Err_checkBIC="La lunghezza deve essere di 8 o 11 caratteri";
        var MSG_Err_Carattere_AbiCab_Head="Il codice contiene un carattere non valido `";
        var MSG_Err_Carattere_AbiCab_Tail="'.\nI caratteri validi sono le cifre.\n";
        var MSG_Alert_LunghIban="Il codice IBAN deve essere lungo 27 caratteri alfanumerici.";
        var MSG_Alert_checkIban_2="Il codice IBAN deve corrispondere con i codici ABI, CAB e N. Conto.";
        var MSG_warnDate_Head="La data inserita e\' precedente a quella odierna (";
        var MSG_warnDate_Tail=").";
        var MSG_Alert_chekCorrect_Date_1="La data inserita (";
        var MSG_Alert_chekCorrect_Date_2=") deve essere compresa tra\n";
        var MSG_Alert_chekCorrect_Date_3=" e ";
        var MSG_Alert_chekCorrect_Date_4="La data inserita (";
        var MSG_Alert_chekCorrect_Date_5=") deve essere successiva a";
        var MSG_Alert_chekCorrect_Date_6=".\nSi consiglia sia compresa tra ";
        var MSG_Alert_chekCorrect_Date_7=" e ";
        var MSG_Alert_chekCorrect_Date_8=".";
        
        var MSG_Err_FormatoImportoCorretto_Head="non può contenere piu' di";
        var MSG_Err_FormatoImportoCorretto_Tail="cifre intere";
        var MSG_Err_FormatoImportoCorretto_1="e";
        var MSG_Err_FormatoImportoCorretto_2="non può contenere";
        var MSG_Err_FormatoImportoCorretto_3="piu' di";
        var MSG_Err_FormatoImportoCorretto_4="cifre decimali.";
        var MSG_Err_FormatoImportoCorretto_5="non può contenere piu' di";
        var MSG_Err_FormatoImportoCorretto_6="cifre intere";
        var MSG_Err_Lungh_AbiCabWithName="La lunghezza del codice immesso non e\'\n corretta: dovrebbe essere lungo\n esattamente 5 cifre.\n";
        var MSG_Err_Carattere_AbiCabWithName_Head="Il codice contiene un carattere non valido '";
        var MSG_Err_Carattere_AbiCabWithName_Tail="'.\nI caratteri validi sono le cifre.\n";
        var MSG_Err_Caratter_Alfanum_Head="Il numero deve avere";
        var MSG_Err_Caratter_Alfanum_Tail="caratteri alfanumerici.\n";
        var MSG_Err_Caratter_Num_Tail="caratteri numerici.\n";
		var MSG_Confirm_checkIban="Attenzione il codice IBAN non è corretto!\nSi desidera procedere?";
		var MSG_Confirm_checkCountryAndIban="Attenzione il codice IBAN non è congruente con il paese selezionato!\nSi desidera procedere?";

		var MSG_number_1_ITEC="uno";
		var MSG_number_2_ITEC="due";
		var MSG_number_3_ITEC="";
		var MSG_number_4_ITEC="quattro";
		var MSG_number_5_ITEC="cinque";
		var MSG_number_6_ITEC="sei";
		var MSG_number_7_ITEC="sette";
		var MSG_number_8_ITEC="otto";
		var MSG_number_9_ITEC="nove";
