...
function moveLayer(descrizione, layerId, nameSpan, evt, offsetXCorrection)
{
	...
	var text1 = '<table bgcolor="#ff00ff" cellpadding="0" cellspacing="1" border="1"><tr><td bgcolor="#FFFFE1"><table bgcolor="#FFFFE1" cellpadding="0" cellspacing="0" border="0"><tr><td><table cellpadding="2" cellspacing="1"><tr><td class="testoBlackSmall">';
...
function collaps(id) {
    if (document.all) {
        ...
        if (document.getElementById(id).style.display == 'none') {
            ...
            document.all(nomeImg).src = "../images/ico-collapse.png";
        }
        else {
            document.getElementById(id).style.display = 'none';
            document.all(nomeImg).src = "../images/ico-expand.png";
        }
    }
}
