...
if (document.getElementById("inserimentoNuovoMandato").elements['contextSelectorData.id'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_contextSelectorData_id','label.contextSelectorData.id',"il campo \u00E8 obbligatorio","validate_contextSelectorData_id_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['contextSelectorData.descrizione'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_contextSelectorData_descrizione','label.contextSelectorData.descrizione',"il campo \u00E8 obbligatorio","validate_contextSelectorData_descrizione_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['contextSelectorData.cf'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_contextSelectorData_cf','label.contextSelectorData.cf',"il campo \u00E8 obbligatorio","validate_contextSelectorData_cf_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['contextSelectorData.banca'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_contextSelectorData_banca','label.contextSelectorData.banca',"il campo \u00E8 obbligatorio","validate_contextSelectorData_banca_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_bic','label.disposizione.bic',"il campo \u00E8 obbligatorio","validate_disposizione_bic_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_bic','label.disposizione.bic',"Ordinante la lunghezza deve essere di 8 o 11 caratteri","validate_disposizione_bic_bicLenghtValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_bic','label.disposizione.bic',"Ordinante non \u00E8 corretto. Il codice di controllo non corrisponde.","validate_disposizione_bic_checkBicValid", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_bic','label.disposizione.bic',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_bic_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['contextSelectorData.identificativoCdtr'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_contextSelectorData_identificativoCdtr','label.contextSelectorData.identificativoCdtr',"il campo \u00E8 obbligatorio","validate_contextSelectorData_identificativoCdtr_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['contextSelectorData.identificativoCdtr'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_contextSelectorData_identificativoCdtr','label.contextSelectorData.identificativoCdtr',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_contextSelectorData_identificativoCdtr_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.nm'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_nm','label.disposizione.beneficiarioEffettivo.nm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_nm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.nm'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_nm','label.disposizione.beneficiarioEffettivo.nm',"Attenzione! La Ragione Sociale del Creditore Effettivo deve essere diversa dalla Ragione Sociale dell\'Ordinante.","validate_disposizione_beneficiarioEffettivo_nm_sepaEqualsRagioneSocialeValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['datiAggCreditoreEffettivo.identificativo'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_datiAggCreditoreEffettivo_identificativo','label.datiAggCreditoreEffettivo.identificativo',"Creditore Effettivo il campo \u00E8 obbligatorio","validate_datiAggCreditoreEffettivo_identificativo_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'bicLenghtValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_bic','label.disposizione.beneficiarioEffettivo.bic',"Creditore Effettivo la lunghezza deve essere di 8 o 11 caratteri","validate_disposizione_beneficiarioEffettivo_bic_bicLenghtValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'checkBicValid';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_bic','label.disposizione.beneficiarioEffettivo.bic',"Creditore Effettivo non \u00E8 corretto. Il codice di controllo non corrisponde.","validate_disposizione_beneficiarioEffettivo_bic_checkBicValid", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_bic','label.disposizione.beneficiarioEffettivo.bic',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_bic_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.cityOfBirth'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_cityOfBirth','label.disposizione.beneficiarioEffettivo.cityOfBirth',"Creditore Effettivo il campo \u00E8 obbligatorio","validate_disposizione_beneficiarioEffettivo_cityOfBirth_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.dataNascita'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_dataNascita','label.disposizione.beneficiarioEffettivo.dataNascita',"La sintassi non \u00E8 corretta","validate_disposizione_beneficiarioEffettivo_dataNascita_sintaxDateValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.dataNascita'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_dataNascita','label.disposizione.beneficiarioEffettivo.dataNascita',"La data inserita non \u00E8 valida","validate_disposizione_beneficiarioEffettivo_dataNascita_validDateValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.dataNascita'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_dataNascita','label.disposizione.beneficiarioEffettivo.dataNascita',"Creditore Effettivo il campo \u00E8 obbligatorio","validate_disposizione_beneficiarioEffettivo_dataNascita_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.prvcOfBirth'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_prvcOfBirth','label.disposizione.beneficiarioEffettivo.prvcOfBirth',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_prvcOfBirth_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.beneficiarioEffettivo.ctryOfBirth'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_beneficiarioEffettivo_ctryOfBirth','label.disposizione.beneficiarioEffettivo.ctryOfBirth',"Creditore Effettivo il campo \u00E8 obbligatorio","validate_disposizione_beneficiarioEffettivo_ctryOfBirth_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.descAnagraficaDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_descAnagraficaDebitore','label.disposizione.descAnagraficaDebitore',"Debitore il campo \u00E8 obbligatorio","validate_disposizione_descAnagraficaDebitore_sepaRagSocFornitoreRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.descAnagraficaDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_descAnagraficaDebitore','label.disposizione.descAnagraficaDebitore',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_descAnagraficaDebitore_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.lineaIndirizzoDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_lineaIndirizzoDebitore','label.disposizione.lineaIndirizzoDebitore',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_lineaIndirizzoDebitore_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.ibanDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_ibanDebitore','label.disposizione.ibanDebitore',"Debitore il campo \u00E8 obbligatorio","validate_disposizione_ibanDebitore_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.ibanDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_ibanDebitore','label.disposizione.ibanDebitore',"Codice IBAN errato o mancante.","validate_disposizione_ibanDebitore_checkIBANSub", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.ibanDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_ibanDebitore','label.disposizione.ibanDebitore',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_ibanDebitore_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'bicLenghtValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.bicDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_bicDebitore','label.disposizione.bicDebitore',"Debitore la lunghezza deve essere di 8 o 11 caratteri","validate_disposizione_bicDebitore_bicLenghtValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'checkBicValid';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.bicDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_bicDebitore','label.disposizione.bicDebitore',"Debitore non \u00E8 corretto. Il codice di controllo non corrisponde.","validate_disposizione_bicDebitore_checkBicValid", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.bicDebitore'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_bicDebitore','label.disposizione.bicDebitore',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_bicDebitore_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['datiAggDebitore.identificativo'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_datiAggDebitore_identificativo','label.datiAggDebitore.identificativo',"Debitore il campo \u00E8 obbligatorio","validate_datiAggDebitore_identificativo_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['datiAggDebitore.identificativo'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_datiAggDebitore_identificativo','label.datiAggDebitore.identificativo',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_datiAggDebitore_identificativo_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['datiAggDebitore.identificativo'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_datiAggDebitore_identificativo','label.datiAggDebitore.identificativo',"Il codice fiscale non \u00E8 corretto:\n il codice di controllo non corrisponde.","validate_datiAggDebitore_identificativo_codiceFiscale", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("inserimentoNuovoMandato").elements['datiAggDebitore.codice'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_datiAggDebitore_codice','label.datiAggDebitore.codice',"Attenzione! Il C.F./P.IVA del Debitore deve essere diverso dal Codice fiscale sottoscrittore ","validate_datiAggDebitore_codice_differentFromField", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("inserimentoNuovoMandato").elements['datiAggDebitore.codice'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_datiAggDebitore_codice','label.datiAggDebitore.codice',"Debitore Codice Fiscale / Partita IVA non valido:\n il codice di controllo non corrisponde.\n","validate_datiAggDebitore_codice_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.nm'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_nm','label.disposizione.debitoreEffettivo.nm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_debitoreEffettivo_nm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'sepaEqualsRagioneSocialeValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.nm'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_nm','label.disposizione.debitoreEffettivo.nm',"Attenzione! La Ragione Sociale del Debitore Effettivo deve essere diversa dalla Ragione Sociale del Debitore.","validate_disposizione_debitoreEffettivo_nm_sepaEqualsRagioneSocialeValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("inserimentoNuovoMandato").elements['datiAggDebEffettivo.identificativo'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_datiAggDebEffettivo_identificativo','label.datiAggDebEffettivo.identificativo',"Debitore Effettivo il campo \u00E8 obbligatorio","validate_datiAggDebEffettivo_identificativo_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'bicLenghtValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_bic','label.disposizione.debitoreEffettivo.bic',"Debitore Effettivo la lunghezza deve essere di 8 o 11 caratteri","validate_disposizione_debitoreEffettivo_bic_bicLenghtValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'checkBicValid';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_bic','label.disposizione.debitoreEffettivo.bic',"Debitore Effettivo non \u00E8 corretto. Il codice di controllo non corrisponde.","validate_disposizione_debitoreEffettivo_bic_checkBicValid", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.bic'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_bic','label.disposizione.debitoreEffettivo.bic',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_debitoreEffettivo_bic_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.cityOfBirth'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_cityOfBirth','label.disposizione.debitoreEffettivo.cityOfBirth',"Debitore Effettivo il campo \u00E8 obbligatorio","validate_disposizione_debitoreEffettivo_cityOfBirth_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'sintaxDateValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.dataNascita'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_dataNascita','label.disposizione.debitoreEffettivo.dataNascita',"La sintassi non \u00E8 corretta","validate_disposizione_debitoreEffettivo_dataNascita_sintaxDateValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'validDateValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.dataNascita'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_dataNascita','label.disposizione.debitoreEffettivo.dataNascita',"La data inserita non \u00E8 valida","validate_disposizione_debitoreEffettivo_dataNascita_validDateValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.dataNascita'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_dataNascita','label.disposizione.debitoreEffettivo.dataNascita',"Debitore Effettivo il campo \u00E8 obbligatorio","validate_disposizione_debitoreEffettivo_dataNascita_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.debitoreEffettivo.ctryOfBirth'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_debitoreEffettivo_ctryOfBirth','label.disposizione.debitoreEffettivo.ctryOfBirth',"Debitore Effettivo il campo \u00E8 obbligatorio","validate_disposizione_debitoreEffettivo_ctryOfBirth_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.identificativoMandato'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_identificativoMandato','label.disposizione.identificativoMandato',"il campo \u00E8 obbligatorio","validate_disposizione_identificativoMandato_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.identificativoMandato'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_identificativoMandato','label.disposizione.identificativoMandato',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_identificativoMandato_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['dataMandato'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_dataMandato','label.dataMandato',"il campo \u00E8 obbligatorio","validate_dataMandato_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'sintaxDateValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['dataMandato'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_dataMandato','label.dataMandato',"La sintassi non \u00E8 corretta","validate_dataMandato_sintaxDateValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'validDateValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['dataMandato'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_dataMandato','label.dataMandato',"La data inserita non \u00E8 valida","validate_dataMandato_validDateValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['disposizione.identificativoRichiestaMandato'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_disposizione_identificativoRichiestaMandato','label.disposizione.identificativoRichiestaMandato',"il campo \u00E8 obbligatorio","validate_disposizione_identificativoRichiestaMandato_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['checkTipoMandato'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_checkTipoMandato','label.checkTipoMandato',"il campo \u00E8 obbligatorio","validate_checkTipoMandato_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("inserimentoNuovoMandato").elements['checkTipoSequenzaIncasso'])  addValidation(showAlert,'inserimentoNuovoMandato','inserimentoNuovoMandato_checkTipoSequenzaIncasso','label.checkTipoSequenzaIncasso',"il campo \u00E8 obbligatorio","validate_checkTipoSequenzaIncasso_requiredCbiValidator", _onsubmit, _onchange);
function validateForm_inserimentoNuovoMandato() {
if (submitCount >= 1) { alert("Richiesta gia' inoltrata."); return false; }
var form = document.getElementById("inserimentoNuovoMandato");
