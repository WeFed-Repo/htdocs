	...
	// manca il messaggio internazionale 
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.id'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_id','label.contextSelectorData.id',"il campo \u00E8 obbligatorio","validate_contextSelectorData_id_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.descrizione'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_descrizione','label.contextSelectorData.descrizione',"il campo \u00E8 obbligatorio","validate_contextSelectorData_descrizione_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.cf'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_cf','label.contextSelectorData.cf',"il campo \u00E8 obbligatorio","validate_contextSelectorData_cf_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.cf'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_cf','label.contextSelectorData.cf',"@ERROR Il codice fiscale contiene un carattere non valido: @CHARNOTVALID.\nI caratteri validi sono le lettere e le cifre.","validate_contextSelectorData_cf_noSpecialCharValidatorForCF", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.cf'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_cf','label.contextSelectorData.cf',"@ERROR La partita IVA contiene un carattere non valido: @CHARNOTNUMBER.\nI caratteri validi sono le cifre.","validate_contextSelectorData_cf_onlyNumbersValidatorforPartIva", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.cf'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_cf','label.contextSelectorData.cf',"La partita IVA non e valida:\n il codice di controllo non corrisponde.","validate_contextSelectorData_cf_partitaIva", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.cf'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_cf','label.contextSelectorData.cf',"Il codice fiscale non \u00E8 corretto:\n il codice di controllo non corrisponde.","validate_contextSelectorData_cf_codiceFiscale", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.cf'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_cf','label.contextSelectorData.cf',"La lunghezza del dato inserito non e corretta:\n la partita IVA dovrebbe essere lunga\n esattamente 11 caratteri, \n il codice fiscale dovrebbe essere lungo\n esattamente 16 caratteri.\n La partita IVA non e valida:\n il codice di controllo non corrisponde.\n","validate_contextSelectorData_cf_checkCFPIVA", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.banca'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_banca','label.contextSelectorData.banca',"il campo \u00E8 obbligatorio","validate_contextSelectorData_banca_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.conto'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_conto','label.contextSelectorData.conto',"il campo \u00E8 obbligatorio","validate_contextSelectorData_conto_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.ragioneSociale'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_ragioneSociale','label.pagamento.ragioneSociale',"il campo \u00E8 obbligatorio","validate_pagamento_ragioneSociale_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.indirizzoResidenza.indirizzo'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_indirizzoResidenza_indirizzo','label.pagamento.indirizzoResidenza.indirizzo',"il campo \u00E8 obbligatorio","validate_pagamento_indirizzoResidenza_indirizzo_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.indirizzoResidenza.CAP'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_indirizzoResidenza_CAP','label.pagamento.indirizzoResidenza.CAP',"il campo \u00E8 obbligatorio","validate_pagamento_indirizzoResidenza_CAP_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.indirizzoResidenza.CAP'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_indirizzoResidenza_CAP','label.pagamento.indirizzoResidenza.CAP',"@WARNING Il valore da inserire deve avere almeno 5 caratteri.","validate_pagamento_indirizzoResidenza_CAP_minLengthNoSubmitValidator", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.indirizzoResidenza.comune'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_indirizzoResidenza_comune','label.pagamento.indirizzoResidenza.comune',"il campo \u00E8 obbligatorio","validate_pagamento_indirizzoResidenza_comune_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.indirizzoResidenza.provincia'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_indirizzoResidenza_provincia','label.pagamento.indirizzoResidenza.provincia',"il campo \u00E8 obbligatorio","validate_pagamento_indirizzoResidenza_provincia_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.coordinateBancaBeneficiario.IBAN'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_coordinateBancaBeneficiario_IBAN','label.pagamento.coordinateBancaBeneficiario.IBAN',"formato del codice non corretto","validate_pagamento_coordinateBancaBeneficiario_IBAN_checkCbiIBAN", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.coordinateBancaBeneficiario.IBAN'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_coordinateBancaBeneficiario_IBAN','label.pagamento.coordinateBancaBeneficiario.IBAN',"@CONFIRM Attenzione!! \n\nIBAN beneficiario errato o mancante.\n\nSi desidera comunque procedere?\n","validate_pagamento_coordinateBancaBeneficiario_IBAN_checkIBAN", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.coordinateBancaBeneficiario.numConto'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_coordinateBancaBeneficiario_numConto','label.pagamento.coordinateBancaBeneficiario.numConto',"Numero di conto errato.\nI valori permessi sono 12.\nControllare il numero di conto proposto! ","validate_pagamento_coordinateBancaBeneficiario_numConto_accountValidator", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.importo'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_importo','label.pagamento.importo',"il campo \u00E8 obbligatorio","validate_pagamento_importo_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.importo'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_importo','label.pagamento.importo',"Inserire un valore reale","validate_pagamento_importo_importiNumero", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.importo'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_importo','label.pagamento.importo',"Valore massimo ammesso 99.999.999.999,99","validate_pagamento_importo_importoMassimo", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.dataAddebito'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_dataAddebito','label.pagamento.dataAddebito',"La sintassi non \u00E8 corretta","validate_pagamento_dataAddebito_sintaxDateValidator", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.dataAddebito'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_dataAddebito','label.pagamento.dataAddebito',"La data inserita non \u00E8 valida","validate_pagamento_dataAddebito_validDateValidator", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.dataAddebito'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_dataAddebito','label.pagamento.dataAddebito',"L\'anno deve essere compreso tra il 1900 e il 2050","validate_pagamento_dataAddebito_checkInRangeValidator", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.dataValuta'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_dataValuta','label.pagamento.dataValuta',"La sintassi non \u00E8 corretta","validate_pagamento_dataValuta_sintaxDateValidator", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.dataValuta'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_dataValuta','label.pagamento.dataValuta',"La data inserita non \u00E8 valida","validate_pagamento_dataValuta_validDateValidator", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.dataValuta'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_dataValuta','label.pagamento.dataValuta',"L\'anno deve essere compreso tra il 1900 e il 2050","validate_pagamento_dataValuta_checkInRangeValidator", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['pagamento.desPagamento'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_pagamento_desPagamento','label.pagamento.desPagamento',"il campo \u00E8 obbligatorio","validate_pagamento_desPagamento_requiredCbiField", _onsubmit, _onchange);
	  ...
	  {     // var message= obj.message; var label=obj.label; 
        	...
        	if (document.getElementById("salvaAssqCbi").elements['contextSelectorData.codiceUnivoco'])  addValidation(showAlert,'salvaAssqCbi','salvaAssqCbi_contextSelectorData_codiceUnivoco','label.contextSelectorData.codiceUnivoco',"Specificare il codice univoco","validate_contextSelectorData_codiceUnivoco_richiestaCodiceUnivoco", _onsubmit, _onchange);
	    ...
	    function validateForm_salvaAssqCbi() {
				if (submitCount >= 1) { alert("Richiesta gia' inoltrata."); return false; } 
		        var form = document.getElementById("salvaAssqCbi");
