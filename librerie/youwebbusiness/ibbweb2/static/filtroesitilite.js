...
function setReadOnlyContoField(){
    var fieldRapportoBanca = document.forms[0].elements['filtroEsiti.idRapportoBanca'];
    if ((typeof fieldRapportoBanca == 'undefined') || (fieldRapportoBanca == null)) { return; }
    var fieldTipoEsito = document.forms[0].elements['filtroEsiti.tipoEsito'];
    if ((typeof fieldTipoEsito != 'undefined') && (fieldTipoEsito != null) && (fieldTipoEsito.value == 'SE')) {
		fieldRapportoBanca.disabled = true;
 		...
 		if ((typeof document.forms[0].elements['filtroEsiti.idComboRapporto'] != 'undefined') && (document.forms[0].elements['filtroEsiti.idComboRapporto'] != null)) {
