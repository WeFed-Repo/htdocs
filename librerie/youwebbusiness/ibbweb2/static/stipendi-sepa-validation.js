...
if (document.getElementById("salvaStipSepa").elements['contextSelectorData.id'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_contextSelectorData_id','label.contextSelectorData.id',"il campo \u00E8 obbligatorio","validate_contextSelectorData_id_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("salvaStipSepa").elements['contextSelectorData.descrizione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_contextSelectorData_descrizione','label.contextSelectorData.descrizione',"il campo \u00E8 obbligatorio","validate_contextSelectorData_descrizione_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("salvaStipSepa").elements['contextSelectorData.cf'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_contextSelectorData_cf','label.contextSelectorData.cf',"il campo \u00E8 obbligatorio","validate_contextSelectorData_cf_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("salvaStipSepa").elements['contextSelectorData.banca'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_contextSelectorData_banca','label.contextSelectorData.banca',"il campo \u00E8 obbligatorio","validate_contextSelectorData_banca_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("salvaStipSepa").elements['contextSelectorData.conto'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_contextSelectorData_conto','label.contextSelectorData.conto',"il campo \u00E8 obbligatorio","validate_contextSelectorData_conto_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
...
if (document.getElementById("salvaStipSepa").elements['disposizione.debitore.nm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_debitore_nm','label.disposizione.debitore.nm',"Debitore Effettivo il campo \u00E8 obbligatorio","validate_disposizione_debitore_nm_sepaRagSocDebEffetivoRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.debitore.nm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_debitore_nm','label.disposizione.debitore.nm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_debitore_nm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.debitore.strtNm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_debitore_strtNm','label.disposizione.debitore.strtNm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_debitore_strtNm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.debitore.bldgNb'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_debitore_bldgNb','label.disposizione.debitore.bldgNb',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_debitore_bldgNb_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.debitore.twnNm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_debitore_twnNm','label.disposizione.debitore.twnNm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_debitore_twnNm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.debitore.pstCd'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_debitore_pstCd','label.disposizione.debitore.pstCd',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_debitore_pstCd_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.debitore.ctrySubDvsn'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_debitore_ctrySubDvsn','label.disposizione.debitore.ctrySubDvsn',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_debitore_ctrySubDvsn_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.nm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_nm','label.disposizione.beneficiario.nm',"Dipendente il campo \u00E8 obbligatorio","validate_disposizione_beneficiario_nm_sepaRagSocFornitoreRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.nm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_nm','label.disposizione.beneficiario.nm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiario_nm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.strtNm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_strtNm','label.disposizione.beneficiario.strtNm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiario_strtNm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.bldgNb'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_bldgNb','label.disposizione.beneficiario.bldgNb',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiario_bldgNb_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.twnNm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_twnNm','label.disposizione.beneficiario.twnNm',"Beneficiario il campo \u00E8 obbligatorio","validate_disposizione_beneficiario_twnNm_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.twnNm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_twnNm','label.disposizione.beneficiario.twnNm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiario_twnNm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'capItaliaValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.pstCd'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_pstCd','label.disposizione.beneficiario.pstCd',"@ERROR Dipendente Il valore da inserire deve avere 5 caratteri.","validate_disposizione_beneficiario_pstCd_capItaliaValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.pstCd'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_pstCd','label.disposizione.beneficiario.pstCd',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiario_pstCd_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiario.ctrySubDvsn'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiario_ctrySubDvsn','label.disposizione.beneficiario.ctrySubDvsn',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiario_ctrySubDvsn_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.ibanBeneficiario'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_ibanBeneficiario','label.disposizione.ibanBeneficiario',"il campo \u00E8 obbligatorio","validate_disposizione_ibanBeneficiario_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.ibanBeneficiario'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_ibanBeneficiario','label.disposizione.ibanBeneficiario',"Codice IBAN errato o mancante.","validate_disposizione_ibanBeneficiario_checkIBANSub", _onsubmit, _onchange);
_onsubmit=false;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.ibanBeneficiario'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_ibanBeneficiario','label.disposizione.ibanBeneficiario',"Non e\' possibile modificare lo stato dell\' IBAN beneficiario.","validate_disposizione_ibanBeneficiario_controlloNazioneIban", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.ibanBeneficiario'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_ibanBeneficiario','label.disposizione.ibanBeneficiario',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_ibanBeneficiario_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=false;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.bicDisposizione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_bicDisposizione','label.disposizione.bicDisposizione',"Dipendente il campo \u00E8 obbligatorio","validate_disposizione_bicDisposizione_nazioneIbanFieldRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.bicDisposizione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_bicDisposizione','label.disposizione.bicDisposizione',"La lunghezza deve essere di 8 o 11 caratteri","validate_disposizione_bicDisposizione_bicLenghtValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.bicDisposizione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_bicDisposizione','label.disposizione.bicDisposizione',"non \u00E8 corretto. Il codice di controllo non corrisponde.","validate_disposizione_bicDisposizione_bicValid", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.bicDisposizione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_bicDisposizione','label.disposizione.bicDisposizione',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_bicDisposizione_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['datiAggBeneficiario.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggBeneficiario_codice','label.datiAggBeneficiario.codice',"Dipendente il campo \u00E8 obbligatorio","validate_datiAggBeneficiario_codice_requiredFornitoreDatiAggCodice", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['datiAggBeneficiario.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggBeneficiario_codice','label.datiAggBeneficiario.codice',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_datiAggBeneficiario_codice_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['datiAggBeneficiario.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggBeneficiario_codice','label.datiAggBeneficiario.codice',"Dipendente La lunghezza del dato inserito non \u00E8 corretta:\n il CUC deve essere lungo esattamente 8 caratteri.","validate_datiAggBeneficiario_codice_sepaBeneficiarioCucLengthValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['datiAggBeneficiario.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggBeneficiario_codice','label.datiAggBeneficiario.codice',"Dipendente il CUC non \u00E8 valido: il codice di controllo non corrisponde","validate_datiAggBeneficiario_codice_sepaBeneficiarioCucValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['datiAggBeneficiario.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggBeneficiario_codice','label.datiAggBeneficiario.codice',"Dipendente \" @CODE \" non \u00E8 corretta","validate_datiAggBeneficiario_codice_checkFornitoreDatiAggCodice", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['datiAggBeneficiario.descCodice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggBeneficiario_descCodice','label.datiAggBeneficiario.descCodice',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_datiAggBeneficiario_descCodice_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiarioEffettivo.nm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiarioEffettivo_nm','label.disposizione.beneficiarioEffettivo.nm',"Creditore Effettivo il campo \u00E8 obbligatorio","validate_disposizione_beneficiarioEffettivo_nm_sepaRagSocCreditoreRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiarioEffettivo.nm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiarioEffettivo_nm','label.disposizione.beneficiarioEffettivo.nm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_nm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiarioEffettivo.strtNm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiarioEffettivo_strtNm','label.disposizione.beneficiarioEffettivo.strtNm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_strtNm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiarioEffettivo.bldgNb'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiarioEffettivo_bldgNb','label.disposizione.beneficiarioEffettivo.bldgNb',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_bldgNb_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiarioEffettivo.twnNm'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiarioEffettivo_twnNm','label.disposizione.beneficiarioEffettivo.twnNm',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_twnNm_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'capItaliaValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiarioEffettivo.pstCd'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiarioEffettivo_pstCd','label.disposizione.beneficiarioEffettivo.pstCd',"@ERROR Creditore Effettivo Il valore da inserire deve avere 5 caratteri.","validate_disposizione_beneficiarioEffettivo_pstCd_capItaliaValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiarioEffettivo.pstCd'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiarioEffettivo_pstCd','label.disposizione.beneficiarioEffettivo.pstCd',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_pstCd_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.beneficiarioEffettivo.ctrySubDvsn'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_beneficiarioEffettivo_ctrySubDvsn','label.disposizione.beneficiarioEffettivo.ctrySubDvsn',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_beneficiarioEffettivo_ctrySubDvsn_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['datiAggCreditore.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggCreditore_codice','label.datiAggCreditore.codice',"Creditore il campo \u00E8 obbligatorio","validate_datiAggCreditore_codice_requiredCreditoreDatiAggCodice", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['datiAggCreditore.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggCreditore_codice','label.datiAggCreditore.codice',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_datiAggCreditore_codice_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['datiAggCreditore.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggCreditore_codice','label.datiAggCreditore.codice',"Creditore La lunghezza del dato inserito non \u00E8 corretta:\n il CUC deve essere lungo esattamente 8 caratteri.","validate_datiAggCreditore_codice_sepaCreditoreCucLengthValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['datiAggCreditore.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggCreditore_codice','label.datiAggCreditore.codice',"Creditore il CUC non \u00E8 valido: il codice di controllo non corrisponde","validate_datiAggCreditore_codice_sepaCreditoreCucValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['datiAggCreditore.codice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggCreditore_codice','label.datiAggCreditore.codice',"Creditore \" @CODE \" non \u00E8 corretta","validate_datiAggCreditore_codice_checkCreditoreDatiAggCodice", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['datiAggCreditore.descCodice'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_datiAggCreditore_descCodice','label.datiAggCreditore.descCodice',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_datiAggCreditore_descCodice_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.importoDisposizioneStringValue'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_importoDisposizioneStringValue','label.disposizione.importoDisposizioneStringValue',"il campo \u00E8 obbligatorio","validate_disposizione_importoDisposizioneStringValue_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.importoDisposizioneStringValue'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_importoDisposizioneStringValue','label.disposizione.importoDisposizioneStringValue',"Inserire un valore reale","validate_disposizione_importoDisposizioneStringValue_importiNumero", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.importoDisposizioneStringValue'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_importoDisposizioneStringValue','label.disposizione.importoDisposizioneStringValue',"deve essere compreso tra 0,01 e 999999999,99","validate_disposizione_importoDisposizioneStringValue_importoMassimo", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.divisaDisposizione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_divisaDisposizione','label.disposizione.divisaDisposizione',"il campo \u00E8 obbligatorio","validate_disposizione_divisaDisposizione_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['monitoraggio.riconciliazione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_monitoraggio_riconciliazione','label.monitoraggio.riconciliazione',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_monitoraggio_riconciliazione_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'requiredCbiValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.keyDisposizione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_keyDisposizione','label.disposizione.keyDisposizione',"il campo \u00E8 obbligatorio","validate_disposizione_keyDisposizione_requiredCbiValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.keyDisposizione'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_keyDisposizione','label.disposizione.keyDisposizione',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_keyDisposizione_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.codiceIsoCausale'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_codiceIsoCausale','label.disposizione.codiceIsoCausale',"il campo \u00E8 obbligatorio","validate_disposizione_codiceIsoCausale_sepaCausaleISORequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'javascriptExpression';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.codiceCausale'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_codiceCausale','label.disposizione.codiceCausale',"Attenzione! E\' possibile inserire la Causale ISO oppure la Causale libera.","validate_disposizione_codiceCausale_javascriptExpression", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.codiceCausale'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_codiceCausale','label.disposizione.codiceCausale',"il campo \u00E8 obbligatorio","validate_disposizione_codiceCausale_sepaCausaleLiberaRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.codiceCausale'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_codiceCausale','label.disposizione.codiceCausale',"E necessario inserire la causale libera o la causale ISO","validate_disposizione_codiceCausale_sepaCausaleLiberaOCausaleISOObbligatorie", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.codiceCausale'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_codiceCausale','label.disposizione.codiceCausale',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_codiceCausale_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'bundleSwiftStringValidator';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.descrizioneFinalitaPagamento'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_descrizioneFinalitaPagamento','label.disposizione.descrizioneFinalitaPagamento',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_descrizioneFinalitaPagamento_bundleSwiftStringValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.descAnagDestinatarioEsito'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_descAnagDestinatarioEsito','label.disposizione.descAnagDestinatarioEsito',"Esito Al Beneficiario il campo \u00E8 obbligatorio","validate_disposizione_descAnagDestinatarioEsito_sepaEsitoBeneficiarioRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.descAnagDestinatarioEsito'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_descAnagDestinatarioEsito','label.disposizione.descAnagDestinatarioEsito',"&SWIFTSTRINGBUNDLE Caratteri ammessi: \nlettere (a-z)(A-Z) \nnumeri (0-9) \ncarattere (spazio) \ncaratteri speciali (/-?:().,\'+)","validate_disposizione_descAnagDestinatarioEsito_switftStringValidatorDestinatarioEsito", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'sepaEsitoBeneficiarioRequired';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.modalitaEsito'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_modalitaEsito','label.disposizione.modalitaEsito',"Esito Al Beneficiario il campo \u00E8 obbligatorio","validate_disposizione_modalitaEsito_sepaEsitoBeneficiarioRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
var ffffnnnn = 'sepaEsitoBeneficiarioRequired';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.cucDestinatarioEsito'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_cucDestinatarioEsito','label.disposizione.cucDestinatarioEsito',"Esito Al Beneficiario il campo \u00E8 obbligatorio","validate_disposizione_cucDestinatarioEsito_sepaEsitoBeneficiarioRequired", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.cucDestinatarioEsito'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_cucDestinatarioEsito','label.disposizione.cucDestinatarioEsito'," La lunghezza del dato inserito non \u00E8 corretta:\n il CUC deve essere lungo esattamente 8 caratteri.","validate_disposizione_cucDestinatarioEsito_sepaEsitoCucLengthValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['disposizione.cucDestinatarioEsito'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_cucDestinatarioEsito','label.disposizione.cucDestinatarioEsito',"Formato dell\'indirizzo e-mail non valido","validate_disposizione_cucDestinatarioEsito_sepaEsitoMailValidator", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['pagamentoSepa.causaleValutariaCvs1'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_pagamentoSepa_causaleValutariaCvs1','label.pagamentoSepa.causaleValutariaCvs1',"CVS 1 il campo \u00E8 obbligatorio","validate_pagamentoSepa_causaleValutariaCvs1_sepaCausaleCVS1Required", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'importiNumero';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.cvs1.importoRiferimentoCvsStringValue'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_cvs1_importoRiferimentoCvsStringValue','label.disposizione.cvs1.importoRiferimentoCvsStringValue',"Inserire un valore reale","validate_disposizione_cvs1_importoRiferimentoCvsStringValue_importiNumero", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'importoMassimo';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.cvs1.importoRiferimentoCvsStringValue'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_cvs1_importoRiferimentoCvsStringValue','label.disposizione.cvs1.importoRiferimentoCvsStringValue',"deve essere compreso tra 0,01 e 999999999,99","validate_disposizione_cvs1_importoRiferimentoCvsStringValue_importoMassimo", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
...
if (document.getElementById("salvaStipSepa").elements['pagamentoSepa.causaleValutariaCvs2'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_pagamentoSepa_causaleValutariaCvs2','label.pagamentoSepa.causaleValutariaCvs2',"CVS 2 il campo \u00E8 obbligatorio","validate_pagamentoSepa_causaleValutariaCvs2_sepaCausaleCVS2Required", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_NONE;
/*
...
if (document.getElementById("salvaStipSepa").elements['tipoCvs2'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_tipoCvs2','label.tipoCvs2',"CVS 2 il campo \u00E8 obbligatorio","validate_tipoCvs2_sepaTipoCVS2Required", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'importiNumero';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.cvs2.importoRiferimentoCvsStringValue'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_cvs2_importoRiferimentoCvsStringValue','label.disposizione.cvs2.importoRiferimentoCvsStringValue',"Inserire un valore reale","validate_disposizione_cvs2_importoRiferimentoCvsStringValue_importiNumero", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'importoMassimo';
...
if (document.getElementById("salvaStipSepa").elements['pagamentoSepa.causaleValutariaCvs3'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_pagamentoSepa_causaleValutariaCvs3','label.pagamentoSepa.causaleValutariaCvs3',"CVS 3 il campo \u00E8 obbligatorio","validate_pagamentoSepa_causaleValutariaCvs3_sepaCausaleCVS3Required", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'importiNumero';
...
if (document.getElementById("salvaStipSepa").elements['disposizione.cvs3.importoRiferimentoCvsStringValue'])  addValidation(showAlert,'salvaStipSepa','salvaStipSepa_disposizione_cvs3_importoRiferimentoCvsStringValue','label.disposizione.cvs3.importoRiferimentoCvsStringValue',"Inserire un valore reale","validate_disposizione_cvs3_importoRiferimentoCvsStringValue_importiNumero", _onsubmit, _onchange);
_onsubmit=true;
_onchange=CHECK_ON_CHANGE;
/*
var ffffnnnn = 'importoMassimo';
