...
$('.oldPdfIcon').removeAttr('src').attr('src', imagePath + 'images/i_pdf.png'+'?vtm=1');
$('.oldXlsIcon').removeAttr('src').attr('src', imagePath + 'images/i_xls.png');
...
function formatFormFields() {
	...
	$('.old-fieldSearch').each(function(index, element) {
		$(this).html('<img src="' + imagePath + 'images/ico-filter.png?vtm=1" class="new-search" alt="Cerca" border="0" height="20" width="20">');
	});
	...
	$('.old-fieldQuickFilter').each(function(index, element) {
		$(this).html('<img src="' + imagePath + 'images/i_quick-filter.png?vtm=1" alt="Applica filtro rapido" border="0" >');//height="20" width="20"
	});
	
	$('.old-fieldFilter').each(function(index, element) {
		$(this).html('<img src="' + imagePath + 'images/i_filter.png?vtm=1" alt="Filtri" border="0" >');//height="20" width="20"
	});
	
	$('.old-fieldRemoveFilter').each(function(index, element) {
		$(this).html('<img src="' + imagePath + 'images/i_remove-filter.png?vtm=1" alt="Azzera filtri" border="0" >');//height="20" width="20"
	});
