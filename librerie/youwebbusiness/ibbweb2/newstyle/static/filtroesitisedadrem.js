...
var ESITI_ESTRAZIONI_SEDAD_REM   = "3347";	//it.itecons.actions.iface.ActionFunctionIds.ESITI_ESTRAZIONI_SEDA = "3346"
...
function detailIntestatario(){
	...
	case ESITI_ESTRAZIONI_SEDA:
		detailIntestatario_Esiti_Pag(intestatario);
		break;
	case ESITI_ESTRAZIONI_SEDAD_REM:
		detailIntestatario_Esiti_Pag(intestatario);
		break;
...
function showParameters(){
	...
	case ESITI_ESTRAZIONI_SEDA: //3346
		...
		break;
	case ESITI_ESTRAZIONI_SEDAD_REM: //3346
		showParameters_Esiti_Seda(flag);
		break;	
	}
...
function reopenParameters_Esiti_Pag(flag){
	var field = document.forms[0].elements['filtroEsitiSedaRemuneration.tipoEsito'];
	if (field.style.removeProperty) {
		field.style.removeProperty ("border-color");
	}else{
		field.style.removeAttribute ("borderColor");
	}
	field = document.forms[0].elements['filtroEsitiSedaRemuneration.statoPagamento'];
	if (field.style.removeProperty) {
		field.style.removeProperty ("border-color");
	}else{
		field.style.removeAttribute ("borderColor");
...
function setReadOnlyField(){
 	...
 	if(document.forms[0].elements['filtroEsitiSedaRemuneration.tipoEsito'] !== undefined && document.forms[0].elements['filtroEsitiSedaRemuneration.tipoEsito'].value=='SE'){
 		document.forms[0].elements['filtroEsitiSedaRemuneration.idRapportoBanca'].disabled=true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.idRapportoBanca'].value="";
 		document.forms[0].elements['filtroEsitiSedaRemuneration.idComboRapporto'].value="";
 		document.forms[0].elements['filtroEsitiSedaRemuneration.idRapportoBanca'].style.color = "#e0e0e0";
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerDistintaAttivo'].disabled=true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerDistintaAttivo'].checked=false;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.statoPagamento'].disabled=true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.statoPagamento'].value="";
 		document.forms[0].elements['filtroEsitiSedaRemuneration.statoPagamento'].style.color = "#e0e0e0";
 		/*
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA'].readOnly = true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA'].disabled = true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA'].style.color = "#e0e0e0";
 		*/
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA'].value="";
	 	document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].value="";
	 	document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].value="";
	 	document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa'].value="";
	 	document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoA'].value = "";
	 	document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoDa'].value = "";
 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA', true, true);
 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa', true, true);
 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA', true, true);
 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa', true, true);
 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.importoA', true, true);
 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.importoDa', true, true);
 		/*
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].readOnly = true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].style.color = "#e0e0e0";
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].disabled = true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].style.color = "#e0e0e0";
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa'].readOnly = true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa'].disabled = true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa'].style.color = "#e0e0e0";
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoA'].readOnly = true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoA'].style.color = "#e0e0e0";
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoDa'].readOnly = true;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoDa'].style.color = "#e0e0e0";
 		*/
	 	document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA'].value="";
	 	document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].value="";
	 	document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].value="";
 		...
 		if( ( document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerDistintaAttivo'].checked == false
 				&& document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerSottoDistintaAttivo'] == undefined) ||
 				
 				(document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerDistintaAttivo'].checked == false
 				&& document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerSottoDistintaAttivo'] !== undefined &&
 					document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerSottoDistintaAttivo'].checked == false )) {
 			...
 			document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerDistintaAttivo'].disabled=false;
	 		...
	 		*/
 			...
 			/*
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].readOnly = true;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].disabled=true;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].style.color = "#e0e0e0";
	 		*/
 			
 			/*
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].readOnly = true;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].disabled=true;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].style.color = "#e0e0e0";
	 		*/
	 		...
	 		*/
	 		...
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaPerDistintaAttivo'].disabled=false;
	 		/*
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA'].readOnly = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA'].disabled = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA'].style.color = "#ffffff";
	 		*/
	 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioA', false, false);
	 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa', false, false);
	 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA', false, false);
	 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa', false, false);
	 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.importoA', false, false);
	 		lockFieldByName('filtroEsitiSedaRemuneration.ricercaDistinta.importoDa', false, false);
	 		/*
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].readOnly = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].disabled = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataInvioDa'].style.color = "#ffffff";
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].readOnly = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].disabled = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneA'].style.color = "#ffffff";
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa'].readOnly = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa'].disabled = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.dataEsecuzioneDa'].style.color = "#ffffff";
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoA'].readOnly = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoA'].style.color = "#ffffff";
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoDa'].readOnly = false;
	 		document.forms[0].elements['filtroEsitiSedaRemuneration.ricercaDistinta.importoDa'].style.color = "#ffffff";
	 		*/
 		}
 		if (document.forms[0].elements['filtroEsitiSedaRemuneration.statoPagamento'] !== undefined){
 			document.forms[0].elements['filtroEsitiSedaRemuneration.statoPagamento'].disabled=false;
 		 	document.forms[0].elements['filtroEsitiSedaRemuneration.statoPagamento'].style.backgroundColor = "#ffffff";
 		}
 		document.forms[0].elements['filtroEsitiSedaRemuneration.idRapportoBanca'].disabled=false;
 		document.forms[0].elements['filtroEsitiSedaRemuneration.idRapportoBanca'].style.backgroundColor = "#ffffff";
 	}
 }
...
if(this.ckecked) { this.form.elements['filtroEsitiSedaRemuneration.ricercaPerSottoDistintaAttivo'].checked = false; }