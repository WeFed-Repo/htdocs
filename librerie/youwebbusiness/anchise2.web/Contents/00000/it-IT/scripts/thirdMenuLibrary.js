...
function visualizzaMenu(nLink, menuSelezionato, e) {
    ...
    if (document.all) {//In questo caso il browser utilizzato e' ie
        ...
        y = parent.main.document.body.scrollTop || parent.main.document.documentElement.scrollTop;
    ...
    if (document.all) {
        ...
        var menu1 = $('#menu1', parent.frames['main'].document);
        if (menu1) {
            menu1.css("left", x).css("top", y);
        }
                ...
                */
                ...
                else if (menu[i].id == 10002)// =============== Contattaci
                {
                    ...
                    if (parent.topframe.isSignOnEnabled)
                        ...
                        htmlGenerato += "<td class='" + class4Menu + "' onmouseover='parent.middle.hideLayerMenu2(\"menu2\")'><a href='javascript:parent.middle.document.formino.menuSelezionato.value=" + menu[i].id + ";parent.parent.tm_top.writeUserStatus(\"menu1\",\"" + menu[i].area + "\");parent.parent.tm_top.writeUserStatus(\"menu2\",\"" + menu[i].descrizione + "\");parent.parent.tm_top.writeUserStatus(\"menu3\",\"\");parent.topframe.setMenuMaster(\"" + menu[i].areaName + "\");parent.topframe.setMenuDetail(\"" + menu[i].collegamento + "\");parent.middle.callServlet(\"" + menu[i].collegamento + "\");' class='" + class4Menu + "'>" + menu[i].descrizione + "</a></td><td></td>";
                    else
                        ...
                        htmlGenerato += "<td class='" + class4Menu + "' onmouseover='parent.middle.hideLayerMenu2(\"menu2\")'><a href='javascript:parent.middle.document.formino.menuSelezionato.value=" + menu[i].id + ";parent.topframe.setMenuMaster(\"" + menu[i].areaName + "\");parent.topframe.setMenuDetail(\"" + menu[i].collegamento + "\");parent.middle.callServlet(\"" + menu[i].collegamento + "\");' class='" + class4Menu + "'>" + menu[i].descrizione + "</a></td><td></td>";
                }
            }
            htmlGenerato += "</tr>";
...
function visualizzaEnnesimoMenu(nLink, menuSelezionato, x, y, posizioneVerticale) {
    ...
    for (i = 0; i < menu.length; i++) {// ===== Questo ciclo for scorre interamente l'array contenente il menu di Terzo livello
        if (menu[i].idMenu == nLink) {// === Vengono visualizzate solamente le voci che riguardano la voce del menu di secondo livello selezionata
            ...
            htmlGenerato += "<td>&nbsp;</td>";
            if (parent.topframe.isSignOnEnabled)
                htmlGenerato += "<td><a href='javascript:parent.middle.document.formino.menuSelezionato.value=" + menu[i].id + ";parent.parent.tm_top.writeUserStatus(\"menu1\",\"" + menu[i].area + "\");parent.parent.tm_top.writeUserStatus(\"menu2\",\"" + menu[i].menuPadre + "\");parent.parent.tm_top.writeUserStatus(\"menu3\",\"" + menu[i].descrizione + "\");parent.topframe.setMenuMaster(\"" + menu[i].areaName + "\");parent.topframe.setMenuDetail(\"" + menu[i].collegamento + "\");parent.middle.callServlet(\"" + urlPagina + "\");' class='" + class4Menu + "'>" + menu[i].descrizione + "</a></td></tr>";
            else
                htmlGenerato += "<td><a href='javascript:parent.middle.document.formino.menuSelezionato.value=" + menu[i].id + ";parent.topframe.setMenuMaster(\"" + menu[i].areaName + "\");parent.topframe.setMenuDetail(\"" + menu[i].collegamento + "\");parent.middle.callServlet(\"" + urlPagina + "\");' class='" + class4Menu + "'>" + menu[i].descrizione + "</a></td></tr>";
    ...
    //    if (document.all) {
    //        debugger;
    //        var finemenu1 = $('#fineMenumenu1', parent.frames['main'].document);
    //        var inizioMenumenu1 = $('#inizioMenumenu1', parent.frames['main'].document);
    //        
    ...
    if (menu1) {
        ...
        if (menu1.css("left") != "auto") {
            x = 0 + parseInt(menu1.css("left").replace("px", "")) + parseInt(menu1.css("width").replace("px", "")) - 10;
        }
        else {
            // x = 0 + parseInt(menu1.style.left.replace("px", "")) + parseInt(menu1.css("width").replace("px", "")) - 10;
            x = 0 + 0 + parseInt(menu1.css("width").replace("px", "")) - 10;
        }

        var menu2 = $('#menu2', parent.frames['main'].document);
        if (menu2) {
            menu2.css("left", x).css("top", y);
        }
    }
    /*
