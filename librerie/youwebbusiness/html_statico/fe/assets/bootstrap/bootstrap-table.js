...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        icons: {
            ...
            detailOpen: 'icon icon-arrow_down',
            detailClose: 'icon icon-arrow_up'
        },
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            ...
            return '<span class="label-group">' + 'Vedi' + '</span>' + ' ' +  pageNumber;
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            //return sprintf('Showing %s to %s of %s rows', pageFrom, pageTo, totalRows);
            return '<span class="label-group">' + totalRows + ' ' + 'Risultati' + '</span>';
        },
    ...
    BootstrapTable.prototype.removeByUniqueId = function (id) {
        ...
        if (row) {
            ...
            this.options.data.splice(jQuery.inArray(row,this.options.data) ,1)
         }
