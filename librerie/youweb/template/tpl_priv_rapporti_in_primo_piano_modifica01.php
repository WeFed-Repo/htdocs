...
.imgSrv{
	...
	<h1>
				...
				<div class="hidden-print hidden-xxs flag rapportiPrimoPianoModifica">&nbsp;</div>
 					...
 					<span>Modifica conto corrente<span class="hidden-xxs"> in primo piano</span></span>
		...
		<div class="contentPagina">
			Questa sezione ti da la possibilit&agrave; di scegliere quale rapporto vuoi visualizzare per primo nel momento in cui 
			accedi ad una funzionalit&agrave;. Puoi impostarne uno per ogni tipologia.
		</div>
	...
	<form id="formPuRapportiPredefiniti" method="post" action="/WEBHT/serviziPerTe/rapportiPredefinitiEsito.do">
	<input type="hidden" name="tipoRapporto" value="conto">
		...
		<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper no-footer">
			<div id="DataTables_Table_10_wrapper" class="dataTables_wrapper no-footer"><table class="table table-responsive table-striped dataTable no-footer" id="DataTables_Table_10" role="grid">
				...
				<tr role="row" class="odd">
										...
										<td class="hidden sorting_1">&nbsp;<input type="hidden" name="codContoCorrente" value="001|2070|207000001788">
										</td>
							...
							<td headers="ccRapporto">0000000</td>
