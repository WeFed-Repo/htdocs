...
<body onLoad="setSaldoParziale(this); visualizzaSegnalazione();" onclick="deselezionaTutti();"  style="zoom: 1;">
	...
	<input type="hidden" name="_control.identificativoDelega" value='5324213' />
		...
		<div class="main row">
			<div class="container">				
				...
				<div style="display: block;" class="messagePanel success">
					...
					<p>
						<strong>
								La delega &egrave; stata salvata ed &egrave; disponibile nella sezione Riepilogo F24.<br/>
								Per completare il pagamento &egrave; necessario selezionare la delega e spedirla in banca mediante il tasto INVIA.
						</strong>
					</p>
				</div>
...
<div class="section clearfix">
	...
	<form name="uploadFlussoForm" method="post" action="/sape/f24/uploadFile.do" enctype="multipart/form-data" target='frF24Center'><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="InvalidToken">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.comDom" tabindex="13" size="30" maxlength="25" value="MILANO" class="form-control" 
			...
			<div class="bs-example">
				<div class="form-group">
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
						...
						<div class="form-field">
							<input type="text" name="sezione(erario).riga[0].codiceTributo" tabindex="17" maxlength="4" value="4033" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
					...
					<div class="form-field-input col-md-2 col-lg-1 col-sm-2 col-xs-2">
						...
						<div class="form-field">
							<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
								<input type="text" name="sezione(erario).riga[0].rateazione" tabindex="18" size="4" maxlength="4" value="0101" class="form-control" onfocus="selezionato(this)" 
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-2">
						...
						<div class="form-field">
							<input type="text" name="sezione(erario).riga[0].anno" tabindex="19" size="4" maxlength="4" value="2017" class="form-control numerico" 
					...
					<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-2">
						...
						<div class="form-field">
							<input type="text" name="sezione(erario).riga[0].interiImportoDebito" tabindex="20" size="9" maxlength="13" value="0" class="form-control numerico" id="importoInt" onblur="tot(this, 'erario')" 
								class="inputImporti"
							/>&nbsp;,
							<input type="text" name="sezione(erario).riga[0].centImportoDebito" tabindex="21" size="2" maxlength="2" value="01" class="form-control numerico" id="importoDec" onblur="tot(this, 'erario')" 
					...
					<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-2">
						...
						<div class="form-field">
							<input type="text" name="sezione(erario).riga[0].interiImportoCredito" tabindex="22" size="9" maxlength="13" value="" class="form-control numerico" id="importoInt" onblur="tot(this, 'erario')" 
								class="inputImporti"
							/>&nbsp;,
							<input type="text" name="sezione(erario).riga[0].centImportoCredito" tabindex="23" size="2" maxlength="2" value="" class="form-control numerico" id="importoDec" onblur="tot(this, 'erario')" 
			...
			<div class="form-group">			
				...
				<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
					...
					<div class="form-field">						
									...
									<input type="text" name="dataIncassoHtml" tabindex="230" size="15" maxlength="10" value="28/04/2017" class="datepicker dataIncassoHtml form-control data" 
				...
				<div class="form-group">
					<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
						...
						<div class="form-field">						
							<input type="text" class="form-control" readonly="readonly" value='5324213' />
						</div>
					</div>
					<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
						...
						<div class="form-field">				
								...
								<input type="text" class="form-control" readonly="readonly" value='Delega da inviare
' />
...
<script type="text/javascript">
			      ...
			      function invia() {
			        if (!getSubmitted()) {
			           document.f24MainForm.action = 'tpl_priv_pagamento_f24_modulo_step3_esito_positivo.php';
			           document.f24MainForm.target = 'frF24Center';
			           document.f24MainForm.submit();
			        }
			      }
