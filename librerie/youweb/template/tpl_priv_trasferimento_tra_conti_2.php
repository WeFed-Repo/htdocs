...
<form id="formTrasferimento" method="post" action="/WEBHT/pagamenti/trasferimentoContiEsito.do" class="form-horizontal"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="853141e74d48a8e385621df62d53228a"></div>
			...
			<div class="riquadro clearfix" id="sliderAddValidi">
				...
				<div class="sliderStaticWrapper">
					<div class="sliderInner">
						...
						<div id="sliderAdd_" class="slider sliderStatic ui-slider-handle-disabled" style="margin:0 45px"><span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 0%;">1</span></div>
