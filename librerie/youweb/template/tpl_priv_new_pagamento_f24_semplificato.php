...
visualizzaSegnalazione();" onclick="deselezionaTutti();" style="zoom: 1;">
	...
	<input type="hidden" name="DelegaUniqueToken" value='MTQ5MDk3MDM0MTY5MA==' />
				...
				<div id="mainContent" class="center col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="riquadro clearfix">
						...
						<div class="clearfix">
							...
							<h1>Modulo F24 Semplificato &nbsp;<a id="general-help" href="javascript:helpIMU('f24_pop_f24_semplificato.php');"><img src="/sape/f24/images/i_help.png" title="aiuto per la compilazione" alt="Aiuto per la compilazione"  class="imgSrv"/></a></h1>
						</div>
...
<div class="section clearfix">
	...
	<form name="uploadFlussoForm" method="post" action="/sape/f24/uploadFile.do" enctype="multipart/form-data" target='frF24Center'><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="3700ed70506c804d3ef72336a0b8c04d">
	  	...
	  	<input type="hidden" name="uploaded" value="false" />
			...
			<input type="hidden" name="id_chiamata" value="1490970297112_2wWUmzgQGnd5SSrw" />
					...
					<form name="f24MainForm" method="post" action="/sape/f24/inserisciNuovoModello.do" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="3700ed70506c804d3ef72336a0b8c04d">
...
<div class="section clearfix">
	<h3 class="titleSection">Dati contribuente <a class="general-help" href="javascript:helpSemplificato('/sape/f24/images/F24-help-1.jpg');"><img alt="Help On Line" class="imgSrv" src="/sape/f24/images/i_help.png" title="aiuto per la compilazione" alt="Aiuto per la compilazione" ></a></h3>
		<div class="bs-example">
			<div class="form-group">
						...
						<div class="col-md-5 col-lg-5 col-sm-5 col-xs-5 margin-top28 nascosto">
...
<script type="text/javascript">
			      ...
			      function salva() {
					if (!getSubmitted()) {
			          document.f24MainForm.action = '/sape/f24/salvaModello.do?id_chiamata=1490970297112_2wWUmzgQGnd5SSrw&_control.returnTo=modelloSalvato';
			      ...
			      function invia() {
			        if (!getSubmitted()) {
			           document.f24MainForm.action = '/sape/f24/controllaModello.do?id_chiamata=1490970297112_2wWUmzgQGnd5SSrw&';
			           document.f24MainForm.target = 'frF24Center';
			           document.f24MainForm.submit();
			        }
			      }
	      ...
	      function inserisciNuovoModelloStepBack() {
		      if (!getSubmitted()) {
			      ...
			      document.f24MainForm.action = '/sape/f24/inserisciNuovoModelloStep.do?id_chiamata=1490970297112_2wWUmzgQGnd5SSrw&_control.tipo=S';
			      document.f24MainForm.target= 'frF24Center';
			      document.f24MainForm.submit();
			  }
	      }
	      ...
	      function riepilogoButton() {
	    	  if (!getSubmitted()) {
		          document.f24MainForm.elements['_control.direction'].value = 'forward';
			      document.f24MainForm.action = '/sape/f24/riepilogo.do?tipoRiepilogo=riepilogo_f24_deleghe';
			      document.f24MainForm.target= 'frF24Center';
			      document.f24MainForm.submit();
			  }
	      }
