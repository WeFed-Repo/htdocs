...
<a href="javascript:OpenHelp('/WEBHT/help/page.do?id=116')" class="general-help help-icon hidden-xs"><img src="/HT/IMAGES/nGrafica/i_help.png" class="imgSrv" title="Help On Line" alt="Help On Line"></a>
...
<div class="pull-right padding-bottom10">
	<input type="submit" value="Cerca" class="btn" alt="Cerca">	
</div>
		...
		<tr role="row" class="odd">
					<td>
								...
								<a href="javascript:goToPage('/pagamenti/bonificoContinuativoDettaglio.do','selezionato' , '21048' )">
									<img class="icon15" title="dettaglio bonifico ripetitivo" src="/HT/IMAGES/i_dettaglio.gif">
								</a>
								...
								<a href="javascript:isValidState('/pagamenti/bonificoContinuativoConfermaRevoca.do','selezionato' , '21048' , 'statoBonificoContinuativo' , 'R' )">
									<img class="icon15" title="revoca bonifico ripetitivo" src="/HT/IMAGES/i_cancella.gif">
								</a>
