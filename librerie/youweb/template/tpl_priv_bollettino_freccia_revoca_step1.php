...
<span class="oLeft">310982505065556849957 </span>
		...
		<form id="formDettaglioDisposizione" method="post" action="/WEBHT/pagamenti/revocaDisposizione.do" onreset="submitForm('formIndietro')"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="0c3972e9c30ca5f648109ef00675684b"></div>
			
			<div class="divForm">
				<input type="hidden" name="codice" value="IH7132047166" id="codice">
