		...
		<div class="main row">
			<div class="container">
				...
				<div style="display: block;" class="messagePanel success">
					...
					<p>
						<strong>La delega &egrave; gi&agrave; stata spedita	</strong>
					</p>
				</div>
			...
			<div class="form-group">
				...
				<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-3">
					...
					<div class="form-field">						
							...
							<input type="text" name="contribuente.dataNascita1Html" tabindex="4" size="13" maxlength="10" value="01/01/1990" style="width:120px" class="dataNascitaHtml datepicker form-control w-auto" 
			...
			<div class="form-group">
				...
				<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
					...
					<div class="form-field">						
							...
							<input type="text" name="dataIncassoHtml" tabindex="55" size="15" maxlength="10" value="30/06/2017" class="datepicker dataIncassoHtml form-control data" 
