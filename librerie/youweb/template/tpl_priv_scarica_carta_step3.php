...
.imgSrv{
	...
	<div class="section clearfix">
	<form id="formScaricaCarta" method="post" action="/WEBHT/cartaConto/scaricaCartaEsito.do" class="form-horizontal"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="5a4146ee15e32d0dfb1de5eb6232bbeb"></div>
...
<div id="helpDialog" class="modal fade bs-example-modal-lg helpDialog" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg">
	...
	<div class="pull-right margin-bottom20">
		...
		<form id="formScaricaCarta" method="post" action="/WEBHT/cartaConto/scaricaCartaEsito.do" style="float:left"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="5a4146ee15e32d0dfb1de5eb6232bbeb"></div>
			<input type="submit" name="modifica" value="Modifica" class="btn btn-primary e" alt="Modifica">
		</form>
		<input type="button" name="ricaricaEsito" value="Conferma" onclick="$('#formScaricaCarta').submit()" class="btn btn-primary execute " alt="Conferma">
	</div>

<script type="text/javascript">
	var url = getPathContext() + "/cartaConto/invioOTPConSMSScaricaCarta.do";
