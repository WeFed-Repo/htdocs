		...
		<div class="row">
				<div class="container help">
					<div class="center col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<form name="ricercaTributiForm" method="post" action="/sape/f24/ricercaCodiciAction.do" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="75690798f9a9fd302f039cd758551be2">
