...
<a href="javascript:OpenHelp('/template/modale.php?pagTit=Help: Apertura Dossier Titoli online&pagCont=testo02')" class="general-help help-icon hidden-xs"><img src="/HT/IMAGES/nGrafica/i_help.png" class="imgSrv" title="Help On Line" alt="Help On Line"></a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
		...
		<div class="contentPagina">
			<div style="text-align: center;"><img src="/HT/IMAGES/CONTODEPOSITO/AttivazioneContoDepApprofondimenti.gif" alt="" width="637" height="57"></div>
		</div>
...
<form id="formInvestimentiDossier" method="post" action="/WEBHT/investimenti/dossierAttivazioneRiepilogo.do">
<div style="display:none">
<input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="5b5c31a1b12907c831b21e3c58f220b6">
</div>
<input type="hidden" name="aggiornamentoCorrispondenza" value="false" id="aggiornamentoCorrispondenza">
	...
	<div class="section clearfix">
		<h3 class="titleSection">	
			...
			<input type="button" name="" value="&nbsp;" onclick="modificaIndirizzo()" id="btnModificaIndirizzo" class="btnEdit floatr " alt="">  
		</h3>
		
		<div class="bs-example">
			<div class="form-group clearfix">
				<div class="form-field-input col-xs-12 col-sm-6">
			  		<label class="control-label" for="indirizzoCorrispondenza">
			  			Indirizzo
			  		</label>
					<div class="form-field">
						<input type="text" name="indirizzoCorrispondenza" maxlength="35"  value="FRAZIONE BARAZZINA II 10" readonly="readonly" id="indirizzoCorrispondenza" class="form-control readonly">
					</div>
				</div>
				<div class="form-field-input col-xs-12 col-sm-6">
				  	<label class="control-label" for="comuneCorrispondenza">
				  		Comune
				  	</label>
					<div class="form-field">	
						<input type="text" name="comuneCorrispondenza" maxlength="30"  value="BORGHETTO LODIGIANO" readonly="readonly" id="comuneCorrispondenza" class="form-control readonly ui-autocomplete-input" autocomplete="off">
			  		</div>
			  	</div>
				<div class="form-field-input col-xs-4 col-sm-2">
				  	<label class="control-label" for="capCorrispondenza">
				  		CAP
				  	</label>
					<div class="form-field">
						<input type="text" name="capCorrispondenza" maxlength="5"  value="26812" readonly="readonly" id="capCorrispondenza" class="form-control  readonly">
			  		</div>
			  	</div>
			  	<div class="form-field-input col-xs-4 col-sm-2">
				  	<label class="control-label" for="provinciaCorrispondenza">
				  		Provincia
				  	</label>
					<div class="form-field">
						<input type="text" name="provinciaCorrispondenza" maxlength="2"  value="LO" readonly="readonly" id="provinciaCorrispondenza" class="form-control  readonly">
			  		</div>
			  	</div>
			  	<div class="form-field-input col-xs-12 col-sm-6 col-sm-offset-2">
			  		<label class="control-label" for="nazioneSelect">
			  			Nazione
			  		</label>
					...
					<select name="nazioneCorrispondenza" onchange="checkNazioneCorrispondenza()" id="nazioneSelect" style="display:none;" class="form-control"><option value="">ITALIA</option>
	...
	<div class="section clearfix">
		...
		<div class="accordion ui-accordion ui-widget ui-helper-reset" role="tablist">
				<h3 class="intestazione ui-accordion-header ui-state-default ui-accordion-header-active ui-state-active ui-corner-top ui-accordion-icons" role="tab" id="ui-id-3" aria-controls="ui-id-4" aria-selected="true" aria-expanded="true" tabindex="0"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-s"></span>
				...
				<div class="bs-example form-horizontal ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active" id="ui-id-4" aria-labelledby="ui-id-3" role="tabpanel" aria-hidden="false" style="display: block;">
					...
					<div class="form-group clearfix">
						...
						<div class="col-xs-12 col-sm-6">
				  		...
				  		<div class="form-field-input col-xs-3 col-sm-2">
							<div class="form-field">
								<div class="form-field-input col-xs-3">
									<input type="radio" name="listaCointestatarioDossier[0].titolareEffettivoRapporto" value="true" checked="checked" id="titolareEffettivoRapportoSi0" class="margin-top5 sfondoForm">
								</div>
								<div class="form-field-input col-xs-3">
									<label for="titolareEffettivoRapportoSi0">S&igrave;</label>
								</div>
							</div>
						</div>
						<div class="form-field-input col-xs-9 col-sm-4">
							<div class="form-field">
								<div class="form-field-input col-xs-1">
									<input type="radio" name="listaCointestatarioDossier[0].titolareEffettivoRapporto" value="false" id="titolareEffettivoRapportoNo0" class="margin-top5 sfondoForm">
								</div>
								<div class="form-field-input col-xs-11">
									<label for="titolareEffettivoRapportoNo0">No, il rapporto verr&agrave; utilizzato principalmente da un'altra persona non intestataria</label>
								</div>
							</div>
						</div>
						<div class="col-xs-12">
						...
						<div class="col-xs-12 margin-bottom5">
							<div class="col-xs-12 col-sm-6">
								<label for="professione0">
									Professione (attivit&agrave; principale)
								</label>
							</div>
							<div class="col-xs-12 col-sm-6">
								<select name="listaCointestatarioDossier[0].professione" onchange="checkProfessione(0)" id="professione0" class="form-control"><option value="-">-</option>
									
										<option value="01">Imprenditore</option>
									
										<option value="02">Lavoratore autonomo</option>
									
										<option value="04" selected="selected">Lavoratore dipendente</option>
									
										<option value="03">Libero professionista</option>
									
										<option value="06">Non occupato</option>
									
										<option value="05">Pensionato</option>
									
										<option value="07">Soggetto apicale</option></select>	
							</div>
						</div>
						<div class="col-xs-12 margin-bottom5">
							<div class="col-xs-12 col-sm-6">
								<label for="provenienzaFondi0">
									Provenienza dei fondi
								</label>
							</div>
							<div class="col-xs-12 col-sm-6">
								<select name="listaCointestatarioDossier[0].codProvenienzaFondi" id="provenienzaFondi0" class="form-control"><option value="0">-</option>
									
										<option value="01">Vincita</option>
						...
						<div class="col-xs-12  margin-bottom5">	
							...
							<div class="col-xs-12 col-sm-6 ">
								<select name="listaCointestatarioDossier[0].codAttivitaEconomica" id="attEconomica0" class="form-control"><option value="">-</option>
								...
								<input type="hidden" name="listaCointestatarioDossier[0].descAttivitaEconomica" value="bancari" id="descAttEconomica0" />
							</div>
						</div>
						...
						<div class="col-xs-12 margin-bottom5">
							...
							<div class="col-xs-12 col-sm-6">
								<select name="listaCointestatarioDossier[0].nazioneAttivitaLavorativa" onchange="checkNazione(0)" id="nazione0" class="form-control"><option value="238">Abu Dhabi</option>
						...
						<div class="col-xs-12  margin-bottom5">
							<div class="col-xs-12 col-sm-6">
							  	<label for="provincia0">
							  		Provincia in cui viene svolta principalmente l'attivit&agrave; lavorativa
							  	</label>
							</div>
							<div class="col-xs-12 col-sm-6">
								<select name="listaCointestatarioDossier[0].provinciaAttivitaLavorativa" id="provincia0" class="form-control">
								<option value="">&nbsp;</option>
						...
						<div class="col-xs-12 margin-bottom5">
							<div class="col-xs-12 col-sm-6">
							  	<label for="nazioneRapporti0">
							  		Principale stato estero con il quale intrattieni rapporti economici
							  	</label>
							</div>
							<div class="col-xs-12 col-sm-6">
								<select name="listaCointestatarioDossier[0].codNazioneRapporti" id="nazioneRapporti0" class="form-control"><option value="">Nessuno</option>
						...
						<div class="col-xs-12  margin-top5">
							<strong>Quale sar&agrave; il principale utilizzo che farai di questo rapporto aperto per esigenze familiari personali?</strong>
						</div>
						<div class="col-xs-4 ">
							<input type="radio" name="listaCointestatarioDossier[0].principaleUtilizzoRapporto" value="01" id="principaleUtilizzoRapporto10" class="sfondoForm">
							<label for="principaleUtilizzoRapporto10">Risparmio</label>
						</div>
						<div class="col-xs-4 ">
							<input type="radio" name="listaCointestatarioDossier[0].principaleUtilizzoRapporto" value="03" checked="checked" id="principaleUtilizzoRapporto30" class="sfondoForm">
							<label for="principaleUtilizzoRapporto30">Investimento</label>
						</div>
						<div class="col-xs-4 ">
							<input type="radio" name="listaCointestatarioDossier[0].principaleUtilizzoRapporto" value="04" id="principaleUtilizzoRapporto40" class="sfondoForm">
							<label for="principaleUtilizzoRapporto40">Servizi vari</label>
						</div>
					 </div>
				</div>
				</div>
...
<form id="dossierIntestazione" method="post" action="/WEBHT/investimenti/dossierIntestazione.do">
<div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="5b5c31a1b12907c831b21e3c58f220b6"></div></form>
...
<div class="pull-right margin-bottom20">
	<input type="button" name="indietro" tabindex="3" value="Indietro" onclick="$('#dossierIntestazione').submit()" class="btn btn-primary">		
	<input type="button" name="avanti" tabindex="2" value="Avanti" onclick="$('#formInvestimentiDossier').submit()" class="btn btn-primary">
</div>
<script type="text/javascript">
	$(document).ready(function() 
	{	
		$("#comuneCorrispondenza").autocomplete({
			source: getPathContext() + '/cd/searchComuni.do',
			minLength: 3,
			select:function(event, ui){
				var prov_cap = ui.item.desc.split("|");
				$("#provinciaCorrispondenza").attr("value", prov_cap[0]);
				$("#capCorrispondenza").attr("value", prov_cap[1]);
			}
		});
	...
	function modificaIndirizzo() {
		...
		if (value == '') { // italia
			$('#provinciaCorrispondenza').removeClass('readonly');
			$('#provinciaCorrispondenza').removeAttr('readonly');
		}	
		
		$('#indirizzoCorrispondenza').removeClass('readonly');
		$('#indirizzoCorrispondenza').removeAttr('readonly');

		$('#comuneCorrispondenza').removeClass('readonly');
		$('#comuneCorrispondenza').removeAttr('readonly');

		$('#capCorrispondenza').removeClass('readonly');		
		$('#capCorrispondenza').removeAttr('readonly');
		...
		$.widget( "ui.combobox", {
			...
			_create: function() {
				...
				var input = this.input = $( "<input>" )
					...
					.addClass( "custom-combobox-input ui-widget ui-widget-content form-control ui-autocomplete-input" );
				...
				this.button = $( "<button type='button'>&nbsp;</button>" )
					...
					$(this.input).width($('#provenienzaFondi0').parent().width()-11-$(this.button).width());
			},
