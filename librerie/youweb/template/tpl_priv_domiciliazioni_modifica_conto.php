<div class="riquadro clearfix">
	<div class="clearfix">
		...
		<h1>
			...
			<span>Modifica conto di addebito</span>
		</h1>
		<div class="col-xs-12 hidden-xs hidden-print">
			<div class="contentPagina">
				Seleziona il nuovo conto corrente su cui addebitare i pagamenti
			</div>
		</div>
	</div>
	<form id="formPuRapportiPredefiniti" method="post" action="/WEBHT/serviziPerTe/rapportiPredefinitiEsito.do"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="0f566800f65e4cbf684be318f4450037"></div>
		<input type="hidden" name="tipoRapporto" value="carta">
			...
			<div class="selezioneCC tabellaSelezioneCC">
				<div class="CCselezionato clearfix">
					<div class="col-sm-6 col-xs-12">
						...
						<span class="col-xs-4" id="conto">YouCard</span>
					    <span class="col-xs-6" id="numero">*9130</span>
					</div>
					<div class="col-sm-6 col-xs-12">
						<span class="col-xs-4 hidden-xs" id="conto">&nbsp;</span>
						<span class="col-xs-6 hidden-xs" id="conto">&nbsp;</span>
						<span class="col-xs-4">Filiale: </span>
					    <span class="col-xs-6" id="agenzia">MILANO&nbsp;-&nbsp;0000</span>
					</div>
						...
						<table class="table table-responsive table-striped dataTable no-footer" id="DataTables_Table_10" role="grid">
							<tbody>
								<tr role="row" class="odd">
									<td class="hidden sorting_1" style="text-align: center"><input type="radio" name="codContoCorrente" value="001|0898|089800911819" checked="checked">
									</td>
									<td headers="tipoRapporto">YouCard </td>
									<td headers="ccRapporto">*0000</td>
								...
								<tr role="row" class="even">
									<td class="hidden sorting_1" style="text-align: center"><input type="radio" name="codContoCorrente" value="141|2070|000002636868"></td>
									<td headers="tipoRapporto">Bancomat</td>
									<td headers="ccRapporto">*0000</td>
									<td headers="filialeRapporto" class="hidden-xs">MILANO&nbsp;-&nbsp;0000</td>
									<td headers="intestazioneRapporto">Cognome Nome </td>
									<td headers="divisaSaldoDisponibile" class="hidden"></td>
...
<div class="pull-right margin-bottom20"> 
	<a class="btn btn-primary btn-annulla" role="button" title="Annulla">Annulla</a>
	<input type="button" name="modifica" value="modifica" class="btn btn-primary execute" alt="Modifica">
</div>