		...
		<table class="table table-striped dataTable no-footer" id="DataTables_Table_0" role="grid">
		    <thead>
			   <tr class="hover">
			        ...
			        <th style="width: 0px;" headers="filialeRapporto" class="hidden-xs oRight">Rate residue</th>        
			        <th style="width: 0px;" headers="saldoDisponibile" class="hidden-xs oRight">Importo accordato</th> 
				...
				<div class="col-xs-12">
					<div class="innerWrapperTab">
						<ul>
							...
							<li class="on"><a href="#" title="Ammortamento" id="amm_fin" role="button" class="amm_fin ">Ammortamento</a></li>
