				...
				<div class="clearfix">
					...
					<div class="col-xs-12">
						<div class="contentPagina">
							...
							<tbody>
							<tr>
								<td valign="top"><img title="YouWinSpecial2" style="margin-bottom: 0pt; margin-left: 15pt; border: 0px;" src="/HT/IMAGES/CONTENUTI/YouWinSpecial2.png" alt="YouWinSpecial2" width="111" height="104"></td>
								<td valign="middle">
