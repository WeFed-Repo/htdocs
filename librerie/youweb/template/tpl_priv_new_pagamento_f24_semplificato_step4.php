...
<script type="text/javascript">
	      ...
	      function inserisciNuovoModelloStepForward() {
		      if (!getSubmitted()) {
			      ...
			      document.f24MainForm.action = 'tpl_priv_new_pagamento_f24_semplificato_step5.php';
			      document.f24MainForm.target= 'frF24Center';
			      document.f24MainForm.submit();
			  }
	      }
	      ...
	      function inserisciNuovoModelloStepBack() {
		      if (!getSubmitted()) {
			      ...
			      document.f24MainForm.action = 'tpl_priv_new_pagamento_f24_semplificato_step3.php';
			      document.f24MainForm.target= 'frF24Center';
			      document.f24MainForm.submit();
			  }
	      }
...
<div class="pull-right margin-bottom20">
		...
		<input type="button" class="btn btn-primary" value="Modifica"  onclick="javascript: inserisciNuovoModelloStepBack();" />		
		<input type="button" class="btn btn-primary execute" value="Conferma"  onclick="javascript: inserisciNuovoModelloStepForward();" />
