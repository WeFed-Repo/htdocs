		...
		<div class="bs-example">		
			...
			<div class="form-field-resume col-xs-6">
				...
				<div class="form-field-resume col-xs-6">
					...
					<span class="resume">19/05/2017 15:16</span>
				</div>
...
<div class="divForm">	
	<form id="formCompraVendi" method="post" action="/template/popup_investimenti_bookOrdina_compra2.php">
	...
	<input type="hidden" name="tokenTol" value="16c2ed45affb1582e9868b17bb7ae481" />
