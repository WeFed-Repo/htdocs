...
<div class="section clearfix">
	...
	<div class="selezioneCC tabellaSelezioneCC">
		<div class="CCselezionato clearfix">
			<div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
				...
				<span class="col-md-6 col-lg-6 col-sm-6 col-xs-6" id="numero">000000001788</span>
				<span class="col-md-4 col-lg-4 col-sm-4 col-xs-4">Filiale:</span>
				<span class="col-md-6 col-lg-6 col-sm-6 col-xs-6" id="agenzia">MONZA - 2070</span>
			</div>		
	...
	<form name="uploadFlussoForm" method="post" action="/sape/f24/uploadFile.do" enctype="multipart/form-data" target="frCenter"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="e5f40243a631a685ff95afe21f95b566">
	  	...
	  	<input type="hidden" name="uploaded" value="false">
			...
			<input type="hidden" name="id_chiamata" value="1490787722150_gLq5H8QFc3702JsL">
					...
					<form name="f24MainForm" method="post" action="/sape/f24/inserisciNuovoModello.do" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="e5f40243a631a685ff95afe21f95b566">
					
						<input type="hidden" name="DelegaUniqueToken" value="MTQ5MDc4NzcyMjYxOQ==">
						<input type="hidden" name="_control.tipo" value="E">
...
<script type="text/javascript">
	...
	function selezionaPersonaGiuridica(fromRubrica) {
		...
		function compila(indice) {
			...
			if (indice == 1) {
				document.getElementsByName("contribuente.codFis")[0].value = 'DMNFRZ72E22A271U';
				document.getElementsByName("contribuente.codFis")[1].value = 'DMNFRZ72E22A271U';
				document.getElementsByName("contribuente.cognome")[0].value = decodeHtml('DOMANIN');
				document.getElementsByName("contribuente.nome")[0].value = decodeHtml('FABRIZIO');
				document.getElementsByName("contribuente.ragSoc")[0].value = decodeHtml('');
				document.getElementsByName("contribuente.sesso")[0].value = 'M';
				
					document.getElementsByName("contribuente.dataNascitaHtml")[0].value = '22/05/1972';
				
				document.getElementsByName("contribuente.indirizzo")[0].value = decodeHtml('VIA ALESSANDRO VOLTA 17');
				document.getElementsByName("contribuente.comNas")[0].value = decodeHtml('ANCONA');
		...
		<div class="bs-example">
			<div class="form-group">
						...
						<div class="form-field">
							<select class="form-control" onchange="compila(this.value)">
								<option value="0">Nuovo Contribuente</option>
											...
											<option value="1" selected="">DOMANIN FABRIZIO</option>
					...
					<div class="col-md-5 col-lg-5 col-sm-5 col-xs-5 margin-top22 nascosto">
						...
						<div id="slider" style="width:50px" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all"><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 0%;"></div><span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 0%;"></span></div>
						<div style="position:relative">
						  <div id="off" class="onText" style="float: left; position: absolute; left: -5px; padding-top: 3px; font-weight: bold;">Off</div>
					...
					<div class="form-group nascosto">
						...
						<div class="col-md-10 col-lg-10 col-sm-10 col-xs-10 pull-right">
							<input type="button" id="fisica" class="btn nonSelezionato" value="Fisica" onclick="selezionaPersonaFisica(false);">
							<input type="button" id="giuridica" class="btn selezionato" value="Giuridica" onclick="selezionaPersonaGiuridica(false);">
						</div>
					</div>
				...
				<div class="form-group schedaPersonaFisica" id="schedaPersonaFisica">
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.nome" tabindex="1" size="30" maxlength="20" value="FABRIZIO" class="form-control">
					...
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.cognome" tabindex="2" size="30" maxlength="24" value="DOMANIN" class="form-control">
						...
						<div class="col-md-1 col-lg-1 col-sm-1 col-xs-1 margin-top22">
							<input type="checkbox" name="flagAnnoSolare" tabindex="3" class="checkbox" value="1">
				...
				<div class="form-group schedaPersonaFisica" id="schedaPersonaFisica">
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.codFis" tabindex="4" size="30" maxlength="16" value="DMNFRZ72E22A271U" class="form-control">
						</div>
					</div>
					<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-2">
						...
						<div class="form-field">
							<div class="form-field-input col-lg-5 col-md-5 col-sm-5 col-xs-5">
										...
										<select name="contribuente.sesso" tabindex="5" class="form-control">
											<option value=" ">&nbsp;</option>
				...
				<div class="form-group schedaPersonaFisica" id="schedaPersonaFisica">
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.comNas" tabindex="6" maxlength="25" value="ANCONA" class="form-control">
					...
					<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-2">
						...
						<div class="form-field">
							<div class="form-field-input col-lg-4 col-md-6 col-sm-6 col-xs-6">
											...
											<select name="contribuente.provNas" tabindex="7" class="form-control">
					...
					<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-2">
						...
						<div class="form-field">
									...
									<input type="text" name="contribuente.dataNascitaHtml" tabindex="8" size="13" maxlength="10" value="22/05/1972" class="dataNascitaHtml form-control w-auto" id="dp1490787723260"><img class="ui-datepicker-trigger" src="/sape/f24/images/calendar.png" alt="Calendario" title="Calendario">
				...
				<div class="form-group schedaPersonaGiuridica" id="schedaPersonaGiuridica" style="display: none;">
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						<label class="control-label">Denominazione:</label>
						<div class="form-field">
							<input type="text" name="contribuente.ragSoc" tabindex="9" size="30" maxlength="44" class="solaLettura" disabled="">
					...
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.codFis" tabindex="10" size="30" maxlength="16" value="DMNFRZ72E22A271U" class="form-control" disabled="">
						</div>
					</div>
						...
						<div class="col-md-1 col-lg-1 col-sm-1 col-xs-1 margin-top22">
							<input type="checkbox" name="flagAnnoSolare" tabindex="11" class="checkbox" value="1" disabled="">
				...
				<div class="form-group">
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.indirizzo" tabindex="12" size="72" maxlength="34" value="VIA ALESSANDRO VOLTA 17" class="form-control">
						</div>
					</div>
	...
	<div class="section clearfix">
			...
			<div class="bs-example">
				...
				<div class="form-group">
					<div class="form-field-input col-md-2 col-lg-3 col-sm-2 col-xs-2">
						<div class="form-field">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								<input type="text" name="sezione(erario).codiceUfficio" tabindex="38" size="11" maxlength="3" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)"><a href="javascript: void(0);" title="Seleziona il codice Ufficio" class="pull-right">
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
						<input type="text" name="sezione(erario).riga[3].codiceTributo" tabindex="39" size="4" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)"><a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
		...
		<div class="bs-example">
			...
			<div class="form-group">
				<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
					...
					<div class="form-field">
						<input type="text" name="sezione(inps).riga[0].codiceSede" tabindex="61" size="3" maxlength="4" class="form-control numerico" onblur="deselezionato(this)" onfocus="selezionato(this)"><a href="javascript: void(0);" title="Seleziona il codice Sede" class="pull-right">							
			...
			<div class="form-group">
				...
				<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
					<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
						...
						<div class="form-field">
							<input type="checkbox" name="sezione(entiLocali).riga[0].ravvedimento" tabindex="131" class="checkbox" value="1">
					...
					<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-4">
						...
						<div class="form-field">
							<input type="checkbox" name="sezione(entiLocali).riga[0].immobiliVariati" tabindex="132" class="checkbox" value="1">
					...
					<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
						...
						<div class="form-field">
							<input type="checkbox" name="sezione(entiLocali).riga[0].acconto" tabindex="133" class="checkbox" value="1">
					...
					<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-3">
						...
						<div class="form-field">
							<input type="checkbox" name="sezione(entiLocali).riga[0].flagSaldo" tabindex="134" class="checkbox" value="1">
				...
				<div class="form-group">
					...
					<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
							<input type="checkbox" name="sezione(entiLocali).riga[1].ravvedimento" tabindex="144" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-4">
							<input type="checkbox" name="sezione(entiLocali).riga[1].immobiliVariati" tabindex="145" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<input type="checkbox" name="sezione(entiLocali).riga[1].acconto" tabindex="146" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<input type="checkbox" name="sezione(entiLocali).riga[1].flagSaldo" tabindex="147" class="checkbox" value="1">
				...
				<div class="form-group">
					...
					<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
							<input type="checkbox" name="sezione(entiLocali).riga[2].ravvedimento" tabindex="157" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-4">
							<input type="checkbox" name="sezione(entiLocali).riga[2].immobiliVariati" tabindex="158" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<input type="checkbox" name="sezione(entiLocali).riga[2].acconto" tabindex="159" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<input type="checkbox" name="sezione(entiLocali).riga[2].flagSaldo" tabindex="160" class="checkbox" value="1">
					...
					<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
							<input type="checkbox" name="sezione(entiLocali).riga[3].ravvedimento" tabindex="170" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-4">
							<input type="checkbox" name="sezione(entiLocali).riga[3].immobiliVariati" tabindex="171" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<input type="checkbox" name="sezione(entiLocali).riga[3].acconto" tabindex="172" class="checkbox" value="1">
							
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<input type="checkbox" name="sezione(entiLocali).riga[3].flagSaldo" tabindex="173" class="checkbox" value="1">
						...
						<div class="form-field">
							<input type="text" name="sezione(inail).riga[0].codiceSede" tabindex="184" size="5" maxlength="5" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)">
								...
								<a href="javascript: void(0);" title="Seleziona il codice Sede" class="pull-right">
										...
										<img border="0" src="/sape/f24/images/lampadina.jpg" name="sezione(inail).riga[0].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeInail', '/sape/f24/showHelp.do');" style="display : none;">
				...
				<div class="col-md-1 col-lg-1 col-sm-1 col-xs-1">
					<input type="text" name="sezione(inail).riga[1].codiceSede" tabindex="193" size="5" maxlength="5" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)">
						...
						<a href="javascript: void(0);" title="Seleziona il codice Sede" class="pull-right">
								...
								<img border="0" src="/sape/f24/images/lampadina.jpg" name="sezione(inail).riga[1].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeInail', '/sape/f24/showHelp.do');" style="display : none;">
				...
				<div class="form-field-input col-md-1 col-md-offset-1 col-lg-1 col-lg-offset-1 col-sm-1 col-sm-offset-1 col-xs-1 col-xs-offset-1">
					<input type="text" name="sezione(inail).riga[2].codiceSede" tabindex="202" size="5" maxlength="5" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)">
						...
						<a href="javascript: void(0);" title="Seleziona il codice Sede" class="pull-right">
								...
								<img border="0" src="/sape/f24/images/lampadina.jpg" name="sezione(inail).riga[2].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeInail', '/sape/f24/showHelp.do');" style="display : none;">
						...
						<div class="form-field">
							<input type="text" name="sezione(altriEnti).codiceEnte" tabindex="211" size="4" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)">
								...
								<a href="javascript: void(0);" title="Seleziona il codice Ente" class="pull-right">
										...
										<img border="0" src="/sape/f24/images/lampadina.jpg" name="sezione(altriEnti).riga[0].codiceEnte.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'enteAltriEnti', '/sape/f24/showHelp.do');" style="display : none;">
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
						...
						<input type="text" name="sezione(altriEnti).riga[0].codiceSede" tabindex="212" size="4" maxlength="5" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)">
							...
							<a href="javascript: void(0);" title="Seleziona il codice Sede" class="pull-right">
									...
									<img border="0" src="/sape/f24/images/lampadina.jpg" name="sezione(altriEnti).riga[0].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeAltriEnti', '/sape/f24/showHelp.do');" style="display : none;">
							...
							<div class="form-field">
								<input type="text" name="sezione(altriEnti).riga[0].causaleContributo" tabindex="213" size="4" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)">
									...
									<a href="javascript: void(0);" title="Seleziona il codice Causale Contributo" class="pull-right">
											...
											<img border="0" src="/sape/f24/images/lampadina.jpg" name="sezione(altriEnti).riga[0].causaleContributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'contributoAltriEnti', '/sape/f24/showHelp.do');" style="display : none;">
				...
				<div class="form-field-input col-md-1 col-md-offset-1 col-lg-1 col-lg-offset-1 col-sm-1 col-sm-offset-1 col-xs-1 col-xs-offset-1">
					<input type="text" name="sezione(altriEnti).riga[1].codiceSede" tabindex="221" size="4" maxlength="5" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)">
						...
						<a href="javascript: void(0);" title="Seleziona il codice Sede" class="pull-right">
									...
									<img border="0" src="/sape/f24/images/lampadina.jpg" name="sezione(altriEnti).riga[1].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeAltriEnti', '/sape/f24/showHelp.do');" style="display : none;">
					...
					<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
							<input type="text" name="sezione(altriEnti).riga[1].causaleContributo" tabindex="222" size="4" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)">
								...
								<a href="javascript: void(0);" title="Seleziona il codice Causale Contributo" class="pull-right">
											...
											<img border="0" src="/sape/f24/images/lampadina.jpg" name="sezione(altriEnti).riga[1].causaleContributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'contributoAltriEnti', '/sape/f24/showHelp.do');" style="display : none;">
...
<!-- Inizio sezione Firma ed altri dati -->
	...
	<input type="hidden" name="contoCorrente.codiceFiscale" value="DMNFRZ72E22A271U">
	<script type="text/javascript">
		$(document).ready(function(){
			...
			<div class="form-group">			
				...
				<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
					...
					<div class="form-field">						
									...
									<input type="text" name="dataIncassoHtml" tabindex="230" size="15" maxlength="10" class="datepicker dataIncassoHtml form-control data hasDatepicker" onfocus="javascript: this.style.backgroundColor = 0xFFFFFF;" id="dp1490787723261"><img class="ui-datepicker-trigger" src="/sape/f24/images/calendar.png" alt="Calendario" title="Calendario">
...
<script type="text/javascript">
			      ...
			      function salva() {
					if (!getSubmitted()) {
			          document.f24MainForm.action = '/sape/f24/salvaModello.do?id_chiamata=1490787722150_gLq5H8QFc3702JsL&_control.returnTo=modelloSalvato';
			          document.f24MainForm.target= 'frCenter';
			      ...
			      function invia() {
			        if (!getSubmitted()) {
			           document.f24MainForm.action = '/sape/f24/controllaModello.do?id_chiamata=1490787722150_gLq5H8QFc3702JsL&';
			           document.f24MainForm.target = 'frCenter';
			           document.f24MainForm.submit();
			        }
			      }
	      ...
	      function nuovoModello() {
		      if (!getSubmitted()) {
			          document.f24MainForm.action = '/sape/f24/inserisciNuovoModello.do?id_chiamata=1490787722150_gLq5H8QFc3702JsL&_control.tipo=E';
			          document.f24MainForm.target= 'frCenter';
			          document.f24MainForm.submit();
			  }
	      }
