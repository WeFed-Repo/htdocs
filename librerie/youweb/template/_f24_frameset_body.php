...
<div class="section clearfix">
	...
	<form name="uploadFlussoForm" method="post" action="/sape/f24/uploadFile.do" enctype="multipart/form-data" target="frCenter"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="1e75afcf5d7694446aafd94a15252976">
			...
			<div class="form-group">
				...
				<div class="form-group schedaPersonaFisica" id="schedaPersonaFisica">
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.nome" tabindex="1" size="30" maxlength="20" value="FABRIZIO" 
					...
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.cognome" tabindex="2" size="30" maxlength="24" value="DOMANIN" 
				...
				<div class="form-group schedaPersonaFisica" id="schedaPersonaFisica" >
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.comNas" tabindex="6" maxlength="25" value="ANCONA" 
					...
					<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-2">
						...
						<div class="form-field">
									...
									<input type="text" name="contribuente.dataNascitaHtml" tabindex="8" size="13" maxlength="10" value="22/05/1972" class="datepicker dataNascitaHtml" 
				...
				<div class="form-group schedaPersonaGiuridica" id="schedaPersonaGiuridica" >
					...
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.codFis" tabindex="10" size="30" maxlength="16" value="DMNFRZ72E22A271U" class="form-control" 
...
<script type="text/javascript">
			      ...
			      function salva() {
					if (!getSubmitted()) {
			          document.f24MainForm.action = '/sape/f24/salvaModello.do?id_chiamata=1490787954803_RAt8KMILi9OVbSBv&_control.returnTo=modelloSalvato';
			      ...
			      function invia() {
			        if (!getSubmitted()) {
			           document.f24MainForm.action = '/sape/f24/controllaModello.do?id_chiamata=1490787954803_RAt8KMILi9OVbSBv&';
			           document.f24MainForm.target = 'frCenter';
			           document.f24MainForm.submit();
			        }
			      }
	      ...
	      function nuovoModello() {
		      if (!getSubmitted()) {
			          document.f24MainForm.action = '/sape/f24/inserisciNuovoModello.do?id_chiamata=1490787954803_RAt8KMILi9OVbSBv&_control.tipo=E';
			          document.f24MainForm.target= 'frCenter';
			          document.f24MainForm.submit();
			  }
	      }
...
<iframe 
	...
	seamless="true"
	src="/WEBHT/pagamenti/f24/footer.do"></iframe>
