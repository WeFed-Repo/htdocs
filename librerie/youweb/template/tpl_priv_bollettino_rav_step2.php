...
<form id="formRavEsito" method="post" action="/WEBHT/pagamenti/ravEsito.do"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="30b35578bfc7b4d6ab85ad51f9d3b85d"></div>
...
.imgSrv{
	...
	<h1>
				<div class="hidden-print hidden-xxs flag rav">&nbsp;</div>
 					<span>Riepilogo Bollettini Rav</span>
	</h1>
<a href="javascript:OpenHelp('/template/modale.php?pagTit=Help: bollettini rav&amp;pagCont=testo02')" class="general-help help-icon hidden-xs"><img src="/HT/fe/img/i_help.png" class="imgSrv" title="Help On Line" alt="Help On Line"></a>
