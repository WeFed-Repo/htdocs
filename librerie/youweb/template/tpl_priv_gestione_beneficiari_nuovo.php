...
.imgSrv{float: none;}
	...
	<form id="formInserimento" method="post" action="/strutt_priv_new.php?pag=gestione_beneficiari_modifica_step2&lev1=pagamenti&wdg=06|02" class="form-horizontal gestioneBenef">
...
<!-- MODIFICA DATI BENEFICIARIO  -->
		<div class="section clearfix">
			<h3 class="titleSection">Nuovo beneficiario</h3>
				...
				<div class="form-group clearfix">
					<div class="form-field-input col-sm-6 col-xs-12">
						...
						<div class="form-field">
							<input type="text" name="nomeBeneficiario" maxlength="35" size="36" value="" onblur="formattaStr(this, 35)" id="nomeBeneficiario" class="form-control">
						</div>
					</div>
					<div class="form-field-input col-sm-6 col-xs-12">
						<label class="control-label" for="nickname">Nickname </label>
						<div class="form-field">
							<input type="text" name="nickname" maxlength="30" size="36" value="" onblur="formattaStr(this, 20)" id="nickname" class="form-control">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="form-field col-sm-6 col-xs-12">
						...
						<div class="form-field">
							<select name="operatore" class="form-control">
								<option value="1" selected="selected">Vodafone</option>
...
<div class="pull-right margin-bottom20">
	<form id="formIndietro" method="post" action="/strutt_priv.php?pag=gestione_beneficiari&lev1=pagamenti&wdg=06|02|03" class="floatl">
		<input type="submit" name="indietro" value="Indietro" class="btn btn-primary">
	</form>
	<button class="btn btn-primary" name="inserisci" onclick="$('#formInserimento').submit()">
		<span class="visible-xs">Avanti</span>
		<span class="hidden-xs">Nuovo beneficiario</span>
	</button>				
</div>