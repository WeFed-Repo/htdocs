...
<div class="clearfix">
		...
		<div class="contentPagina">
			<img style="margin-bottom: 10pt; float: left; margin-right: 15pt; border: 0px;" title="BlackRock" src="/HT/IMAGES/CONTENUTI/BlackRock.png" alt="BlackRock" width="200" height="125" />
<p><strong>Black Rock</strong> &egrave; una delle principali societ&agrave; di gestione del risparmio a livello mondiale e tra i primi fornitori di servizi di gestione degli investimenti, del rischio e di consulenza rivolti a investitori privati, istituzionali e agli intermediari finanziari.</p>
<p>E&rsquo; presente in 60 paesi al mondo e gestisce un patrimonio totale di 4.600 miliardi di dollari, infatti &egrave; il primo gestore indipendente quotato alla&nbsp;<a title="Borsa di New York" href="https://it.wikipedia.org/wiki/Borsa_di_New_York">borsa di New York</a>&nbsp;in termini di masse gestite.</p>
		</div>
