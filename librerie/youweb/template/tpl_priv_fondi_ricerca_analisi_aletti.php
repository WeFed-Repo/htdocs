...
<div class="clearfix">
		...
		<div class="contentPagina">
			<p><img style="margin-bottom: 10pt; float: left; margin-right: 15pt; border: 0px;" title="Aletti" src="/HT/IMAGES/CONTENUTI/Aletti.png" alt="Aletti" width="200" height="125" /> <strong>Aletti Gestielle Sgr</strong> offre ai risparmiatori una gamma di fondi comuni di investimento ampia, diversificata e costantemente aggiornata comprendente strumenti caratterizzati da diversi stili di gestione:</p>
<ul style="overflow: hidden;">
<li>Total Return Funds (fondi flessibili);</li>
<li>&nbsp;Market Funds (fondi obbligazionari);</li>
<li>&nbsp;Absolute Return Funds (fondi a ritorno assoluto);</li>
<li>&nbsp;Target Date Funds &nbsp;(fondi a finestra di collocamento a volatilit&agrave; decrescente).</li>
</ul>
<p style="float: left;">I fondi Gestielle sono studiati in relazione al diverso profilo rischio/rendimento dei risparmiatori e vengono gestiti da un team di 27 professionisti stabile ed esperto affiancato da strutture preposte all&rsquo;erogazione di servizi, anche dedicati, a supporto dei collocatori ed investitori istituzionali.</p>
		</div>
