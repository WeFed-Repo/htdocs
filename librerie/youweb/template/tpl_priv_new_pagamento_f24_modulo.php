						...
						<div class="form-field">
							...
							/>
								...
								<a href="javascript: void(0);" title="Seleziona il codice Ente" class="pull-right">
										...
										<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(altriEnti).riga[0].codiceEnte.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'enteAltriEnti', 'f24_pop_codice_tributo.php');" style="display : none;" />
...
<script type="text/javascript">
			      ...
			      function salva() {
					if (!getSubmitted()) {
			          document.f24MainForm.action = 'tpl_priv_new_pagamento_f24_modulo_step2_bozza.php';
			      ...
			      function invia() {
			        if (!getSubmitted()) {
			           document.f24MainForm.action = 'tpl_priv_new_pagamento_f24_modulo_step2.php';
			           document.f24MainForm.target = 'frF24Center';
			           document.f24MainForm.submit();
			        }
			      }
	      ...
	      function nuovoModello() {
		      if (!getSubmitted()) {
			          document.f24MainForm.action = 'tpl_priv_new_pagamento_f24_modulo.php';
			          document.f24MainForm.target= 'frF24Center';
			          document.f24MainForm.submit();
			  }
	      }
