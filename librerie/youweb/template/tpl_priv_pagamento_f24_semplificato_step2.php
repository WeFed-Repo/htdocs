			...
			<div class="form-group">				
				...
				<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
					<label class="control-label">
								...
								<a href="javascript:help('/sape/f24/showHelp.do?tipoRicerca=ufficioErario');" class="help">
					...
					<div class="form-field">
						...
						/>
							...
							<a href="javascript: void(0);" class="action nascosto" title="Seleziona il codice Identificativo">
								<img border="0" src='/sape/f24/images/ico-filter.png' name="sezione(f24Semplificato2012).codiceUfficio.image" onclick="ricercaTributo(this, 'ufficioErario', '/sape/f24/showHelp.do');" alt="cerca codice" title="cerca codice"/>
							</a>
