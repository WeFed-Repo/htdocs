...
.imgSrv{
	...
	<h1>
				...
				<div class="hidden-print hidden-xxs flag ricerca">&nbsp;</div>
 					...
 					<span>Elenco Covered Warrant</span>
...
$(document).ready(function() {
	startGrid('#I_RICERCA', { 
url: '/template/investimenti/ricercaCWCertificateJson.php?tipo=1&sottostante=IT0001233417',
...
{name:'quotazione.ritardata',jsonmap:'quotazione.ritardata',label:"Rit.",title:"Ritardata",width:35,align:'Center'},
{name:'quotazione.descrizioneFase',jsonmap:'quotazione.descrizioneFase',label:"Fase",title:"Fase",width:70,align:'Left'},
{name:'quotazione.trend',jsonmap:'quotazione.trend',label:"Tr.",title:"Trend",width:30,align:'Center',formatter:trendFmt,sortable:false},
...
{name:'quotazione.apertura',jsonmap:'quotazione.apertura',label:"Apert.",title:"Prezzo di apertura",width:60,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D4'},unformat:decimalUnFmt,sorttype:'currency'},
...
{name:'quotazione.prezzoChiusuraPrecedente',jsonmap:'quotazione.prezzoChiusuraPrecedente',label:"Ult. Chius.",title:"Ultima Chiusura",width:60,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D4'},unformat:decimalUnFmt,sorttype:'currency'},
{name:'quotazione.massimoGiorno',jsonmap:'quotazione.massimoGiorno',label:"Max ",title:"Massimo del giorno",width:60,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D4'},unformat:decimalUnFmt,sorttype:'currency'},
{name:'quotazione.minimoGiorno',jsonmap:'quotazione.minimoGiorno',label:"Min",title:"Minimo del giorno",width:60,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D4'},unformat:decimalUnFmt,sorttype:'currency'},
...
{name:'quotazione.quantitaBid',jsonmap:'quotazione.quantitaBid',label:"Q.t&agrave; Miglior Acquisto",title:"Quantità miglior offerta in acquisto",width:80,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D0'},unformat:decimalUnFmt,sorttype:'currency'},
...
{name:'quotazione.quantitaAsk',jsonmap:'quotazione.quantitaAsk',label:"Q.t&agrave; Miglior Vendita",title:"Quantità miglior offerta in vendita",width:80,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D0'},unformat:decimalUnFmt,sorttype:'currency'},
...
{name:'quotazione.prezzoUfficiale',jsonmap:'quotazione.prezzoUfficiale',label:"Ult. Pr. Uff.",title:"Ultimo Prezzo Ufficiale",width:60,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D4'},unformat:decimalUnFmt,sorttype:'currency'},
{name:'quotazione.prezzoRiferimento',jsonmap:'quotazione.prezzoRiferimento',label:"Pr. Rif. Prec.",title:"Prezzo di riferimento",width:60,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D4'},unformat:decimalUnFmt,sorttype:'currency'},
{name:'quotazione.prezzoRiferimentoOdierno',jsonmap:'quotazione.prezzoRiferimentoOdierno',label:"Pr. Rif. Odier.",title:"Prezzo Riferimento Odierno",width:60,align:'Right',formatter:decimalFmt,formatoptions:{cellFormat:'D4'},unformat:decimalUnFmt,sorttype:'currency'}
],
opzioniTabella:[
