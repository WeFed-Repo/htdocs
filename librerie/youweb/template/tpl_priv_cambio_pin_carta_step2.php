...
.imgSrv{
	...
	<h1>
		...
		<div id="conferma" class="section clearfix conferma" style="display: none;">
...
<div id="helpDialog" class="modal fade bs-example-modal-lg helpDialog" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg">
	...
	<div class="clearfix pull-right margin-bottom20 messaggio">
		<div class="actions">
	...
	<div class="pull-right margin-bottom20 conferma" style="display: none;">
