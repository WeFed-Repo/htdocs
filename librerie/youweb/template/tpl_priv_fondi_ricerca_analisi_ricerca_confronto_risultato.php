...
window.fndConfronto = function(fondiInput, codAreaFinanza) {
	return goToPage("/investimenti/fondiConfrontoFondi.do", fondiInput, codAreaFinanza);
}
</script>
...
$(function() {
	...
	$(document).ready(function() {
		startGrid('#I_FND_RIC', { 
url: '/template/investimenti/fondiConfrontoRisultatoJson.php?proventi=&sgr=&rating=&categoria=&divisa=&rischio=&conferma=Cerca&volatilita1Y=&descrizione=',
