...
.imgSrv{
	...
	<h1>
		...
		<div class="contentPagina">
			<p><img style="margin-bottom: 10pt; float: left; margin-right: 15pt; border: 0px;" title="attenzione" src="/HT/IMAGES/CONTENUTI/Attenzione.jpg" alt="attenzione" width="100" height="100"> Gentile cliente,<br><br>da una verifica sui nostri Database ci risulta scaduto il tuo documento d'identit&agrave;. Qualora non avessi gi&agrave; provveduto, ti preghiamo di<br> recarti con un documento in corso di validit&agrave; presso la tua filiale, al fine di aggiornare la tua posizione anagrafica consentendoti cos&igrave; la prosecuzione della tua normale operativit&agrave;.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
