<div class="riquadro clearfix">
	...
	<div class="bs-example form-horizontal">
		<div class="form-group">
			...
			<div class="form-field-resume">
				<input type="hidden" name="questionario.sezione[1].domanda[1].risposta[2].selezionata" value="true" class="260 2">
			...
			<div class="form-field-resume">
				...
				<img src="/HT/fe/img/pager_item_current.png" style="margin-right:10px" class="260 4 rispostaSel invisible floatl" onclick="cambiaSelezione(this, false, 260, 4);submitForm(this, false, false, 1);">
				<img src="/HT/fe/img/pager_item.png" style="margin-right:10px" class="260 4 rispostaNonSel visible floatl" onclick="cambiaSelezione(this, false, 260, 4);submitForm(this, false, false, 1);">
				<span class="leftl">Lorem ipsum dolor sit amet, consectetur adipisicing</span>
			</div>
			<div class="form-field-resume">
				<input type="hidden" name="questionario.sezione[1].domanda[1].risposta[4].selezionata" value="false" class="260 5">
				<img src="/HT/fe/img/pager_item_current.png" style="margin-right:10px" class="260 5 rispostaSel invisible floatl" onclick="cambiaSelezione(this, false, 260, 5);submitForm(this, false, false, 1);">
				<img src="/HT/fe/img/pager_item.png" style="margin-right:10px" class="260 5 rispostaNonSel visible floatl" onclick="cambiaSelezione(this, false, 260, 5);submitForm(this, false, false, 1);">
				<span class="leftl">Lorem ipsum dolor sit amet, consectetur adipisicing</span>
			</div>
		</div>
