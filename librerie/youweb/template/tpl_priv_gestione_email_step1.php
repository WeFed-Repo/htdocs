...
.imgSrv{
	...
	<div class="innerBoxWhite  clearfix inner">
		...
		<!-- TABELLA CONTATTI MAIL -->
		<form id="formGestioneEMail" method="post" action="/WEBHT/serviziPerTe/contattiERecapiti/EMail/inserimento.do">
			<input type="hidden" name="tipologia" value="" id="tipologiaField">
			<input type="hidden" name="contatto" value="" id="contattoField">
			<input type="hidden" name="flagPredefinito" value="" id="predefinitoField">
			<div style="display:none">
				<input type="submit" name="elimina" value="elimina" onclick="changeSubmitUrl(this, '/serviziPerTe/contattiERecapiti/EMail/eliminazione');" id="eliminaSubmit">
		...
		<div class="table-responsive">
			<table id="tabellaEMail" class="table table-striped dataTable no-footer">
				<colgroup>
					<col width="10%">
					<col width="10%">
					<col width="30%">
				...
				<thead>
					<tr class="hover">
						...
						<th style="width: 0px;" class="oCenter">Indirizzo</th>
					...
					<tbody><tr id="row0">
						<td class="min-width-85px">	
							<!-- AGGIUNGERE LA CLASSE hidden-xs nel styleClass="imgSrv hidden-xs"  nel elemento sotto-->
							
							<img src="/HT/IMAGES/i_modifica.gif" class="imgSrv hover-hand" title="Modifica contatto eMail" alt="Modifica contatto eMail" onclick="modifica(0); "> 
							
						</td>
						<td>
							<img src="/HT/IMAGES/ico_email.png">
						</td>
						<td class="oCenter">
						...
						<td class="oCenter">
							<input type="hidden" name="contatto" value="OSANDROSILVIA@ALICE.IT" id="contatto0">
							<div style="overflow:hidden; text-overflow:ellipsis">
								OSANDROSILVIA@ALICE.IT
							</div>
						</td>
						<td class="oCenter">
