...
function getPathContext() {	return "";}
...
function generateReport() {
	...
	{
		openAjaxDialog('/template/modale_fondi.php', 'dialogName', 'dialogSelezione', 'title', 'Crea nuova lista', 'width' ,600);
	}
	function eliminaSelezione()
	{
		if(confirm('Sicuro di voler eliminare la lista '+ $('#idPortafoglio option:selected').text() + '?')) 
		{
			openAjaxDialog('/template/modale_fondi.php', 'idPortafoglio', $('#idPortafoglio').val(), 'dialogName', 'dialogSelezione', 'title', 'Elimina lista', 'width' ,600);
		}
	}
	function rinominaSelezione()
	{
		openAjaxDialog('/template/modale_fondi.php', 'idPortafoglio', $('#idPortafoglio').val(), 'dialogName', 'dialogSelezione', 'title', 'Rinomina una lista', 'width' ,600);
	}
