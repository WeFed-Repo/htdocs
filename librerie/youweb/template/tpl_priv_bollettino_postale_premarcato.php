...
<form id="formBollettinoPostale" method="post" action="/WEBHT/pagamenti/bollettiniPostaliConferma.do" class="form-horizontal" onsubmit="checkOpzionale()">
<div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="5ff708c767934ecbd598c486a4a33779"></div>
...
.imgSrv{
	...
	<h1>
		...
		<a href="javascript:OpenHelp('/template/modale.php?pagTit=Help: bollettino postale&pagCont=testo02')" class="general-help help-icon hidden-xs">
		...
		<div class="clearfix">
			<div class="form-field-input col-xs-12 col-sm-4">
				...
				<div class="form-field">
					<input type="text" name="codiceBollettino" maxlength="18" size="25" value="" id="codiceBollettino" class="form-control">
				</div>
			</div>
			...
			<div class="form-field-input col-xs-12 col-sm-5">
				<label for="importoPrestampato" class="control-label"> 
					L'importo &egrave; prestampato sul bollettino? 
					<a href="javascript:OpenHelp('/template/modale.php?pagTit=Help: bollettino postale&pagCont=testo02')" class="general-help help-icon hidden-xs">
				...
				<div class="form-field">
								...
								<div class="col-xs-4">
									<label class="radio-inline" for="importoNonPrestampato">
										<input type="radio" name="codiceNumerico" value="674" id="importoNonPrestampato"> 
										No 
									</label>
								</div>
							</div>
