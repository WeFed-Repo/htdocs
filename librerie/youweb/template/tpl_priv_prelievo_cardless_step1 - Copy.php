			...
			<div class="accordion ui-accordion ui-widget ui-helper-reset" role="tablist">
				...
				<div class="bs-example form-horizontal ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active" id="ui-id-3" aria-labelledby="ui-id-2" role="tabpanel" aria-hidden="false" style="display: block;">
					<div class="form-group">
						...
						<div class="form-field-input col-sm-5 col-xs-12 clear-padding">
						  	<label class="control-label" for="indirizzoEmail">
						  		Indirizzo e-mail di SGO AENZZREHODSLA
						  	</label>
						</div>
					 	<div class="form-field-input col-sm-7 col-xs-12 clear-padding">
							<div class="form-field">
					  			<div class="col-xs-11 margin-top5 floatl">
						  			<strong><input type="text" name="indirizzoEmail" value="OSANDROSILVIA@ALICE.IT" readonly="readonly" id="email" style="border:0px;background-color:transparent;" class=""></strong>
					  			</div>
					  			<div class="col-xs-1">
...
<!-- 							  	</span> -->
<!-- 							</div> -->
<!-- 							<div class="col-sm-6 col-xs-12 clear-padding margin-top5"> -->
...
<!-- 							</div> -->
<!-- 							<div class="col-sm-9 col-xs-12 clear-padding margin-top20"> -->

<!-- 							</div> -->
<!-- 							<div class="col-sm-3 col-xs-12 clear-padding"> -->
...
<!-- 								</label> -->
<!-- 							</div> -->
<!-- 							<div class="col-sm-9 col-xs-12 clear-padding margin-top10"> -->
