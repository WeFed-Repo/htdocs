...
<div id="helpDialog" class="modal fade bs-example-modal-lg helpDialog" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg">
	...
	<!-- Inseriti nella spalla sinistra 
...
<div class="DettInf">
	<table class="table allarmi">
		...
		<tr>
			<th>&nbsp;</th>
			<th>Allarmi in essere</th>
			<th><img src="/HT/fe/img//ico_sms.png" title="SMS" alt="SMS" /></th>
			<th><img src="/HT/fe/img//ico_email.png" title="Email" alt="Email" /></th>
			<th><img src="/HT/fe/img//ico_notifiche.png" title="App" alt="App" /></th>
		</tr>
		</thead>
				...
				<tbody>
					<tr>
						...
						<td style="text-align:center">
								...
								<img src="/HT/fe/img/NNFFSpunta.png
" title="Spunta" alt="Spunta">
...
" title="Spunta" alt="Spunta">
					...
					<tr>
							...
							<td rowspan="3">
									...
									<input type="image" name="modifica" src="/HT/fe/img/icon_edit.png" onclick="javascript:setFormParameters('formContoAllarmi','chiaveRiepilogoConto','001|2001|200100001657')" class="imgSrv" title="Modifica allarme" alt="modifica operazione"> 
						...
						<td style="border-bottom: 0px; font-weight: bold;" colspan="5">
							<p>
								...
								Intestato a:&nbsp;TALLO MAURO,TALLO ANDREA
							</p>
						</td>							
					</tr>							
					...
					<tr>
							...
							<td rowspan="4">
									...
									<input type="image" name="modifica" src="/HT/fe/img/icon_edit.png" onclick="javascript:setFormParameters('formContoAllarmi','chiaveRiepilogoConto','001|2001|200100002804')" class="imgSrv" title="Modifica allarme" alt="modifica operazione"> 
										
										<input type="image" name="cancella" src="/HT/fe/img/icon_delete.png" onclick="javascript:setFormParameters('formContoAllarmi','chiaveRiepilogoConto','001|2001|200100002804')" class="imgSrv" title="Cancella allarmi" alt="cancella operazione">
						...
						<tr>
							...
							<td>
								<p>
									...
									Saldo a sforamento soglia inferiore a 0,00 e superiore a 999.999,00
								</p>
							</td>							
							<td style="text-align:center">
...
" title="Spunta" alt="Spunta">
					...
					<tr>
							...
							<td rowspan="3">
									...
									<input type="image" name="modifica" src="/HT/fe/img/icon_edit.png" onclick="javascript:setFormParameters('formContoAllarmi','chiaveRiepilogoConto','001|2001|200100002961')" class="imgSrv" title="Modifica allarme" alt="modifica operazione"> 
						...
						<td style="border-bottom: 0px; font-weight: bold;" colspan="5">
							<p>
								...
								Intestato a:&nbsp;TALLO MAURO LUCA TALLO GIUSEPPINA
							</p>
						</td>							
					</tr>							
					...
					<tr>
							...
							<td rowspan="3">
									...
									<input type="image" name="modifica" src="/HT/fe/img/icon_edit.png" onclick="javascript:setFormParameters('formContoAllarmi','chiaveRiepilogoConto','001|1896|189600030015')" class="imgSrv" title="Modifica allarme" alt="modifica operazione"> 
					...
					<tr>
							...
							<td rowspan="3">
									...
									<input type="image" name="modifica" src="/HT/fe/img/icon_edit.png" onclick="javascript:setFormParameters('formContoAllarmi','chiaveRiepilogoConto','001|0898|089800115927')" class="imgSrv" title="Modifica allarme" alt="modifica operazione"> 
					...
					<tr>
							...
							<td rowspan="3">
									...
									<input type="image" name="modifica" src="/HT/fe/img/icon_edit.png" onclick="javascript:setFormParameters('formContoAllarmi','chiaveRiepilogoConto','001|1896|189600000933')" class="imgSrv" title="Modifica allarme" alt="modifica operazione"> 
...
" title="Spunta" alt="Spunta">
					...
					<tr>
							...
							<td rowspan="1">
								<input type="image" name="elemento" src="/HT/fe/img/icon_edit.png" onclick="javascript:setFormParameters('formAllarmiTitoli','chiaveRiepilogoTitoli','46|BE0974293251|false')" class="imgSrv" alt="modifica operazione"> 
								<input type="image" name="cancella" src="/HT/fe/img/icon_delete.png" onclick="javascript:setFormParameters('formAllarmiTitoli','chiaveRiepilogoTitoli','46|BE0974293251|false')" class="imgSrv" alt="cancella operazione"> 														
							</td>
							<td rowspan="1">
								BI - Azioni Italia
								 -- AB INBEV
