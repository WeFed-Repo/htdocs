...
<body style="zoom:	1;">
<div class="wrapper">
	<form name="f24MainForm" method="post" action="/sape/f24/spedisciModello.do"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="5d55f064b58b8fc18727363af91c3d13">
		...
		<div class="main row">
	  	...
	  	<div style="display: block;" class="messagePanel success">
				...
				<p>
					<strong>
						Operazione correttamente inserita. Delega revocata con data esecuzione 04/04/2017
