...
<div id="helpDialog" class="modal fade bs-example-modal-lg helpDialog" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg">
	...
	<form id="formStatoAssegni" method="post" action="/WEBHT/cc/statoAssegni.do" class="clearfix"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="009a69e58dea5925cea9beca8d22b201"></div>
...
<div class="selezioneCC tabellaSelezioneCC">
	...
	<div class="col-sm-6 col-xs-12">
	    ...
	    <span class="col-xs-6 col-sm-8" id="agenzia">VERONA AG. 3&nbsp;-&nbsp; 0004</span>
	</div>
