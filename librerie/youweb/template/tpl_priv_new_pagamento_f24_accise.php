...
<body onLoad="setSaldoParziale(this); visualizzaSegnalazione();" onclick="deselezionaTutti();" style="zoom: 1;">
	...
	<input type="hidden" name="DelegaUniqueToken" value='MTQ5MTMwNjQ5NTkzMA==' />
...
<div class="section clearfix">
	...
	<form name="uploadFlussoForm" method="post" action="/sape/f24/uploadFile.do" enctype="multipart/form-data" target="frCenter"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="be737b7a53c5009959e912c0a17ade1e">
	  	...
	  	<input type="hidden" name="uploaded" value="false" />
			...
			<input type="hidden" name="id_chiamata" value="1491306491805_93sUeQ2ZrWjYddIg" />
							...
							<form name="f24MainForm" method="post" action="/sape/f24/inserisciNuovoModello.do" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="be737b7a53c5009959e912c0a17ade1e">
	...
	function selezionaPersonaGiuridica(fromRubrica) {
		...
		function compila(indice) {
			...
			if (indice == 1) {
				...
				document.getElementsByName("contribuente.comDom")[0].value = decodeHtml('MONZA');
			...
			<div class="form-group">
				...
				<div class="form-group schedaPersonaFisica" id="schedaPersonaFisica" >
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.comNas" tabindex="6" maxlength="25" value="CASALPUSTERLENGO" 
					...
					<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-2">
						...
						<div class="form-field">
									...
									<input type="text" name="contribuente.dataNascitaHtml" tabindex="8" size="13" maxlength="10" value="00/00/0000" class="datepicker dataNascitaHtml" 
				...
				<div class="form-group">
					...
					<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
						...
						<div class="form-field">
							<input type="text" name="contribuente.comDom" tabindex="13" size="30" maxlength="25" value="MONZA" class="form-control" 
						...
						<div class="form-field">
							...
							/>
								...
								<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
										...
										<img  border="0"  src='/sape/f24/images/lampadina.jpg' name="sezione(erario).riga[0].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoErario', '/sape/f24/showHelp.do');" style="display : none;" />
					...
					<div class="form-field-input col-md-1 col-md-offset-2 col-lg-1 col-lg-offset-3 col-sm-1 col-sm-offset-2 col-xs-1 col-xs-offset-2">
							...
							/>
								...
								<a href="javascript: void(0);" title="Seleziona il codice tributo"  class="pull-right">
										...
										<img  border="0"  src='/sape/f24/images/lampadina.jpg' name="sezione(erario).riga[1].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoErario', '/sape/f24/showHelp.do');" style="display : none;" />
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1 ">
						...
						/>
							...
							<a href="javascript: void(0);" title="Seleziona il codice tributo"  class="pull-right">
									...
									<img  border="0"  src='/sape/f24/images/lampadina.jpg' name="sezione(erario).riga[2].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoErario', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-group">
						...
						<div class="form-field">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								...
								/><a href="javascript: void(0);" title="Seleziona il codice Ufficio"  class="pull-right">
										...
										<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(erario).codiceUfficio.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'ufficioErario', '/sape/f24/showHelp.do');" style="display : none;" />
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
						...
						/><a href="javascript: void(0);" title="Seleziona il codice tributo"  class="pull-right">
								...
								<img  border="0"  src='/sape/f24/images/lampadina.jpg' name="sezione(erario).riga[3].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoErario', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-group">
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1 ">
						...
						<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
								...
								<img  border="0"  src='/sape/f24/images/lampadina.jpg' name="sezione(erario).riga[4].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoErario', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-group">
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
						...
						<a href="javascript: void(0);" title="Seleziona il codice tributo"  class="pull-right">
								...
								<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(erario).riga[5].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoErario', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
					...
					<div class="form-field">
						...
						/><a href="javascript: void(0);" title="Seleziona il codice Sede" class="pull-right">							
								...
								<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(inps).riga[0].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeInps', '/sape/f24/showHelp.do');" style="display : none;" />
					...
					<div class="form-field">
						...
						/>
							...
							<a href="javascript: void(0);" title="Seleziona il codice Causale Contributo" class="pull-right">
									...
									<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(inps).riga[0].causaleContributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'contributoInps', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-group">
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
						...
						<a href="javascript: void(0);" title="Seleziona il codice Sede"  class="pull-right">
								...
								<img border="0" src='/sape/f24/images/lampadina.jpg'name="sezione(inps).riga[1].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeInps', '/sape/f24/showHelp.do');" style="display : none;" />
					...
					<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
						...
						<a href="javascript: void(0);" title="Seleziona il codice Causale Contributo" class="pull-right">
								...
								<img border="0" src='/sape/f24/images/lampadina.jpg'name="sezione(inps).riga[1].causaleContributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'contributoInps', '/sape/f24/showHelp.do');" style="display : none;" />
					...
					<div class="form-group">
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
							...
							<a href="javascript: void(0);" title="Seleziona il codice Sede"  class="pull-right">
									...
									<img border="0" src='/sape/f24/images/lampadina.jpg'name="sezione(inps).riga[2].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeInps', '/sape/f24/showHelp.do');" style="display : none;" />
						...
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
							...
							<a href="javascript: void(0);" title="Seleziona il codice Causale Contributo"  class="pull-right">
									...
									<img border="0" src='/sape/f24/images/lampadina.jpg'name="sezione(inps).riga[2].causaleContributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'contributoInps', '/sape/f24/showHelp.do');" style="display : none;" />
					...
					<div class="form-group">
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
							...
							<a href="javascript: void(0);" title="Seleziona il codice Sede" class="pull-right">
									...
									<img border="0" src='/sape/f24/images/lampadina.jpg'name="sezione(inps).riga[3].codiceSede.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'sedeInps', '/sape/f24/showHelp.do');" style="display : none;" />
						...
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
							...
							<a href="javascript: void(0);" title="Seleziona il codice Causale Contributo" class="pull-right">
									...
									<img border="0" src='/sape/f24/images/lampadina.jpg'name="sezione(inps).riga[3].causaleContributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'contributoInps', '/sape/f24/showHelp.do');" style="display : none;" />
					...
					<div class="form-field">
						...
						/>
							...
							<a href="javascript: void(0);" title="Seleziona il codice Regione" class="pull-right">
									...
									<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(regioni).riga[0].codiceRegione.image" onfocus="selezionato(this)" onclick="ricercaRegione(this, '/sape/f24/moduloF24/common/sezioni/tabellaCodiciRegione.jsp');" style="display : none;" />
					...
					<div class="form-field">
						...
						/>
							...
							<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
									...
									<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(regioni).riga[0].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoRegioni', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-2">
					...
					/>
						...
						<a href="javascript: void(0);" title="Seleziona il codice Regione" class="pull-right">
								...
								<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(regioni).riga[1].codiceRegione.image" onfocus="selezionato(this)" onclick="ricercaRegione(this, '/sape/f24/moduloF24/common/sezioni/tabellaCodiciRegione.jsp');" style="display : none;" />
				...
				<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-2">
					...
					/>
						...
						<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
								...
								<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(regioni).riga[1].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoRegioni', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-2">
					...
					/>
						...
						<a href="javascript: void(0);" title="Seleziona il codice Regione" class="pull-right">
								...
								<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(regioni).riga[2].codiceRegione.image" onfocus="selezionato(this)" onclick="ricercaRegione(this, '/sape/f24/moduloF24/common/sezioni/tabellaCodiciRegione.jsp');" style="display : none;" />
				...
				<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-2">
					...
					/>
						...
						<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
							...
							<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(regioni).riga[2].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoRegioni', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-2">
					...
					/>
						...
						<a href="javascript: void(0);" title="Seleziona il codice Regione" class="pull-right">
								...
								<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(regioni).riga[3].codiceRegione.image" onfocus="selezionato(this)" onclick="ricercaRegione(this, '/sape/f24/moduloF24/common/sezioni/tabellaCodiciRegione.jsp');" style="display : none;" />
				...
				<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-2">
					...
					/>
						...
						<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
							...
							<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(regioni).riga[3].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoRegioni', '/sape/f24/showHelp.do');" style="display : none;" />
						...
						<div class="form-field-input form-field">
							...
							/>
									...
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
											...
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(entiLocali).riga[0].codiceTributo.image" onfocus="selezionato(this);" onclick="ricercaTributo(this, 'codiceTributoImu', '/sape/f24/showHelp.do');" style="display : none;" />
						...
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
							...
							/>
									...
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
											...
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(entiLocali).riga[1].codiceTributo.image" onfocus="selezionato(this);" onclick="ricercaTributo(this, 'codiceTributoImu', '/sape/f24/showHelp.do');" style="display : none;" />
						...
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
							...
							/>
									...
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
											...
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(entiLocali).riga[2].codiceTributo.image" onfocus="selezionato(this);" onclick="ricercaTributo(this, 'codiceTributoImu', '/sape/f24/showHelp.do');" style="display : none;" />
						...
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
							...
							/>
									...
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
											...
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(entiLocali).riga[3].codiceTributo.image" onfocus="selezionato(this);" onclick="ricercaTributo(this, 'codiceTributoIci', '/sape/f24/showHelp.do');" style="display : none;" />
		...
		<div class="section clearfix">
			...
			<div class="bs-example">
					...
					<div class="form-group">
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<div class="form-field-input col-md-6 col-lg-6 col-sm-6 col-xs-6">
								...
								<div class="form-field">
									<input type="text" name="sezione(accise2012).riga[0].ente" tabindex="184" size="2" maxlength="2" class="form-control" 
							...
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								...
								<div class="form-field">
									<input type="text" name="sezione(accise2012).riga[0].codiceProvincia" tabindex="185" size="2" maxlength="2" class="form-control" 
						...
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
							...
							<div class="form-field">
								<input type="text" name="sezione(accise2012).riga[0].codiceTributo" tabindex="186" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
								
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
										 
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(accise2012).riga[0].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoAccise', '/sape/f24/showHelp.do');" style="display : none;" />
						...
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
							...
							<div class="form-field">
								<input type="text" name="sezione(accise2012).riga[0].codiceIdentificativo" tabindex="187" size="14" maxlength="14" class="form-control" onfocus="selezionato(this)" 
						...
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
							...
							<div class="form-field">
								<input type="text" name="sezione(accise2012).riga[0].rateazione" tabindex="188" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
						...
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								...
								<div class="form-field">
									<input type="text" name="sezione(accise2012).riga[0].mese" tabindex="189" size="2" maxlength="2" class="form-control numerico" 
							...
							<div class="form-field-input col-md-7 col-lg-7 col-sm-7 col-xs-7">
								...
								<div class="form-field">
									<input type="text" name="sezione(accise2012).riga[0].annoDiRiferimento" tabindex="190" size="4" maxlength="4" class="form-control numerico" 
						...
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
							...
							<div class="form-field">
								<input type="text" name="sezione(accise2012).riga[0].interiImportoDebito" tabindex="191" size="9" maxlength="13" class="form-control numerico" id="importoInt" onblur="tot(this, 'accise2012')" 
									class="inputImporti"
								/>&nbsp;,
								<input type="text" name="sezione(accise2012).riga[0].centImportoDebito" tabindex="192" size="2" maxlength="2" class="form-control numerico" id="importoDec" onblur="tot(this,'accise2012')" 
					...
					<div class="form-group">
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<div class="form-field-input col-md-6 col-lg-6 col-sm-6 col-xs-6">
								<input type="text" name="sezione(accise2012).riga[1].ente" tabindex="193" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								<input type="text" name="sezione(accise2012).riga[1].codiceProvincia" tabindex="194" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[1].codiceTributo" tabindex="195" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
								
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
										 
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(accise2012).riga[1].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoAccise', '/sape/f24/showHelp.do');" style="display : none;" />
											
									</a>
								
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
								<input type="text" name="sezione(accise2012).riga[1].codiceIdentificativo" tabindex="196" size="14" maxlength="14" class="form-control" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[1].rateazione" tabindex="197" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
									<input type="text" name="sezione(accise2012).riga[1].mese" tabindex="198" size="2" maxlength="2" class="form-control numerico" 
										
									/>
							</div>
							<div class="form-field-input col-md-7 col-lg-7 col-sm-7 col-xs-7">
									<input type="text" name="sezione(accise2012).riga[1].annoDiRiferimento" tabindex="199" size="4" maxlength="4" class="form-control numerico" 
										
									/>
							</div>
						</div>
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
								<input type="text" name="sezione(accise2012).riga[1].interiImportoDebito" tabindex="200" size="9" maxlength="13" class="form-control numerico" id="importoInt" onblur="tot(this, 'accise2012')" 
									class="inputImporti"
								/>&nbsp;,
								<input type="text" name="sezione(accise2012).riga[1].centImportoDebito" tabindex="201" size="2" maxlength="2" class="form-control numerico" id="importoDec" onblur="tot(this,'accise2012')" 
						...
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<div class="form-field-input col-md-6 col-lg-6 col-sm-6 col-xs-6">
								<input type="text" name="sezione(accise2012).riga[2].ente" tabindex="202" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								<input type="text" name="sezione(accise2012).riga[2].codiceProvincia" tabindex="203" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[2].codiceTributo" tabindex="204" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
								
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
										 
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(accise2012).riga[2].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoAccise', '/sape/f24/showHelp.do');" style="display : none;" />
											
									</a>
								
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
								<input type="text" name="sezione(accise2012).riga[2].codiceIdentificativo" tabindex="205" size="14" maxlength="14" class="form-control" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[2].rateazione" tabindex="206" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
									<input type="text" name="sezione(accise2012).riga[2].mese" tabindex="207" size="2" maxlength="2" class="form-control numerico" 
										
									/>
							</div>
							<div class="form-field-input col-md-7 col-lg-7 col-sm-7 col-xs-7">
									<input type="text" name="sezione(accise2012).riga[2].annoDiRiferimento" tabindex="208" size="4" maxlength="4" class="form-control numerico" 
										
									/>
							</div>
						</div>
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
								<input type="text" name="sezione(accise2012).riga[2].interiImportoDebito" tabindex="209" size="9" maxlength="13" class="form-control numerico" id="importoInt" onblur="tot(this, 'accise2012')" 
									class="inputImporti"
								/>&nbsp;,
								<input type="text" name="sezione(accise2012).riga[2].centImportoDebito" tabindex="210" size="2" maxlength="2" class="form-control numerico" id="importoDec" onblur="tot(this,'accise2012')" 
					...
					<div class="form-group">
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<div class="form-field-input col-md-6 col-lg-6 col-sm-6 col-xs-6">
								<input type="text" name="sezione(accise2012).riga[3].ente" tabindex="211" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								<input type="text" name="sezione(accise2012).riga[3].codiceProvincia" tabindex="212" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[3].codiceTributo" tabindex="213" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
								
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
										 
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(accise2012).riga[3].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoAccise', '/sape/f24/showHelp.do');" style="display : none;" />
											
									</a>
								
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
								<input type="text" name="sezione(accise2012).riga[3].codiceIdentificativo" tabindex="214" size="14" maxlength="14" class="form-control" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[3].rateazione" tabindex="215" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
									<input type="text" name="sezione(accise2012).riga[3].mese" tabindex="216" size="2" maxlength="2" class="form-control numerico" 
										
									/>
							</div>
							<div class="form-field-input col-md-7 col-lg-7 col-sm-7 col-xs-7">
									<input type="text" name="sezione(accise2012).riga[3].annoDiRiferimento" tabindex="217" size="4" maxlength="4" class="form-control numerico" 
										
									/>
							</div>
						</div>
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
								<input type="text" name="sezione(accise2012).riga[3].interiImportoDebito" tabindex="218" size="9" maxlength="13" class="form-control numerico" id="importoInt" onblur="tot(this, 'accise2012')" 
									class="inputImporti"
								/>&nbsp;,
								<input type="text" name="sezione(accise2012).riga[3].centImportoDebito" tabindex="219" size="2" maxlength="2" class="form-control numerico" id="importoDec" onblur="tot(this,'accise2012')" 
					...
					<div class="form-group">
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<div class="form-field-input col-md-6 col-lg-6 col-sm-6 col-xs-6">
								<input type="text" name="sezione(accise2012).riga[4].ente" tabindex="220" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								<input type="text" name="sezione(accise2012).riga[4].codiceProvincia" tabindex="221" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[4].codiceTributo" tabindex="222" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
								
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
										 
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(accise2012).riga[4].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoAccise', '/sape/f24/showHelp.do');" style="display : none;" />
											
									</a>
								
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
								<input type="text" name="sezione(accise2012).riga[4].codiceIdentificativo" tabindex="223" size="14" maxlength="14" class="form-control" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[4].rateazione" tabindex="224" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
									<input type="text" name="sezione(accise2012).riga[4].mese" tabindex="225" size="2" maxlength="2" class="form-control numerico" 
										
									/>
							</div>
							<div class="form-field-input col-md-7 col-lg-7 col-sm-7 col-xs-7">
									<input type="text" name="sezione(accise2012).riga[4].annoDiRiferimento" tabindex="226" size="4" maxlength="4" class="form-control numerico" 
										
									/>
							</div>
						</div>
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
								<input type="text" name="sezione(accise2012).riga[4].interiImportoDebito" tabindex="227" size="9" maxlength="13" class="form-control numerico" id="importoInt" onblur="tot(this, 'accise2012')" 
									class="inputImporti"
								/>&nbsp;,
								<input type="text" name="sezione(accise2012).riga[4].centImportoDebito" tabindex="228" size="2" maxlength="2" class="form-control numerico" id="importoDec" onblur="tot(this,'accise2012')" 
					...
					<div class="form-group">
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<div class="form-field-input col-md-6 col-lg-6 col-sm-6 col-xs-6">
								<input type="text" name="sezione(accise2012).riga[5].ente" tabindex="229" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								<input type="text" name="sezione(accise2012).riga[5].codiceProvincia" tabindex="230" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[5].codiceTributo" tabindex="231" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
								
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
										 
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(accise2012).riga[5].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoAccise', '/sape/f24/showHelp.do');" style="display : none;" />
											
									</a>
								
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
								<input type="text" name="sezione(accise2012).riga[5].codiceIdentificativo" tabindex="232" size="14" maxlength="14" class="form-control" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[5].rateazione" tabindex="233" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
									<input type="text" name="sezione(accise2012).riga[5].mese" tabindex="234" size="2" maxlength="2" class="form-control numerico" 
										
									/>
							</div>
							<div class="form-field-input col-md-7 col-lg-7 col-sm-7 col-xs-7">
									<input type="text" name="sezione(accise2012).riga[5].annoDiRiferimento" tabindex="235" size="4" maxlength="4" class="form-control numerico" 
										
									/>
							</div>
						</div>
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
								<input type="text" name="sezione(accise2012).riga[5].interiImportoDebito" tabindex="236" size="9" maxlength="13" class="form-control numerico" id="importoInt" onblur="tot(this, 'accise2012')" 
									class="inputImporti"
								/>&nbsp;,
								<input type="text" name="sezione(accise2012).riga[5].centImportoDebito" tabindex="237" size="2" maxlength="2" class="form-control numerico" id="importoDec" onblur="tot(this,'accise2012')" 
					...
					<div class="form-group">
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2">
							<div class="form-field-input col-md-6 col-lg-6 col-sm-6 col-xs-6">
								<input type="text" name="sezione(accise2012).riga[6].ente" tabindex="238" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
								<input type="text" name="sezione(accise2012).riga[6].codiceProvincia" tabindex="239" size="2" maxlength="2" class="form-control" 
									
								/>
							</div>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[6].codiceTributo" tabindex="240" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
								
									<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
										 
											<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(accise2012).riga[6].codiceTributo.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'tributoAccise', '/sape/f24/showHelp.do');" style="display : none;" />
											
									</a>
								
						</div>
						<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
								<input type="text" name="sezione(accise2012).riga[6].codiceIdentificativo" tabindex="241" size="14" maxlength="14" class="form-control" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
								<input type="text" name="sezione(accise2012).riga[6].rateazione" tabindex="242" size="5" maxlength="4" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
									
								/>
						</div>
						<div class="col-md-2 col-lg-2 col-sm-2 col-xs-3">
							<div class="form-field-input col-md-5 col-lg-5 col-sm-5 col-xs-5">
									<input type="text" name="sezione(accise2012).riga[6].mese" tabindex="243" size="2" maxlength="2" class="form-control numerico" 
										
									/>
							</div>
							<div class="form-field-input col-md-7 col-lg-7 col-sm-7 col-xs-7">
									<input type="text" name="sezione(accise2012).riga[6].annoDiRiferimento" tabindex="244" size="4" maxlength="4" class="form-control numerico" 
										
									/>
							</div>
						</div>
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
								<input type="text" name="sezione(accise2012).riga[6].interiImportoDebito" tabindex="245" size="9" maxlength="13" class="form-control numerico" id="importoInt" onblur="tot(this, 'accise2012')" 
									class="inputImporti"
								/>&nbsp;,
								<input type="text" name="sezione(accise2012).riga[6].centImportoDebito" tabindex="246" size="2" maxlength="2" class="form-control numerico" id="importoDec" onblur="tot(this,'accise2012')" 
				...
				<div class="form-group">
					...
					<div class="col-md-3 col-lg-2 col-sm-3 col-xs-3">
						<input type="text" name="sezione(accise2012).interiTotaleDebito" size="9" maxlength="13" class="form-control numerico" id="importoInt" readonly="readonly" onfocus="this.blur();" 
							
						/>&nbsp;,
						<input type="text" name="sezione(accise2012).centTotaleDebito" size="2" maxlength="2" class="form-control numerico" id="importoDec" readonly="readonly" onfocus="this.blur();" 
			...
			<div class="form-group">
				<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
					...
					<input type="text" name="sezione(accise2012).codiceUfficio" tabindex="247" size="5" maxlength="3" class="form-control inRiga" onfocus="selezionato(this)" 
					  
					/>
					
						<a href="javascript: void(0);" title="Seleziona il codice tributo" class="pull-right">
							 
								<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(accise2012).codiceUfficio.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'ufficioAccise', '/sape/f24/showHelp.do');" style="display : none;" />
				...
				<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
					Atto				
					<input type="text" name="sezione(accise2012).codiceAtto" tabindex="248" size="11" maxlength="11" class="form-control inRiga numerico" onfocus="selezionato(this)" 
				...
				<div class="col-md-3 col-lg-2 col-sm-3 col-xs-3">
					<input type="text" name="sezione(accise2012).interiSaldo" size="9" maxlength="13" class="form-control numerico" id="importoInt" readonly="readonly" onfocus="this.blur();" 
					
					/>&nbsp;,
					<input type="text" name="sezione(accise2012).centSaldo" size="2" maxlength="2" class="form-control numerico" id="importoDec" readonly="readonly" onfocus="this.blur();" 
			...
			<div class="form-group">			
				...
				<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
					...
					<div class="form-field">						
									...
									<input type="text" name="dataIncassoHtml" tabindex="249" size="15" maxlength="10" class="datepicker dataIncassoHtml form-control data" 
...
<script type="text/javascript">
			      ...
			      function salva() {
					if (!getSubmitted()) {
			          document.f24MainForm.action = '/sape/f24/salvaModello.do?id_chiamata=1491306491805_93sUeQ2ZrWjYddIg&_control.returnTo=modelloSalvato';
			      ...
			      function invia() {
			        if (!getSubmitted()) {
			           document.f24MainForm.action = 'tpl_priv_new_pagamento_f24_accise_step2.php';
			           document.f24MainForm.target = 'frF24Center';
			           document.f24MainForm.submit();
			        }
			      }
