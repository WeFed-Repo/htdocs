...
<script type="text/javascript">
	...
	{	
		...
		{	
			...
			$('#attEconomica').combobox({
				idHiddenInput: 'descAttEconomica'
			});
			checkProfessione(i);
		});
	});
	...
	function checkProfessione() {
		...
		if (value == '05' || value == '06') 
		{
			...
			{
				$('#attEconomica').val('');
				$('#attEconomica').combobox('disable');
			}
			else
			{
				$('#attEconomica').combobox('enable');
			}
		}
		else 
		{
...
<form id="formYouCardApri" method="post" action="/WEBHB/cartaConto/youCardApriRiepilogo.do">
	<input type="hidden" name="origine" value="approfondimenti">
...
.imgSrv{
	...
	<h1>
				...
				<div class="hidden-print hidden-xxs flag youCardApri">&nbsp;</div>
 					...
 					<span class="hidden-xs">:&nbsp; approfondimenti</span>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
		...
		<div class="contentPagina">
			<p style="text-align: center;"><img src="/HT/IMAGES/CONTODEPOSITO/AttivazioneContoDepApprofondimenti.gif" alt="" width="637" height="57"></p>
		</div>
			...
			<div class="bs-example form-horizontal">
				<div class="form-group col-xs-4">
					<div class="form-field-resume">
						...
						<span class="resume">SESTIERE SAN MARCO 2922/A</span>
					</div>
				</div>
				<div class="form-group col-xs-4">
					<div class="form-field-resume">
						<label class="control-label">Comune</label> 
						<span class="resume">VENEZIA</span>
					</div>
				</div>
				<div class="form-group col-xs-4">
					<div class="form-field-resume">
						<label class="control-label">CAP</label> 
						<span class="resume">30124</span>
					</div>
				</div>
				<div class="form-group col-xs-4">
					<div class="form-field-resume">
						<label class="control-label">Provincia</label> 
						<span class="resume">VE</span>
					</div>
				</div>
				<div class="form-group col-xs-4">
					<div class="form-field-resume">
				...
				<div class="form-field col-xs-12">
		    		<span class="floatl margin-right20">La carta verrà spedita a questo indirizzo, qualora non fosse corretto dovrai contattare la tua filiale di riferimento per la modifica.</span>
		    	</div>
			</div>
		</div>
		<div class="section clearfix">
			...
			<div class="accordion ui-accordion ui-widget ui-helper-reset" role="tablist">
				...
				<div class="bs-example form-horizontal ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom ui-accordion-content-active" id="ui-id-2" aria-labelledby="ui-id-1" role="tabpanel" aria-hidden="false" style="display: block;">
					<div class="form-group clearfix">
						<div class="col-xs-12 clear-padding margin-bottom5">
						  	<strong>Titolare effettivo:</strong>
						</div>
						<div class="col-xs-6 clear-padding">
				  			Il rapporto è aperto per conto dell'intestatario/i?
				  		</div>
				  		<div class="form-field-input col-xs-2">
							<div class="form-field">
								<div class="form-field-input col-xs-2 clear-padding">
									<input type="radio" name="intestatario.titolareEffettivoRapporto" value="true" checked="checked" id="titolareEffettivoRapportoSi" class="margin-top5 sfondoForm">
								</div>
								<div class="form-field-input col-xs-8 clear-padding">
									<label for="titolareEffettivoRapportoSi">Sì</label>
								</div>
							</div>
						</div>
						<div class="form-field-input col-xs-4">
							<div class="form-field">
								<div class="form-field-input col-xs-2 clear-padding">
									<input type="radio" name="intestatario.titolareEffettivoRapporto" value="false" id="titolareEffettivoRapportoNo" class="margin-top5 sfondoForm">
								</div>
								<div class="form-field-input col-xs-10 clear-padding">
									<label for="titolareEffettivoRapportoNo">No, il rapporto verrà utilizzato principalmente da un'altra persona non intestataria</label>
								</div>
							</div>
						</div>
						...
						<div class="col-xs-12 clear-padding margin-bottom5">
							...
							<div class="col-xs-6 clear-padding">
								<select name="intestatario.professione" onchange="checkProfessione()" id="professione" class="form-control"><option value="-">-</option>
						...
						<div class="col-xs-12 clear-padding margin-bottom5">
							<div class="col-xs-6 clear-padding">
								<label for="provenienzaFondi">
									Provenienza dei fondi
								</label>
							</div>
							<div class="col-xs-6 clear-padding">
								<select name="intestatario.codProvenienzaFondi" id="provenienzaFondi" class="form-control"><option value="0">-</option>
						...
						<div class="col-xs-12 clear-padding margin-bottom5">	
							<div class="col-xs-6 clear-padding">					  
							  	<label for="attEconomica">
							  		Attività economica
							  	</label>
								<div style="font-size: 10px;">
									(per i pensionati indicare l'atttività precedentemente svolta)
								</div>
							</div>
							<div class="col-xs-6 clear-padding">
								<select name="intestatario.codAttivitaEconomica" id="attEconomica" class="form-control" style="display: none;"><option value="">-</option>
										...
										<option value="740">servizi trasporti marittimi, cabotaggio, aerei</option></select><input name="intestatario.descAttivitaEconomica" class="ui-autocomplete-input custom-combobox-input ui-widget ui-widget-content form-control" autocomplete="off" style="width: 20px;"><button type="button" tabindex="-1" title="Show All Items" class="ui-button ui-widget ui-state-default ui-button-icon-only ui-button-icon btnAutoComplete form-control" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-triangle-1-s"></span><span class="ui-button-text">&nbsp;</span></button>	
						...
						<div class="col-xs-12 clear-padding margin-bottom5">
							<div class="col-xs-6 clear-padding">
							  	<label for="nazione">
							  		Nazione in cui viene svolta principalmente l'attività lavorativa
							  	</label>
							</div>
							<div class="col-xs-6 clear-padding">
								<select name="intestatario.nazioneAttivitaLavorativa" onchange="checkNazione()" id="nazione" class="form-control"><option value="238">Abu Dhabi</option>
						...
						<div class="col-xs-12 clear-padding margin-bottom5">
							<div class="col-xs-6 clear-padding">
							  	<label for="provincia">
							  		Provincia in cui viene svolta principalmente l'attività lavorativa
							  	</label>
							</div>
							<div class="col-xs-6 clear-padding">
								<select name="intestatario.provinciaAttivitaLavorativa" id="provincia" class="form-control"><option value="">&nbsp;</option>
										...
										<option value="VE" selected="selected">Venezia</option>
						...
						<div class="col-xs-12 clear-padding margin-bottom5">
							<div class="col-xs-6 clear-padding">
							  	<label for="nazioneRapporti">
							  		Principale stato estero con il quale intrattieni rapporti economici
							  	</label>
							</div>
							<div class="col-xs-6 clear-padding">
								<select name="intestatario.codNazioneRapporti" id="nazioneRapporti" class="form-control"><option value="">Nessuno</option>
						...
						<div class="col-xs-12 clear-padding margin-top5">
							<strong>Quale sarà il principale utilizzo che farai di questo rapporto aperto per esigenze familiari personali?</strong>
						</div>
						<div class="col-xs-12 clear-padding">
							<input type="radio" name="intestatario.principaleUtilizzoRapporto" value="04" checked="checked" id="principaleUtilizzoRapporto4" class="sfondoForm">
							<label for="principaleUtilizzoRapporto4">Servizi vari</label>
						</div>
					 </div>
				</div>
			</div>
