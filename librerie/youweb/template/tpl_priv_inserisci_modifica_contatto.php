...
<form id="formGestioneContatti" method="post" action="/WEBHT/serviziPerTe/aggiornaContatto.do"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="e44472de37c1b0f6cd35dd87365c35fb"></div>
	<input type="hidden" name="idContatto" value="mauroluca.tallo2@bancopopolare.it">
				...
				<div class="form-group">
					<div class="form-field-input col-sm-6 col-xs-12">
						...
						<div class="form-field">	
							<input type="text" name="contatto" maxlength="60" size="40" value="mauroluca.tallo2@bancopopolare.it" id="contatto" class="form-control">
						</div>
					</div>
			...
			<div class="form-group clearfix">
				...
				<div class="form-field-input col-xs-6">
					<div class="form-field-input col-xs-6 clear-padding">
						<label style="padding-top:2px" for="flagPrivacy">
							<input type="radio" name="flagPrivacy" value="true" checked="checked">
							Si
						</label>
					</div>
					<div class="form-field-input col-xs-6 clear-padding">
						<label style="padding-top:2px" for="flagPrivacy">
							<input type="radio" name="flagPrivacy" value="false">
							No
						</label>
					</div>
				</div>
...
<div class="pull-right margin-top20">
		...
		<form id="formGestioneContatti" method="post" action="/WEBHT/serviziPerTe/contatti.do" class="floatl"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="e44472de37c1b0f6cd35dd87365c35fb"></div>
	...
	<input type="button" name="confermaContatti" value="Conferma" onclick="$('#formGestioneContatti').submit();" class="btn btn-primary execute floatl" alt="Conferma">
</div>