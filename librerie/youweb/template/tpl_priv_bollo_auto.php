...
function stateSelected(item){
    ...
    // se un tipo di veicolo era selezionato, lo resta dopo il modifica
    ...
    $(document).ready(function(){
		...
		regioni["01"] = "IT-65";
		regioni["IT-65"] = "01";
		$("path[data-code='IT-65']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
		...
		regioni["02"] = "IT-77";
		regioni["IT-77"] = "02";
		$("path[data-code='IT-77']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
		...
		regioni["03"] = "IT-BZ";
		regioni["IT-BZ"] = "03";
		$("path[data-code='IT-BZ']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["04"] = "IT-78";
				regioni["IT-78"] = "04";
				$("path[data-code='IT-78']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["05"] = "IT-72";
				regioni["IT-72"] = "05";
				$("path[data-code='IT-72']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["06"] = "IT-45";
				regioni["IT-45"] = "06";
				$("path[data-code='IT-45']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioniDisabilitate.push("IT-36");
				...
				regioni["08"] = "IT-62";
				regioni["IT-62"] = "08";
				$("path[data-code='IT-62']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["09"] = "IT-42";
				regioni["IT-42"] = "09";
				$("path[data-code='IT-42']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["10"] = "IT-25";
				regioni["IT-25"] = "10";
				$("path[data-code='IT-25']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["11"] = "IT-57";
				regioni["IT-57"] = "11";
				$("path[data-code='IT-57']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["12"] = "IT-67";
				regioni["IT-67"] = "12";
				$("path[data-code='IT-67']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["13"] = "IT-21";
				regioni["IT-21"] = "13";
				$("path[data-code='IT-21']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["14"] = "IT-75";
				regioni["IT-75"] = "14";
				$("path[data-code='IT-75']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioniDisabilitate.push("IT-88");
				...
				regioni["16"] = "IT-82";
				regioni["IT-82"] = "16";
				$("path[data-code='IT-82']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["17"] = "IT-52";
				regioni["IT-52"] = "17";
				$("path[data-code='IT-52']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["18"] = "IT-TN";
				regioni["IT-TN"] = "18";
				$("path[data-code='IT-TN']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["19"] = "IT-55";
				regioni["IT-55"] = "19";
				$("path[data-code='IT-55']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioni["20"] = "IT-23";
				regioni["IT-23"] = "20";
				$("path[data-code='IT-23']").attr("fill","#c0c5c9").attr("cursor", "pointer").attr('data-enabled', "true");
				...
				regioniDisabilitate.push("IT-34");
			
		
		
		var regioniDisabilitateColore = new Object();
		$.each(regioniDisabilitate, function( index, value ) {
			regioniDisabilitateColore[value] = "#ebedee";
			$("path[data-code='"+value+"']").attr("fill","#ebedee").attr("cursor", "normal");
		});
		    
    
    
    
	    $('select[name="codRegione"]').change(function(){
	    	clearMap();
	    	var indice = $(this).find('option:selected').val();
	    	var codice = regioni[indice];
	    	
	    	$("path[data-code='"+codice+"']").attr('fill', '#007c66');
    		//$("path[data-code='"+codice+"']").attr('data-selected', 'true');
	    });
	    
    	$("path").mouseover(function(){
    		if($(this).attr("data-enabled") == "true" && $(this).attr("data-selected") != "true"){
    			$(this).attr('fill', '#007c66');
    		}
       	}).mouseleave(function(){
       	 	if($(this).attr("data-enabled") == "true" && $(this).attr("data-selected") != "true"){
	    		$(this).attr('fill', '#c0c5c9');
       	 	}
    	})
    	$("path").click(function(){
    		...
    		clearMap();
    		var indice = $(this).attr('data-code');
    		
    		$("select[name='codRegione']").val(regioni[indice]);
    		$(this).attr('fill', '#007c66');
    		$(this).attr('data-selected', 'true');
    	})
    	  stateSelected($("input[name='codTipoVeicolo']:checked").closest(".labelAutomezzo"));
    	   
	
	     $('#formBolloAuto').submit(function(){
		   $("input[name='targa']").val($("input[name='targa']").val().toUpperCase());      
	    });
	   	var indice = $(this).find('option:selected').val();
	   	var codice = regioni[indice];
	   	$("path[data-code='"+codice+"']").attr('fill', '#007c66').attr('data-selected', 'true');
    })
    ...
    function clearMap(){
  	...
  	<form id="formBolloAuto" method="post" action="/WEBHT/pagamenti/bolloAutoConferma.do" class="form-horizontal"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="ccea2ebcaeedccf4c4d3c2fdeffe0bbc"></div>
...
.imgSrv{
	...
	<h1>
				...
				<div class="hidden-print hidden-xxs flag bolloauto">&nbsp;</div>
...
<a href="javascript:OpenHelp('/template/modale.php?pagTit=Bollo auto: Help&pagCont=testo02')" class="general-help help-icon hidden-xs"><img src="/HT/IMAGES/nGrafica/i_help.png" class="imgSrv" title="Help On Line" alt="Help On Line"></a>
					...
					<div class="bs-example">
						<div class="form-group clearfix">
							<div class="col-xs-12 col-sm-6"> 
								<div class=" margin-top20  section">
									<fieldset>
										<div class="form-field-input col-xs-12 col-sm-12">
											<label class="control-label">Seleziona la regione</label>
								...
								<div class="form-field-input col-xs-12 section">
									<label class="control-label">Tipologia di veicolo:</label>
									<div class="form-field">
										<div class="col-xs-12 margin-bottom10">
											<input type="radio" name="codTipoVeicolo" value="AU" checked="checked" id="tipoVeicolo0">
											Autoveicolo
										</div>
										<div class="col-xs-12">
											
												<input type="radio" name="codTipoVeicolo" value="MO" id="tipoVeicolo1"> Motoveicolo
								...
								<div class="form-field-input col-xs-12 section">
									...
									<div class="form-field">
										<div class="col-xs-12">
											<input type="text" name="targa" maxlength="9" value="" id="targa" style="" class="form-control uppercase">
										</div>
...
" data-enabled="true" fill-opacity="1" stroke="#fefefe" stroke-width="2" stroke-opacity="1" data-name="Puglia" cursor="pointer"></path>
		...
		<div class="pull-right margin-bottom20">
			<input type="button" name="avanti" value="Avanti" onclick="$('#formBolloAuto').submit()" class="btn btn-primary" alt="Avanti">
		</div>
	</form>