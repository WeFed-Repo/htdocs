...
<span class="oLeft">12/05/2017 13.42.38</span>
</div>
<div class="row">
<label>Codice bollettino:</label>
<span class="oLeft">83069917298807775 </span>
</div>
<div class="row">
...
<span class="oLeft">                                                                                                                                                                                                        </span>
		...
		<form id="formIndietro" method="post" action="/WEBHT/pagamenti/ultimeDisposizioniConferma.do" class="form-horizontal"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="3c4c1a3644d701848fdea0ca09a96e38"></div>
		...
		<form id="formDettaglioDisposizione" method="post" action="/WEBHT/pagamenti/revocaDisposizione.do" onreset="submitForm('formIndietro')"><div style="display:none"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="3c4c1a3644d701848fdea0ca09a96e38"></div>
			
			<div class="divForm">
				<input type="hidden" name="codice" value="IH7132047165" id="codice">
