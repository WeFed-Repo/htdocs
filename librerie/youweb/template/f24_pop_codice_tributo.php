...
<body onload="window.focus();">
		<div class="row">
				<div class="container help">
					<div class="center col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<form name="ricercaTributiForm" method="post" action="f24_pop_codice_tributo_esito_ricerca.php" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="75690798f9a9fd302f039cd758551be2">
	...
	<script type="text/javascript">
	 ...
	 <input type="hidden" name="tipoRicerca" value='tributoErario' />

	 
	 	<input type="hidden" name="returnField" value='sezione(erario).riga[0].codiceTributo' />
	 
	
		<div class="clearfix">
			<div class="flag pagamentoF24">&nbsp;</div>
			<h1>Ricerca codici tributo sezione Erario</h1>
		...
		<div class="section sectionNoBg clearfix">
			...
			<div class="bs-example help">
              ...
              <select name="parametro" onChange="selezione(this)" class="form-control">
	             		...
	             		<option value="tributo" >Codice tributo</option>
		    ...
		    <div id="selezioneDescrizione" class="form-group">
          	...
          	<div class="form-field">
	              ...
	              />
							...
							<div class="pull-right margin-bottom20 btn-col">
