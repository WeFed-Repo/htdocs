...
<body>
 	<div id="headerF24">
		<iframe src="/template/tpl_priv_f24_frameset_header.php?pag=<?php print $pag; ?>"></iframe>
	</div>
 	<div id="contentF24" style="-webkit-overflow-scrolling: touch;">
    	<iframe id="frF24Center" name="frF24Center" src="/template/tpl_priv_<?php print $pag; ?>.php" scrolling="yes" ></iframe>
	</div>
</body>
</html>