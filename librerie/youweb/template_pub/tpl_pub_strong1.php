...
<div class="riquadro strong-auth">
	...
	<form id="tokenForm" action="#" name="tokenForm" novalidate="novalidate">
		<div class="section clearfix">
			<p class="alignCenter hidden-xs">Inserisci il codice OTP generato dal tuo Token </p>
			<div class="alignCenter section hidden-xs"><img src="/HT/fe/img/ban_strong_token_fisico.png" alt="Inserisci il codice OTP generato dal tuo Token"></div>
			<div class="row">
