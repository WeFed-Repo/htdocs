    ...
    <div class="col-sm-7 col-sm-pull-5 loginTxt">
  		...
  		<div class="textLogin"> 
			...
			<div class="row margin-bottom20">
				<div class="col-xs-3">
					<img src="/HT/fe/img/ico_responsive.png" alt="naviga responsive" class="img-resp"/>
				</div>
				<div class="col-xs-9">
					<h4><strong>RESPONSIVE</strong></h4>
					<p>Accedi da PC, smartphone oppure da tablet</p>
				</div>
			</div>
			<div class="row margin-bottom40">
				...
				<div class="col-xs-9">
					...
					<p>Scaricala e completa la tua esperienza digitale</p>
				</div>
			</div>

			<p>
				<strong><a class="arrow-link" href="#">Primo accesso?</a></strong>
			</p>
			<p>
				<a href="#" class="arrow-link">Accesso Easy, scoprilo</a>
			</p>
