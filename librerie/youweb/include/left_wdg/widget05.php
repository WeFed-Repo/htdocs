	...
	<div class="bs-example form-horizontal">
		...
		<div class="col-xs-12 clear-padding">
			<div class="sliderContainer sliderContainerSpalla">
				<a href="#Prev" class="meno" onclick="prevMovimenti(this)" id="p" style="display: none;">
	 				<img src="/HT/IMAGES/ico-slide-left.png" height="14" width="14" title="Precedente" alt="Precedente">
				</a>
				<div id="slider_ContoDeposito" class="slider"></div>
				<a href="#Next" class="piu" onclick="nextMovimenti(this)" id="n" style="display: none;">
