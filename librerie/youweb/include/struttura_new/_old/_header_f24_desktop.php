...
@media (min-width:992px) {
	.headerDesktopX #firstMenu { width: 1024px;}
...
<div id="headerDesktop" class="headerDesktopX">
	...
	<div class="contMenuDesk">
		<ul id="firstMenu" class="firstMenuDesk">
			...
			<!-- Riepilogo f23 -->		
			<li class="row2">
				<a href="/strutt_priv_new_f24_frameset.php?pag=pagamento_f23_riepilogo&lev1=pagamenti&wdg=06|02" title="RIEPILOGO F23">RIEPILOGO<br>F23</a>
			</li>	
			<!-- END Riepilogo f24 -->	
		</ul>
	</div>
