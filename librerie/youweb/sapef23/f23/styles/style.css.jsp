...
html { height: 100%; background: url(/sapef23/f23/images/header_bkg_repeat.jpg) left -113px repeat-x; }

body {
	height: 100%;
	margin: 0;
	background: url(/sapef23/f23/images/header_bkg.jpg) center -113px no-repeat;
	font-size: 11px;
...
.conferma{
	behavior: url(/sapef23/f23/javascript/css3pie.htc)!important;
}
...
.titleSection, .titleSectionLong {
	display: inline-block;
	color: #003b79;
	background: url(/sapef23/f23/images/sf_titolo.png) right center no-repeat;
	margin-top: 0px;
	...
	.success .titleSection {
		background: url(/sapef23/f23/images/sf_titolo_verde.png) right center no-repeat;
	}
	
	.alert .titleSection,
	.waiting .titleSection {
	background: url(/sapef23/f23/images/sf_titolo_giallo.png) right center no-repeat;
	}
	
	.error .titleSection {
		background: url(/sapef23/f23/images/sf_titolo_rosso.png) right center no-repeat;
		color: #fff;
	}
...
div.context-buttons {
	...
	.context-buttons a {
		...
		.context-buttons a.btnTable { background: url(/sapef23/f23/images/btn-i-tabella.png) center top no-repeat; }
		.context-buttons a.btnChart { background: url(/sapef23/f23/images/btn-i-grafico.png) center top no-repeat; }
		.context-buttons a.btnTimeline { background: url(/sapef23/f23/images/btn-i-timeline.png) center top no-repeat; }
...
.ui-dialog .tabSelezioneCarte .table tbody tr.hover:nth-child(even) { cursor: pointer; background: #7884a2 !important; color: #fff; }
...
.dataTables_paginate > a { display: none; }
	...
	#mainContent .riquadro .tabSelezioneCC .table tbody > tr.hover.even td { cursor: pointer; background: #8AB10B; color: #fff; }
...
.hide{
	...
	a.table-expand-collapse.collapse {
		...
		a.table-expand-collapse.expand { background: url(/sapef23/f23/images/ico-expand.png) center center no-repeat; }
		a.table-expand-collapse.collapse { background: url(/sapef23/f23/images/ico-collapse.png) center center no-repeat; }
...
div.flag.pagamentoF23{ background: url(/sapef23/f23/images/pins-sprite.png) no-repeat -78px 0; } /*new SIMO*/
...
.logout form {
	width: 25px;
	height: 25px;
	background: url(/sapef23/f23/images/sprite.png) no-repeat -222px -89px;
	display: block;
}
...
.pref a {
	width: 25px;
	height: 25px;
	background: url(/sapef23/f23/images/sprite.png) no-repeat -200px -88px;
	display: block;
}
...
.lock a {
	width: 25px;
	height: 25px;
	background: url(/sapef23/f23/images/sprite.png) no-repeat -172px -89px;
	display: block;
}
...
ul#topMain div.contodeposito { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -32px 0px; }
ul#topMain li.active div.contodeposito,
ul#topMain li.hover div.contodeposito,
ul#topMain a:hover div.contodeposito { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -32px -32px; }
...
ul#topMain div.alert { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -128px 0px; }
ul#topMain li.active div.alert,
ul#topMain li.hover div.alert,
ul#topMain a:hover div.alert { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -128px -32px; }

ul#topMain div.posta_personale { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -160px 0px; }
ul#topMain li.active div.posta_personale,
ul#topMain li.hover div.posta_personale,
ul#topMain a:hover div.posta_personale { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -160px -32px; }

ul#topMain div.investimenti { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -192px 0px; }
ul#topMain li.active div.investimenti,
ul#topMain li.hover div.investimenti,
ul#topMain a:hover div.investimenti { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -192px -32px; }

ul#topMain div.servizi_per_te { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -224px 0px; }
ul#topMain li.active div.servizi_per_te,
ul#topMain li.hover div.servizi_per_te,
ul#topMain a:hover div.servizi_per_te { background: url(/sapef23/f23/images/menu-sprite.png) no-repeat -224px -32px; }
...
#topMain > li.sub-open > a:after {
	...
	height: 15px;
	content: '';
	background: url(/sapef23/f23/images/menu-arrow.png) center bottom no-repeat;
	left: 50%;
	margin-left: -11px;
	z-index: 99900;
}
...
.footer-logo{
	margin-top:10px;
	float:right;	
	background: url(/sapef23/f23/images/sprite.png) no-repeat 0px -178px;
	width: 170px;
	height: 52px;
}
.footer-logo span{
...
a.pdf {
	...
	color: #003b79;
	text-decoration: none;
	background: url(/sapef23/f23/images/i_pdf.png) left 0px no-repeat;
	line-height: 20px;
}
...
div.messagePanel.error { background: url(/sapef23/f23/images/ico_msg_error.png) #fff9f9 20px 35px no-repeat; }
div.messagePanel.alert { background: url(/sapef23/f23/images/ico_msg_alert.png) #fdfce4 20px 35px no-repeat; }
div.messagePanel.waiting { background: url(/sapef23/f23/images/ico_msg_awaiting.png) #fdfce4 20px center no-repeat; }
div.messagePanel.success { background: url(/sapef23/f23/images/ico_msg_ok.png) #f3fdf2 20px 35px no-repeat; }
...
html, body, div.flag.pagamentoF23, .titleSection, .titleSectionLong {background:none; }
...
.CCselezionato .btnSelezioneCC {display: block; width:23px; height:23px; background: url(/sapef23/f23/images/icon_accordion_closed.png) no-repeat 98% center; background-size:100%; top:62px; right: 30px;}
