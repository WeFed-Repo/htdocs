					...
					<div class="col-xs-12">
						<div class="contentPagina">
							<div>
								...
								<tbody>
								<tr>
									<td><table class="tplPubTable">
									<tbody>
									<tr>
										<td><img title="imm_ass_cut" src="/HT/IMAGES/CONTENUTI/imm_ass_cut.gif" alt="imm_ass_cut"></td>
										<td>
											<p>Gentile cliente,</p>
