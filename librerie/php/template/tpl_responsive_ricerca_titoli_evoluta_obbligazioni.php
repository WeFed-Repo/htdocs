	...
	<div id="cercaSel">
		<form class="formGenerico borderFormRounded" role="form" id="form02">
			...
			<div class="form-group">			
				<div class="row">				
					<div class="col-xs-12 col-sm-6">
						<label class="control-label">Tipo emittente</label>
			...
			<div class="form-group">
				<div class="row">				
					<div class="col-xs-12 col-sm-6">
						<label class="control-label">Mercati</label>
						<select class="form-control">
							<option>tutti</option>
							<option>lorem</option>
						</select>
				...
				<div class="form-group">
					<div class="row">				
						<div class="col-xs-12 col-sm-6">
							...
							<select class="form-control">
								<option>Enti ed agenzie pubbliche</option>
								<option>lorem</option>
							</select>						
						</div>	
						<div class="col-xs-12 col-sm-6">
	...
	<div id="cercaRisp" style="display:none">
		<form class="formGenerico borderFormRounded" role="form" id="form02">
			<div class="form-group">			
				<div class="row">				
					<div class="col-xs-12 col-sm-6">
						<label class="control-label-output">Tipo emittente</label>
			...
			<div class="form-group">
				<div class="row">				
					<div class="col-xs-12 col-sm-6">
						<label class="control-label-output">Mercati</label>
						<span class="output">Tutti</span>
					</div>
					<div class="col-xs-12 col-sm-6">
						<label class="control-label-output">Valuta</label>
						<span class="output">Tutti</span>
					</div>				
				</div>
			</div>
		...
		<table cellspacing="0" cellpadding="0" border="0" data-sortable="true" data-sort-order="desc" data-sort-name="Titolo" data-toggle="table" class="sortableTable" data-pagination="true" data-page-size="10">
		    <thead>
		        <tr>
		        	<th class="center" data-field="icona">&nbsp;</th>
		            <th class="left no-border-left" data-field="Titolo" data-sortable="true"><span><i class="icon icon-2x icon-accordion_up"></i><i class="icon icon-2x icon-accordion_down"></i></span>Titolo</th>     
		            <th class="right" data-field="Codice_ISIN" data-sortable="false">Codice ISIN</th>
		            <th class="right" data-field="Valuta" data-sortable="false">Valuta</th>
		            <th class="right" data-field="Tasso" data-sortable="true"><span><i class="icon icon-2x icon-accordion_up"></i><i class="icon icon-2x icon-accordion_down"></i></span>Tasso</th>
		            ...
		            <th class="right" data-field="Mercato" data-sortable="false">Mercato</th>
		            <th class="right" data-field="Prezzo_rif" data-sortable="false">Prezzo rif.<br>Data</th>
		        </tr>
		    </thead>
		    <tbody>
		        <tr class="dispari">
		            ...
		            <td class="left min-width">3I GROUP PLC 10/17 5,625% 17.03 - EURO</td>
		            <td class="left">XS0495913229</td>
		            <td class="left">EUR</td>
		            <td class="left posi">5,625%</td>
		            <td class="left">17.03.17</td>
		            <td class="left">Best execution</td>
		            <td class="center">103,01<br>11.08.16</td>
		        </tr>
		        <tr class="pari">
		            <td class="center">
		            	<!-- ICONA OPERATIVA MEECCANISMO UGUALE NON MODIFICATO: CAMBIATO SOLO HTML E CSS e si apre in overlayer-->
		            ...
		            <td class="left min-width">3I GRP 32-S 5.75%</td>
		            <td class="left">XS0104440986</td>
		            <td class="left">GBP</td>
		            <td class="left posi">5,750%</td>
		            <td class="left">17.04.17</td>
		            <td class="left">Best execution</td>
		            <td class="center">142,59<br>11.08.16</td>
		        </tr>
		        <tr class="dispari">
		        	<td class="center">
		            	<!-- ICONA OPERATIVA MEECCANISMO UGUALE NON MODIFICATO: CAMBIATO SOLO HTML E CSS e si apre in overlayer-->
		            ...
		            <td class="left min-width">ABB 42 JRN 4.375%</td>
		            <td class="left">US00037BAC63</td>
		            <td class="left">USD</td>
		            <td class="left posi">4,375%</td>
		            <td class="left">17.05.17</td>
		            <td class="left">Best execution</td>
		            <td class="center">115,55<br>11.08.16</td>
		        </tr>
