...
var valori = {  
   "dati":[  
      {  
         ...
         "nSvin": '<a href="#" class="no-underline btn-icon"  data-toggle="modal" data-target="#layer"><i class="icon icon-2x icon-zoom_small_piu"></i></a>'
      },
        {  
         "intestato":"Rossetti Luigino",
         "descrizione":"CARDLESS",
         "tipo":"Contrattuale",
         "dataEmissione":"10\/05\/2016",
         "rapporto":"*******880",
         "canale":'<i class="colorbank icon icon-2x icon-user_id"></i>',
         "nSvin": '<a href="#" class="no-underline btn-icon"  data-toggle="modal" data-target="#layer"><i class="icon icon-2x icon-zoom_small_piu"></i></a>'
      },
