...
<table id="tableOrdered" cellspacing="0" cellpadding="0" border="0" class="sortableTable">
    <thead>
        <tr>
            <th data-field="intestato" data-sortable="true" class="">
            	Intestato a
            </th>
            <th data-field="descrizione"  data-sortable="true" class="">
            	Descrizione
            </th>
            <th data-field="tipo" data-sortable="true" class="">
            	Tipo
            </th>
            <th data-field="dataEmissione" data-sortable="true" class="center">
            	Data emissione
            </th>
            <th data-field="rapporto" data-sortable="true" class="">
            	Rapporto	
            </th>
