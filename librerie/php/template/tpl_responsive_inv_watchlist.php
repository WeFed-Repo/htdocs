...
<section>
		...
		<div class="form-group">
			<div class="row">
				<div class="col-xs-12 col-sm-8">
					<label class="control-label-output">Seleziona watchlist</label>
	...
	<script type="text/javascript">
		...
		var cacheAC = {},
		autoCompUrl = "/wscmn/xml/fes_autocomplete.json",
		showSearchResults,
		icoopeUrl = "",
		checkToConf = [],
		$tableWatchlist;
		...
		var loadWatchlist = function(){
			...
			$.ajax({
				url: "/librerie/include/commons/ajax/fes_watchlist.php",
				data: {
					"idWL" : $("#wlSelect").val()
				},
				dataType: "json",
											...
											<div class="form-group">
												<div class="row">
													<div class="col-sm-6">
														...
														<div class="editable-input"><input type="text" name="" class="form-control clear-x" id="nomeISIN"></div>
													</div>
												</div>
											</div>
											<div class="form-group btnWrapper">
										...
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus ipsa nemo ullam, consequuntur repellat quidem consequatur est assumenda fugiat eveniet.</p>
										 <div class="selector-wrap selector-mini" data-input-type="radio" data-input-name="selectBoxesMini">
							                ...
							                <div class="selector-box " data-value="x">
							                    <img src="/fe/img/fes_soc_S-allianz.png" class="img100">
											...
											<div class="selector-box " data-value="x<?php print $x;?>">
							                    <img src="/wscmn/fe/img/placeholder_1-1.png" class="img100">
										 ...
										 <table cellspacing="0" cellpadding="0" border="0" id="searchResultsTable">
	     								    ...
	     								    <tbody>
												...
												<tr class="pari">
								                    ...
								                    <td class="hidden-xs">FR012345<?php print ($y*132); ?></td>
								                ...
								                <tr class="dispari">
								                    ...
								                    <td class="hidden-xs">FR012345<?php print ($y*111); ?></td>
