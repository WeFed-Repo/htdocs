...
<section>
  ...
  <div class="row">
    <div class="col-sm-5 col-sm-push-7" > <!-- TABELLA -->

        <table>
            <tbody>
                <tr>
                    <td style="border-top: dashed 1px #c6c6c6;">Ultimo prezzo</td>
                    <td style="border-top: dashed 1px #c6c6c6;"><strong>1,238</strong></td>
                </tr>
                <tr>
                    <td style="border-top: dashed 1px #c6c6c6;">Ora</td>
                    <td style="border-top: dashed 1px #c6c6c6;"><strong>10:36,46</strong></td>
                </tr>
                <tr>
                    <td style="border-top: dashed 1px #c6c6c6;">Variazione %</td>
                    <td style="border-top: dashed 1px #c6c6c6;"><strong>-0,91%</strong></td>
                </tr>
                <tr>
                    <td style="border-top: dashed 1px #c6c6c6;">Max giornata</td>
                    <td style="border-top: dashed 1px #c6c6c6;"><strong>1,7268</strong></td>
                </tr>
                <tr>
                    <td style="border-top: dashed 1px #c6c6c6;">Min giornata</td>
                    <td style="border-top: dashed 1px #c6c6c6;"><strong>1,715</strong></td>
                </tr>
                <tr>
                    <td style="border-top: dashed 1px #c6c6c6;">Pr domanda</td>
                    <td style="border-top: dashed 1px #c6c6c6;"><strong>1,91</strong></td>
                </tr>
                <tr>
                    <td style="border-top: dashed 1px #c6c6c6;">Pr offerta</td>
                    <td style="border-top: dashed 1px #c6c6c6;"><strong>1,7268</strong></td>
                </tr>
                <tr>
                    <td style="border-top: dashed 1px #c6c6c6;">Divisa</td>
                    <td style="border-top: dashed 1px #c6c6c6;"><strong>EUR</strong></td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="col-sm-7 col-sm-pull-5" ><!-- FORM-->
        ...
        <tr  class="dispari">
            <td>
               <span>
                ...
                <div class="lenghtTdAlert" style="width: 160px">
                   <strong>Periodicit&agrave; invio alert</strong>
                </div>
            </td>
        </tr>
...
<div class="form-group btnWrapper">
    ...
    <div class="btn-align-left">
        <a type="button" class="btn btn-default" href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_imposta_alert_indici_1.php&responsive=y&liv0=0&liv1=1&liv2=0&liv3=1#">indietro</a>
    </div>
    <div class="btn-align-right">
        <a type="button" class="btn btn-primary" href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_imposta_alert_titoli_indici.php&responsive=y&liv0=0&liv1=1&liv2=0&liv3=1#"id="">conferma</a>
    </div>
    <div class="btn-align-right">
        <a type="button" class="btn btn-primary" id="" href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_imposta_alert_titoli_indici.php&responsive=y&liv0=0&liv1=1&liv2=0&liv3=1#">annulla</a>
    </div>
    <br class="clear">
</div>
