	    ...
	    <div class="form-group">
	        <div class="row">
				<div class="col-sm-12 requiredField">
					...
					<input type="text" name="" class="form-control clear-x" value="Sondrio" id="campo5">
				</div>
			</div>
		</div>
	</form>
...
<section>
	...
	<form class="formGenerico borderFormRounded" role="form" id="formCorrispondenza">
	    <div class="form-group">
	        <div class="row">
	            <div class="col-sm-6 requiredField">
	            	<label class="control-label">Via*</label>
	            	<input type="text" name="" class="form-control clear-x" value="VIA MARCONI 32" id="">
	            </div>
	            <div class="col-sm-6">
	            	<label class="control-label">Presso</label>
	            	<input type="text" name="" class="form-control clear-x" id="campo7">
	            </div>
	        </div>
	    </div>    
		<div class="form-group">
	...
	<div class="btnWrapper">
	    <div class="btn-align-right">
	        <a type="button" class="btn btn-primary" id="btnInvio" href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_modifica_residenza_output.php&liv0=0&liv1=0&liv2=0&liv3=0&responsive=y">prosegui</a>
	    </div>
	    <br class="clear">
	</div>
</section>
