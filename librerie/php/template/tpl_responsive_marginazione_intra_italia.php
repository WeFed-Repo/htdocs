...
<div class="navContFirstLev outerTab">
	<div class="innerTab">
		<ul class="tabmedium">
			...
			<li class="on" id="box5tab2"><a href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_marginazione_intra_italia.php&responsive=y&liv0=3&liv1=1&liv2=1&liv3=3" title="Italia">Italia</a></li>
			...
			<li class="off" id="box5tab4"><a href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_marginazione_intra_america.php&responsive=y&liv0=3&liv1=1&liv2=1&liv3=3" title="Europa">America</a></li>
		</ul>
	</div>
