...
<div class="navContFirstLev outerTab">
	<div class="innerTab">
		<ul class="tabmedium">
			<li><a href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_ricerca_titoli_evoluta_derivati.php&liv0=3&liv1=1&liv2=0&liv3=0&responsive=y">futures</a></li>			
