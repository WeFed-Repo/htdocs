...
<div class="navContFirstLev outerTab">
	<div class="innerTab">
		<ul class="tabmedium">
			<li class="off" id="box5tab1"><a href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_marginazione_overnight.php&responsive=y&liv0=3&liv1=1&liv2=1&liv" title="come funziona">come funziona</a></li>
			<li class="on" id="box5tab2"><a href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_marginazione_overnight_paniere.php&responsive=y&liv0=3&liv1=1&liv2=1&liv" title="paniere">paniere</a></li>
		</ul>
	</div>
...
<script>
	...
	$.ajax({
       url: '/librerie/include/commons/ajax/marginazioneOver.php',
       dataType: 'json',
	...
	function setCoefficiente(value, row, index, options){
  	...
  	function setpercLongDisponibile(value, row, index, options){
  		...
  		{
  			return '<img src="/img/ret/img_avail' + value +'.gif" title="' + row.qtaLongAvailable + ' titoli">';
  		}
  		else{
  			return '-';
  		}
  	...
  	function setpercShortDisponibile(value, row, index, options){
  		if(typeof value != 'undefined')
  		{
  			return '<img src="/img/ret/img_avail' + value +'.gif" title="' + row.qtaShortAvailable + ' titoli">';
  		}
  		else{
  			return '-';
  		}
