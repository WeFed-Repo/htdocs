...
<div class="navContFirstLev outerTab">
	<div class="innerTab">
		<ul class="tabmedium">
			...
			<li class="on"><a href="connect.php?page=strutt_priv.php&amp;tpl=tpl_responsive_ricariche_kjeans.php&liv0=2&liv1=2&liv2=1&liv3=0&responsive=y">ricarica</a></li>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-xs-12">
								...
								<strong><a href="#">999.000,00 &euro;</a></strong>
								<!--a href="#" class="output">999.000,00 &euro;</a-->
							</div>
						</div>
					</div>
