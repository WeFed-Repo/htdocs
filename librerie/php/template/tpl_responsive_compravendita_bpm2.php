...
<div class="navContFirstLev outerTab">
	<div class="innerTab">
		<ul class="tabbig">
			<li><a href="#">ricerca semplice</a></li>
			<li  class="on"><a href="#">ricerca avanzata</a></li>
		</ul>
	</div>
			...
			<form class="formGenerico borderFormRounded" role="form" id="form01">
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-6">
							<label class="control-label">Scadenza (gg/mm/aaaa)</label>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-inline">
									 <div class="form-group">
			    ...
			    <div class="form-group">
					<div class="row">
						<div class="col-sm-6">
							<label class="control-label txthelp closeable"  data-toggle="tooltip"  data-title="Per emittente si intende il soggetto (societ&agrave;, governo o ente sovranazionale) che offre i propri titoli ai sottoscrittori, rendendosi garante degli obblighi derivanti dalla particolare categoria di appartenenza degli stessi.">Emittente</label>
							<select class="form-control">
								<option>Tutte</option>
								<option>Warrant</option>
							</select>
						...
						<div class="col-sm-6">
							<label class="control-label">Tipo opzione</label>
							<div class="row">
								<div class="col-sm-6">
									<div class="radio inline">
				       					<label class="textWrapper">
				         					 <input type="radio" name="" id="" disabled>
				         					 <span class="text txthelp closeable" data-toggle="tooltip"  data-title="Conferisce al portatore il diritto di acquistare una determinata attivit&agrave;, ad un certo prezzo, entro una data prestabilita.">Call</span>
										</label>
		     						</div>
								</div>
								<div class="col-sm-6">
									<div class="radio inline">
				       					<label class="textWrapperIn">
				         					 <input type="radio" name="" id="">
				         					<span class="text txthelp closeable" data-toggle="tooltip"  data-title="Conferisce al portatore il diritto di vendere una determinata attivit&agrave;, ad un certo prezzo, entro una data prestabilita.">Put</span>
										</label>
		     						</div>
								</div>
							</div>
				 ...
				 <div class="form-group">
					<div class="row">
						<div class="col-sm-12">
							<label class="control-label txthelp closeable" data-toggle="tooltip"  data-title="Significa 'Prezzo di esercizio'. &Egrave; il prezzo al quale l'acquirente di un contratto di opzione, warrant o covered warrant ha la facolt&agrave; di acquistare o vendere l'attivit&agrave; sottostante.">Strike</label>
							<div class="row ">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="row">
											...
											<div class="col-xs-6 col-sm-6">
												<input  maxlength="" id="" value="" type="text" name="" class="form-control clear-x" disabled>
											</div>
											<div class="col-xs-1 col-sm-1">
												,
											</div>
			    ...
			    <div class="row">
			      <div class="col-sm-12">
			        <div class="btn-align-right">
			          <a type="button" class="btn btn-primary">ricerca</a>
			        </div>
			      </div>
			    </div>
			</div>
