    ...
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Recapiti per rapporti intestati a: "Intestazione NDG fisico" <i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i>
        </a>
      </h4>
    </div>
	...
	<section>
		...
		<div class="btnWrapper">
			<div class="btn-align-right">
				<a type="button" class="btn btn-primary" id="btnInvio" href="#1" onclick="if( $('#boxesitoServizio').css('display')== 'none' ) {$('#boxesitoServizio').css('display','block');} else {window.location.href='/connect.php?page=strutt_priv.php&tpl=tpl_responsive_modifica_residenza_output_molti_new.php&liv0=0&liv1=0&liv2=0&liv3=0&responsive=y';}">prosegui</a>
			</div>
			<br class="clear">
		</div>
	</section>
    ...
    <div class="panel-heading" role="tab" id="headingTwo">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          Recapiti per rapporti intestati a: "Intestazione NDG cointestazione #1"<i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i>
        </a>
      </h4>
    </div>
    ...
    <div class="panel-heading" role="tab" id="headingThree">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
          Recapiti per rapporti intestati a: "Intestazione NDG cointestazione #2<i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i>
        </a>
      </h4>
    </div>
