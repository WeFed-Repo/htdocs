...
<div class="navContFirstLev outerTab">
	<div class="innerTab">
		<ul class="tabmedium">
			...
			<li class="on"><a href="connect.php?page=strutt_priv.php&amp;tpl=tpl_responsive_saldo_kjeans.php&liv0=2&liv1=2&liv2=1&liv3=0&responsive=y">saldo e movimenti</a></li>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									...
									<span class="output">9.999,99 EUR</span>
								</div>
