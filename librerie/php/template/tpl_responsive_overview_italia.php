...
<p style="width:100%;padding:20px;text-align:center;background-color:red;color:white;text-transform:uppercase">sezione top che deve essere disegnata </p>
<div>
	<div id="IdUltimiPrezzi" class="borderFormRounded formGenerico align-center">
	...
	<div class="panel-group panel-fill" id="accordion2" role="tablist" aria-multiselectable="true">
		<div class="panel panel-default">
			...
			<div id="collapse1b" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading1b">
				<div class="panel-body">
					<div class="tab-wrap">
						<div class="row">
							<div id="glossarioWrap" class="loading">
		...
		<div class="panel panel-default">
			...
			<div id="collapse6b" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading6b">
				<div class="panel-body">
					<div class="tab-wrap">
						<p>contenuto 6 Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
					</div>
				</div>
			</div>
		</div>
