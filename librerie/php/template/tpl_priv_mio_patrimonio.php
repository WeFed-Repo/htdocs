...
<style type="text/css">
@import url('/wscmn/fe/css/priv_mio_patrimonio.css');
</style>

<h1 class="hidden-xs">IL MIO PATRIMONIO</h1>
	                    ...
	                    <div class="input-group">
			                <div id="sceltaRapportoFP" class="selectRapp">
			                    <form action="" method="post">
			                        ...
			                        <a href="#!" class="inputOption inputSx">
										<span class="inputDx">
											<span class="input">
	...
	<div id="grafPatrimonio" class="form-group spHead formGenerico">
	    <div class="row">
	        ...
	        <div id="legendaBody" class="col-xs-12 col-sm-5 col-sm-offset-1">
	        	<h3 class="titLegenda">Liquidità<span id="titValLiquidita" class="titValLegenda"><span id="liquiditaTotale"></span>&nbsp;&euro;</span></h3>
	            ...
	            <div class="panel-group panel-group-icon grafLegenda" id="accordionLegLiq" role="tablist" aria-multiselectable="false">
	                <div class="panel panel-default">
	                    <div class="panel-heading" role="tab" id="headerLegLiq1">
	                        <h4 class="panel-title">
								<a href="#subLegenda1" aria-expanded="false" aria-controls="subLegenda1" class="collapsed"><span id="icoLegenda1" class="icoLegenda iconIndex title-icon boxBgIcon boxBgIcon01"><i class="icon icon-small-attivo" title="icon-small-attivo"></i></span><span class="title-text"><span id="labelLegenda1" class="labelLegenda">Saldo disponibile c/c</span><br><span id="valLegenda1" class="valLegenda"><span id="numLegenda1"></span>&nbsp;&euro;</span></span><i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i></a>
							</h4>
	                    </div>
	                    <div id="subLegenda1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headerLegLiq1">
	                        <div class="panel-body subLegenda">
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon01_1"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon01_2"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon01_3"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon01_4"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon01_5"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon01_6"></div></div>
	                ...
	                <div class="panel panel-default">
	                    <div class="panel-heading">
	                        <h4 class="panel-title">
								<a href="#!"><span id="icoLegenda2" class="icoLegenda iconIndex title-icon boxBgIcon boxBgIcon02"><i class="icon icon-small-attivo" title="icon-small-attivo"></i></span><span class="title-text"><span id="labelLegenda2" class="labelLegenda">Saldo deposito libero</span><br><span id="valLegenda2" href="#!" class="valLegenda"><span id="numLegenda2"></span>&nbsp;&euro;</span></span></a>
							</h4>
	                    </div>
	                </div>
	                <div class="panel panel-default">
	                    <div class="panel-heading" role="tab" id="headerLegLiq3">
	                        <h4 class="panel-title">
								<a href="#subLegenda3" aria-expanded="false" aria-controls="subLegenda3" class="collapsed"><span id="icoLegenda3" class="icoLegenda iconIndex title-icon boxBgIcon boxBgIcon03"><i class="icon icon-small-attivo" title="icon-small-attivo"></i></span><span class="title-text"><span id="labelLegenda3" class="labelLegenda">Saldo linee vincolate</span><br><span id="valLegenda3" class="valLegenda"><span id="numLegenda3"></span>&nbsp;&euro;</span></span><i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i></a>
							</h4>
	                    </div>
	                ...
	                <div id="boxContoDeposito" class="panel panel-default btnBgPort">
	                    <div class="panel-heading">
	                        <h4 class="panel-title link">
								<a class="link" href="#!" title="Apri Conto Webank: pi&ugrave; rendimento e zero spese!">Apri Conto Webank: pi&ugrave; rendimento e zero spese!</a>
							</h4>
	                    </div>
	                </div>
	                <div class="panel panel-default">
	                    <div class="panel-heading" role="tab" id="headerLegLiq4">
	                        <h4 class="panel-title">
								<a href="#subLegenda4" aria-expanded="false" aria-controls="subLegenda4" class="collapsed"><span id="icoLegenda4" class="icoLegenda iconIndex title-icon boxBgIcon boxBgIcon04"><i class="icon icon-small-attivo" title="icon-small-attivo"></i></span><span class="title-text"><span id="labelLegenda4" class="labelLegenda">Saldo disponibile derivati</span><br><span id="valLegenda4" class="valLegenda"><span id="numLegenda4"></span>&nbsp;&euro;</span></span><i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i></a>
							</h4>
	                    </div>
	                    <div id="subLegenda4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headerLegLiq4">
	                        <div class="panel-body subLegenda">
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon04_1"></div></div>
	                            	<div id="labelLegenda4_1" class="saldoLabel labelLegenda">Liquidit&agrave; impegnata per operativit&agrave; intraday</div>
	                            	<div id="valLegenda4_1" class="saldoVal valLegenda"><span id="numLegenda4_1"></span> &euro;</div>
	                            </div>
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon04_2"></div></div>
	                            	<div id="labelLegenda4_2" class="saldoLabel labelLegenda">Margini iniziali derivati (Idem, Eurex, CME, LIFFE)</div>
	            ...
	            <h3 class="titLegenda">Portafoglio<span id="titValPortafoglio" class="titValLegenda titPortafoglio"><span id="portafoglioTotale"></span>&nbsp;&euro;</span></h3>
	            <div class="panel-group panel-group-icon grafLegenda" id="accordionLegPor" role="tablist" aria-multiselectable="false">
	                <div class="panel panel-default">
	                    <div class="panel-heading" role="tab" id="headerLegPor">
	                        <h4 class="panel-title">
								<a data-parent="#accordionLegPor" href="#subLegenda5" aria-expanded="false" aria-controls="subLegenda5" class="collapsed"><span id="icoLegenda5" class="icoLegenda iconIndex title-icon boxBgIcon boxBgIcon05"><i class="icon icon-small-attivo" title="icon-small-attivo"></i></span><span class="title-text"><span id="labelLegenda5" class="labelLegenda">Portafoglio titoli</span><br><span id="valLegenda5" href="#!" class="valLegenda"><span id="numLegenda5"></span>&nbsp;&euro;</span></span><i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i></a>
							</h4>
	                    </div>
	                    <div id="subLegenda5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headerLegPor">
	                        <div class="panel-body subLegenda">
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon05_1"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon05_2"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon05_3"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon05_4"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon05_5"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon05_6"></div></div>
	                            ...
	                            <div class="saldoRow">
	                            	<div class="saldoColor"><div class="saldoColorBox boxBgIcon05_7"></div></div>
	                ...
	                <div class="panel panel-default">
	                    <div class="panel-heading">
	                        <h4 class="panel-title">
								<a href="#!"><span id="icoLegenda6" class="icoLegenda iconIndex title-icon boxBgIcon boxBgIcon06"><i class="icon icon-small-attivo" title="icon-small-attivo"></i></span><span class="title-text"><span id="labelLegenda6" class="labelLegenda">Portafoglio fondi e sicav</span><br><span id="valLegenda6" href="#!" class="valLegenda"><span id="numLegenda6"></span>&nbsp;&euro;</span></span></a>
							</h4>
	                    </div>
	                </div>
	                <div class="panel panel-default">
	                    <div class="panel-heading">
	                        <h4 class="panel-title">
								<a href="#!"><span id="icoLegenda7" class="icoLegenda iconIndex title-icon boxBgIcon boxBgIcon07"><i class="icon icon-small-attivo" title="icon-small-attivo"></i></span><span class="title-text"><span id="labelLegenda6" class="labelLegenda">Totale Pronti contro termine</span><br><span id="valLegenda7" href="#!" class="valLegenda"><span id="numLegenda7"></span>&nbsp;&euro;</span></span></a>
							</h4>
	                    </div>
	                </div>
	                <div id="boxPortafoglio" class="panel panel-default btnBgPort">
	                    <div class="panel-heading">
	                        <h4 class="panel-title link">
								<a class="link" href="#!" title="Scopri le soluzioni per il trading">Scopri le soluzioni per il trading</a>
							</h4>
	                    </div>
	                </div>
	            </div>
			...
			<div id="collapseOne2Pre_1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOnePre_1">
				<div class="panel-body panel-accordion-body">
			        ...
			        <p><strong>Saldo disponibile c/c</strong> <br/>
			        	Il saldo tiene conto della presenza di &quot;movimenti non contabilizzati&quot;. Si tratta di operazioni (addebiti e accrediti) gi&agrave; effettuate, ma non ancora contabilizzate.</p>
			        <ul>
			            <li><strong>Saldo contabile</strong>
			                <br/> A differenza del saldo disponibile, non tiene conto dei movimenti non contabilizzati.</li>
			            <li><strong>Totale impegni banking, trading e investimenti</strong>
			                <br/> Gli <strong>impegni</strong> sono operazioni in <strong>addebito</strong> effettuate sul conto, ma non ancora contabilizzate. Incidono pertanto sul saldo disponibile. Per esempio, un prelievo bancomat o un ordine di acquisto di titoli.</li>
			            <li><strong>Totale preavvisi trading e fondi</strong>
			                <br/> I <strong>preavvisi</strong> sono movimenti in accredito (es. ordini di vendita di titoli) e incidono sul saldo disponibile soltanto al momento delle loro contabilizzazione effettiva.</li>
			        </ul>
			        <p><strong>Saldo disponibile derivati</strong><br/>
			        	Il saldo tiene conto degli impegni derivanti dai margini iniziali accantonati, dall'operatività ordinaria e da quella marginata intraday.</p>
			        <ul>
			            <li><strong>Liquidit&agrave; impegnata per operativit&agrave; intraday</strong>
			                <br/> &Egrave; l'importo impegnato sul saldo disponibile del conto corrente per l'apertura o l'incremento di posizioni marginate</li>
			            <li><strong>Margini iniziali derivati (Idem, Eurex, CME, LIFFE)</strong>
			                <br/> &Egrave; l'importo impegnato sul saldo disponibile del conto corrente a seguito di apertura di posizioni ordinarie (non marginate) in derivati</li>
			        </ul>
			        <h4>PORTAFOGLIO</h4>
			        ...
			        <ul>
			            <li><strong>Azioni Italia, Azioni estero, Obbligazioni, Derivati, Covered warrants/Certificates, Etf, Marginazione</strong>
			                <br /> &Egrave; il controvalore dei titoli suddiviso nelle principali tipologie di strumenti finanziari</li>
			        </ul>
...
<div id="patrimonioBtns" class="form-group btnWrapper">
    ...
    <div class="btn-align-right hidden-xs">
        ...
        <a type="button" class="btn btn-primary" id="" href="#!">Esporta in Excel</a>
    </div>
...
<script type="text/javascript" src="/wscmn/fe/js/priv_mio_patrimonio.js"></script>
