...
<section>
    ...
    <div class="btnWrapper">
        <div class="btn-align-left">
            <a type="button" class="btn btn-default" href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_modifica_residenza.php&liv0=0&liv1=0&liv2=0&liv3=0&responsive=y">indietro</a>
        </div>
        <div class="btn-align-right">
            <a type="button" id="AnnullaPin" class="btn btn-default clearPin">annulla</a>
            <a type="button" class="btn btn-primary" id="btnInvio" href="/connect.php?page=strutt_priv.php&tpl=tpl_responsive_modifica_residenza_conferma.php&liv0=0&liv1=0&liv2=0&liv3=0&responsive=y">prosegui</a>
        </div>
        <br class="clear">
    </div>
</section>
