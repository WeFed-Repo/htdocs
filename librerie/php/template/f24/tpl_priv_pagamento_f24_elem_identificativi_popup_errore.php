...
<body style="zoom:1;"  onblur="self.focus()">
				...
				<table class="table table-striped">
					<thead>
				     ...
				     <tr>
				        ...
				        <td class="txt-center">
				          Campo data di pagamento errato perchè non numerico o formalmente non corretto o festivo.
...
<div class="pull-right margin-bottom20">
			...
			<input type="button" value="Chiudi" class="btn btn-default" onclick="javascript: window.close();" />
		    	...
		    	<div class="clearfix"></div>
  			</div><!--center	col-xs-6	col-sm-6	col-md-6	col-lg-6-->
			</div><!--container-->
		</div><!-- row-->
