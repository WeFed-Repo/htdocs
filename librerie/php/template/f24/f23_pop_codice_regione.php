...
<div id="containerHelp">
	<a name="top">&nbsp;</a>
	<h5 class="help">Tabella codici Regione</h5>	
			
		<div class="bs-example help">
			<div class="tablePanel clearfix">
				<div class="table-responsive">
				 <table summary="tabella codici" class="table table-striped help">
					<thead>
						<tr>
							<th class="leftHelp">Codice Regione</th>
							<th class="leftHelp">Descrizione</th>
						</tr>
					</thead>
					<tbody>
