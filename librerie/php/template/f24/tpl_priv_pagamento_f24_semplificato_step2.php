		...
		<div class="main row">
			<div class="container">
				<div id="mainContent" class="center col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<form name="f24MainForm" method="post" action="/sape/f24/inserisciNuovoModello.do" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="6227e6d1b9c5add9014aac79824b8e41">
...
<div class="section clearfix">
	<h3 class="titleSection">Codici aggiuntivi <a href="javascript:helpSemplificato('/sape/f24/images/F24-help-2.jpg');" class="general-help"><img title="aiuto per la compilazione" src="/sape/f24/images/i_help.png" class="imgSrv" alt="Help On Line"></a></h3>
		<div class="bs-example">
			<div class="form-group">				
				<div class="form-field-input col-lg-4 col-md-5 col-sm-5 col-xs-5">
					<label class="control-label">Inserisci l&#8217;identificativo dell&#8217;operazione (se valorizzato):</label>
					<div class="form-field">
						<input type="text" name="sezione(f24Semplificato2012).identificativoOperazione" tabindex="1" size="30" maxlength="18" class="form-control" 
				...
				<div class="form-field-input col-lg-4 col-md-4 col-sm-4 col-xs-4">
					...
					<div class="form-field">
						<input type="text" name="sezione(f24Semplificato2012).codiceUfficio" tabindex="2" size="5" maxlength="3" class="form-control w-auto" 
							
						/>
						 
							<a href="javascript: void(0);" class="action nascosto" title="Seleziona il codice Identificativo">
								<img border="0" src='/sape/f24/images/ico-filter.png' name="sezione(f24Semplificato2012).codiceUfficio.image" onclick="ricercaTributo(this, 'ufficioErario', 'f24_pop_codice_identificativo.php');" alt="cerca codice" title="cerca codice"/>
							</a>
						
	
					</div>
				</div>
				<div class="form-field-input col-lg-4 col-md-3 col-sm-3 col-xs-3">
					<label class="control-label">
					Codice atto (se valorizzato):
					</label>
					<div class="form-field">
						<input type="text" name="sezione(f24Semplificato2012).codiceAtto" tabindex="3" size="11" maxlength="11" class="form-control numerico" 
...
<script type="text/javascript">
	      ...
	      function inserisciNuovoModelloStepForward() {
		      if (!getSubmitted()) {
			      ...
			      document.f24MainForm.action = 'tpl_priv_pagamento_f24_semplificato_step3.php';
			      document.f24MainForm.target= 'frF24Center';
			      document.f24MainForm.submit();
			  }
	      }
...
<section>
	<div class="form-group btnWrapper form-footer">
		<div class="stepBtn">Step 2 di 5</div>
		<div class="btn-align-left">
			<input type="button" class="btn btn-primary btn-default" value="Indietro"  onclick="javascript: inserisciNuovoModelloStepBack();" />
		</div>
