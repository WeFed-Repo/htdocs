		...
		<div class="main row">
			<div class="container">
				<div id="mainContent" class="center col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<form name="f24MainForm" method="post" action="/sape/f24/inserisciNuovoModello.do" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="25d530dc97f0badf1701933070e98cd1">
	...
	<div class="bs-example">
			...
			<div class="form-group">
				...
				<div class="form-field-resume col-md-3 col-lg-3 col-sm-3 col-xs-3">
					...
					<span class="resume">26/04/2017</span>
				</div>
			</div>			
...
<script type="text/javascript">
	      ...
	      function inserisciNuovoModelloStepForward() {
		      if (!getSubmitted()) {
			      ...
			      document.f24MainForm.action = 'tpl_priv_pagamento_f24_semplificato_step5.php';
			      document.f24MainForm.target= 'frF24Center';
			      document.f24MainForm.submit();
			  }
	      }
...
<section>
	<div class="form-group btnWrapper form-footer">
		<div class="stepBtn">Step 4 di 5</div>
		<div class="btn-align-left">
			<input type="button" class="btn btn-primary btn-default" value="Modifica"  onclick="javascript: inserisciNuovoModelloStepBack();" />
		</div>
		<div class="btn-align-right">
			<input type="button" class="btn btn-primary" value="Conferma"  onclick="javascript: inserisciNuovoModelloStepForward();" />
		</div>
