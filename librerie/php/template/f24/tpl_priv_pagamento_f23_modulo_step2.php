...
mostra_loading_screen();
	...
	<input type="hidden" name="DelegaUniqueToken" value='MTQ5ODQ2Nzg5MzQxNA==' />
	<input type="hidden" name="_control.identificativoDelega" value='61' />
				...
				<div id="mainContent" class="center col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="riquadro clearfix">
						...
						<div class="clearfix">
							...
							<div class="padtit">
								<img border="0" src='/sapef23/f23/images/img_pag_f23.gif' alt="pagamento unificato" title="pagamento unificato"/>
							</div>
						</div>
		...
		<div class="bs-example">
			<div class="form-group">
				...
				<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
					<input type="text" name="numeroRiferimento" tabindex="1" size="20" maxlength="17" value="TPJ2013710000956A" class="form-control" 
						readonly="readonly" class="solaLettura"
					/>
				</div>
			</div>
		</div>
...
<!-- 			Inizio Anagrafica 1 -->
			<div class="form-group">
				<div class="form-field-input col-lg-5 col-md-5 col-sm-5 col-xs-5">
					...
					<div class="form-field">
						<div class="form-field-input col-lg-10 col-md-10 col-sm-10 col-xs-10">
							<input type="text" name="contribuente.cognome1" tabindex="2" size="30" maxlength="24" value="COGNOME" class="form-control" 
								readonly="readonly" class="solaLettura"
							/>
				...
				<div class="form-field-input col-lg-5 col-md-5 col-sm-5 col-xs-4">
					...
					<div class="form-field">
						<div class="form-field-input col-lg-10 col-md-10 col-sm-10 col-xs-10">
							<input type="text" name="contribuente.nome1" tabindex="3" size="30" maxlength="20" value="NOME" class="form-control" 
								readonly="readonly" class="solaLettura"
							/>
				...
				<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-3">
					...
					<div class="form-field">						
							...
							<input type="text" name="contribuente.dataNascita1Html" tabindex="4" value="01/01/1990" style="width:120px" class="dataNascitaHtml datepicker form-control w-auto" 
								readonly="readonly" class="solaLettura"
								disabled="disabled"
							/>
					...
					<label class="control-label">Sesso:</label>
						<div class="form-field">
							<div class="form-field-input col-lg-8 col-md-8 col-sm-8 col-xs-6">						
									...
									<input type="text" name="contribuente.sesso1" tabindex="5" size="1" maxlength="1" value="M" class="form-control" 
										readonly="readonly" class="solaLettura"
									/>
					...
					<div class="form-field-input col-lg-1 col-md-1 col-sm-1 col-xs-2">
						...
						<div class="form-field">
							<div class="form-field-input col-lg-9 col-md-9 col-sm-9 col-xs-8">
									...
									<input type="text" name="contribuente.provNas1" tabindex="7" size="2" maxlength="2" value="MI" class="form-control" 
										readonly="readonly" class="solaLettura"
									/>
					...
					<div class="form-field-input col-lg-3 col-md-3 col-sm-3 col-xs-3">
						...
						<div class="form-field">
							<div class="form-field-input col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<input type="text" name="contribuente.codFis1" tabindex="8" size="30" maxlength="16" value="CGNNMO90A01F205R" class="form-control" 
			...
			<div class="form-group">
				...
				<div class="form-field-input col-lg-2 col-md-2 col-sm-2 col-xs-3">
					...
					<div class="form-field">						
							...
							<input type="text" name="contribuente.dataNascita2Html" tabindex="11" value="" style="width:120px" class="dataNascitaHtml datepicker form-control w-auto" 
								readonly="readonly" class="solaLettura"
								disabled="disabled"
							/>
					...
					<label class="control-label">Sesso:</label>
						<div class="form-field">
							<div class="form-field-input col-lg-8 col-md-8 col-sm-8 col-xs-6">							
									...
									<input type="text" name="contribuente.sesso2" tabindex="12" size="1" maxlength="1" class="form-control" 
										readonly="readonly" class="solaLettura"
									/>
					...
					<div class="form-field-input col-lg-1 col-md-1 col-sm-1 col-xs-2">
						...
						<div class="form-field">
							<div class="form-field-input col-lg-9 col-md-9 col-sm-9 col-xs-8">
									...
									<input type="text" name="contribuente.provNas2" tabindex="14" size="2" maxlength="2" class="form-control" 
										readonly="readonly" class="solaLettura"
									/>
	...
	<div class="bs-example">
		<div class="form-group">
			...
			<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">				 
				...
				<div class="form-field">
					<input type="text" name="versamento.codiceUfficio" tabindex="16" size="4" maxlength="3" value="TNM" style="width:50px;float:left;margin-right:10px" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
						readonly=&quot;readonly&quot; class=&quot;solaLettura&quot;
					/>
			...
			<div class="form-field-input col-md-1 col-lg-1 col-sm-1 col-xs-1">
				...
				<div class="form-field">
					<input type="text" name="versamento.contenzioso" tabindex="19" size="6" maxlength="1" value="1" class="form-control" onblur="deselezionato(this)" onfocus="selezionato(this)" 
						readonly=&quot;readonly&quot; class=&quot;solaLettura&quot;
					/>
				</div>
			</div>
			...
			<div class="form-group">				
				<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">						 
					...
					<div class="form-field">
						<input type="text" name="versamento.tributi.codice[0]" tabindex="23" size="5" maxlength="4" value="109T" style="width:90px;" class="form-control" onblur="trimTributo(this); deselezionato(this)" onfocus="selezionato(this)" 
							readonly=&quot;readonly&quot; class=&quot;solaLettura&quot;
						/>					
					</div>
				</div>
				...
				<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2">
					...
					<div class="form-field"> 
						<input type="text" name="versamento.tributi.interiImporto[0]" tabindex="24" size="9" maxlength="13" value="1" class="form-control numerico importoFieldClass puliziaImportiAZero" id="importoInt" onblur="deselezionato(this); getTot(this);" onfocus="selezionato(this)" 
							readonly=&quot;readonly&quot; class=&quot;solaLetturaRight&quot; 
						/>
						,
						<input type="text" name="versamento.tributi.centImporto[0]" tabindex="25" size="1" maxlength="2" value="00" class="form-control numerico importoDecClass puliziaImportiAZero" id="importoDec" onblur="deselezionato(this); getTot(this);" onfocus="selezionato(this)" 
							readonly=&quot;readonly&quot; class=&quot;solaLettura&quot;
						/>
					</div>
				</div>
		...
		<div class="form-group">				
			...
			<div class="form-field-input col-md-2 col-lg-2 col-sm-2 col-xs-2 margin-top22">				   
				  <input id="interiSaldoVers" type="text" class="form-control numerico solaLettura puliziaImportiAZero" style="text-align: right" size="9" maxlength="13" readonly="true" onfocus="blur" value='1'>
				  ,
		...
		<div class="bs-example">
			<div class="form-group">
						...
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
							...
							<div class="form-field">						
								<input type="text" readonly="readonly" value='26/06/2017' class="form-control" />												
							</div>
						</div>
				...
				<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
					...
					<div class="form-field">						
							...
							<input type="text" name="dataIncassoHtml" tabindex="55" size="15" maxlength="10" value="30/06/2017" class="form-control" 
				...
				<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
					...
					<div class="form-field">
						<input type="text" name="interiSaldo" maxlength="13" value="1" class="form-control numerico puliziaImportiAZero" id="interiSaldo" readonly="readonly" />
						,
					...
					<div class="form-group">
						<div class="form-field-input col-md-3 col-lg-2 col-sm-3 col-xs-3">
							...
							<div class="form-field">						
								<input type="text" class="form-control" readonly="readonly" value='61' />
							</div>
						</div>
						<div class="form-field-input col-md-3 col-lg-3 col-sm-3 col-xs-3">
...
<script type="text/javascript">
		  	  ...
		  	  function conferma() {
		        if (!getSubmitted()) {
		           document.f23MainForm.action = 'tpl_priv_pagamento_f23_modulo_step3_esito_positivo.php';
      ...
      function indietro() {
	      if (!getSubmitted()) {
		          document.f23MainForm.action = 'tpl_priv_pagamento_f23_riepilogo.php?forwarding=riepilogo';
		          document.f23MainForm.target= 'frF24Center';
		          document.f23MainForm.submit();
		  }
      }
	...
	<section>
		<div class="form-group btnWrapper form-footer">
			...
			<div class="btn-align-left">
				 <input type="button" class="btn btn-primary btn-default" value="Indietro" href="#" onclick="javascript: indietro();">
			</div>
			<div class="btn-align-right">
				<input type="button" class="btn btn-primary" value="Stampa" href="#" onclick="javascript: stampa();">
				
				<input type="button" class="btn btn-primary" value="Conferma" href="#" onclick="javascript: conferma();">
			</div>
