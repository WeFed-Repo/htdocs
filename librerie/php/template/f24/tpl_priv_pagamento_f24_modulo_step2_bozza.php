						...
						<div class="form-field">
							...
							/>
								...
								<a href="javascript: void(0);" title="Seleziona il codice Ente" class="pull-right">
										...
										<img border="0" src='/sape/f24/images/lampadina.jpg' name="sezione(altriEnti).codiceEnte.image" onfocus="selezionato(this)" onclick="ricercaTributo(this, 'enteAltriEnti', '/sape/f24/showHelp.do');" style="display : none;" />
