	<script language="javascript" type="text/javascript">
		...
		<script src="/wscmn/fe/js/priv_calcolatore_aucap.js"></script>
...
<div class="navContFirstLev outerTab">
		<div class="innerTab">
			<ul class="tabmedium">
				...
				<li class="on" id="box5tab2"><a href="connect.php?page=strutt_priv.php&amp;tpl=tpl_responsive_aumenti_capitale.php&responsive=y&liv0=3&liv1=1&liv2=1&liv3=2">aumenti di capitale</a></li>

				<li class="off" id="box5tab3"><a href="connect.php?page=strutt_priv.php&amp;tpl=tpl_responsive_opv.php&responsive=y&liv0=3&liv1=1&liv2=1&liv3=2" title="OPS, OPV, OPVS">OPS, OPV, OPVS</a></li>
					...
					<div class="tab-content" id="tab1" style="display:block">
						...
						<div class="form-group btnWrapper">
							<div class="btn-align-right">
								<a type="button" class="btn btn-primary" id="" href="connect.php?page=strutt_priv.php&amp;tpl=tpl_responsive_aumenti_capitale2.php&responsive=y&liv0=3&liv1=1&liv2=1&liv3=2#1">aderisci</a>
							</div>
							<div class="btn-align-right">
...
function changeButton_00005284030() {
    if ($('#presa_visione_00005284030').is(':checked')) {
        $('#attiva_00005284030').html('<div><a href=\"javascript:;\" onclick=\"inviaFlag_00005284030();\" class=\"btnformright\" title=\"prospetto informativo (pdf)\"><img src=\"/img/ret/btn_left_ar.gif\" alt=\"\"><span>prospetto informativo (pdf)</span><img src=\"/img/ret/btn_right_ar.gif\" alt=\"\"></a></div>');
    } else {
