...
<h2>Bancomat internazionale</h2>
<div class="navfrontPage outerTab">
    <div class="innerTab">
        <ul class="tabbig">
            <li><a href="connect.php?page=strutt_priv.php&tpl=tpl_responsive_info_richiesta_bancomat.php&liv0=2&liv1=1&liv2=0&liv3=0&responsive=y#">Scheda prodotto</a></li>
            <li><a href="connect.php?page=strutt_priv.php&tpl=tpl_responsive_costi_condizioni.php&liv0=2&liv1=0&liv2=1&liv3=0&responsive=y#">Costi e condizioni</a></li>
            <li class="on"><a href="connect.php?page=strutt_priv.php&tpl=tpl_responsive_richiesta_carta.php&liv0=2&liv1=1&liv2=0&liv3=0&responsive=y#">Richiesta carta</a></li>
        </ul>
    </div>    
                        ...
                        <div id="datiInput">
                            ...
                            <form class="formGenerico" role="form" id="form01">
                                <div class="form-group">
                                            ...
                                            <div class="col-sm-12 requiredField">
                                                ...
                                                <div class="checkbox">
                                                    <label id="informative2" class="textWrapper disabledField richiesta-1">
                                                        <span class="hovfin closeable" data-toggle="tooltip" data-title="Prima di procedere, occorre prendere visione dell'informativa precontrattuale, aprendo il relativo Pdf, salvandolo e/o stampandolo in modo da poterlo conservare."></span>
                                                        <input type="checkbox" name="" id="contratto2" disabled>
                                                        <span class="text">Dichiaro di aver preso visione del<a id="docInfo" target="_blank"> Documento di Sintesi e dell'Informativa precontrattuale</a> dopo averli stampati e/o salvati su supporto durevole. Puoi prendere visione anche del <a href="#!" target="_blank">foglio informativo.</a></span>
                                                    </label>
                                                  </div>
                                            </div>
                                        </div>
                                    ...
                                    <script>
                                        $('#docInfo').click(function(event){
                                            enableInput('#informative2');
                                            window.open('/webankpri/common/apriDocumento.do?id=48');
                                            return false;
                                         })
                                    </script>
                                    <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<tbody>
					<tr>
						<td>Massimale per prelievi giornalieri</td>
						<td class="align-right">9.999 &euro;</td>
					</tr>
					<tr>
						<td>Massimale per prelievi e pagamenti mensili</td>
						<td class="align-right">9.999 &euro;</td>
					</tr>
				</tbody>
                </table>
			
                <!--DAYM <table cellspacing="0" cellpadding="0" border="0" class="dettTable">
                    <thead>
                        <tr>
                            <th>Tipologia</th>
                            <th>Al giorno</th>
