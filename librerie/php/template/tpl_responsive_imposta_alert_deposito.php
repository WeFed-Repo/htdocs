...
<div class="navContFirstLev outerTab">
    <div class="innerTab">
        <ul class="tabsmall">
            ...
            <li class="on"><a href="#">Deposito</a></li>
...
<h4>Definisci gli alert dei movimenti deposito</h4>
<table id="tableSmsAlert_1">
    <thead>
        <tr>
            <th class="left" style="width:50%">Movimenti deposito</th>
    ...
    <tbody>
        <tr class="dispari">
            <td>
                ...
                <div class="lenghtTdAlert">
                    Trasferimento da c/c a deposito superiore a 
                </div>    
            </td>
            <td class="center"> 
                <div class="checkbox">
        ...
        <tr class="dispari">
            <td>
               <span> 
                ...
                <div class="lenghtTdAlert">
                    Trasferimento da deposito a c/c superiore a 
                </div>
            </td>
            <td class="center"> 
                <div class="checkbox">
        ...
        <tr class="pari">
            <td>
                Trasferimento da c/c per superamento soglia massima impostata
            </td>
            <td class="center">
                <div class="checkbox">
                    <label class="textWrapper">
            ...
            <td class="center">
               <p class="note">disponibile a breve</p>
            </td>
            <td class="center">
                <div class="checkbox">
                    <label class="textWrapper">
        ...
        <tr class="pari">
            <td>
               Trasferimento a c/c per superamento soglia minima impostata
            </td>
            <td class="center">
                <div class="checkbox">
                    <label class="textWrapper">
