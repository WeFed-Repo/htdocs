...
<style type="text/css">
@import url("/wscmn/fe/css/priv_fp_trading.css");
</style>
...
<div id="fpTrading">
    ...
    <section>
        <div class="boxApriDepTit">
            <div class="titleApriDepTit"><a href="#!">Vuoi investire? Apri il deposito titoli <span class="arrowApriDepTit"><i class="icon icon-arrow_right"></i></span></a></div>
            <div class="row">
                <div class="col-sm-6">v
                    <div class="platformApriDepTit">
                        ...
                        <div class="infoLinkApriDepTit">
                            <div class="titleLinkApriDepTit"><a href="#!">PIATTAFORME <span class="arrowApriDepTit"><i class="icon icon-arrow_right"></i></span></a></div>
                            <div class="textLinkApriDepTit">Scopri la nostra T3: per accedere alla versione demo ti basta utilizzare le credenziali (User ID e password) di accesso al conto.</div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="walletApriDepTit">
                        ...
                        <div class="infoLinkApriDepTit">
                            <div class="titleLinkApriDepTit"><a href="#!">PORTAFOGLIO VIRTUALE <span class="arrowApriDepTit"><i class="icon icon-arrow_right"></i></span></a></div>
            ...
            <div class="col-sm-8">
                <div class="headerContainerNoBootS">
                    <div class="tableContainerNoBootS">
                        <table id="chartLegend" cellspacing="0" cellpadding="0" border="0">
                            <thead>
                                <tr>
    ...
    <section class="hidden-xs">
        ...
        <a href="#">
            Scopri la tua nuova piattaforma T3 <i class="icon icon-arrow_right"></i>
             ...
             <a href="#" class="ban-img"><img src="/fe/img/banner_T3.png"></a>
             <a href="#" class="ban-img"><img src="/fe/img/banner_T3open.png"></a>
             <a href="#" class="ban-img"><img src="/fe/img/banner_T3noframe.png"></a>
        </div>
    </section>
            ...
            <div class="panel-group panel-fill" id="tradingInfoContent" role="tablist">
                <div class="panel panel-default">
                    ...
                    <div id="collapse1b" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading1b">
                        <div class="panel-body">
                            <?php virtual("tpl_priv_fp_trading_table_indici.php"); ?></div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading visible-xs" role=" tab"="" id="heading2b">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion2" href="#collapse2b" aria-expanded="false" aria-controls="collapse2b" class="collapsed">Futures<i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i></a>
                        </h4> </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading visible-xs" role=" tab"="" id="heading3b">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion2" href="#collapse3b" aria-expanded="false" aria-controls="collapse3b" class="collapsed">Watchlist<i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i></a>
                        </h4> </div>
                    <div id="collapse3b" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading3b">
                        <div class="panel-body">
                            ...
                            <div id="watchlistBtns" class="form-group btnWrapper">
                                <div class="btn-align-right"> <a type="button" class="btn btn-primary" id="">Modifica</a> <a type="button" class="btn btn-primary" id="">Dettagli e altre watchlist</a> </div>
                                <br class="clear"> </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="/wscmn/fe/js/bootstrap-table.js"></script>
    <script type="text/javascript" src="/wscmn/fe/assets/amcharts/amcharts.js"></script>
    <script type="text/javascript" src="/wscmn/fe/assets/amcharts/pie.js"></script>
    <script type="text/javascript" src="/wscmn/fe/js/fp/fp_trading.js"></script>
                    ...
                    <section>
                        ...
                        <table cellspacing="0" cellpadding="0" border="0" id="table1" class="fixed">
                            ...
                            <tbody>
                                ...
                                <tr class="merged">
                                    <td class="right text-small"><span class="txthelp closeable" data-title="&gt;" data-toggle="tooltip">liquidit&agrave; impegnata per operativit&agrave; intraday</span></td>
                                    <td class="bgkWhite center nega">&euro; 0,00</td>
                                    <td class="bgkWhite"></td>
                                    <td class="bgkWhite"></td>
                                    <td class="bgkWhite"></td>
    ...
    <div class="modal fade slide-right" id="risulatiTitoli" tabindex="-1" role="dialog" aria-labelledby="risulatiTitoli">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header"> <a class="close close-top btn-icon" data-dismiss="modal" aria-label="Close"><i class="icon icon-alert_error_fill icon-2x"></i ></a>
                            ...
                            <div class="col-xs-12">
                                <section>
                                    ...
                                    <div class="form-group btnWrapper">
                                        <div class="btn-align-right"> <a type="button" class="btn btn-primary" id="" href="javascript:;" onclick="unObscurateElement('#fieldsInsOrd');$('#ultimoPrezzoInfo,#tableTit').show()" data-dismiss="modal" role="button" title="Conferma ricerca">conferma</a> </div>
                                    </div>
                                </section>
                            </div>
                        </div>
