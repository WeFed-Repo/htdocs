...
<section>	
	<div class="form-group btnWrapper">
	    ...
	    <div class="btn-align-right">
	        <a type="button" class="btn btn-primary" id=""  href="connect.php?page=strutt_priv.php&amp;tpl=tpl_responsive_opv3.php&responsive=y&liv0=3&liv1=1&liv2=1&liv3=2">prosegui</a>
	    </div>
	    <div class="clear"></div>
	</div>
</section>
