...
<script type="text/javascript">
	...
	var urlDett = {
		"tempi": "/librerie/include/commons/ajax/fes_tempi_costi_tempi.php",
		"costi": "/librerie/include/commons/ajax/fes_tempi_costi_costi.php",
		"invmin": "/librerie/include/commons/ajax/fes_tempi_costi_invmin.php",
	} 
	...
	$(function(){
		...
		$("#selectSocietaGestione").val("<?php print $codSoc; ?>").change(function(){
				...
				location.href= "/connect.php?page=strutt_priv.php&tpl=tpl_responsive_fes_tempi_costi.php&responsive=y&liv0=4&liv1=2&liv2=1&liv3=1&codSoc=" + $(this).val() + "&selTab=" + $("#dettSoc .tabWrapper .on a").attr("data-tab");
