...
<div class="navContFirstLev outerTab">
    <div class="innerTab">
        <ul class="tabsmall">
            ...
            <li class="on"><a href="#">Trading</a></li>
...
<h4>Definisci gli alert delle notifiche ordini</h4>
<table>
    <thead>
        <tr>
            <th class="left" style="width:50%">Notifiche ordini</th>
    ...
    <tbody>
        ...
        <tr class="pari">
            <td>
                Notifica ordini eseguiti totali
            </td>
            <td class="center">
                <div class="checkbox">
        ...
        <tr class="dispari">
            <td>
                Notifica ordini eseguiti parziali
            </td>
            <td class="center">
                <div class="checkbox">
                    <label class="textWrapper">
...
<div class="headerContainerNoBootS">
    <div class="tableContainerNoBootS">
<h4>Definisci gli alert di mercato</h4>
<table>
    <thead>
        <tr>
            <th class="left" style="width:50%">Alert di mercato</th>
            <th class="center wTd15">Sms</th>
            <th class="center wTd10">Email (Gratis)</th>
            <th class="center wTd10">Push (Gratis)</th>
        </tr>
...
<div class="headerContainerNoBootS">
    <div class="tableContainerNoBootS">
<h4>Definisci gli alert del controvalore portafoglio</h4>
<table id="tableSmsAlert_1">
    <thead>
        <tr>
            <th class="left" style="width:50%">Controvalore portafoglio</th>
...
<!-- GESTIONE DELLA SOTTOTABELLA SEZIONE   -->
