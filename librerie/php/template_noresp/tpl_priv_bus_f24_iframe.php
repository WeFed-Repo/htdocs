...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<!--link rel="stylesheet" href="/css/ret/webank_3_v1.css" type="text/css"-->
	<link rel="stylesheet" href="/INLINEANET/Stile/delega.css" type="text/css">
...
</head><body class="Home" onload="javascript: setFormOnChange_CF_PIVA(true); start();">
...
<table class="contribuente">
	...
	<tr>
		...
		<td>provincia&nbsp;<br><select style="background-color: rgb(255, 255, 255);" class="selectcls" id="prov" onclick="normalizeColor(this);" tabindex="8" name="contribuente.provinciaNascita">
...
<div class="fooform">
	...
	<div class="fooformleft">
		<div><a href="#1" class="btnformleft" title="indietro"><img src="/INLINEANET/img/btn_left_bi.gif" alt="" /><span>indietro</span><img src="/INLINEANET/img/btn_right_bi.gif" alt="" /></a></div>	
	</div>
	<div class="fooformright">
		<div><a href="#1" class="btnformright" title="prosegui"><img src="/INLINEANET/img/btn_left_ar.gif" alt="" /><span>prosegui</span><img src="/INLINEANET/img/btn_right_ar.gif" alt="" /></a></div>
	<br class="clear" />
	</div>	
<br class="clear" />
</div>
