<?php 
	...
	//Intercetta l'eventuale apertura di un evento, identificandolo 
	$openedEvent = $_GET["openedEvent"];

	if (empty($openedEvent))
	{
		$openedEvent = "";
	}
	else
...
<div id="maincontent">
	...
	<h2 class="title">Ciclo lorem ipsum dolor sit</h2>
	<!-- Elenco degli eventi -->
	<div class="eventList">
		<?php 
		for ($i==0;$i<20; $i++)
