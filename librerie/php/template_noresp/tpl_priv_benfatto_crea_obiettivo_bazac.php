...
<div id="layerVetrina" class="layeralert3" style="display: none;">
	<div class="head handle" onmouseover="this.style.cursor='move'; $('layerVetrina').dragHandle = new Draggable('layerVetrina',{handle: 'handle'}, { scroll: window });"><img src="/img/ret/layeralert_x.gif" alt="chiudi" onclick="closePopOverLayer('layerVetrina')"/></div>
		<div class="body flLeft">
			<h2 class="vetrinaTit"><span class="flLeft">Lorem ipsum</span> <img class="flLeft" src="/img/ret/logo_bazak_vetrina.jpg"></h2>
...
The Suite Club
Via tal dei tali  42, 20146 Milano (MI)</p><p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
...
<div class="boxrichiesta">
 <div class="steprichiesta on">
	...
	<!--STEP 1 OUPUT FINE-->
		<div class="btnc aButtoncons" id="btnProsegui1"><a href="javascript:;" class="first aButton" onclick="openPopOverLayer('layerVetrina', 'floating', 1);""><span>prosegui</span></a></div>
	...
	<!--STEP 2 INPUT FINE-->
					...
					<div class="row-fluid">
						...
						<div class="span6 paddLeftLarge" style="*width:43.66%">
							...
							<div class="boxImgVetrina">
								<a href="#1" onclick="openPopOverLayer('layeralert3', 'floating', 1);" class="aggDaVetrina" style="background-image:url(/img/ret/vetrina/0010/ldpi.png);"><img src="/img/btn_aggobiettivo.png" class="aggObiettivo"></a>
							</div>
			...
			<div style="display:none" id="contformrichiesta2output">
				...
				<div class="row-fluid">
					<div class="span12">
						<img src="/img/ret/ico2or_risparmiare.jpg" class="flLeft"><p style="margin:10px 0 0 0"><strong>Lorem ipsum</strong><br>Nella pagina di gestione obiettivo potrai controllare l'andamento del tuo obiettivo. Una volta raggiunto lorem ipsum dolor sit amet</p>
				...
				<div class="row-fluid">
					<div class="span12">
						<img src="/img/ret/ico2or_appbenfatto.jpg" class="flLeft"><p style="margin:10px 0 0 0">Scaricando l'app potrai impostare un importo fisso per il trasferimento.</p>
						<div class="flRight">
							<a href="#"><img src="/wscmn/img/btn_apple_store_download.png" /></a>
							<a href="#"><img src="/wscmn/img/btn_android_store.png" /></a>
						</div>
					</div>
				</div>
			</div>
