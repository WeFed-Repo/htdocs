	...
	<div class="steprichiesta on">
		...
		<div class="formGeneric steprichiestacont">
			...
			<div id="formRichiestaFirmaStep1">
				...
				<div id="btnProsegui1Dis" class="btnc aButtoncons"><a class="aButton  buttDis"><span>lorem ipsum</span></a></div>
				<div id="btnProsegui1" class="btnc aButtoncons" style="display:none"><a onclick="$('#formRichiestaFirmaStep1').hide();$('#formRichiestaFirmaStep1output').show();stepRichiesta(this);" class="nextstep first aButton" href="javascript:;"><span>lorem ipsum</span></a></div>
			</div>
