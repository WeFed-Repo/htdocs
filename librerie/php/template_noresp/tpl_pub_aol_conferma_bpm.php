<div id="aolcontainer" class="post">
	<br class="clear" />
	<ul class="flaglist">
		<li>A breve riceverai un'email di conferma con tutte le informazioni necessarie per completare l'apertura del conto.</li>
		<li>
			Puoi verificare, <strong>quando vuoi</strong>, lo stato della tua richiesta su <a href="https://webanksvi8web.webank.local/webankpub/aol/wb/contents/statoPratica/loginStatoPratica.jsp?OBS_KEY=pro_wbn_stato_pratica&OBS_REF=HP_StatoPratica">www.webank.it/statopratica</a>.<br>
			Per accedere alle informazioni, ricorda di <strong>tenere a portata di mano</strong> il tuo codice fiscale e la password che ti comunicheremo per email.
		</li>
	</ul>
	<div class="boxconf">
		<div class="boxconfTop"><h2>PER CONCLUDERE LA TUA RICHIESTA DI APERTURA CONTO</h2></div>
			<div class="boxconfMiddle">
				<div class="step  first"><img src="/img/ico2inf_confstep1.gif" alt="" />
					<div class="steptxt">
						<h3>Stampa i documenti</h3>
						<br class="clear" />
						<a href="#" class="printDocAol" target="_blank">stampa il contratto</a>
					</div>
				</div>
				<br class="clear" />
				<div class="step">
					<img src="/img/ico2inf_confstep2.gif" alt="" />
					<div class="steptxt"><h3>Firmali in tutte le parti</h3></div>
				</div>
				<br class="clear" />
				<div class="step">
					<img src="/img/ico2inf_confstep3.gif" alt="" />
						<div class="steptxt"><h3>Inviaci i documenti firmati</h3><br class="clear" />
						Spedisci i documenti insieme alla <strong>fotocopia del documento d'identit&agrave;</strong> che hai indicato all'inizio della richiesta di apertura conto.<br><br>
						<p>Il nostro indirizzo &egrave; : WeBank S.P.A Via Massaua, 4 - 20146 Milano</p>
					</div>
				</div>
				<br class="clear" />
				<div class="step">
					<img src="/img/ico2inf_confstep4.gif" alt="" />
					<div class="steptxt"><h3>Fai l'identificazione</h3>
					<br class="clear" />
						
						<p>Ricordati di fare il bonifico o di recarti in agenzia in base alla modalità da te scelta per <strong>l'identificazione necessaria</strong> all'apertura del conto.</p>
	...
	<p class="large"><strong>Cosa accade dopo?</strong></p><br>
	<ul class="flaglist">
		<li>Una volta ricevuti i documenti contrattuali firmati ed effettuate tutte le verifiche, procederemo con l'<strong>apertura</strong> del tuo conto;</li>
		
		<li>Ti informeremo con un SMS e un'email, in cui troverai l'IBAN del tuo nuovo conto;</li>
		<li>Infine, ti spediremo per posta i codici di accesso al conto.</li>
	...
	*/
				...
				<div class="contact">
					...
					<div class="contactcont">
						...
						<div id="formInsert">
							...
							<form action="/webankpub/wb/AolAdesioneCMB.do?cf=0.590322325054296" method="post" id="formCallMeBackAOL" name="formCallMeBackAOL">
	...
	<div id="callmeback" class="overlayer" style="display:none">
				...
				<div class="overlayerbody">
				<span class="sep"></span>
				<form action="/webankpub/wb/AolAdesioneCMB.do?cf=0.590322325054296" method="post" id="formCallMeBackAOL2" name="formCallMeBackAOL2">
