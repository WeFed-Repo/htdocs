...
<div class="promobolli">
	<div class="bannerLink">
		<img src="/img/ret/ban_inquBolli2.gif" class="bannerLinkContent" alt="Apri conto Webank, bolli congelati per tutto il 2012 sul nuovo deposito titoli">
	...
	<div class="boxPromoBolliContainer">
		...
		<div class="boxPromoBolliCont">
				<div class="bianco button">
					...
					<div class="dx">
						<div class="esito"><a href="#" class="cta">Apri il conto</a></div>
					</div>
				</div>
				<div class="bianco">
					<div class="sx">
	...
	<div class="boxPromoBolliContainer">
		<div class="boxPromoBolliTop">
			...
			<div class="text"><img src="/img/ret/ico2inf_spunta.gif" alt="" /><span>I requisiti, per ottenere il congelamento dei bolli, sono stati ancora raggiunti!</span><br /> L'importo che pagherai sar&agrave;:</div>
		</div>
		<div class="boxPromoBolliCont">
				<div class="boxPromoBolliRispTot">
					<ul class="importi">
						...
						<li><span class="anno">2012</span><span>99,99&euro;</span></li>
					</ul>
					<br class="clear" />
	...
	<!-- caso senza box totale disabilitato-->
		...
		<div class="boxPromoBolliTop">
			...
			<div class="text notarget"><img src="/img/ret/ico2inf_spunta_off.gif" alt="" /><span>I requisiti, per ottenere il congelamento dei bolli, non sono stati ancora raggiunti!</span><br /> L'importo che pagherai sar&agrave;:</div>
		</div>
		<div class="boxPromoBolliCont">
	...
	<div class="boxPromoBolliContainer">
		<div class="boxPromoBolliTop">
			...
			<div class="label">Controvalore attuale<strong>52.000 &euro;</strong></div>
		...
		<div class="boxPromoBolliCont">
			<div class="boxRisparmio">
				<div class="label attiva"><strong>Risparmio totale</strong><strong class="dod">0</strong><span>fino a 49.999</span></div>
				<div class="label"><strong>Risparmio totale</strong><strong class="qui">53,70 &euro;</strong><span>da 50.000 a 150.000</span></div>
