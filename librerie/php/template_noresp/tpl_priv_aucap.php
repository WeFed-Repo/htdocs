...
<a href="javascript:;" onclick="openAucap('valore_codice_aucap',true)">apri aucap</a><br>
<a href="javascript:;" onclick="openAucap('valore_codice_aucap',false)">apri aucap senza acquisto</a> 
</div>
<!-- OVERLAYER  AUCAP-->
