...
<script type="text/javascript" src="/wscmn/4s/js/4s.js"></script>
...
<h1>Ricerca e confronta fondi</h1>
<!-- TABS -->
...
<div id="fesRicWrap" style="display:none">
	...
	<div id="fesRicercaCont">
						...
						<div class="formGeneric">
							<form autocomplete="off" id="fesSearchForm" action="javascript:;">
								...
								<div id="avanzate">
									...
									<div class="row-fluid noMargbottom paddTopSmall">
										<div class="span12">
											<div class="aButtoncons formCenteredBtn">
												<a href="javascript:;" class="aButton" id="avanzateBtn"><span><span class="nascondi">Nascondi</span><span class="mostra">Mostra</span> opzioni avanzate</span></a>
											</div>
										</div>
									</div>
								</div>
								<!-- fine opzioni avanzate -->
		...
		<div id="fesSearchResults">
			...
			<input type="hidden" id="fesSearchTableSelect" value="sintesi">
			<!--
