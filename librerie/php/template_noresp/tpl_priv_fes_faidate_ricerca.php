...
<div id="fesRicWrap" style="display:none">
    <ul class="tabGeneric">
        <li class="active" id="tabRicerca">
            <span class="tabBorder"><span class="tabGradient"><a href="javascript:;">Ricerca</a></span></span>
        </li>
        <li id="tabConfronta">
            <span class="tabBorder"><span class="tabGradient"><a href="javascript:;" class="leftelement">Confronta</a><span id="fesConfButt" style="display:none"><span>2 fondi</span><a class="smallClose">&nbsp;</a></span></span></span>
        </li>
    </ul>
    <!-- FINE TABS -->
    <!-- WRAPPER -->
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span4">
                                        ...
                                        <div id="fesFondo" class="btnMultiSel">
                                            <input type="hidden" id="fondoSicav" name="fondoSicav" value="P">
                                        </div>
                                    </div>
                                </div>
                                <div class="row-fluid">
