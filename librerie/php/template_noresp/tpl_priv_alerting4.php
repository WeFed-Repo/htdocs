...
<!-- CONTENUTI TAB-->
	...
	<table class="form01">
		<tr>
			<td rowspan="2" width=""><strong>Titolo</strong></td>
			<td width="400" class="nobor"  colspan="3">
					<div class="nobor3"><input type="radio" class="nobor3" value="radiobutton" name="radiobutton"/>Nome</div>
					<div class="nobor3"><input type="text" class="grande" /><span class="tooltip"><a class="nounderline" onmouseout="vedi('lampa1');" onmouseover="nascondi('lampa1');" href="#1"><img class="lampa" id="lampa1" src="/img/ret/lampa_off.gif"/><span><span><span>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vestibulum placerat. Nullam nec justo eget turpis pharetra rhoncus.</span></span></span></a></span></div>
			</td>
		</tr>
		<tr>
			<td width="400" colspan="4">
					<div class="nobor3"><input type="radio" class="nobor3" value="radiobutton" name="radiobutton"/>Iniziale</div>
					<div class="nobor3"><select name="select">
					<option>A</option>
					<option>B</option>
					<option>-----------------------</option>
					</select>
		...
		<tr>
			<td width=""><strong>Mercato</strong></td>
			<td width="400" class="nobor"  colspan="3">
					<select name="select">
					<option>MTA</option>
					<option></option>
	...
	<div class="fooform">
		<div class="fooformleft">
			<div><a href="#1" class="btnformleft" title="vai alla lista titoli"><img src="/img/ret/btn_left_bi.gif" alt=""/><span>vai alla lista titoli</span><img src="/img/ret/btn_right_bi.gif" alt=""/></a></div>
		</div>
	<div class="fooformright">
		<div><a href="#1" class="btnformright" title="prosegui" onclick="javascript:obscurateAll(1); openAlert('layeralert1')";><img src="/img/ret/btn_left_ar.gif" alt=""/><span>prosegui</span><img src="/img/ret/btn_right_ar.gif" alt=""/></a></div>
		<br class="clear"/>
	</div>	
	<br class="clear"/>
	</div>
...
<div class="layeralert2" id="layeralert1" style="display: none;">
	...
	<div class="tithelp">	
			<div class="helpleft"><h2 class="titTable">Risultati di ricerca per: A</h2> </div>
			<div class="helpright2 wt">Trovati 34 elementi<br class="clear"/></div>
			<br class="clear"/>
	</div>
	<div id="contcont">	
<table cellpadding="0" cellspacing="0" class="condiz2 fondi">
	...
	<tr class="dispari"> 
	  ...
	  <td class="left">ASR</td>
	  <td class="left">A.S Roma</td>
...
<br class="clear">
<a href="#1" class="btnformright" title="prosegui" onclick="javascript:unobscurateAll(); closeAlert('layeralert1');" ><img src="/img/ret/btn_left_ar.gif" alt=""><span>prosegui</span><img src="/img/ret/btn_right_ar.gif" alt=""></a>
</div>
</div>
