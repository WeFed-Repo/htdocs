...
<div id="fesRicWrap">
    <ul class="tabGeneric">
        <li id="tabTop10" class="tablink">
            <span class="tabBorder"><span class="tabGradient"><a href="/connect.php?page=strutt_priv.php&amp;liv0=0&amp;liv1=0&amp;liv2=0&amp;responsive=n&amp;tpl=../template_noresp/tpl_priv_fes_faidate_top_10.php" class="leftelement">Top 10 Fondi</a></span></span>
        </li>
        <li id="tabTopFlop" class="tablink active">
            <span class="tabBorder"><span class="tabGradient"><a href="#!">Categorie migliori e peggiori</a></span></span>
        </li>
    </ul>
    <!-- FINE TABS -->

    <!-- WRAPPER -->
    <div id="fesTopFlopCont" style="display:none">
    	<div class="paddMedium">
			...
			<div class="row-fluid">
				<div class="span6">
					<h2>10 migliori categorie Fondi a 1 mese
						<a class="noborder" href="javascript:;" data-tooltip="<strong>CATEGORIE BRATING</strong>: i prodotti di risparmio gestito vengono classificati da BRating in categorie omogenee. Il processo di classificazione prende in considerazione, tra gli altri elementi, <strong>l'asset class</strong> di riferimento, <strong>l'area geografica</strong>, il <strong>settore merceologico</strong>, <strong>la tipologia di strumenti</strong> in portafoglio e <strong>l'esposizione valutaria</strong>. Gli elementi su cui si basa l'analisi sono prevalentemente: la politica di gestione dichiarata nella documentazione d'offerta, l'evoluzione storica del NAV rispetto a benchmark di mercato e la composizione effettiva di portafoglio"><img style="margin: -10px 0px 0px 0px;" alt="" src="/img/ret/ico2or_help2.gif"></a>
					</h2>
					<div id="fesTopResults" class="fesResults">
                        <table id="fesTopTable" class="dettTable sortable">
                            <thead>
                                <tr class="festTableHead">
                                    <th>
                                        <a class="sortDir" href="#!" fieldname="categoriabrating">Migliori categorie<br>BRating</a>
                                    </th>
                                    <th>
                                        <a class="sortDir" href="#!" fieldname="numfondi">N. Fondi</a>
                                    </th>
                                    <th>
                                        <a class="sortDir" href="#!" fieldname="rendimento">Rendimento<br>a 1 mese*</a>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
				...
				<div class="span6">
					<h2>10 peggiori categorie Fondi a 1 mese
						<a class="noborder" href="javascript:;" data-tooltip="<strong>CATEGORIE BRATING</strong>: i prodotti di risparmio gestito vengono classificati da BRating in categorie omogenee. Il processo di classificazione prende in considerazione, tra gli altri elementi, <strong>l'asset class</strong> di riferimento, <strong>l'area geografica</strong>, il <strong>settore merceologico</strong>, <strong>la tipologia di strumenti</strong> in portafoglio e <strong>l'esposizione valutaria</strong>. Gli elementi su cui si basa l'analisi sono prevalentemente: la politica di gestione dichiarata nella documentazione d'offerta, l'evoluzione storica del NAV rispetto a benchmark di mercato e la composizione effettiva di portafoglio."><img style="margin: -10px 0px 0px 0px;" alt="" src="/img/ret/ico2or_help2.gif"></a>
					</h2>
					<div id="fesBottomResults" class="fesResults">
                        <table id="fesBottomTable" class="dettTable sortable">
                            <thead>
                                <tr class="festTableHead">
                                    <th>
                                        <a class="sortDir" href="#!" fieldname="categoriabrating">Migliori categorie<br>BRating</a>
    ...
    <!-- WRAPPER -->
    <div id="fesRicercaCont" style="display:none">
        <div class="filettoGenericoVerticale">
            <div class="filettoGenericCorner">
                <div class="paddMedium">
			    	<h2 class="titRic">Categoria BRating: <span class="catFondo"></span> (<span class="numFondi"></span>)</h2>
					<br class="clear" />
...
<script type="text/javascript" src="/wscmn/fe/js/noresp_priv_fes_top_flop.js"></script>
<script type="text/javascript" src="/wscmn/fe/js/noresp_priv_fes_ricerca.js"></script>
...
var fesConf = {
	   ...
	   "codSocieta":{
	      "1":{
	         "img":"/wscmn/img/ret/img_or_S-allianz.gif",
	         "nome":"Allianz Global Investors Lux."
	      },
	      "2":{
	         "img":"/wscmn/img/ret/img_or_prima_new.gif",
	         "nome":"Anima Prima Funds Plc"
	      },
	      "3":{
	         "img":"/wscmn/img/ret/img_or_S-anima_new.gif",
	         "nome":"Anima Sgr Spa"
	      },
	      "4":{
	         "img":"/wscmn/img/ret/img_or_S-Blackrock.gif",
	         "nome":"BlackRock (Luxembourg) S.A."
	      },
	      "5":{
	         "img":"/wscmn/img/ret/img_or_S-carmignac_fondi.gif",
	         "nome":"Carmignac Gestion"
	      },
	      "6":{
	         "img":"/wscmn/img/ret/img_or_S-carmignac_port.gif",
	         "nome":"Carmignac Portfolio Sicav"
	      },
	      "7":{
	         "img":"/wscmn/img/ret/img_or_S-dws.gif",
	         "nome":"Dws Investments Sa"
	      },
	      "8":{
	         "img":"/wscmn/img/ret/img_or_S-epsilon.gif",
	         "nome":"Epsilon Sgr Spa"
	      },
	      "9":{
	         "img":"/wscmn/img/ret/img_or_S-etica.gif",
	         "nome":"Etica Sgr Spa"
	      },
	      "10":{
	         "img":"/wscmn/img/ret/img_or_S-Eurizon.gif",
	         "nome":"Eurizon Capital Sgr Spa"
	      },
	      "11":{
	         "img":"/wscmn/img/ret/img_or_S-fidelity.gif",
	         "nome":"Fidelity Investments Lux. S.A."
	      },
	      "12":{
	         "img":"/wscmn/img/ret/img_or_S-Franklin.gif",
	         "nome":"Franklin Templeton Inv. Sicav"
	      },
	      "13":{
	         "img":"/wscmn/img/ret/img_or_S-JPMorganAM.gif",
	         "nome":"JPMorgan Funds"
	      },
	      "14":{
	         "img":"/wscmn/img/ret/img_or_S-JPMinv.gif",
	         "nome":"JPMorgan Investment Funds"
	      },
	      "15":{
	         "img":"/wscmn/img/ret/img_or_MG.gif",
	         "nome":"M&G Global"
	      },
	      "16":{
	         "img":"/wscmn/img/ret/img_or_S-morganstanley.gif",
	         "nome":"Morgan Stanley Investment Fund"
	      },
	      "17":{
	         "img":"/wscmn/img/ret/img_or_S-pictet.gif",
	         "nome":"Pictet Funds (Europe) S.A."
	      },
	      "18":{
	         "img":"/wscmn/img/ret/img_or_S-pimco.gif",
	         "nome":"Pimco Funds Gl.Inv. Series Plc"
	      },
	      "19":{
	         "img":"/wscmn/img/ret/img_or_S-schroeder.gif",
	         "nome":"Schroder Int. Selection Fund"
	      },
	      "20":{
	         "img":"/wscmn/img/ret/img_or_JB.gif",
	         "nome":"Swiss & Global AM Lux SA"
	      },
	      "21":{
	         "img":"/wscmn/img/ret/img_or_S-threadneedle.gif",
	         "nome":"Threadneedle Management Lux SA"
	      },
	      "22":{
	         "img":"/wscmn/img/ret/img_or_S-invesco.gif",
	         "nome":"Invesco Stacked"
	      }
	   },
	   "fondoSicav":{
	      "F":{
