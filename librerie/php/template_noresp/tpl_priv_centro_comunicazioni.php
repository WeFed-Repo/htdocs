...
<!-- INIZIO CODICE--> 
	   ...
	   <div class="boxnews"> 
        <div class="riassunto"> 
          <p class="alto"><a href="javascript:MM_showBoxNews('boxnews1');">Messaggio 1</a><br>
		  <span class="comunicaz_data">del 18-08-2007</span></p>
          <p class="basso">Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt </p>
          <div id="boxnews1esteso" class="esteso"> 
      ...
      <div class="boxnews"> 
        <div class="riassunto"> 
          <p class="alto"><a href="javascript:MM_showBoxNews('boxnews2');">Messaggio 2</a><br>
		  <span class="comunicaz_data">del 15-08-2007</span></p>
          <p class="basso">Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt </p>
          <div id="boxnews2esteso" class="esteso"> 
            <p>Sed ut perspiciatis, unde omnis iste natus error sit voluptatem 
              accusantium doloremque laudantium, totam rem aperiam eaque ipsa, 
              quae ab illo inventore veritatis et quasi architecto beatae vitae 
              dicta sunt, explicabo. Nemo enim ipsam voluptatem, quia voluptas 
      ...
      <div class="boxnews"> 
        <div class="riassunto"> 
          <p class="alto"><a href="javascript:MM_showBoxNews('boxnews3');">Messaggio 3</a><br>
		  <span class="comunicaz_data">del 10-08-2007</span></p>
          <p class="basso">Lorem ipsum dolor sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt </p>
          <div id="boxnews3esteso" class="esteso"> 
            <p>Sed ut perspiciatis, unde omnis iste natus error sit voluptatem 
              accusantium doloremque laudantium, totam rem aperiam eaque ipsa, 
              quae ab illo inventore veritatis et quasi architecto beatae vitae 
              dicta sunt, explicabo. Nemo enim ipsam voluptatem, quia voluptas 
