<?php 
	// Raccolta "framework"
	virtual("/librerie/php/core/wbresp_functions.php"); 

	// Inizializzazioni e variabili esterne  
	$templatePath = "/librerie/template_wbresp/";
	$tpl = $_GET["tpl"];
...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <?php else: ?>
		<!-- LOGIN -->
		<?php virtual("/librerie/include/struttura_wbresp/barra_login.php"); ?>
	    <!-- FINE LOGIN -->
		
		<!-- NAVIGATORE  -->
		<?php virtual("/librerie/include/struttura_wbresp/nav.php"); ?>
	    <!-- FINE NAVIGATORE -->
    <?php endif; ?>
    ...
    <?php if (!$isHp && !$isHpCms) { ?>
    	<?php if (!$isAOL): ?>
			<!-- BARRA DEL TITOLO -->
			<?php virtual("/librerie/include/struttura_wbresp/barra_titolo.php"); ?>
			...
			<div class="container">
				...
				<!-- LAYOUT A 3 COLONNE -->
					...
					<div class="col-lg-2 col-md-12 col-sm-12">
						<!-- Template nav -->
							<?php virtual("/librerie/include/struttura_wbresp/sub_nav.php"); ?>
						<!-- Fine template nav -->
					</div>
					<?php } ?>
					...
					<div class="<?php print $contclass;?> col-md-12 col-sm-12">
						<!-- Template contatti -->
							<?php virtual("/librerie/php/template_wbresp/".$tpl); ?>
					...
					<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 widget-container">
						<!-- Colonna di destra -->
						<?php virtual("/librerie/include/struttura_wbresp/promo.php"); ?>
						<!-- Colonna di destra -->
					</div>
	...
	<?php if ($isAOL): ?>
		<!-- FOOTER -->
		<?php virtual("/librerie/include/struttura_wbresp/footer.php"); ?>	
	    <!-- FINE FOOTER -->
    <?php else: ?>
		<!-- FOOTER -->
		<?php virtual("/librerie/include/struttura_wbresp/footer.php"); ?>	
