			...
			<div id="<?php print$idCar?>" class="slide greenarrows carousel-moveplus"  data-interval="false">
				...
				<div class="item active item01">
					<div class="row">
						...
						<div class="col-md-6 col-xs-12 text-align-center <?php print$invertiColDx?> hidden-xs">
							<img src="/wbresp/img/conto_webank/conto_webank-b6-1.png" class="img-responsive" alt="" title="">
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
							<h5 class="titolo">Lorem ipsum!</h5>
							<p>Lorem ipsum dolor sit amet, consectetur <strong>adipiscing elit</strong>, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lorem ipsum dolor</p>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-12">
