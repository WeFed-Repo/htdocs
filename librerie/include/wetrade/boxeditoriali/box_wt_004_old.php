...
addEvent(window, 'load', function() {
	createSelectRapp('sceltaRapporto');
	createSelectRapp('sceltaSottoRapporto');
});
		...
		<tr>
			...
			<td class="rappWt">
				<div id="sceltaRapporto" class="selectRapp">
					<input type="hidden" class="value" name="rapporto" value="xxx/aaaaaa"/>
		...
		<tr>
			...
			<td class="rappWt">
				<div id="sceltaSottoRapporto" class="selectRapp">
					<input type="hidden" class="value" name="sottorapporto" value="xxx/aaaaaa"/>
					<a href="javascript:;" class="inputOption inputSx">
						<span class="inputDx">
							<span class="input">
								xxx/aaaaaa
