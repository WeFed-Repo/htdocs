			...
			<div class="row hidden-xs hidden-sm no-gutter-left">
				...
				<div class="col-md-9">
					<div class="userMenu">
						...
						<?php if($bank=="bpm") { ?>
							<li><a class="userMenuLink telLink" href="tel:800880088"><i class="icon icon-numeroverde_desktop"></i><span class="userMenuLabel">800 880 088</span></a></li>
						<? } 
						if($bank=="webank") { ?>
						...
						<? }						
						if($bank=="bm") { ?>
							<li><a class="userMenuLink telLink" href="tel:800134135"><i class="icon icon-numeroverde_desktop"></i><span class="userMenuLabel">800 134 135</span></a></li>
						<? } ?>
							...
							<li><a class="userMenuLink" href="#"><i class="icon icon-esci_desktop"></i><span class="userMenuLabel">Esci</span></a></li>
						</ul>
			...
			<div class="headerMobile">
				<div class="row hidden-md hidden-lg no-gutter">
					<div class="col-xs-2">
						...
						<a class="headbtn logoicon hidden-xs" href="#"><img src="/fe/img/logo_small.png" /></a>
					</div>
					<div class="col-xs-8">
