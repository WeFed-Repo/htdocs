...
<h4>Tabella con ordinamento e paginazione</h4>
 <table id="tableOrdered" cellspacing="0" cellpadding="0" border="0" class="sortableTable table-evident">
     <thead>
        <tr>
            <th data-field="descrizione" data-sortable="true">Descrizione</th>
            <th data-field="operativita" data-sortable="true">Operativit&agrave;</th>
