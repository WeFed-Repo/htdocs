...
<table id="data-grid-movimenti" cellspacing="0" cellpadding="0" border="0" class="sortableTable mov" data-unique-id="id">
	<thead>
      <tr>
        ...
        <th data-field="VTa" data-sorter="fixDate" data-sortable="true" class="center hidden-xs">Data valuta</th>
        <th data-field="descB" data-formatter="setDetailsFormat" data-sortable="true" class="left hidden-xs">Descrizione</th>
  			<th data-field="val" data-formatter="setEntrate" data-sortable="true" class="right hidden-xs">Entrate</th>
  			<th data-field="val" data-formatter="setUscite" data-sortable="true" class="right hidden-xs">Uscite</th>
  ...
  <tfoot>
    <tr class="totali">
        ...
        <td class="hidden-xs no-border-left"></td>
        <td id="totMovEnt" class="right bgWhite"></td>
        <td id="totMovUsc" class="right bgWhite"></td>
        <td colspan="2" class="hidden-xs bgWhite brdWhite"></td>
    </tr>
     <tr class="totali">
