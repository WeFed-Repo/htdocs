    ...
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          Titolo: si posiziona su pi&ugrave; righe quando l'accordion &egrave; aperto e il titolo &egrave; molto lungo<i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i>
        </a>
      </h4>
    </div>
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        <p class="sottotitolo">Stottotitolo (opzionale): utilizzarlo per sottotitoli, note, date</p>
        ...
        <div class="imgWrapperResponsive">
          <img src="/wscmn/img/img_str_responsive.jpg">
        </div>
