...
<div id="fixedtools"  class="fixedconsoletools">
	<div class="console" id="toolconsole">
		...
		<div class="contTool" style="display:none;">
			<span class="consoletooltip"><span></span><img src="/img/ret/str_console_tooltip_right.gif" /></span>
		</div>
		<!-- TOOLTIP -->
		
		<img src="/wscmn/img/str_toolbox_chat_bus.gif" class="consoletoolTop" /><div id="c2mToolbar"></div>
		<a href="javascript:;" onclick="opentool(2)" class="tooltcons toolrecall"></a>
		<a href="javascript:;" href="#1" class="tooltcons toolmail"></a>
		<a href="javascript:;" href="#2" class="tooltcons toolsafety"></a>
