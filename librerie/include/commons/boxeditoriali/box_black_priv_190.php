...
<table class="form01">		
	<tr><td class="uno" >Lorem ipsum dolor lorem ipsum</td>
...
<div id="boxCompPremContainer">
	...
	<div class="verde">
		...
		<div class="operaz_premi_middle">
			...
			<table class="dettHidden"><tr><td>
						<ul>
							<li>Per importo addebitato si intende quanto speso nel mese con il bancomat e quanto addebitato nello stesso mese per l’utilizzo della carta di credito (dunque per spese fatte nel mese precedente)</li>
	...
	<div class="boxCompPremBottom">
		...
		<h2>RISULTATO MESE DI LUGLIO: <br />Complimenti hai centrato <span>3</span> obiettivi su <span>5</span><br /><a href="#">Scopri il tuo premio</a></h2>
		<img src="/img/ret/img_or_comportamenti_premianti.gif" alt="" />
		</div>
