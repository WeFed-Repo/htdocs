...
?>var menuData = [
	...
	"voices":[
		...
		"voices":[
			...
			"link":"tpl_responsive_ricerca_titoli_generica.php",
			"responsive":true,
			"voices":[                          
				{
				"title":"Generica",
			...
			{
			"title":"Scheda titolo [in lavorazione]",
			"link":"tpl_responsive_trading_scheda_titolo.php",
			"responsive":true
			}
		]
		},
		...
		"voices":[
			...
			"voices":[                          
				{
				"title":"Overview sui mercati [in lavorazione]",
				"link":"tpl_responsive_overview.php",
				"responsive":true
				},
				{
				...
				{
				"title":"News",
				"link":"tpl_responsive_overview_news.php",
				"responsive":true
				}
			]
			},
			...
			"voices":[                          
				...
				{
				"title":"News",
				"link":"tpl_responsive_derivati_news.php",
				"responsive":true
				}
			]
			},
	...
	"voices":[
		...
		"voices":[
			...
			"voices": [
				...
				,
					{
					"title":"Collocamenti",
					"link":"tpl_responsive_collocamenti.php",
					"responsive": true
					}
				]
			},
		...
		"voices":[
			...
			"voices": [
				...
				"link":"tpl_responsive_fes_topandflops.php",
				"responsive":true
				},
				{
			...
			"voices":[
				...
				{
				"title":"Confronta",
				"link":"tpl_responsive_inv_ricerca.php&confronta=123|456",
				"responsive":true
				},
				{
				"title":"Scheda fondo",
