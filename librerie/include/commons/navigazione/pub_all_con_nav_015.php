...
<ul class="context_nav">
	...
	<li><a href="/connect.php?page=str_interna_pub.php&tpl=tpl_pub_help_center_strumenti_glossario.php" <?php if ($tpl=="tpl_pub_help_center_strumenti_glossario.php") { ?>class="selected_item"<?php } ?>>Glossario</a></li>
</ul>
<?php
		break;
