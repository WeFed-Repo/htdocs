...
var pacSimulatore = (function() {
    ...
    function loadChartDataSimPac() {
        var chartDataUrl = isLibrerieOK ? libreriePath + "/fdaSimPac.php" : cgi_script + "/investimenti/GraficoSimPac.action",
            codicifida = [],
            importiiniziali = [],
            importi = [],
            paramsBase = {
    ...
    function initForms() {
        var showBuyPacUrl = isLibrerieOK ? "/connect.php?page=strutt_priv.php&tpl=tpl_priv_fes_pac_acquisto.php&responsive=y&liv0=4&liv1=2&liv2=4&liv3=1" : "SimCartPAC.action?OBSCNT=FNZ_NAV&tabId=nav_priv_wbx_investimenti&OBSKEY=nav_priv_wbx_pacsimulatore",
            dateFrom = $("#dateFrom"),
            dateTo = $("#dateTo");
