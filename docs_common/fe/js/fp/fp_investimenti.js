$(function () {
	var tickerImgArr = [
		    ...
		    '<li><img src="/wscmn/img/ret/logo_sliderfp2.gif" alt ="J. P. Morgan"></li>',
		    '<li><img src="/wscmn/img/ret/logo_sliderfp3.gif" alt ="Epsilon Sgr"></li>',
		    '<li><img src="/wscmn/img/ret/logo_sliderfp4.gif" alt ="Schroders"></li>',
