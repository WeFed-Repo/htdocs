...
if (!is4s)
{
	fesFondoUrl = (!isLib)? cgi_script + "/investimenti/SchedaFondo.action" : "/librerie/include/commons/ajax/fes_scheda_fondo_resp.php";
				...
				$("a[data-int-id]").click(function(e){
					...
					if ($(this).is("*[data-toggle='collapse']")) {
						if ($(this).parents(".panel").children(".panel-collapse").hasClass("in")) {
							// Blocca la chiusura dei pannelli già aperti
							e.stopPropagation();
						}
						else
						{
