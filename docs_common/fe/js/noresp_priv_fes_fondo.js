/*globals $:false, cgi_script:true, is4s:true, isLib:false, switchTab:false, newTabSelected:false,
    alert:false, ttSet:false, societa:false, cfam:false, fesPlotGraph:false, dati_sintesi:false,
    graphBankColor:false, getBank:false, nome_indice:false, data_assetallocation:false,
    dati_graficofondo:false, dati_distribuzione:false, dati_settori:false, dati_topten:false,
    dati_esposizione:false, codSocieta:false, newTabOn:false, newTabOff:false,
     fesRicStarted:false, fesRicShow:false */
/*exported graphColors, fesFondoStart */
"use strict";
// Indirizzo di base della scheda fondo
var fesFondoUrl, fesTempisticheUrl, fesGestioneUrl, fesFondoWrap;
...
function fesFondoShow(params) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var gNoDisp = $("<div>").html("Grafico non disponibile").addClass("gNoDisp");
            ...
            var fondoViewData = function() {
                ...
                switch ($(this).attr("data-tabid")) {
                    ...
                    case "2":
                        ...
                        $.each(dati_graficofondo, function() { isDataEmpty = false; });
                        if (!isDataEmpty) {
                            // Crea gli elementi del grafico e li popola
                            var gSpace = $("<div>").attr({ "id": "grafico_fondo_space" });
                            // Select
                            var gSelect = $("<select>");
                            $.each(dati_graficofondo, function(k) {
            ...
            $(".fesBackRicerca").html("Indietro");
            $(".fesBackRicerca").click(function() {
                ...
                if (typeof fromPage !== "undefined" && fromPage !== "") {
                    ...
                    $("#fromPage").val("");
                    fesFondoWrap.hide();
                    if ((typeof pageType !== "undefined" && (pageType !== "") || fesRicStarted)) {
                        $("#fesRicWrap").show();
                    } else {
                        fesRicShow();
                    }
