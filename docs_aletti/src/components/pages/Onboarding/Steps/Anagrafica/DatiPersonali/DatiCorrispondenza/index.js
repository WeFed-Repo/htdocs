                ...
                hasErrors={
                    CheckAccordionErrors(this.props.formstate.errors,
                        [
                            ...
                            this.props.anagraficaIntestatario + "comunecorrisp",
                            this.props.anagraficaIntestatario + "capcorrisp"
                        ])}
            >
                    ...
                    <Row>
                        <Col xs="4">
                            <Form.select
                                ...
                                cbchange={(val) => {
                                    if (val === "") {
                                        this.props.formstate[this.props.anagraficaIntestatario + "comunecorrisp"] = "";
                                        this.props.formstate[this.props.anagraficaIntestatario + "capcorrisp"] = ""
                                    }
                                }}
                        ...
                        {this.props.formstate[this.props.anagraficaIntestatario + "provinciacorrisp"] !== "" &&
                            <>
                                <Col sm="6">
                                    <Form.select
                                        label="Comune*"
                                ...
                                <Col xs="2">
                                    <Form.input
                                        label="Cap corrisp*"
                                        name={this.props.anagraficaIntestatario + "capcorrisp"}
                                        value={this.props.formstate[this.props.anagraficaIntestatario + "capcorrisp"]}
                                        error={this.props.formstate.errors[this.props.anagraficaIntestatario + "capcorrisp"]}
                                        onChange={this.props.obchange}
                                        placeholder=""
                                        mask="numero"
                                    ></Form.input>
