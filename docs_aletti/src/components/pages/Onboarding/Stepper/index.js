        ...
        stepObj.push(
            {
                ...
                {
                    name: "INT"+  primocomp +"_CERTIF_CREDENZIALI",
            ...
            {
                owner: primocompel,
                status: (avanzamento["INT"+ primocomp  +"_FIRMA_TUB"].status==="corrente" || avanzamento["INT"+ primocomp  +"_FIRMA_VESSATORIE_TUB"].status==="corrente"
                ||(form.field_sessionfirmeblob_depositoincluso==="true" && (avanzamento["INT"+ primocomp  +"_FIRMA_TUF"].status==="corrente" || avanzamento["INT"+ primocomp  +"_FIRMA_VESSATORIE_TUF"].status==="corrente"))
                )? "attivo":"",
                steps: (()=>{
                    let stepFirma = [
            ...
            {
                owner: <>Prom.<br />finan.</>,
                status: (avanzamento["INT"+ primocomp  +"_ATTESA_FIRMA_CONSULENTE"].status==="corrente" || (nint === "1" && avanzamento["CONCLUSA"].status==="corrente"))? "attivo":"",
                steps: (()=>{
                    ...
                    // In caso di mono intestatario chiude qui la pratica
                    if (nint === "1")
                    firmaCons.push({
                        name: "CONCLUSA",
