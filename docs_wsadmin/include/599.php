<h3>Titolo della pagina</h3>
		...
		<div class="boxleftinput" id="elementoCaricamento">	
			<table class="inputtableb" cellpadding="0" cellspacing="0">	
				...
				<tr>
					<td>
					<fieldset>
						<input type="radio" class="radiofl" />
						<label>Cognome e Nome</label>
						<input type="text" size="50"/>
					</fieldset>
					<fieldset>
						<input type="radio" class="radiofl" />
						<label>Rapporto <span class="pic">(agenzia / numero)</span></label>
						<div class="wrapper">
							<select/>
		...
		<div class="boxrightinput">	
			<table class="inputtableb" cellpadding="0" cellspacing="0">	
				<tr>
					<th colspan="3">Shortcut:</th>
				</tr>
				<tr>
					<td>C. CORRENTE
						<ul>
							<li><a href="#" title="da azzerare">da azzerare</a></li>
							<li><a href="#" title="da liquidare">da liquidare</a></li>
							<li><a href="#" title="da estinguere">da estinguere</a></li>
							<li><a href="#" title="iban mancante">iban mancante</a></li>
							<li><a href="#" title="sospesi">sospesi</a></li>
							<li><a href="#" title="attesa estinz .serv">attesa estinz .serv</a></li>
						</ul>					
					</td>	
					<td>C. DEPOSITO
						<ul>							
