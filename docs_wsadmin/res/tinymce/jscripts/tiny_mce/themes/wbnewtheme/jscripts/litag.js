...
function init() {
	...
	document.getElementById('hrefbrowsercontainer').innerHTML = getBrowserHTML('hrefbrowser','href','file','theme_wbnewtheme_link');
	...
	document.forms[0].lilabel.value = tinyMCE.getWindowArg('lilabel');
	document.forms[0].insert.value = tinyMCE.getLang('lang_' + tinyMCE.getWindowArg('action'), 'Insert', true); 

	addClassesToList('styleSelect', 'theme_wbnewtheme_link_styles');
...
function insertLitag() {
	...
	var lilabel = document.forms[0].lilabel ? document.forms[0].lilabel.value : "";
	var dummy;
	...
	tinyMCE.themes['wbnewtheme']._insertLitag(href, target, title, dummy, lilabel);
	tinyMCEPopup.close();
}
