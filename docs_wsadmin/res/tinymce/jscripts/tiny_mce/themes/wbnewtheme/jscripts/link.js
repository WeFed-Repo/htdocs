...
function insertLink() {
	...
	var style_rel = document.forms[0].relSelect ? document.forms[0].relSelect.value : "";
	var dummy;
	...
	tinyMCE.themes['wbnewtheme']._insertLink(href, target, title, dummy, style_class, style_rel);
	tinyMCEPopup.close();
}
