...
var TinyMCE_WbnewthemeTheme = {
	...
	_buttonMap : 'bold,italic,underline,strikethrough,undo,redo,cleanup,link,unlink,litag,code,tooltip,justifyleft,justifycenter,justifyright,justifyfull,macroselect',
          ...
          switch (macroID)
          {
            case "baloon":
              ...
              if (selectedText.length > 0)
                html = html.replace(selectedText, ('[baloon]' + selectedText + '[/baloon]'));
			...
			case "mceLink":
				...
				if (inst.settings['insertlink_callback']) {
					...
					if (returnVal && returnVal['href']) {
						TinyMCE_WbnewthemeTheme._insertLink(returnVal['href'], returnVal['target'], returnVal['title'], returnVal['onclick'], returnVal['style_class'], returnVal['style_rel']);
					}
				} else {
		...
		switch(layoutManager) {
			case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
				...
				var defVals = {
					...
					theme_wbnewtheme_buttons2 : "bullist,numlist,separator,outdent,indent,separator,undo,redo,separator,link,unlink,anchor,image,cleanup,help,code",
