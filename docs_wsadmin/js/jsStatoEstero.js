...
function InviaDati() { //v2.0
 ...
 var dimensione = document.FormStati.PPStatoEstero.value.length;
 if ( dimensione <= 1)
  {
   it_alert_error('MSG-00032');
   document.FormStati.PPStatoEstero.focus()
  }
 else
  { 
    document.FormStati.PStatoEstero.value = ControllaLocalita(document.FormStati.PPStatoEstero.value);
    document.FormStati.submit(); 
  }		 
}
//--------------------------------------------------------------------------------------------------
