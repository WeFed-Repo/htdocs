...
<section>
	<h3>Lverage securutised derivatives</h3>
	<p>I leverage securitised derivatives consentono al portatore di partecipare, con un impiego di capitale relativamente basso, alle variazioni di prezzo dell'attivit&agrave; sottostante in misura più che proporzionale; la performance del sottostante viene cioè amplificata al rialzo (consentendo all'investitore di ottenere rendimenti anche molto elevati), o al ribasso (esponendo l'investitore anche alla perdita dell'intero capitale). Questi strumenti si adattano maggiormente ad investitori con una buona preparazione tecnico-finanziaria che tendono ad avere una strategia di investimento più speculativa ed un orizzonte temporale mediamente di breve periodo.</p>
	<h3>Investment securutised derivatives</h3>
	<p>Gli investment securitised derivatives invece costituiscono, sia in termini di capitale investito che in termini di rischio, un'alternativa diretta all'investimento nel sottostante: in questa categoria sono cosÌ ricompresi i securitised derivatives che replicano la performance del sottostante (vantaggiosa in caso di sottostanti altrimenti difficilmente raggiungibili da investitori privati quali ad esempio indici, future sul petrolio, oro o argento) ma anche quelli che permettono la realizzazione di strategie di investimento più complesse (ad esempio strategie con protezione parziale o totale del capitale investito oppure preposte all'ottenimento di una performance migliore del sottostante stesso in particolari condizioni di mercato). Questi strumenti rispondono a logiche di investimento più conservative e orientate al medio-lungo termine. Al fine di consentire agli investitori una chiara informativa sulle caratteristiche degli strumenti finanziari negoziati su SEDEX, Borsa Italiana prevede una segmentazione del mercato che, pur non presentando differenze nelle modalità di negoziazione tra i diversi segmenti, ripartisce i securitised derivatives in classi omogenee per tipologia di prodotto e finalità d'investimento.</p>
	<h3>Scala di certificates</h3>
	<section>
		<div style="width: 100%;background-color: red;text-align: center;padding:30px;margin-bottom:20px">
			ELEMENTO SCALA DEI CERTIFICATES DA DISEGNARE
		</div>
		<p>
			La scala dei certificates permette di riassumere il grado di protezione del certificato in caso di ribasso del mercato e il grado di partecipazione dello stesso nei confronti dell'andamento del mercato.<br>
			<strong>Clicca sul nome di un certificates per accedere alla sezione di compravendita.</strong>
		</p>
	</section>
</section>
<section>
