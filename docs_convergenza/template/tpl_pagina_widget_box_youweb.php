...
<!-- SEMPRE AL TUO FIANCO -->
 ...
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/HT/fe/img/youapp/13_assistenza.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
...
<!-- NUOVI MODI DI INTERAGIRE CON L’APP -->
 ...
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/HT/fe/img/youapp/02_navigazione.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
        <h3>Nuovi modi di interagire con l'app</h3>
        <p>Per utilizzare YouApp bastano pochi e semplici gesti.</p>
...
<!-- COME FARE UN BONIFICO -->
 ...
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/HT/fe/img/youapp/04_fare_bonifico.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
...
<!-- PORTAFOGLIO PER PRODOTTI POSSEDUTI E ASSET CLASS -->
 ...
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/HT/fe/img/youapp/09_portafoglio.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
