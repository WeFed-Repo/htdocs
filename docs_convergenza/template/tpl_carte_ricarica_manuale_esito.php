		...
		<div class="row">
			<div class="col-sm-12">
				<div class="messagePanel success hidden-print">
					<div>
						<h3>Ricarica eseguita</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem, quam quidem vel enim maiores. Nihil animi quis, quisquam vero quidem laudantium! Ut tempora quaerat pariatur quos facere error quod id!</p>
					</div>
				</div>
			</div>
		</div>
