    ...
    <div id="tabVincoli" class="navContSecondLev">
        <div class="outerTab">
            <ul class="tabWrapper tabsmall hidden-xs">
                <li id="tabVinc1"><a href="javascript:">Linee attive</a></li>
                <li id="tabVinc2"><a href="javascript:">Attiva nuova linea</a></li>
            </ul>
        </div>
	            ...
	            <div id="contentVinc1" class="panel-collapse collapse" role="tabpanel">
	                <div class="panel-body">
	                    <div class="tab-wrap">
				                        ...
				                        <div class="panel-heading" role="tab" id="headingLVNote">
				                            <h4 class="panel-title">
				                                <a class="collapsed" data-toggle="collapse" href="#collapseLVNote" aria-expanded="false" aria-controls="collapseLVNote">
				                                  Imposte e oneri fiscali applicati alle somme vincolate<i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i>
				                                </a>
				                            </h4>
				                        </div>
								...
								<div class="row">
									<div class="col-sm-12 col-md-5">
										<div class="form-output-aligned">
											<span class="control-label">Totale vincolato</span>
							...
							<section>
								<h4 class="strongTitle">Dettaglio linee</h4>
								<form class="formGenerico borderFormRounded searchFilter" role="form" id="form08">
									<div class="form-group">
										<div class="row">
											<div class="col-sm-4">
												<label class="control-label" for="scadenzaLvDa">Apertura</label>
									            <div class="form-inline">
									                <div class="input-group">
									                    <input type="text" id="scadenzaLvDa" placeholder="gg/mm/aaaa" value="" class="form-control clear-x"><a class="input-group-addon date btn-icon" href="javascript:"><i class="icon icon-calendar_filled"></i></a>
									                </div>
									            </div>
											</div>
											<div class="col-sm-4">
												<label class="control-label" for="scadenzaLvA">Scadenza</label>
									            <div class="form-inline">
									                <div class="input-group">
									                    <input type="text" id="scadenzaLvA" placeholder="gg/mm/aaaa" value="" class="form-control clear-x"><a class="input-group-addon date btn-icon" href="javascript:"><i class="icon icon-calendar_filled"></i></a>
									                </div>
									            </div>
											</div>
										</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-4">
												<label class="control-label" for="mesiLVfiltro">Vincolo</label>
												<select class="form-control" name="mesi" id="mesiLVfiltro">
													<option value="">- - -</option>
												</select>
											</div>
											<div class="col-sm-4">
												<label class="control-label" for="tassoLVfiltro">Tasso</label>
											...
											<div class="col-sm-4">
		                                        <div class="btnWrapper bottomZero">
		                                            <div class="btn-full">
		                                                <a type="button" href="javascript:" class="btn btn-primary" title="Imposta" id="filtraLV">Filtra</a>
		                                            </div>
		                                        </div>
											</div>
										</div>
                                ...
                                <table id="tabellaLV" data-toggle="table">
                                    <thead>
                                        <tr>
											<th class="right">N.</th>
											...
											<th class="center"><span class="lighText">Apertura</span><br>Disponibilit&agrave; somme</th>
                            ...
                            <section>
                                <div class="form-group btnWrapper">
                                    <div class="btn-align-left">
                                        <a type="button" class="btn btn-primary" href="javascript:" title="Esporta in Excel" id="boxExcelLV">Esporta in Excel</a>
                                    </div>
                                    <div class="btn-align-right">
                                        <a type="button" class="btn btn-primary" href="javascript:" title="Aumenta il tuo rendimento" id="aumentaRendimento">Aumenta il tuo rendimento</a>
										<a type="button" class="btn btn-primary" href="javascript:" title="Apri nuova linea" id="apriLineaVincolata">Apri nuova linea</a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <p class="note">
                                    I Totali delle voci Importo iniziale e Importo finale non includono
                                    eventuali linee vincolate in attesa di attivazione.
                                </p>
                            </section>
						</div>
					</div>
		        ...
		        <div id="contentVinc2" class="panel-collapse collapse" role="tabpanel">
	                <div class="panel-body">
	                    <div class="tab-wrap">
                            ...
                            <section>
                                <h4 class="strongTitle">1. Decidi quanto investire</h4>
                                <p>Scegli l'importo da vincolare.</p>
                            </section>

							<section>
                                <h4 class="strongTitle">2. Verifica la disponibilit&agrave;</h4>
                                <p>L'importo da vincolare sar&agrave; prelevato dal tuo deposito. Se il saldo non &egrave; sufficiente puoi fare un trasferimento dal conto corrente.</p>
								<div class="boxDispDep box-ria">
									...
									<div class="collapse" id="collapseDispDep">
										<div class="wrapDispDep">
											...
											<label class="control-label" for="importoCDLV">Versa sul deposito &euro;</label>
											<div class="row">
												<div class="col-sm-3">
			                ...
			                <section>
			                    <h4 class="strongTitle">3. Scegli la durata</h4>
			                    <p>Potrai <strong>svincolare</strong>, anche parzialmente,
									la linea <strong>prima</strong> della sua <strong>scadenza</strong> impostata:
									in questo caso <strong>l'importo sar&agrave; riaccreditato sul deposito</strong>
                                    e gli interessi calcolati al tasso del deposito libero (non a quello della linea vincolata).</p>
								
								<div id="importoNuovaLVwrap" class="form-group bottomZero">
									<div class="row">
										<div class="col-sm-3 requiredField">
											<label for="importoNuovaLV" class="control-label">Importo <span class="valuta"></span></label>
										...
										<div id="boxExtraMoney" class="row">
											<div id="boxExtraMoneyText" class="col-sm-6 col-md-7">
												<div class="wrapEM">
													...
													<a id="extraMoneyLink" title="Come funziona" href="javascript:" class="btn btn-em">Come funziona</a>
											...
											<div id="boxExtraMoneyInner" class="col-sm-6 col-md-5">
												<div class="wrapEM">
													...
													<hr class="sepEM1">
													<div class="infoEM">
														<div class="vincoloEM">Vincolo a <span class="mesiEM"></span> mesi</div>
													...
													<hr class="sepEM2">
													<div class="importoEM requiredField"><!--suppress HtmlFormInputWithoutLabel --><input type="text" class="inputManualeForm" id="importoNuovaEM" name="importoNuovaEM"></div>
													<div class="infoEM">
													...
													<div class="nuovaEMBox">
														<a id="nuovaEM" title="Apri ora" class="btn" href="javascript:">Apri nuova linea</a>
													</div>
												</div>
												<a id="helpEM" title="Clicca per vedere come &egrave; calcolata la disponibilit&agrave; ExtraMoney" href="javascript:"><i class="icon icon-help_filled"></i></a>
											</div>
										</div>
									</div>
								</div>
