            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="confermaContent1" class="confermaContent">
                        <section>
                            <p>
                                Stai per effettuare un trasferimento dal conto corrente al deposito<br/>
                                Ti invitiamo a lasciare, sul conto corrente,
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="confermaContent2" class="confermaContent">
                        <section>
                            <p>
                                Stai per effettuare un trasferimento dal conto corrente al deposito</p>
                        </section>
                        <form class="formGenerico output" role="form">
                            <!--RIGA DIVISA IN TRE CAMPI -->
                            <div class="form-group">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="confermaContent1a" class="confermaContent">
                        <section>
                            <p>
                                Stai per effettuare un trasferimento dal conto corrente alla liquidit&agrave; derivati<br/>
                                Ti invitiamo a lasciare, sul conto corrente,
                                <strong>la liquidit&agrave; sufficiente per coprire le spese</strong>
                                (imposta di bollo, addebiti carta di credito, etc..)</p>
                        </section>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="confermaContent2a" class="confermaContent">
                        <section>
                            <p>
                                Stai per effettuare un trasferimento dalla liquidit&agrave; derivati al conto corrente</p>
                        </section>
                        <form class="formGenerico output" role="form">
                            <!--RIGA DIVISA IN TRE CAMPI -->
                            <div class="form-group">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="confermaContent3" class="confermaContent">
                        <section>
                            <p>
                                Stai per eliminare un trasferimento periodico dal conto corrente al deposito</p>
                        </section>
                        <form class="formGenerico output" role="form">
                            <!--RIGA DIVISA IN TRE CAMPI -->
                            <div class="form-group">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="confermaContent4" class="confermaContent">
                        <section>
                            <p>
                             Stai per disporre un trasferimento periodico dal conto corrente al deposito.</p>
                        </section>
                        <form class="formGenerico output" role="form">
                            <!--RIGA DIVISA IN TRE CAMPI -->
                            <div class="form-group">
                    ...
                    <div id="confermaContent6" class="confermaContent">
                        ...
                        <section class="boxesitoWrap">
                            <div class="boxesito attenzione">
                                <div class="text">
                                    Ti ricordiamo che <strong>confermando l'operazione</strong> gli interessi maturati saranno liquidati
                                    <strong>al tasso del deposito libero</strong> e non a quello della linea vincolata.
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            <p>
                                <strong>Stai per svincolare questa linea prima della scadenza della durata impostata</strong>,
                                l'importo sar&agrave; riaccreditato sul deposito libero.</p>
                        </section>
                        ...
                        <form class="formGenerico output" role="form">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <label class="control-label">Data apertura</label>
                                        <span class="output"><span id="dataALV6"></span></span>
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="control-label">Data disponibilit&agrave; somme</label>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="confermaContent7" class="confermaContent">
                        <section>
                			<p>Stai impostando una nuova linea vincolata.<br/></p>
                        ...
                        <form class="formGenerico output" role="form">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="control-label" for="inputX7">
                            ...
                            <p class="note">
                                Le linee vincolate impostate in una giornata non lavorativa saranno attivate,
                                previa verifica della disponibilità dell'importo sul deposito libero, il primo giorno lavorativo successivo.<br>
                    ...
                    <section id="confermaResponse7" class="confermaResponse boxesitoWrap">
                        <div class="boxesito positivo confirmHead">
                            <div class="text">
                                <h4>Operazione inserita correttamente</h4>
                                <div class="messageResponse"></div>
                            </div>
                        </div>
                        <div class="boxesito attenzione warningHead">
                            <div class="text">
                                <h4>Operazione inserita correttamente</h4>
                                <div class="messageResponse"></div>
                            </div>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="confermaContent9" class="confermaContent">
                        <section class="box">
            				<p>Porta le tue coordinate bancarie sempre con te, stampa un documento PDF <br>con i tuoi dati del conto corrente.</p>
                        </section>
                        <div class="form-group btnWrapper">
                            <div class="btn-align-center">
...
<div style="display: none;">
    <div id="extramoneyinfo">
        <div class="formGenerico formResponsive">
            <div class="form-group">
                <label class="control-label" for="contoSelModal">Deposito</label>
