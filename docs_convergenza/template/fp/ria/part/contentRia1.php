<div id="contentRia1" class="tab-content contentRia formGenerico" style="display: none">
    ...
    <div id="dynamicBoxRisp">
        <div id="accordionSaldi" class="row">
                ...
                <div class="boxSaldoCT panel-group panel-group-ria panel-group-collapse">
                    <div class="panel panel-default panel-accordion">
                        <div class="panel-heading" id="saldiHeadingCT">
                            ...
                            <a class="expanded" href="javascript:">
                              Conto tecnico
                            </a>
                          </h4>
                        </div>
                                        ...
                                        <div class="col-xs-12">
                                            <span class="output output-icon">
                                                <span class="icon-group abs-right">
                                                    ...
                                                    --><a id="movimentiCT" href="javascript:" title="Invia per email" class="btn-icon"><i class="icon icon-movimenti_ria_filled icon-2x" title="Ultimi 10 movimenti"></i></a>
                                                </span>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body panel-body-accordion">
                                <div class="saldoGroup">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">
                                            <span class="saldoVal">
                                                <span id="margineCC"></span>&nbsp;<span class="valuta"></span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <span class="output output-icon">
                                    <span class="icon-group abs-right">
                                        ...
                                        --><a id="movimentiCC" href="javascript:" title="Invia per email" class="btn-icon"><i class="icon icon-movimenti_ria_filled icon-2x" title="Ultimi 10 movimenti"></i></a>
                                    </span>
                                </span>
                            </div>
                        </div>
                                    ...
                                    <div class="col-xs-12">
                                        <span class="output output-icon">
                                            <span class="icon-group abs-right">
                                                ...
                                                --><a id="movimentiCD" href="javascript:" title="Invia per email" class="btn-icon"><i class="icon icon-movimenti_ria_filled icon-2x" title="Ultimi 10 movimenti"></i></a>
                                            </span>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="panel-wrap">
                                    ...
                                    <div class="btnWrapper saldoButton">
                                        <div class="btn-align-left">
                                            <a type="button" class="btn btn-primary" id="linkCondizioniCD" href="javascript:" title="Tutte le condizioni">Tutte le condizioni</a>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                    <!-- /Questa parte si carica solo all'espansione del box di C/C -->
            ...
            <div class="col-sm-12 col-md-6">
                <div id="boxSaldoCDER1" class="boxSaldoCDER hidden-sm panel-group panel-group-ria panel-group-collapse" role="tablist" aria-multiselectable="false">
                    <div class="panel panel-default panel-accordion">
                        <div id="saldiHeadingCDER1" class="panel-heading" role="tab">
                            <h4 class="panel-title">
                                <a class="collapsed" data-toggle="collapse" data-parent="#boxSaldoCDER1" href="#contentAccordion4a" aria-expanded="false" aria-controls="contentAccordion4a">
                            ...
                            <div class="panel-body panel-body-accordion">
                                ...
                                <div class="row last-row">
                                    <div class="col-xs-12">
                                        <span class="output output-icon">
                                            <span class="icon-group abs-right">
                                                <a href="javascript:" title="Dettagli" class="btn-icon dettaglioCDERLink"><i class="icon icon-zoom_ria_filled icon-2x" title="Dettagli"></i></a><!--
                                                --><a href="javascript:" title="Invia per email" class="btn-icon movimentiCDER"><i class="icon icon-movimenti_ria_filled icon-2x" title="Ultimi 10 movimenti"></i></a>
                                            </span>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div id="contentAccordion4a" class="panel-collapse collapse collapse-bottom" role="tabpanel" aria-labelledby="saldiHeadingCDER1">
                            <div class="panel-body panel-body-accordion">
                                <div class="panel-wrap">
                                    <hr class="accordion">
                        ...
                        <div id="contentAccordion3" class="panel-collapse collapse collapse-bottom" role="tabpanel" aria-labelledby="saldiHeadingLV">
                            <div class="panel-body panel-body-accordion">
                                <div class="panel-wrap">
                                    ...
                                    <div id="infoRichieste3" class="infoRichieste">
                                        <div class="row">
                                            <div class="col-sm-4 col-md-6">
                                                <a href="javascript:" id="boxLV1" class="boxTassoBox2b boxTassoBox1">
                                            ...
                                            <div class="col-sm-4 col-md-6">
                                                <a href="javascript:" id="boxLV2" class="boxTassoBox2b boxTassoBox1">
                                            ...
                                            <div class="col-sm-4 col-md-6">
                                                <a href="javascript:" id="boxLV3" class="boxTassoBox2b boxTassoBox2">
                                            ...
                                            <div class="col-sm-4 col-md-6">
                                                <a href="javascript:" id="boxLV4" class="boxTassoBox2b boxTassoBox2">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-12">
                                                <a href="javascript:" id="boxLV5" class="boxTassoBox2a boxTassoBox1 boxTassoPromo">
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                            <div class="icoTasso">
                                            ...
                                            <div class="col-sm-6 col-md-12">
                                                <a href="javascript:" id="boxLV6" class="boxTassoBox2a boxTassoBox1">
                                                    <div class="row">
                                                        <div class="col-xs-6">
                                                            <div class="icoTasso">
                                    ...
                                    <div class="btnWrapper saldoButton">
                                        <div class="btn-align-left">
                                            <a id="linkVediTutteLV" type="button" class="btn btn-primary btn-mostra" href="javascript:"><i class="icon icon-show"></i><span class="icon-text">Linee attive</span></a>
                                            <a id="altTextVediTutteLV" type="button" class="btn btn-primary btn-disabled btn-mostra" href="javascript:" style="display:none;"><i class="icon icon-show"></i><span class="icon-text">Linee attive</span></a>
                                        </div>
                                        <div class="btn-align-right">
                                            <a id="linkVediTutteLVBis" type="button" class="btn btn-primary btn-aggiungi" href="javascript:"><i class="icon icon-add"></i><span class="icon-text">Nuova linea</span></a>
                                            <a id="altTextVediTutteLVBis" type="button" class="btn btn-primary btn-disabled btn-aggiungi" href="javascript:" style="display:none;"><i class="icon icon-add"></i><span class="icon-text">Nuova linea</span></a>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
                ...
                <div id="boxSaldoCDER2" class="boxSaldoCDER hidden-md hidden-lg panel-group panel-group-ria panel-group-collapse" role="tablist" aria-multiselectable="false">
                    <div class="panel panel-default panel-accordion">
                        <div id="saldiHeadingCDER2" class="panel-heading" role="tab">
                            <h4 class="panel-title">
                                <a class="collapsed" data-toggle="collapse" data-parent="#boxSaldoCDER2" href="#contentAccordion4b" aria-expanded="false" aria-controls="contentAccordion4b">
                                  Liquidit&agrave; derivati<i class="icon icon-arrow_down"></i><i class="icon icon-arrow_up"></i>
                                </a>
                            </h4>
                        </div>
                        ...
                        <div id="contentAccordion4b" class="panel-collapse collapse collapse-bottom" role="tabpanel" aria-labelledby="saldiHeadingCDER2">
                            <div class="panel-body panel-body-accordion">
                                <div class="panel-wrap">
                                    <hr class="accordion">
                ...
                <div id="dashboardBanner">
                    <a href="javascript:" target="_blank">CELLETTA</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <h4 id="titleTrasferimento" class="btnPatr">Trasferimenti veloci</h4>

    <div id="tabTrasferimento" class="navContSecondLev">
        <div class="outerTab">
            <ul class="tabWrapper tabsmall hidden-xs">
                <li id="tabTrasferimento1"><a href="javascript:">Deposito</a></li>
                <li id="tabTrasferimento2"><a href="javascript:">Derivati</a></li>
            </ul>
        </div>
                            ...
                            <div id="trasferimentiBox1" class="row">
                                    ...
                                    <div class="riaTrasf riaTrasf1">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                ...
                                                <span class="dispVal visible-sm-inline-block"><a href="javascript:" class="dispTrasfCDLink"><span class="dispImp"></span>&nbsp;<span class="valuta"></span></a></span>
                                            </div>
                                            <div class="col-md-6 visible-md visible-lg">
                                                <span class="output dispVal"><a href="javascript:" class="dispTrasfCDLink"><span class="dispImp"></span>&nbsp;<span class="valuta"></span></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="riaTrasf riaTrasf2">
                                        <input type="hidden" id="dataDisposizione" />
                                        <div class="form-group requiredField">
                                            <label id="etichettaCC" for="importoCC" class="control-label">Versa sul conto corrente</label>
                                            <div class="riaTrasfInput">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <label class="dispLabel">Disponibilit&agrave;</label>
                                                <span class="dispVal visible-sm-inline-block"><a href="javascript:" class="dispTrasfCCLink"><span class="dispImp"></span>&nbsp;<span class="valuta"></span></a></span>
                                            </div>
                                            <div class="col-md-6 visible-md visible-lg">
                                                <span class="output dispVal"><a href="javascript:" class="dispTrasfCCLink"><span class="dispImp"></span>&nbsp;<span class="valuta"></span></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="trasferimentiBox2" class="row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="riaTrasf riaTrasf1">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <label class="dispLabel">Disponibilit&agrave;</label>
                                                <span class="dispVal visible-sm-inline-block"><a href="javascript:" class="dispTrasfCDERLink"><span class="dispImp"></span>&nbsp;<span class="valuta"></span></a></span>
                                            </div>
                                            <div class="col-sm-6 visible-md visible-lg">
                                                <span class="output dispVal"><a href="javascript:" class="dispTrasfCDERLink"><span class="dispImp"></span>&nbsp;<span class="valuta"></span></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="riaTrasf riaTrasf2">
                                        <input type="hidden" id="dataDisposizione" />
                                        <div class="form-group requiredField">
                                            <label id="etichettaCC2" for="importoCC2" class="control-label">Versa sul conto corrente</label>
                                            <div class="riaTrasfInput">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <label class="dispLabel">Disponibilit&agrave;</label>
                                                <span class="dispVal visible-sm-inline-block"><a href="javascript:" class="dispTrasfCC2Link"><span class="dispImp"></span>&nbsp;<span class="valuta"></span></a></span>
                                            </div>
                                            <div class="col-md-6 visible-md visible-lg">
                                                <span class="output dispVal"><a href="javascript:" class="dispTrasfCC2Link"><span class="dispImp"></span>&nbsp;<span class="valuta"></span></a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- popup movimenti -->
    <?php include("popUpMovimenti.php") ?>
    <!-- /popup movimenti -->
</div>
