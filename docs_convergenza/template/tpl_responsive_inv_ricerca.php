...
<script type="text/javascript" src="/common/fe/assets/amcharts/serial.js"></script>
<script type="text/javascript" src="/common/fe/js/priv_fes_resp.js"></script>
<script type="text/javascript" src="/common/fe/js/priv_fes_ricerca_resp.js"></script>
...
var fesConf = {
	   ...
	   "codSocieta":{
	   		 ...
	   		 <?php virtual("/include/ajax/fes/obj_societa_gestione.php"); ?>
	   },
	   "fondoSicav":{
	      "F":{
	         "nome":"Fondo"
