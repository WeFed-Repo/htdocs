                ...
                <?php endif; ?>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6">
                                    <label for="iban_int<?php print ($key +1 ) ?>">IBAN*</label>
                                    <input type="text" id="iban_int<?php print ($key +1 ) ?>" name="iban_int<?php print ($key +1 ) ?>" class="textinput form-control" placeholder="Inserisci il codice IBAN">
                                </div>
                            </div>
                            ...
                            <div class="modulo-doc sidocumento" style="display:none">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label for="stato_emissione_int<?php print ($key +1 ) ?>">Paese di rilascio*</label>
                                        <select name="stato_emissione_int<?php print ($key +1 ) ?>" id="stato_emissione_int<?php print ($key +1 ) ?>" class="form-control">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label for="provincia_emissione_int<?php print ($key +1 ) ?>">Provincia di rilascio*</label>
                                        <select name="provincia_emissione_int<?php print ($key +1 ) ?>" id="provincia_emissione_int<?php print ($key +1 ) ?>" class="form-control">
                                            <option value="">seleziona</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label for="comune_emissione_int<?php print ($key +1 ) ?>" data-modulo="doc-comune">Comune di rilascio*</label>
                                        <select name="comune_emissione_int<?php print ($key +1 ) ?>" id="comune_emissione_int<?php print ($key +1 ) ?>" class="form-control">
                                            <option value="">seleziona</option>
