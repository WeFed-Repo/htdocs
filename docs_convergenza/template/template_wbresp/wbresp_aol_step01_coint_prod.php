...
<div class="row rowArea1">
	...
	<form id="aolStep1" action="/webankpub/aol/step2.do?BV_UseBVCookie=Yes&fromPageName=1&save=true" method="POST" class="validate">
		...
		<input type="hidden" name="presaVisioneUS" id="presaVisioneUS" value="" /> <input type="hidden" name="cod_fiscale_int1" id="cod_fiscale_int1" value="RSSMRA80A01G388O" /> <input type="hidden" name="tel_3_int1" id="tel_3_int1" value="00393333333333" />
		...
		<div class="panel panel-default">
			...
			<div class="panel panel-default">
				<div class="panel-heading" role="tab"
					...
					<h4 class="panel-title">
						<a role="button" data-toggle="collapse" href="#!"
							data-target="#collapse_int2" aria-expanded="false"
							aria-controls="collapse_int2" class="collapsed"> Inserisci i dati personali
							del secondo
							intestatario
						</a>
					</h4>
				...
				<div id="collapse_int2"
					class="panel-collapse collapse "
					role="tabpanel" aria-labelledby="headingOne_int2"
					aria-expanded="false">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-sm-12 form-section-title">
								<h4>
									1. Inserisci i dati anagrafici del
									secondo
									intestatario
								</h4>
							</div>
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label for="nome_int2" class="labelTooltip">Nome*</label>
								<a href="javascript:;" data-toggle="tooltip" title=""
									id="ttNome" class="icoinfo"
									data-original-title="Scrivi il tuo nome per esteso, come &egrave; scritto sul documento di identit&agrave;"></a>
								<input type="text"
									placeholder="Nome completo (es: Maria Luisa Chiara)"
									name="nome_int2" id="nome_int2"
									value="" class="textinput form-control" required
									>
							</div>
							<div class="col-md-6 form-group">
								<label for="cognome_int2" class="labelTooltip">Cognome*</label>
								<a href="javascript:;" data-toggle="tooltip" title=""
									id="ttCognome" class="icoinfo"
									data-original-title="Scrivi il tuo cognome per esteso, come &egrave; scritto sul documento di identit&agrave;"></a>
								<input type="text"
									placeholder="Cognome completo (es: De luca)"
									name="cognome_int2" id="cognome_int2"
									value="" class="textinput form-control"
									required
									>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label for="gg_nascita_int2">Data di nascita*</label>
								<div class="input input-inline input-date">
									<input type="tel" pattern="\d+" placeholder="gg"
										maxlength="2" name="gg_nascita_int2"
										id="gg_nascita_int2" value=""
										class="textinput form-control nascGg ignore"
										>
									<div class="nascSl">/</div>
									<input type="tel" pattern="\d+" placeholder="mm"
										maxlength="2" name="mm_nascita_int2"
										id="mm_nascita_int2" value=""
										class="textinput form-control nascGg ignore"
										>
									<div class="nascSl">/</div>
									<input type="tel" pattern="\d+" placeholder="aaaa"
										maxlength="4" name="aa_nascita_int2"
										id="aa_nascita_int2" value=""
										class="textinput form-control nascAn ignore"
										> <input type="text"
										name="nascita_int2" id="nascita_int2"
										class="hidden-input" value="null">
								</div>
							</div>
							<div class="col-md-6 form-group">
								...
								<div class="radio radio-inline">
									<input type="radio" name="sesso_int2"
										id="sesso_int2a" value="M"
										
										> <label
										for="sesso_int2a">M</label>
								</div>
								<div class="radio radio-inline">
									<input type="radio" name="sesso_int2"
										id="sesso_int2b" value="F"
										
										> <label
										for="sesso_int2b">F</label>
								</div>
							</div>
						</div>
						<div class="spacer-no-border hidden-xs">&nbsp;</div>
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label for="cod_fiscale_int2">Codice fiscale*</label>
								<input type="text" placeholder="16 caratteri" maxlength="16"
									name="cod_fiscale_int2"
									id="cod_fiscale_int2" value=""
									class="textinput form-control" >
							</div>
							<div class="col-md-6 form-group">
								<label for="mail_int2" class="labelTooltip">Email*</label> 
								<a href="javascript:;" data-toggle="tooltip"
									title="" id="ttEmail2" class="icoinfo"
									data-original-title="Riceverai l'email con il codice per completare la richiesta di apertura di Conto Webank."></a>
								<input
									type="email" placeholder="Es. email@esempio.it"
									name="mail_int2" id="mail_int2"
									value="" class="textinput form-control" required>
							</div>
						</div>
						<div class="spacer-no-border hidden-xs">&nbsp;</div>
						...
						<div class="row">
							<div class="col-md-6 form-group input-tel">
								<label for="telefono_3_int2" class="labelTooltip">Numero
									di cellulare*</label> <a href="javascript:;" data-toggle="tooltip"
									title="" id="ttCell2" class="icoinfo"
									data-original-title="0039 &egrave; il prefisso internazionale per l'Italia.<br><br>Riceverai l'SMS con il codice per completare la richiesta di apertura di Conto Webank."></a>
								<div class="input input-inline">
									<input type="tel" maxlength="5"
										name="pref_intern_3_int2"
										id="pref_intern_3_int2" value="0039"
										class="textinput form-control numPref ignore"
										placeholder="Prefisso"> <input type="tel"
										maxlength="10" name="telefono_3_int2"
										id="telefono_3_int2" value=""
										class="textinput form-control numCell ignore"
										placeholder="Senza spazi, barre o trattini"> <input
										type="tel" name="tel_3_int2"
										id="tel_3_int2" class="hidden-input"
										value="0039">
								</div>
							</div>
							<div class="col-md-6 form-group">
								<label for="operatore_int2">Operatore*</label> <select
									name="operatore_int2" id="operatore_int2"
									class="form-control">
									<option value="">Seleziona</option>
									...
									<option value="FASTWEB"
										>Fastweb Mobile</option>
									
									<option value="DAILY"
										>Daily Telecom Mobile</option>
						...
						<div class="row">
							<div class="col-sm-12 form-section-title">
								<h4>
									1. Inserisci le informazioni personali
									del
									secondo
									intestatario
								</h4>
						...
						<div class="spacer-no-border hidden-xs">&nbsp;</div>
						<div class="recapNascita" data-tit="2">
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="stato_nascita_int2">Paese di
										nascita*</label> <select name="stato_nascita_int2"
										id="stato_nascita_int2"
										class="form-control indStato" >
										<option value="">seleziona</option>
								...
								<div class="col-md-6 form-group">
									<label for="cittadinanza_int2">Cittadinanza*</label>
									<select name="cittadinanza_int2"
										id="cittadinanza_int2" class="form-control"
										>
										<option value="">seleziona</option>
							...
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="provincia_nascita_int2">Provincia
										di nascita*</label> <select name="provincia_nascita_int2"
										id="provincia_nascita_int2"
										class="form-control indProv"
										>
										<option value="">seleziona</option>
									</select>
								...
								<div class="col-md-6 form-group">
									<label for="comune_nascita_int2">Comune di
										nascita*</label> <select name="comune_nascita_int2"
										id="comune_nascita_int2"
										class="form-control indCom"
										>
										<option value="">seleziona</option>
									</select>
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label class="labelTooltip">Paese di residenza
									fiscale*</label> <a href="javascript:;" data-toggle="tooltip"
									title="" id="ttNome_int2" class="icoinfo"
									data-original-title="Ai fini delle imposte sui redditi, si considerano residenti le persone fisiche che per la maggior parte del periodo d'imposta sono iscritte nelle anagrafi della popolazione residente anche se domiciliano all'estero, oppure le persone fisiche che hanno nel territorio dello Stato il proprio domicilio o residenza ai sensi del codice civile (Art. 2, co. 2, D.P.R. 917/1986).<br><br><strong>&Eacute; possibile aprire Conto Webank solo se il Paese di residenza fiscale &egrave; l'Italia</strong>."></a> <span
									class="output">Italia</span>
							</div>
						</div>
						...
						<div class="spacer-no-border hidden-xs">&nbsp;</div>
						<div class="panel-group panel-sub" id="accordion2_int2"
							role="tablist" aria-multiselectable="true">
							<div class="panel panel-default">
								<div class="panel-heading" role="tab"
									id="headingOneB_int2">
									<h4 class="panel-title">
										<a role="button" data-toggle="collapse" href="#!"
											data-target="#collapse_int2B" aria-expanded="true"
											aria-controls="collapse_int2B" class=""> Altri
											dati FATCA e CRS </a>
									</h4>
								</div>
								<div id="collapse_int2B"
									class="panel-collapse collapse in" role="tabpanel"
									aria-labelledby="headingOneB_int2"
									aria-expanded="true">
									<div class="panel-body">
										<p>Con l'entrata in vigore delle normative FATCA (Foreign Account Tax Compliance Act) e CRS (Common Reporting Standard,) il Governo italiano si è impegnato a garantire la compliance fiscale internazionale mediante l'adesione allo scambio automatico di informazioni fra le amministrazioni tributarie dei rispettivi Paesi aderenti.<br><h4>Residenza fiscale estera</h4>Ogni giurisdizione definisce autonomamente i criteri per l'attribuzione della residenza fiscale ad un soggetto. Il Paese nel quale il soggetto è tenuto a pagare le imposte sui redditi, in virtù della propria residenza, domicilio o altro, è verosimilmente il Paese nel quale tale soggetto ha la propria residenza fiscale. Tuttavia, alcune circostanze (ad es. lavorare all'estero) potrebbero implicare la residenza fiscale di un soggetto in più Paesi, nello stesso intervallo temporale (ad. es. anno civile). In tal caso, al fine di risolvere tali casistiche di doppia residenza fiscale, le Convenzioni contro la doppia imposizione contengono le cosiddette "tiebreaker rules", alle quali il soggetto può fare riferimento per stabilire la propria residenza fiscale. Per ulteriori informazioni relative alla propria residenza fiscale, si prega di contattare il proprio consulente fiscale o verificare le informazioni disponibili sul Portale Web dell'<a href="http://www.oecd.org/tax/automatic-exchange/crs-implementation-and-assistance" target="_blank">OECD</a>.</p>
										<p>Alla luce di quanto sopra, se risulti essere
										...
										<!-- seconda residenza fiscale -->
										<div class="fatcaContainer" data-tit="2">
											<!-- _int2 -->
											<div class="fatcaBox" data-res="1" style="display: none">
												<div class="spacer-no-border">&nbsp;</div>
												<div class="row fatcaLinkButton">
											...
											<div class="fatcaBox" data-res="2">
												<div class="row fatcaFieldButton">
													<div class="col-md-6 form-group">
														<label for="residenzaFiscale2_int2"
															class="labelTooltip">Secondo paese di
															residenza fiscale</label> <a href="javascript:;"
															data-toggle="tooltip" title=""
															id="ttRes2_int2" class="icoinfo"
															data-original-title="Il regime fiscale applicato sarà quello dell'Italia. Questa informazione è rilevante solo ai fini FATCA e CRS. Se il cliente dichiara un Paese estero come «Altro Paese di residenza fiscale», la banca è tenuta, ai sensi delle normative FATCA e CRS, a segnalarlo con frequenza annuale all'Agenzia delle Entrate."></a>
														<select name="sel_residenzaFiscale2_int2"
															id="sel_residenzaFiscale2_int2"
															class="form-control">
															<option value="">seleziona</option>
															...
															name="residenzaFiscale2_int2"
															id="residenzaFiscale2_int2"
															value="">
													</div>
													<div class="col-md-6 form-group">
														<label for="TIN2_int2">Codice fiscale
															estero</label> <input type="text" name="TIN2_int2"
															id="TIN2_int2" value=""
															class="textinput form-control" disabled maxlength="20">
													</div>
												</div>
								...
								<div class="col-xs-12 form-group">
									<div class="form-group">
										...
										<div class="input-group btn-file-group" style="display:none;">
											<span class="input-group-btn">
												<span class="btn btn-file">
													Seleziona<input type="file" id="fileTIN2_int2" name="fileTIN2_int2" accept=".pdf,.jpg,.jpeg,.png">
												</span>
											</span>
											<input type="text" class="form-control btn-file-name" readonly="">
										</div>
						...
						<div class="row">
							<div class="col-sm-12 form-section-title">
								<h4>
									2.Inserisci i dati del documento
									di identit&agrave; del
									secondo
									intestatario
								</h4>
							</div>
						...
						<div class="modulo-doc">
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="tipo_doc_int2">Tipo di
										documento*</label> <select name="tipo_doc_int2"
										id="tipo_doc_int2" class="form-control"
								...
								<div class="col-md-6 form-group">
									<label for="numero_doc_int2"
										data-modulo="doc-numero">Numero documento*</label> <input
										type="text" placeholder="Inserisci il numero del documento"
										maxlength="16" name="numero_doc_int2"
										id="numero_doc_int2" value=""
										class="textinput form-control" >
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="gg_emissione_int2"
										data-modulo="doc-rilascio">Data di
										rilascio/rinnovo*</label>
									<div class="input input-inline input-date">
										<input type="tel" pattern="\d+" placeholder="gg"
											maxlength="2" name="gg_emissione_int2"
											id="gg_emissione_int2"
											value=""
											class="textinput form-control nascGg ignore"
											>
										<div class="nascSl">/</div>
										<input type="tel" pattern="\d+" placeholder="mm"
											maxlength="2" name="mm_emissione_int2"
											id="mm_emissione_int2"
											value=""
											class="textinput form-control nascGg ignore"
											>
										<div class="nascSl">/</div>
										<input type="tel" pattern="\d+" placeholder="aaaa"
											maxlength="4" name="aa_emissione_int2"
											id="aa_emissione_int2"
											value=""
											class="textinput form-control nascAn ignore"
											> <input type="text"
											name="emissione_int2" id="emissione_int2"
											class="hidden-input" value="null">
									</div>
								</div>
								<div class="col-md-6 form-group">
									<label for="gg_scadenza_int2"
										data-modulo="doc-scadenza">Data di scadenza*</label>
									<div class="input input-inline input-date">
										<input type="tel" pattern="\d+" placeholder="gg"
											maxlength="2" name="gg_scadenza_int2"
											id="gg_scadenza_int2"
											value=""
											class="textinput form-control nascGg ignore">
										<div class="nascSl">/</div>
										<input type="tel" pattern="\d+" placeholder="mm"
											maxlength="2" name="mm_scadenza_int2"
											id="mm_scadenza_int2" value=""
											class="textinput form-control nascGg ignore">
										<div class="nascSl">/</div>
										<input type="tel" pattern="\d+" placeholder="aaaa"
											maxlength="4" name="aa_scadenza_int2"
											id="aa_scadenza_int2" value=""
											class="textinput form-control nascAn ignore"> <input
											type="text" name="scadenza_int2"
											id="scadenza_int2" class="hidden-input"
											value="null">
									</div>
								</div>
							</div>
							...
							<div class="spacer-no-border hidden-xs">&nbsp;</div>
							<div class="recapRilascio" data-tit="2">
								<div class="row">
									<div class="col-md-6 form-group">
										<label for="stato_emissione_int2">Paese di
											rilascio*</label> <select name="stato_emissione_int2"
											id="stato_emissione_int2"
											class="form-control indStato" >
											<option value="">seleziona</option>
									...
									<div class="col-md-6 form-group">
										<label for="provincia_emissione_int2">Provincia
											di rilascio*</label> <select
											name="provincia_emissione_int2"
											id="provincia_emissione_int2"
											class="form-control indProv">
											<option value="">seleziona</option>
										</select>
									</div>
								...
								<div class="row">
									<div class="col-md-6 form-group">
										<label for="comune_emissione_int2"
											data-modulo="doc-comune">Comune di rilascio*</label> <select
											name="comune_emissione_int2"
											id="comune_emissione_int2"
											class="form-control indCom">
											<option value="">seleziona</option>
										</select>
									</div>
						...
						<div class="row">
							<div class="col-md-9 form-group">
								<label for="qualif_int2">Indirizzo di
									residenza*</label>
								<div class="input input-inline input-address">
									...
									</select> <input type="text" name="via_int2"
										id="via_int2" value=""
										class="textinput form-control IndNome ignore"> <input
										type="text" name="ind_int2" id="ind_int2"
										class="hidden-input" value="">
								</div>
							</div>
							<div class="col-md-3 form-group">
								<label for="civico_int2">Numero*</label> <input
									type="text" name="civico_int2"
									id="civico_int2" value=""
									class="textinput form-control" maxlength="8">
							</div>
						</div>
						<div class="spacer-no-border hidden-xs">&nbsp;</div>
						<div class="recapPrinc" data-tit="2">
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="provincia_int2">Provincia di
										residenza*</label> <select name="provincia_int2"
										id="provincia_int2" class="form-control indProv">
										<option value="">seleziona</option>
							...
							<div class="row">
								<div class="col-md-6 form-group">
									<label for="comune_int2">Comune di
										residenza*</label> <select name="comune_int2"
										id="comune_int2" class="form-control indCom">
										<option value="">seleziona</option>
									</select>
								</div>
								<div class="col-md-6 form-group">
									<label for="cap_int2">CAP di residenza*</label> 
									<input type="text" name="cap_int2"  
										id="cap_int2"
										class="form-control" />
								</div>
							</div>
						...
						<div class="spacer-no-border hidden-xs">&nbsp;</div>
						<div class="panel-group panel-sub" id="accordion3_int2"
							role="tablist" aria-multiselectable="true">
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab"
									...
									<h4 class="panel-title">
										<a role="button" data-toggle="collapse" href="#!"
											data-target="#collapse_int2E" aria-expanded="true"
											aria-controls="collapse_int2E" class="collapsed">
											Aggiungi altri recapiti </a>
										<p>Puoi aggiungere un ulteriore numero di telefono.</p>
									</h4>
								</div>
								<div id="collapse_int2E"
									class="panel-collapse collapse" role="tabpanel"
									aria-labelledby="headingOneE_int2">
									<div class="panel-body">
										<div class="row">
											<div class="col-md-6 form-group input-tel">
												<label for="telefono_int2" class="labelTooltip">Numero
													di telefono fisso di casa</label>
												<div class="input input-inline">
													<input type="tel" maxlength="5"
														name="prefisso_int2" id="prefisso_int2"
														value="0039"
														class="textinput form-control numPref ignore"
														placeholder="Prefisso"> <input type="tel"
														maxlength="15" name="telefono_int2"
														id="telefono_int2" value=""
														class="textinput form-control numNaz ignore"
														placeholder="Numero"> <input type="tel"
														name="tel_int2" id="tel_int2"
														class="hidden-input" value="">
												</div>
											</div>
											<div class="col-md-6 form-group input-tel">
												<label for="telefono_2_int2" class="labelTooltip">Numero
													di telefono fisso dell'ufficio</label>
												<div class="input input-inline">
													<input type="tel" maxlength="5"
														name="prefisso_2_int2"
														id="prefisso_2_int2"
														value="0039"
														class="textinput form-control numPref ignore"
														placeholder="Prefisso"> <input type="tel"
														maxlength="15" name="telefono_2_int2"
														id="telefono_2_int2"
														value=""
														class="textinput form-control numNaz ignore"
														placeholder="Numero"> <input type="tel"
														name="tel_2_int2" id="tel_2_int2"
														class="hidden-input" value="">
												</div>
											</div>
										</div>
						...
						<div class="row">
							<div class="col-sm-2 form-group">
								<div class="radio radio-inline">
									<input type="radio" name="isbpmcliente_int2"
										id="isbpmcliente_int2a" value="SI"
										> <label
										for="isbpmcliente_int2a">S&igrave;</label>
								</div>
							</div>
							<div class="col-sm-10 form-group">
								<div class="radio radio-inline">
									<input type="radio" name="isbpmcliente_int2"
										id="isbpmcliente_int2b" value="NO"
										> <label
										for="isbpmcliente_int2b">No</label>
								</div>
							</div>
						</div>
						<hr>
						...
						<div class="row">
							<div class="col-md-6 form-group">
								<label for="titolo_studio_int2">Titolo di
									studio</label> <select name="titolo_studio_int2"
									id="titolo_studio_int2" class="form-control">
									<option selected
										value="">seleziona</option>
									<option
...
<script type="text/javascript"
	src="/wbresp/js/aol/step1.js?a=464"></script>
...
function impostaValoriSelect() {
	...
	impostaValoreSelect('stato_nascita_int2', 'ITALIA');
	impostaValoreSelect('stato_emissione_int2', 'ITALIA');
}
...
function impostaResidenzaFiscale() {
	...
	var collapse_int2B =  $('#collapse_int2B');
	//Seconda residenza fiscale
	//Terza residenza fiscale
	//Quarta residenza fiscale
}
