                        ...
                        <div class="row">
                            ...
                            <div class="bcrumbs" vocab="http://schema.org/" typeof="BreadcrumbList">
                                ...
                                <style>
                                    ...
                                    .btn-switch {clear:both;display:inline-block;width:100%; text-align:center;margin-bottom:20px;}
                                    .btn-switch button {padding:0 15px !important;display:inline-block;}
                                ...
                                <div class="basic-content content simple-format">
                                        ...
                                        <section>
                                            ...
                                            <section>
                                                ...
                                                <p><strong>GLASSBOX</strong><br>L'installazione è finalizzata alla raccolta di informazioni sulle preferenze di navigazione e all'invio di comunicazioni personalizzate e/o offerte commerciali, sulla base degli interessi manifestati attraverso la navigazione in internet.</p>
                                                
                                                <!-- CONSENSO -->
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="consGruppo" id="" value="0">
                                                            <label for="">Acconsento</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="radio radio-inline">
                                                            <input type="radio" name="consGruppo" id="" value="1">
                                                            <label for="">Non acconsento</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- FINE CONSENSO -->
                                            ...
                                            <section>
                                                ...
                                                <p><strong>Sos Tariffe</strong><br><a href="https://www.sostariffe.it/info/policy-cookie" target="_blank">https://www.sostariffe.it/info/policy-cookie</a></p>
                                                <p><strong>Adform</strong><br>L'installazione è finalizzata all'invio di pubblicità basata sugli interessi manifestati attraverso la navigazione internet, alla gestione delle statistiche di navigazione, alla personalizzazione dei contenuti, all'ottimizzazione della navigazione, alla visualizzazione di comunicazioni personalizzate e maggiormente appropriate; tale personalizzazione avviene anche sulla base del comportamento di navigazione dell'utente su siti di terze parti con cui AdForm ha stipulato accordi per l'installazione del proprio cookie.<br>I dati di navigazione ricavati da AdForm anche su siti di terze parti potranno essere comunicati alla Banca e – per i clienti che accedono all'area internet banking mediante l'uso dei codici personali di identificazione – le informazioni ricavate dal cookie potranno essere aggregate a quelle che la Banca già detiene e utilizzate anche per integrarne il profilo personale.<br><a href="https://site.adform.com/privacy-center/website-privacy/cookie-policy/" target="_blank">https://site.adform.com/privacy-center/website-privacy/cookie-policy/</a></p>
                                                <p><strong>Taboola</strong><br>L'installazione è finalizzata all' ottimizzazione della navigazione, migliorando la qualità e la funzionalità del sito web, alla modifica/cancellazione di contenuti e servizi esistenti e/o ad altri scopi interni e statistici. L'installazione è finalizzata altresì all'invio di pubblicità basata sugli interessi manifestati attraverso la navigazione internet anche su siti di terze parti.<br><a href="https://www.taboola.com/privacy-policy#user-choices-and-optout" target="_blank">https://www.taboola.com/privacy-policy#user-choices-and-optout</a></p>
                                                <p><strong>Payclick</strong><br>L'installazione è finalizzata all'invio di pubblicità basata sugli interessi manifestati attraverso la navigazione sul sito web al fine di inviare offerte personalizzate su altri prodotti e/o servizi.<br><a href="https://payclick.it/en/privacy" target="_blank">https://payclick.it/en/privacy</a></p>
                                                <p><strong>Ligatus</strong><br>L'installazione è finalizzata all' ottimizzazione della navigazione, migliorando la qualità e la funzionalità del sito web, alla modifica/cancellazione di contenuti e servizi esistenti e/o ad altri scopi interni e statistici. L'installazione è finalizzata altresì all'invio di pubblicità basata sugli interessi manifestati attraverso la navigazione internet anche su siti di terze parti.<br><a href="https://www.ligatus.com/it/privacy-policy" target="_blank">https://www.ligatus.com/it/privacy-policy</a></p>
                                                <p><strong>Bing</strong><br>L'installazione è finalizzata all'ottimizzazione della navigazione, all'invio di pubblicità basata sugli interessi manifestati attraverso la navigazione internet anche su siti di terze parti, all'invio di pubblicità a soggetti che hanno precedentemente visitato il sito www.bancobpm.it e alla personalizzazione dei contenuti.<br><a href="http://www.microsoft.com/privacystatement/it-it/MicrosoftOnlineAdvertising/Default.aspx" target="_blank">http://www.microsoft.com/privacystatement/it-it/MicrosoftOnlineAdvertising/Default.aspx</a></p>
                                                <p><strong>Google Advertising</strong><br>L'installazione è finalizzata all'invio di pubblicità basata sugli interessi manifestati attraverso la navigazione internet, all'invio di pubblicità a soggetti che hanno precedentemente visitato il sito, alla personalizzazione dei contenuti, all'ottimizzazione della navigazione e alla condivisione di contenuti sui social network.<br><a href="https://policies.google.com/technologies/ads?hl=it" target="_blank">https://policies.google.com/technologies/ads?hl=it</a></p>
                                                <p><strong>Facebook</strong><br>L'installazione è finalizzata all'ottimizzazione della navigazione, all'invio di pubblicità basata sugli interessi manifestati attraverso la navigazione internet anche su siti di terze parti, all'invio di pubblicità a soggetti che hanno precedentemente visitato il sito, alla personalizzazione dei contenuti, e alla condivisione di contenuti sui social network.<br><a href="https://www.facebook.com/policies/cookies/" target="_blank">https://www.facebook.com/policies/cookies/</a></p>
                                                <p><strong>Criteo</strong><br>L'installazione è finalizzata all'ottimizzazione della navigazione, all'invio di pubblicità basata sugli interessi manifestati attraverso la navigazione internet, all'invio di pubblicità a soggetti che hanno precedentemente visitato il sito, alla personalizzazione dei contenuti.<br><a href="https://www.criteo.com/it/privacy/" target="_blank">https://www.criteo.com/it/privacy/</a></p>
