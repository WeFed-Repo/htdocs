	...
	<div class="container">
			<div class="row rowArea1">
				...
				<!-- container 2 inizio -->
					...
					<div class="carte-di-credito container02 large-mob-carousel" id="s2">
						...
						<h3>BPM MASTERPASS</h3>
							<div class="row">
									...
									<div class="col-sm-5 hidden-xs">
											<img src="/wbresp/img/carte/bpmm.png"  class="img-responsive "  alt="BPM MASTERPASS" title="BPM MASTERPASS - &Egrave; la soluzione per fare shopping online in pochi clic!" />
									</div>
