...
<div class="row">
    <div class="col-md-12">
        <h2>Integrazione Webcam Infocert</h2>
    </div>
</div>
<div id="webcamBox">
    ...
    <div id="testPositivo" style="display: block;">
        <div id="localMediaBox">
            <div id="localMediaStream" class="mediaStream">
            </div>
            <div id="localMediaInfo" class="mediaInfo">Francesco Rossi</div>
        </div>
        <div id="remoteMediaStream" class="mediaStream">
        	<div id="remoteMediaInfo" class="mediaInfo">
                <div class="row">
                    <div class="col-md-8 operatoreInfo">
                		<span id="operatoreNome">ROMINA</span> <span id="operatoreAzienda">- Operatrice INFOCERT 000255</span><br>
        ...
        <form id="chatBox" name="chat_form" onsubmit="return false">
            ...
            <div id="chat" class="chat">
                <div id="chatHistory" class="container-fluid">
                    <div class="row">
                        <div class="col-md-3">
                            <span class="messageName">Francesco Rossi</span><br>
                    ...
                    <div class="row fromOperator">
                        <div class="col-md-3">
                            <span class="messageName">Romina - IC</span><br>
                            <span class="messageDate">20-04-2016, 10:15:30</span>
                        </div>
                        <div class="col-md-9">
                            <div class="messageText">
