...
<a href="/webankpri/wbOnetoone/2l/do/wbOnetoone/schedaPrivata.do?OBSCNT=FNZ_NAV&tabId=nav_priv_wbx_myhome&OBSKEY=LANDINGPAGE-1320417316993" title="Commizzioni Zero%"><img src="/WB/fe/img/bnr_commissioni0.jpg" alt="Commizzioni Zero%" title="Commizzioni Zero%" style="width:100%;"></a>
<br><br><br>
<hr>
<section>
...
var isLibrerie = true,
    ...
    fesConfig = {
        ...
        "codSocieta": {
            <?php virtual("/include/ajax/obj_societa_gestione.php"); ?>
        },
        "macroCat": {
            "6": {
                "nome": "Altri"
...
<script type="text/javascript" src="/common/fe/js/priv_fes_pac_ricerca.js"></script>
