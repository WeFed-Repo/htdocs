		...
		$("body").prepend(helpDialog);
					...
					<div class="row">
						<div class="form-field-input col-xs-12">
							<label>
								<input type="checkbox" name="propostaConferma.listaCointestatari[0].adeguataVerificaForm.titolareEffettivoRapporto" value="true" id="titEff0">
...
<!-- 				</div> -->
				...
				<div class="form-group">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="redditoAnnuoNetto0">Reddito annuo </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
		...
		$("body").prepend(helpDialog);
				...
				<div class="form-group" id="note30" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="notePatrimonio0">Note Patrimonio </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
		...
		$("body").prepend(helpDialog);
				...
				<div class="form-group" id="note40" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="noteOriginePatrimonio0">Note Origine del patrimonio </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
	...
	if ($("#helpDialog").length==0) {
		...
		$("body").prepend(helpDialog);
					...
					<div class="row">
						<div class="form-field-input col-xs-12">
							<label>
								<input type="checkbox" name="propostaConferma.listaCointestatari[1].adeguataVerificaForm.titolareEffettivoRapporto" value="true" id="titEff1">
		...
		$("body").prepend(helpDialog);
				...
				<div class="form-group">
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="secondaCittadinanza1">Seconda cittadinanza </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
		...
		Profilo professionale e patrimoniale
				...
				<div class="form-group">
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="professione1">Professione </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
		...
		$("body").prepend(helpDialog);
				...
				<div class="form-group">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="nazione1">Stato di svolgimento </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
				...
				<div class="form-group">
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="provincia1"> Provincia di svolgimento </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
...
<!-- 				</div> -->
				...
				<div class="form-group">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="redditoAnnuoNetto1">Reddito annuo </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
				...
				<!-- qui va note del reddito -->
				<div class="form-group" id="note11" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="noteRedditoAnnuoNetto1">Note Reddito annuo </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
				...
				<div class="form-group">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="origineReddito1">Origine del reddito </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
				...
				<!-- qui va note dell'origine del reddito -->
				<div class="form-group" id="note21" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="noteOrigineReddito1">Note Origine del reddito </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
...
$(function() {
	if ($("#helpDialog").length==0) {
		...
		$("body").prepend(helpDialog);
				...
				<!-- qui va note del patrimonio -->
				<div class="form-group" id="note31" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="notePatrimonio1">Note Patrimonio </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
...
$(function() {
	if ($("#helpDialog").length==0) {
		...
		$("body").prepend(helpDialog);
				...
				<!-- qui va note dell'origine del patrimonio -->
				<div class="form-group" id="note41" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
				...
				<div class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom" role="tabpanel" id="ui-id-36" aria-labelledby="ui-id-35" aria-hidden="true" style="display: none;">
					<div class="row">
						<div class="col-xs-12">
							...
							<label for="oicrFlag1" class="input-rcb-inline">
								<input type="checkbox" name="oicrFlag1" value="on">
							...
							<label for="oicrFlag2">
								<input type="checkbox" name="oicrFlag2" value="on">
								<span class="input-rcb-text">
							...
							<label for="oicrFlag3">
								<input type="checkbox" name="oicrFlag3" value="on">
								<span class="input-rcb-text">
