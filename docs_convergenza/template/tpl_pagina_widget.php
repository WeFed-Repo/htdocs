...
<div class="link-box">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6">
            <a href="#" class="text-link" onclick="showVideo('487138384')">Comoda, sicura, veloce: &egrave; You App!</a>
            <a href="#" class="text-link" onclick="showVideo('489824861')">Da You App tutto l'aiuto di cui hai bisogno</a>
            <a href="#" class="text-link" onclick="showVideo('487136160')">You App: la tua banca in una mano</a>
            <a href="#" class="text-link" onclick="showVideo('489822710')">Con You App il bonifico &egrave; semplice e intuitivo</a>
            <a href="#" class="text-link" onclick="showVideo('489824222')">La nuova sezione Investimenti di You App</a>
        </div>
        <div class="col-xs-12 col-sm-6">
            <a href="#" class="text-link" onclick="showVideo('489823051')">Il tuo conto su You App</a>
            <a href="#" class="text-link" onclick="showVideo('489823407')">Le tue carte su You App</a>
            <a href="#" class="text-link" onclick="showVideo('489824602')">Con You App zero sorprese, controlli tu le spese</a>
            <a href="#" class="text-link" onclick="showVideo('489825070')">Gestisci le impostazioni e gli Alert in You App</a>
            <a href="#" class="text-link" onclick="showVideo('489825373')">Grazie a You App la Filiale &egrave; pi&ugrave; vicina</a>
        </div>
    </div>
</div>
<!-- / linkbox -->
