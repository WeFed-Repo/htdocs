...
<div class="navfrontPage outerTab">
	<div class="innerTab">
		<ul class="newLabel">
			<li><a href="/template/strutt_<?= $site ?>.php?tpl=tpl_responsive_fes_topandflops.php&html=mi&liv1=investimenti&liv2=fondi_e_sicav&liv3=soluzioni_self&liv4=migliori_e_peggiori">Top 10 fondi</a></li>
...
<section id="tfCatWrap" class="loading">
	...
	<script type="text/javascript">
		...
		var tfTCategorieUrl = "/include/ajax/fes/fesFlopAndTop.php";
