...
*/
var swFondiUrl = "/common/fe/js/priv_investimenti_fondi.json",
swFondiSwitch =  "/common/fe/js/priv_investimenti_fondi_switch.json",
swFondiConfirm = "/common/fe/js/priv_investimenti_fondi_confirm.html";
