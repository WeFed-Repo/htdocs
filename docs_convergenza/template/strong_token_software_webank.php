		...
		<div class="formGeneric" id="bloccoAttesaPush">
				...
				<div class="row otpdesc app">
					...
					<div class="col-xs-12 col-sm-6">
						<span class="introtext">Inserisci il tuo <strong>PIN</strong> o usa <strong data-toggle="tooltip" title="" class="txthelp" data-original-title="Se il tuo smartphone supporta la funzione, puoi impostare la <strong>conferma sull'app</strong> tramite 
				...
				<div class="row">
					<div class="col-xs-12">
						<a href="javascript:;" class="openinfo" id="infoOtpOpener"><i class="icon icon-info_fill icon-2x"></i><span data-toggle="tooltip" class="txthelp" title="" data-original-title="Per autorizzare l'operazione devi utilizzare lo smartphone su cui hai installato <strong>l'app di sicurezza</strong>.
			<br>
			<br>
				...
				<div class="row otpdesc app">
					...
					<div class="col-xs-12 col-sm-4">
						<span class="introtext">
							...
							<strong data-toggle="tooltip" title="" class="txthelp" data-original-title="Se il tuo smartphone supporta la funzione, puoi impostare la <strong>conferma sull'app</strong> tramite 
										la tua <strong>impronta digitale</strong>, al posto dell'inserimento del Pin.
										Per <strong>scegliere</strong> se utilizzare l'impronta digitale o il Pin vai nella sezione &quot;imposta strumento di sicurezza&quot; 
										della tua app">
									l'impronta digitale
