...
mostra_loading_mobile();
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<form name="ricercaTributiForm" method="post" action="/sapef24/f24/ricercaCodiciAction.do" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="9f5778cee5d5ea87de48919cf0b57140">
