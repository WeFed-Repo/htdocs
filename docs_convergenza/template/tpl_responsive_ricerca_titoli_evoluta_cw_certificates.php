...
<div class="navContFirstLev outerTab">
	<div class="innerTab">
		<ul class="tabmedium">
			<li><a href="/template/strutt_<?php print $site; ?>.php?tpl=tpl_responsive_ricerca_titoli_evoluta_cw.php&liv1=trading&liv2=compravendita&liv3=ricerca_titoli_evoluta&liv4=cw_e_certificates">covered warrants</a></li>
			<li class="on"><a href="#">certificates</a></li>									
		</ul>
	</div>
					...
					<div class="form-group">			
						<div class="row">				
							<div class="col-xs-12 col-sm-6">
								...
								<select class="form-control" onChange="$('#idTdTipologia').show();">
									<option>tutti</option>
									<option>lorem</option>
								</select>
							</div>
			...
			<div id="cercaRisp" style="display:none">
				...
				<div class="form-group">			
					<div class="row">				
						...
						<div class="col-xs-12 col-sm-6">
							<label class="control-label-output">Tipologia</label>
							<span class="output">Lorem ipsum</span>
						</div>				
					</div>
				</div>					
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6">
							...
							<span class="output">Dal: 99/99/9999 &nbsp; - &nbsp; Al: 99/99/9999</span>
						</div>			
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row">
						<div class="col-xs-12 col-sm-6">
							<label class="control-label-output">Strike price</label>
							<span class="output">Da: 9.999,99 &nbsp; - &nbsp; A: 9.999,99</span>
						</div>
