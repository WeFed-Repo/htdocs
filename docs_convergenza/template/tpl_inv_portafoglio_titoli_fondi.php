    ...
    <form class="formGenerico borderFormRounded">
        <div class="row">
            <div class="col-sm-6">
                ...
                <!-- VERSIONE PAR-TEC -->
                <div class="form-group">                        <div class="row">                            <div class="col-sm-6">									<label class="control-label">Colonne visibili</label>									<div class="mww-dom-component webank-component-portfolioVisualizationsCombobox">	<div class="spsel spsel-hasconsole mww-dom-component webank-component-overlay" id="select">		<div class="spsel-option spsel-selected">			<a class="spsel-option-el">Standard</a>			<div class="spsel-btn-console mww-dom-component webank-component-linkedIcon" hidden="">				<a class="no-underline btn-icon mww-dom-component webank-component-icon"> 	<i class="icon icon-edit_fill"></i>	</a>				<a class="no-underline btn-icon mww-dom-component webank-component-icon"> 	<i class="icon icon-delete_table"></i>	</a>			</div>		</div>		<div class="spsel-options">		   					<div class="spsel-option" value="Standard">						<a class="spsel-option-el">Standard</a>					</div>									<div class="spsel-option" value="Enorme">						<a class="spsel-option-el" value="Enorme">Enorme</a>						<div class="spsel-btn-console mww-dom-component webank-component-linkedIcon">							<a class="no-underline btn-icon mww-dom-component webank-component-icon"> 	<i class="icon icon-edit_fill"></i>	</a>							<a class="no-underline btn-icon mww-dom-component webank-component-icon"> 	<i class="icon icon-delete_table"></i>	</a>						</div>					</div>									<div class="spsel-option" value="Media">						<a class="spsel-option-el" value="Media">Media</a>						<div class="spsel-btn-console mww-dom-component webank-component-linkedIcon">							<a class="no-underline btn-icon mww-dom-component webank-component-icon"> 	<i class="icon icon-edit_fill"></i>	</a>							<a class="no-underline btn-icon mww-dom-component webank-component-icon"> 	<i class="icon icon-delete_table"></i>	</a>						</div>					</div>							<div class="spsel-option spsel-custom">				<a class="spsel-option-el">Scegli colonne</a>				<div class="spsel-btn-console mww-dom-component webank-component-linkedIcon">					<a class="no-underline btn-icon mww-dom-component webank-component-icon"> 	<i class="icon icon-row_expand"></i>	</a>				</div>			</div>		</div>		<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="layerEliminaColonna">	<div class="modal-dialog" role="document">		<div></div>		<div class="modal-content">			<div class="modal-header">				<a class="close btn-icon" data-dismiss="modal" aria-label="Close"><i class="icon icon-alert_error_fill icon-2x"></i></a>				<h2 class="modal-title">Cancella vista</h2>			</div>			<div class="modal-body"></div>			<div class="mww-confirmButtonWrapper modal-footer">			<div class="form-group">				<div class="btn-align-left mww-dom-component webank-component-button" data-dismiss="modal">					<a class="btn btn-default" type="button" title="annulla">Annulla</a>				</div>				<div class="btn-align-right mww-dom-component webank-component-button">					 <a class="btn btn-primary" type="button" title="conferma">Sì, cancella</a>				</div>							</div>			</div>		</div>	</div></div>		<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="overlayEditVisualization">	<div class="modal-dialog" role="document">		<div></div>		<div class="modal-content">			<div class="modal-header">				<a class="close btn-icon" data-dismiss="modal" aria-label="Close"><i class="icon icon-alert_error_fill icon-2x"></i></a>				<h2 class="modal-title">Modifica colonne</h2>			</div>			<div class="modal-body mww-dom-component webank-component-portafoglio-titoli-titoliInPortafoglio-overlayScegliColonne"><div class="container-fluid formGenerico">	<div class="row">		<div class="col-xs-12">			<div class="form-group marginBottomMedium">				<label class="control-label flLeft noFloatMobile txthelp" title="" data-toggle="tooltip" data-html="true" data-trigger="focus click" data-original-title="<ul><li>Massimo 40 caratteri</li><li>solo caratteri dalla 'a' alla 'z' (minuscoli e maiuscoli), numeri, spazi e underscores</li><li>Lo spazio non &amp;egrave consentito come primo o ultimo carattere</li></ul><a class=&quot;closeTooltip&quot;><i class=&quot;icon icon-close_inverted_fill icon-2x&quot;></i></a>">Nome vista</label>				<input class="form-control" maxlenght="40" type="text" id="inputSelColName">			</div>		</div>	</div>	<div class="row">		<div class="col-xs-12">			<div class="form-group">				<label class="control-label flLeft noFloatMobile">Seleziona le colonne da visualizzare (massimo 20)</label>				<p class="note flRight noFloatMobile"><strong>0</strong> di 20 selezionate</p>				<br class="clear">												<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox" disabled="1">	          	          <span class="text checked">Titolo/Fondo</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox" disabled="1">	          	          <span class="text checked">Mercato</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Quantità</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Quantità disponibile</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo medio di carico</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Ultimo prezzo</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Controvalore (Euro)</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Utili/Perdite potenziali</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Rubrica</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">ISIN</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Simbolo</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Fase</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Divisa</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Var. %</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Volume scambiato</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo offerta</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo domanda</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Volume offerta</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Volume domanda</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Lotto minimo</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo riferimento odierno</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Valore minimo anno corrente</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Valore massimo anno corrente</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Massimo giornata</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Minimo giornata</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Scadenza</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Cedola</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo apertura/asta</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Var. % apertura</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Ult. chiusura</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Cambio medio di carico</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Rateo</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Vita Residua</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Controvalore investito</span>	      </label></div>								</div>										</div>		</div>	</div>			<div class="row">			<div class="col-xs-12">				<div class="form-group">					<label class="control-label flLeft noFloatMobile">Parametri visibili solo nella sezione Marginazione</label>					<br class="clear">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">											<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo Stop Loss</span>	      </label></div>										</div>																		<div class="col-sm-4 mww-dom-component webank-component-checkbox">											<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Margine Eur %</span>	      </label></div>										</div>												</div>			</div>		</div>	</div></div></div>			<div class="mww-confirmButtonWrapper modal-footer">			<div class="form-group">				<div class="btn-align-left mww-dom-component webank-component-button" data-dismiss="modal">					<a class="btn btn-default" type="button" title="Annulla">	Annulla</a>				</div>				<div class="btn-align-right mww-dom-component webank-component-button">					 <a class="btn btn-primary" type="button" title="Modifica">	Modifica</a>				</div>							</div>			</div>		</div>	</div></div>		<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="overlayAddVisualization">	<div class="modal-dialog" role="document">		<div></div>		<div class="modal-content">			<div class="modal-header">				<a class="close btn-icon" data-dismiss="modal" aria-label="Close"><i class="icon icon-alert_error_fill icon-2x"></i></a>				<h2 class="modal-title">Scegli colonne</h2>			</div>			<div class="modal-body mww-dom-component webank-component-portafoglio-titoli-titoliInPortafoglio-overlayScegliColonne"><div class="container-fluid formGenerico">	<div class="row">		<div class="col-xs-12">			<div class="form-group marginBottomMedium">				<label class="control-label flLeft noFloatMobile txthelp" title="" data-toggle="tooltip" data-html="true" data-trigger="focus click" data-original-title="<ul><li>Massimo 40 caratteri</li><li>solo caratteri dalla 'a' alla 'z' (minuscoli e maiuscoli), numeri, spazi e underscores</li><li>Lo spazio non &amp;egrave consentito come primo o ultimo carattere</li></ul><a class=&quot;closeTooltip&quot;><i class=&quot;icon icon-close_inverted_fill icon-2x&quot;></i></a>">Nome vista</label>				<input class="form-control" maxlenght="40" type="text" id="inputSelColName">			</div>		</div>	</div>	<div class="row">		<div class="col-xs-12">			<div class="form-group">				<label class="control-label flLeft noFloatMobile">Seleziona le colonne da visualizzare (massimo 20)</label>				<p class="note flRight noFloatMobile"><strong>0</strong> di 20 selezionate</p>				<br class="clear">												<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox" disabled="1">	          	          <span class="text checked">Titolo/Fondo</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox" disabled="1">	          	          <span class="text checked">Mercato</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Quantità</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Quantità disponibile</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo medio di carico</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Ultimo prezzo</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Controvalore (Euro)</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Utili/Perdite potenziali</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Rubrica</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">ISIN</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Simbolo</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Fase</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Divisa</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Var. %</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Volume scambiato</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo offerta</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo domanda</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Volume offerta</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Volume domanda</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Lotto minimo</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo riferimento odierno</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Valore minimo anno corrente</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Valore massimo anno corrente</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Massimo giornata</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Minimo giornata</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Scadenza</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Cedola</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo apertura/asta</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Var. % apertura</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Ult. chiusura</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Cambio medio di carico</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Rateo</span>	      </label></div>								</div>															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Vita Residua</span>	      </label></div>								</div>															</div>															<div class="row">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">									<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Controvalore investito</span>	      </label></div>								</div>										</div>		</div>	</div>			<div class="row">			<div class="col-xs-12">				<div class="form-group">					<label class="control-label flLeft noFloatMobile">Parametri visibili solo nella sezione Marginazione</label>					<br class="clear">															<div class="col-sm-4 mww-dom-component webank-component-checkbox">											<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Prezzo Stop Loss</span>	      </label></div>										</div>																		<div class="col-sm-4 mww-dom-component webank-component-checkbox">											<div class="checkbox inline">	      <label class="textWrapper">	          <input type="checkbox">	          	          <span class="text">Margine Eur %</span>	      </label></div>										</div>												</div>			</div>		</div>	</div></div></div>			<div class="mww-confirmButtonWrapper modal-footer">			<div class="form-group">				<div class="btn-align-left mww-dom-component webank-component-button" data-dismiss="modal">					<a class="btn btn-default" type="button" title="Annulla">	Annulla</a>				</div>				<div class="btn-align-right mww-dom-component webank-component-button">					 <a class="btn btn-primary" type="button" title="Crea">	Crea</a>				</div>							</div>			</div>		</div>	</div></div>		<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" id="overlayEsito">	<div class="modal-dialog" role="document">		<div></div>		<div class="modal-content">			<div class="modal-header">				<a class="close btn-icon" data-dismiss="modal" aria-label="Close"><i class="icon icon-alert_error_fill icon-2x"></i></a>				<h2 class="modal-title">Salvataggio</h2>			</div>			<div class="modal-body"></div>			<div class="mww-confirmButtonWrapper modal-footer" hidden="">			<div class="form-group">				<div class="btn-align-left mww-dom-component webank-component-button" hidden="">					<a class="btn btn-default" type="button" title="annulla">	annulla</a>				</div>				<div class="btn-align-right mww-dom-component webank-component-button" hidden="">					 <a class="btn btn-primary" type="button" title="conferma">	conferma</a>				</div>							</div>			</div>		</div>	</div></div></div></div>								</div>								<div class="col-sm-6">									<label class="control-label">Strumenti finanziari</label>									<div class="mww-dom-component webank-component-combobox"><select class="form-control" id="select">    		    <option value="TOTAL">Totale Portafoglio</option>        		    <option value="STOCK">Azioni</option>        		    <option value="BOND">Obbligazioni</option>        		    <option value="DERIVATIVE">Derivati</option>        		    <option value="CW_CERTIFICATES">CW/Certificates</option>        		    <option value="ETF">ETF</option>        		    <option value="MARGIN">Marginazione</option>    </select></div>								</div>                        </div>                    </div>
