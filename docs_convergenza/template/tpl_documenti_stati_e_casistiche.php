...
<section class="font-table">
    ...
    <div class="row pract-toggle boxed">       
        <div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-2 col-xs-12">
                    <div class="btn-align-center visible-mobile">
                       <a type="button" href="#" class="btn btn-primary noMargin" title="sottoscrivi">Sottoscrivi</a>
                    </div>
                </div>
            </div>
   ...
   <!-- END ROW 3 -->
<!-- ROW 4 CASISTICA CON UN SOLO DOCUMENTO-->
        ...
        <div class="col-sm-12">
            ...
            <div class="row row-eq-height pract-toggle-head right-space alignItemCenter-desktop">
                ...
                <div class="col-sm-2 col-xs-6">
                    <div class="mobile-label">Avviata da</div>
                    <!-- Casistica Icon -->
                    <div class="text-without-icon">
                        <span><span>Cliente</span></span>
                    </div>
                </div>
                <div class="col-sm-2 col-xs-6">
                    <div class="mobile-label">Scadenza</div>
    ...
    <div class="row pract-toggle boxed">       
        <div class="col-sm-12">
            ...
            <div class="row row-eq-height pract-toggle-head right-space alignItemCenter-desktop">
                ...
                <div class="col-sm-2 col-xs-12">
                    <div class="btn-align-center visible-desktop">
                       <a type="button" href="#" class="btn btn-primary noMargin disabled" title="sottoscrivi" disabled>Sottoscrivi</a>
                    </div>
                </div>
                <div class="wrapper-icon-fixed">
                    <div class="linked-icon disabled">
                ...
                <div class="col-sm-4 col-xs-12 ellips">
                    ...
                    <div class="text-with-icon ">
                        <a class="linker" data-toggle="collapse" href="#collapse7" role="button" aria-expanded="false" aria-controls="collapse7">
                            <span class="icon icon-arrow_down" title="icon-arrow_down"></span>
                            <span class="icon icon-arrow_up" title="icon-arrow_up"></span>
                            <span class="text ellipsis dark"><strong>NOME_PRATICA_UNIVOCO_6_NOME_PRATICA_UNIVOCO_6</strong></span>
                            <span class="sub-text">a682002b-db58-4325-ba7d-51166868a68f</span>
                        </a>
                    </div>
                </div>
...
<script>
    $('.pract-toggle-head a[data-toggle="collapse"]').click(function(){
        ...
        let loader='<div id="" class="caricamentoAjax loading" style="display: block; margin:60px 0"></div>';
