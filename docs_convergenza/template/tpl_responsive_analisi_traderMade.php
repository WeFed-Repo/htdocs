			                    ...
			                    <div class="col-xs-12 col-sm-4">
			                        <div class="form-group">
						                <div class="btn-align-right">
						                    	<a class="btn btn-primary" type="button" title="Non sei abilitato al servizio(a pagamento). Se desideri, abilitati ora." data-toggle="tooltip" data-html="false" data-trigger="focus click" data-original-title="Non sei abilitato al servizio(a pagamento). Se desideri, abilitati ora.">	vai</a>
						                </div>
						                <br class="clear">
						            </div>
			                    </div>
