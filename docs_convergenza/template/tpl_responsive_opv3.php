...
<section>
	<h4>Riepilogo sottoscrizione OPS, OPV, OPVS</h4>
	<form class="formGenerico borderFormRounded output" role="form" id="form02">
			...
			<!-- UNICA RIGA CON CAMPO-->
			 <div class="row">
			 	<div class="col-sm-6">
					...
					<span class="output">1099/683496</span>
				</div>
				<div class="col-sm-6">
		...
		<div class="form-group">
			<div class="row">
			 	<div class="col-sm-12">
					<label class="control-label-output">Data assegnazione</label>
					<span class="output">12/10/17</span>
				</div>
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="col-sm-6">
					<label class="control-label">Conferma numero dei lotti</label>
					<div class="row">
						<div class="col-sm-4">
							<input type="text" class="form-control clear-x">
						</div>
						<div class="col-sm-8">
							<span>pari a 1000 azioni</span>
						</div>
					</div>
				</div>
			</div>
...
<section>	
	<div class="form-group btnWrapper">
	    ...
	    <div class="btn-align-right">
	        <a type="button" class="btn btn-primary" id="" href="/template/strutt_<?php print $site; ?>.php?tpl=tpl_responsive_opv4.php&liv1=trading&liv2=compravendita&liv3=inserimento_ordini&liv4=operazioni_sul_capitale">prosegui</a>
	    </div>
	    <div class="clear"></div>
	</div>
</section>
