...
<div class="navContFirstLev outerTab">
	<div class="innerTab">
		<ul class="tabmedium">
			...
			<li><a href="/template/strutt_<?php print $site; ?>.php?tpl=tpl_responsive_ricerca_titoli_evoluta_derivati_sto&liv1=trading&liv2=compravendita&liv3=ricerca_titoli_evoluta&liv4=derivati">stock futures</a></li>			
		</ul>
	</div>
