...
<script type="text/javascript" src="/wscmn/fe/js/priv_fes.js"></script>
<script type="text/javascript" src="/wscmn/fe/js/priv_fes_ricerca.js"></script>
<script type="text/javascript" src="/wscmn/fe/js/priv_fes_fondo.js"></script>
...
<div id="fesRicWrap" style="display:none">
	...
	<div class="navfrontPage outerTab">
		<div class="innerTab">
			<ul class="newLabel">
				<li class="on" id="tabRicerca"><a href="javascript:;" title="Ricerca">Ricerca</a></li>
				<li class="" id="tabConfronta"><a href="javascript:;" title="Confronta" class="leftelement">Confronta</a><div id="fesConfButt" style="display:none"><span>2 fondi</span><a class="smallClose"><i class="icon icon-close"></i></a></div></li>
			</ul>
		</div>
		<div class="separator" style="min-width: 750px;"></div>
	</div>
	<!-- Fine tabs -->
	...
	<div id="fesRicercaCont">
					...
					<form autocomplete="off" id="fesSearchForm" action="javascript:;">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-xs-12 col-sm-4">
									<label class="control-label-output nomefield">Nome o ISIN</label>
									<div class="form-inline">
					       	 			<div class="input-group">
											<div class="editable-input">
												<input maxlength="" id="descrizione" value="" name="descrizione" type="text" name="" autocomplete="off" class="form-control clear-x"></span>
											</div>
					       	 				<div class="input-group-addon">
					       	 					<a href="javascript:;" class="no-underline btn-icon" id="descrizione_btn"><i class="icon icon-zoom_small"></i></a>
					       	 				</div>
										</div>
					       	 		</div>
								</div>
								...
								<div class="col-xs-12 col-sm-4">
									<label class="control-label-output nomefield">Societ&agrave; di gestione</label>
								...
								<div class="col-xs-12 col-sm-4">
									<label class="control-label-output nomefield">Fondo o sicav</label>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-xs-12 col-sm-4">
									<label class="control-label-output nomefield">Tipologia di fondo</label>
								...
								<div class="col-xs-12 col-sm-4">
									<label class="control-label-output nomefield">Rating</label>
								...
								<div class="col-xs-12 col-sm-4">
									<label class="control-label-output nomefield">Categoria Assogestioni o BRating</label>
		...
		<div id="fesSearchResults">
			...
			<div class="modal fade" id="tablePersOverlay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="btn-align-center">
											<a type="button" class="btn btn-primary" title="Salva modifiche" href="javscript:;">Salva modifiche</a>
											<br class="clear">
										</div>
									</div>
								</div>
