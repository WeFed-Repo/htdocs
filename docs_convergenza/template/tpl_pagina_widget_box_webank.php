 ...
 <div class="lr-box">
    <div class="box-image">
        ...
        <div class="smartphone-wrapper small">
            <img src="/WB/fe/img/wbapp/01_pre_login.gif" />
        </div>
    ...
    <div class="box-description light-bg">
        ...
        <p>Dopo aver effettuato l'accesso, nella&nbsp;<em>Home</em>&nbsp;hai una visione immediata del Conto corrente, delle Carte, degli Investimenti e dei Finanziamenti attivi.</p>
    </div>
</div>
...
<!-- SEMPRE AL TUO FIANCO -->
 ...
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/WB/fe/img/wbapp/13_assistenza.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
        <h3>Sempre al tuo fianco</h3>
        <p>L'assistenza si fa in tre:</p>
        <ul>
            <li>scrivi a <strong>Paolo</strong>, l'assistente virtuale</li>
...
<!-- MENu' DI NAVIGAZIONE SEMPRE CON TE -->
 <!-- box autoimpaginato -->
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/WB/fe/img/wbapp/03_silos.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
...
<!-- NUOVI MODI DI INTERAGIRE CON L’APP -->
 ...
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/WB/fe/img/wbapp/02_navigazione.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
        <h3>Nuovi modi di interagire con l'app</h3>
        <p>Per utilizzare wbapp bastano pochi e semplici gesti.</p>
        <p>Nell'<strong><em>area di benvenuto</em></strong>, senza inserire la password, puoi:</p>
        <ul>
            <li><strong>visualizzare il saldo</strong>&nbsp;con uno&nbsp;<strong>shake</strong></li>
...
<!-- COME FARE UN BONIFICO -->
 ...
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/WB/fe/img/wbapp/04_fare_bonifico.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
...
<!-- PORTAFOGLIO PER PRODOTTI POSSEDUTI E ASSET CLASS -->
 <!-- box autoimpaginato -->
 <div class="lr-box">
    <div class="box-image">
        <!-- Wrapper smartphone -->
        <div class="smartphone-wrapper small">
            <img src="/WB/fe/img/wbapp/09_portafoglio.gif" />
        </div>
        <!-- fine Wrapper smartphone -->
    </div>
    <div class="box-description light-bg">
