...
<!-- NUOVI MODI DI INTERAGIRE CON L’APP -->
 ...
 <div class="lr-box">
    ...
    <div class="box-description light-bg">
        ...
        <p>Per utilizzare <strong>App Webank</strong> bastano pochi e semplici gesti.</p>
        <p>Nell'<strong> <i>area di benvenuto </i></strong>, senza inserire la password, puoi:</p>
        <ul>
