...
<div class="navfrontPage outerTab">
	<div class="innerTab">
		<ul class="newLabel">
			...
			<li><a href="/template/strutt_<?= $site ?>.php?tpl=tpl_responsive_fes_topandflops_categorie.php&html=mi&liv1=investimenti&liv2=fondi_e_sicav&liv3=soluzioni_self&liv4=migliori_e_peggiori">Categorie migliori e peggiori</a></li>
		</ul>
	</div>
...
<section id="tfTop10Wrap" class="loading">
	...
	<script type="text/javascript">
		...
		var tfT10Url = "/include/ajax/fes/fesFlopAndTop.php";
		...
		var tfTop10 = function() {
			...
			$.each(tData,function(i,v){
				...
				tData[i].linkfondo = "<a href=\"/template/strutt_<?= $site ?>.php?tpl=tpl_responsive_inv_scheda_fondo.php&responsive=y&liv0=4&liv1=2&liv2=6&liv3=1\" title=\"Vedi fondo " + v.nome + "\">" + v.nome + "</a>"
