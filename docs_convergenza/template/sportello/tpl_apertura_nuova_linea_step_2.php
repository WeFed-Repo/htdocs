...
<section>
    ...
    <form class="formGenerico borderFormRounded" role="form" id="form01">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-6">
                    <label class="control-label" for="nomeLV">Nome linea vincolata (opzionale)</label>
    ...
    <div class="form-group btnWrapper">
        ...
        <div class="btn-align-left">
            <a type="button" class="btn btn-default"
               href="/template/strutt_webank.php?tpl=sportello/tpl_apertura_nuova_linea.php">modifica</a>
        </div>
        <div class="btn-align-right">
            <a type="button" class="btn btn-primary" id="btnInvio"
               href="/template/strutt_webank.php?tpl=sportello/tpl_apertura_nuova_linea_step_3.php">
                vincola</a>
        </div>
        <div class="clear"></div>
    </div>
