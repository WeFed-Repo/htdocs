...
<section>
    ...
    <form class="formGenerico borderFormRounded" role="form" id="form01">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-6">
                    <label class="control-label" for="conto">Deposito</label>
                    <div class="form-inline">
                        <div class="input-group">
                            <select class="form-control" name="" id="conto">
            ...
            "dati": [
                {
                    ...
                    "tassoLordo": "1,00",
                    "nSvin": '<a href=\"javascript:\" class="no-underline btn-icon" data-toggle="modal" data-target="#layer"><i class="icon icon-2x icon-sicurezza_desktop"></i></a>'
                },
                {
                    "idVincolo": "162",
                    "durataVincolo": 3,
                    ...
                    "tassoLordo": "0,75",
                    "nSvin": '<a href=\"javascript:\" class="no-underline btn-icon btn-disabled" title="Questa è la linea &quot;Mediaworld&quot;, non svincolabile, che hai attivato per ricevere il premio."><i class="icon icon-2x icon-sicurezza_desktop"></i></a>'
                },
                {
                    "idVincolo": "163",
                    "durataVincolo": 3,
                    "nomeLinea": "eri",
                    "importoAllaScadenza": "N.D.",
                    "importoVincolato": "1,00",
                    "dataScadenza": "N.D.",
                    "dataApertura": "18\/07\/2016",
                    "tassoLordo": "0,75",
                    "nSvin": "<span class=\"txthelp\"><i class=\"icon icon-2x icon-clessidra_stroke closeable\" data-toggle=\"tooltip\" data-title=\"Linea vincolata in attesa di attivazione.<br>L'importo finale comprensivo degli interessi sarà visualizzato al momento dell'attivazione.\"></i></span>"
                },
                ...
                },
                {
                    "idVincolo": "168",
                    "durataVincolo": 18,
                    "nomeLinea": "<a href=\"javascript:\" class=\"no-underline btn-icon\" data-toggle=\"modal\" data-target=\"#layerLinea\">sono io</a>",
                    "importoAllaScadenza": "N.D.",
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-12">
                            <img src="/WB/upload/cellette/banner_retention_430x40.gif" class="center-block marginBottomMini" alt="Banner retention">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <section>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input id="importo" type="text" name="" class="form-control clear-x">
                                            </div>
                                            <div class="col-sm-6">
                                ...
                                <div class="form-group btnWrapper">
                                    <div class="btn-align-left">
                                        <a type="button" class="btn btn-default" href="javascript:" data-dismiss="modal">annulla</a>
                                    </div>
                                    <div class="btn-align-right">
                                        <a type="button" class="btn btn-primary" id="btnInvio" href="javascript:"
                            ...
                            <section>
                                ...
                                <form class="formGenerico borderFormRounded" role="form" id="form01">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label class="control-label" for="nome">Nome linea (opzionale) </label>
                                                <input type="text" name="" id="nome" class="form-control clear-x">
                                            </div>
                                            <div class="col-sm-6">
                                ...
                                <div class="form-group btnWrapper">
                                    ...
                                    <div class="btn-align-right">
                                        <a type="button" class="btn btn-primary" href="javascript:" id="btnInvio">salva</a>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <!--END  BTN STEP -->
