...
<div class="panel-nofill">
    ...
    <section>
        <div class="box-generico">
            <div class="row">
                <div class="col-sm-4"><br><img src="/WB/fe/img/img_carta_amex_green.jpg" alt="Carta verde american express"></div>
                <div class="col-sm-8">
    ...
    <section>
        ...
        <div class="form-group btnWrapper">
            <div class="btn-align-right">
                <a href="#">Costi e condizioni</a>
                <a title="Richiedi" href="#" type="button" class="btn btn-primary">Richiedi</a> <br class="clear">
            </div>
        </div>
        <br class="clear">
    </section>
    ...
    <section>
        <div class="box-generico">
            <div class="row">
                <div class="col-sm-4"><br><img src="/WB/fe/img/img_carta_amex_platino.jpg" alt="Carta platino american express"></div>
                <div class="col-sm-8">
    ...
    <section>
        <div class="box-generico">
            <div class="row">
                <div class="col-sm-4"><br><img src="/WB/fe/img/img_carta_amex_gold.jpg" alt="Carta oro american express"></div>
                <div class="col-sm-8">
