            ...
            <div class="slide slide-01 slide-active">
                ...
                <script>
                  ...
                  $(function () {
                    ...
                    $.ajax({
                        url: '/include/ajax/mercatoindici/azioni.php',
                                    ...
                                    <table class="tabTradCambi" cellspacing="0" cellpadding="0" border="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="right">Cambio1</th>
												<th class="right">Cambio2</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="dispari">
                                                <td class="left"><img src="/common/fe/img/ico_flagUsa.png" class="imgFlag"> Euro/Dollaro</td>
                                                <td class="right">1,1694</td>
												<td class="right">1,1694</td>
                                            </tr>
                                            <tr class="pari">
                                                <td class="left"><img src="/common/fe/img/ico_flagKiun.png" class="imgFlag"> Euro/Sterlina</td>
                                                <td class="right">0,894</td>
												<td class="right">1,1694</td>
                                            </tr>
                                            <tr class="dispari">
                                                <td class="left"><img src="/common/fe/img/ico_flagSviz.png" class="imgFlag"> Euro/Franco svizzero</td>
                                                <td class="right">1,1063</td>
												<td class="right">1,1694</td>
                                            </tr>
                                            <tr class="dispari">
                                                <td class="left"><img src="/common/fe/img/ico_flagGiap.png" class="imgFlag"> Euro/Yen</td>
                                                <td class="right">130,28</td>
												<td class="right">1,1694</td>
                                            </tr>
                                            <tr class="pari">
                                                <td class="left"><img src="/common/fe/img/ico_flagAust.png" class="imgFlag"> Euro/Dollaro Australiano</td>
                                                <td class="right">1,4693</td>
												<td class="right">1,1694</td>
                                            </tr>
                                            <tr class="dispari">
                                                <td class="left"><img src="/common/fe/img/ico_flagCana.png" class="imgFlag"> Euro/Dollaro Canadese</td>
                                                <td class="right">1,4608</td>
												<td class="right">1,1694</td>
                                            </tr>
											<tr class="pari">
                                                <td class="left"><img src="/common/fe/img/ico_flagNorv.png" class="imgFlag"> Euro/Corona Norvegese</td>
                                                <td class="right">9,3035</td>
												<td class="right">1,1694</td>
                                            </tr>
											<tr class="dispari">
                                                <td class="left"><img src="/common/fe/img/ico_flagNeol.png" class="imgFlag"> Euro/Dollaro Neozelandese</td>
                                                <td class="right">1,5712</td>
												<td class="right">1,1694</td>
                                            </tr>
											<tr class="pari">
                                                <td class="left"><img src="/common/fe/img/ico_flagSvez.png" class="imgFlag"> Euro/Corona Svedese</td>
                                                <td class="right">305,49</td>
												<td class="right">1,1694</td>
                                            </tr>
                                            <tr class="dispari">
                                                <td class="left"><img src="/common/fe/img/ico_flagTurc.png" class="imgFlag"> Euro/Nuova Lira Turca</td>
                                                <td class="right">1,5712</td>
												<td class="right">1,1694</td>
                                            </tr>
											<tr class="pari">
                                                <td class="left"><img src="/common/fe/img/ico_flagSafr.png" class="imgFlag"> Euro/Rand Sudafricano</td>
                                                <td class="right">1,1063</td>
												<td class="right">1,1694</td>
                                            </tr>
