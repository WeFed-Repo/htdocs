...
mostra_loading_mobile();
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<form name="ricercaTributiForm" method="post" action="/sapef24/f24/ricercaCodiciAction.do" class="form-horizontal"><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="InvalidToken">
	...
	<script type="text/javascript">
	 ...
	 <input type="hidden" name="tipoRicerca" value="tributoF24Semplificato">

	 
	 	<input type="hidden" name="returnField" value="sezione(f24Semplificato2012).riga[0].codiceTributo">
	 
	
	
			<div class="flag pagamentoF24">&nbsp;</div>
			<h1>Ricerca codici tributo F24 Semplificato</h1>
		...
		<div class="section clearfix">
			...
			<div class="bs-example">
	          ...
	          <select name="parametro" onchange="selezione(this)" class="form-control">
	           		...
	           		<option value="codice">Codice tributo</option>
		    ...
		    <div id="selezioneDescrizione" class="form-group">
					<label class="col-xs-5 control-label">Descrizione</label>
					<div class="col-xs-7">
             <input type="text" name="valore" maxlength="38" size="35" onblur="javascript: checkTributo(this);" class="form-control" disabled="disabled">
		    	</div>
		    </div>
			</div>
					...
					<div class="pull-right margin-bottom20">
						  <input type="button" class="btn execute" value="Cerca" href="#" onclick="javascript: visualizzaCodici();">
					    <input type="button" class="btn" value="Chiudi" onclick="javascript: window.parent.closeModalPopup();">
					</div>
