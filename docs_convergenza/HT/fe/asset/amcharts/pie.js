    ...
    k.AmSlicedChart = k.Class({
        ...
        animateAgain: function() {
            ...
            for (var b = 0; b < a.chartData.length; b++) {
                ...
                (d = c.labelSet) && d.translate(c.startX, c.startY)
            }
            b = a.startDuration;
            0 < b ? (b = setTimeout(function() {
                a.pullSlices.call(a)
...
(function() {
    ...
    k.AmPieChart = k.Class({
        ...
        construct: function(a) {
	    	...
	    	k.logError('AmPieChart');
            k.applyTheme(this, a, this.cname)
	    	k.logError('AmPieChart 2');
        },
        drawChart: function() {
            ...
            if (k.ifArray(a)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    this.realHeight = g;
                    var f = k.toCoordinate, h = f(this.marginLeft, d), e = f(this.marginRight, d), z = f(this.marginTop, g) + this.getTitleHeight(), n = f(this.marginBottom, g), A, B, l, x = k.toNumber(this.labelRadius), p = this.measureMaxLabel();
                    ...
                    l = f(this.radius, d, g);
                    l || (d = 0 <= x ? d - h - e - 2 * p : d - h - e,
                    g = g - z - n,
                    l = Math.min(d, g),
                    g < d && (l /= 1 - this.angle / 90,
                    l > d && (l = d)),
                    g = k.toCoordinate(this.pullOutRadius, l),
                    l = (0 <= x ? l - 1.8 * (x + g) : l - 1.8 * g) / 2);
                    ...
                    360 < n && (n -= 360);
                    d = l - l * this.angle / 90;
                    for (h = p = 0; h < a.length; h++)
                        e = a[h],
                        !0 !== e.hidden && (p += k.roundTo(e.percents, this.pf.precision));
                    p = k.roundTo(p, this.pf.precision);
                    this.tempPrec = NaN;
                    ...
                    for (var D, h = 0; h < a.length; h++)
                        ...
                        !0 !== e.hidden && (this.showZeroSlices || 0 !== e.percents)) {
                            ...
                            e.url && (q.cursor = "pointer");
                            q = k.wedge(c, A, B, n, r, l, d, f, this.depth3D, q, this.gradientRatio, e.pattern, this.path, this.gradientType);
                            k.setCN(this, q, "pie-item");
                            k.setCN(this, q.wedge, "pie-slice");
                            k.setCN(this, q, e.className, !0);
                            this.addEventListeners(q, e);
                            e.startAngle = n;
                            a[h].wedge = q;
                            0 < b && (this.chartCreated || q.setAttr("opacity", this.startAlpha));
                            e.ix = p;
                            e.iy = C;
                            e.wedge = q;
                            e.index = h;
                            ...
                            if (this.labelsEnabled && this.labelText && e.percents >= this.hideLabelsPercent) {
                                ...
                                0 > t && (e.skipTick = !0));
                                var r = A + p * (l + t), E = B + C * (l + t), w, u = 0;
                                isNaN(D) && 350 < m && 1 < a.length - h && (D = h - 1 + Math.floor((a.length - h) / 2));
                                if (0 <= t) {
                                    var y;
                                    90 >= m && 0 <= m ? (y = 0,
                                    w = "start",
                                ...
                                t = e.labelColor;
                                t || (t = this.color);
                                "" !== m && (m = k.wrappedText(c, m, t, this.fontFamily, this.fontSize, w, !1, this.maxLabelWidth),
                                k.setCN(this, m, "pie-label"),
                                k.setCN(this, m, e.className, !0),
                                m.translate(r + 1.5 * u, E),
                            ...
                            r = f + (l - f) / 2;
                            e.pulled && (r += this.pullOutRadiusReal);
                            e.balloonX = p * r + A;
                            e.balloonY = C * r + B;
                            e.startX = Math.round(p * z);
                            e.startY = Math.round(C * z);
                            e.pullX = Math.round(p * g);
        ...
        checkOverlapping: function(a, b, c, d, g) {
            ...
            if (n) {
                ...
                !0 === f && 100 > g && isNaN(b.labelRadius) && (f = b.ty + 3 * b.iy,
                b.ty = f,
