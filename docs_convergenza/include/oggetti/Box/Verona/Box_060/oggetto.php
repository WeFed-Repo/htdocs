	 ...
	 <div class="top-box-promo">
	 	<div class="row">
	 		<div class="col-xs-12 col-sm-7">
	 			<h2 class="top-title-promo">STAI PENSANDO DI ACQUISTARE CASA O SOSTITUIRE IL MUTUO ATTUALE?</h2>
	 			<p>Scopri i vantaggi dei mutui Banco BPM</p>
	 		</div>
	 		<div class="col-sm-5">
	 			<img src="/HT/fe/img/assic_covea_scheda.png" alt="" class="img-resp">
	 		</div>
	 	</div>
	 	<hr>
	 	<div class="row">
