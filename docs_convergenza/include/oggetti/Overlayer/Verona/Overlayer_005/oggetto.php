...
<?php 
	...
	{
		?>
<a href="javascript:$('#helpDialog .modal-body').empty();OpenHelp('/template/strong_token_fisico.php')" class="no-underline btn-icon">Link per l'apertura dell'overlayer di autenticazione <strong>CASO TOKEN FISICO </strong></a>
		...
		<form id="formEsempio" role="form">			
			...
			<div class="row otpdesc">
				<div class="col-xs-12 col-sm-4">
					...
					<div class="center hidden-xs"><img src="/WB/fe/img/token_info_1.png"></div>
				</div>
				<div class="col-xs-12 col-sm-4">
					...
					<div class="center hidden-xs"><img src="/WB/fe/img/token_info_2.png"></div>
				</div>
				<div class="col-xs-12 col-sm-4">
					<span class="introtext"><strong>3.</strong> Inserisci il codice OTP generato dal token qua sotto</span>
					<div class="center"><img src="/WB/fe/img/token_info_3.png"></div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-8">
