...
<?php 
	...
	{
		?>
<a href="javascript:$('#helpDialog .modal-body').empty();OpenHelp('/template/strong_otp_sms.php')" class="no-underline btn-icon">Link per l'apertura dell'overlayer di autenticazione <strong>OTP VIA SMS</strong></a>
