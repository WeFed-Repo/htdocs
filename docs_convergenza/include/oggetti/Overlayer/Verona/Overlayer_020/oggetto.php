...
<?php 
	...
	{
		?>
<a href="javascript:$('#helpDialog .modal-body').empty();OpenHelp('/template/strong_token_software_sblocco_offline.php')" class="no-underline btn-icon">Link per l'apertura dell'overlayer di autenticazione <strong>CASO TOKEN SOFTWARE NOTIFICA + CODICE SBLOCCO APP OFFLINE</strong></a>
