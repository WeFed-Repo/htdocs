...
<table id="tbFixedColumnB" class="fixedColumns scelta-profilo">
    <thead>
        <tr>
            ...
            <th class="center" data-index="2">Linea 1</th>
            <th class="center" data-index="3">Linea 2</th>
            <th class="center" data-index="4">Linea 3</th>
            <th class="center" data-index="5">Linea 4</th>
         </tr>
    </thead>
    <tbody>
        <tr class="dispari">
       ...
       <tr class="dispari title-row hidden-xs">
        ...
        <tr class="radio-mobile">
            ...
            <td class="center">Linea 1 </td>
            <td class="center">Linea 2 </td>
            <td class="center">Linea 3</td>
            <td class="center">Linea 4</td>
         </tr>
    </tbody>
 </table>
</section>
...
<script>
function fixColonnaB() {
    if(isSmallDevice) {
        $('#tbFixedColumnB').bootstrapTable('destroy').bootstrapTable({
            fixedColumns: true,
            fixedNumber: 2,
            onPostBody : selectRadioColumnB
        })
    }
    else {
        $('#tbFixedColumnB').bootstrapTable('destroy').bootstrapTable({
...
var selectRadioColumnB = function() {
    var tableC = $('#tbFixedColumnB'),
    ...
    function(el,index) {
        ...
        var indexSel;
        $('#tbFixedColumnB').find('th').each(function(index){
            if ($(this).attr('class').indexOf('highlight')!= -1) {
                indexSel = index;
           }
        })
