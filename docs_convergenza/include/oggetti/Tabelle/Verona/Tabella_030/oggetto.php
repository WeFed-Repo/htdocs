...
<section>
	<form>
		<div class="form-group scrollFocus" id="confrCarteB">
			<div class="row">
	...
	<div id="tabellaComparazione" class="comparazioneFocus">
		<div class="headerContainerNoBootS">
        	<div class="tableContainerNoBootS">
				<table cellspacing="0" cellpadding="0" border="0" id="confrontaTableB">
					<thead>
						<tr data-type="titolo">
...
<script>
 $(function () {
	var $table = $('#confrontaTableB'),
		chekBox = $('#confrCarteB').find('.confronta-carte input[type=checkbox]'),
		htmlTable =  {
		"cimpronta" : {
