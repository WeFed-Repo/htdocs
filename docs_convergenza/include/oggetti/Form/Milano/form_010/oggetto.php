...
$(function() {
    ...
    function getspinnerVal() {
       if(spinnerVal > 3 && !($('#spinnerId').hasClass('.inited'))) {
            $('#spinnerId').attr('data-toggle','tooltip').attr('data-title','testo tooltip').addClass('closeable');
            initTooltip();
            $('#spinnerId').focus();
        }
             ...
             $('.tooltip.in').hide();
             $('#spinnerId').attr('data-toggle','').attr('data-title','').removeClass('closeable inited');
        }
    }
});
</script>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-sm-6">
                ...
                <input type="text" class="form-control clear-x" name="numero" ng-model="participant.numero">
            </div>
            <div class="col-sm-6">
                <label class="control-label">Email partecipante</label>
                <input type="text" class="form-control clear-x" name="email" ng-model="participant.email">
            </div>
        </div>
    </div>
    <div class="form-group">
        <div class="row">
            <div class="col-xs-6 requiredField">
                ...
                <input type="text" name="" class="form-control clear-x" value="prova">
            </div>
            <div class="col-xs-6 requiredField">
                <label class="control-label txthelp closeable" data-toggle="tooltip" data-title="">Lorem ipsum*</label>
                <div class="htmlTooltip"><a href="#">link</a> etsto</div>
            ...
            <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-4">
                        <div class="radio">
                            <label>
                                <input type="radio" name="" id=""> su richiesta
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="radio">
                            <label>
                                <input type="radio" name="" id=""> fino al giorno
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-inline">
