<section>
	...
	<input type="hidden" name="intestatario.adeguataVerificaForm.pepIniziale" id="pepIniziale0" value="false">
	<div class="clearfix">
	...
	<a href="javascript:OpenHelp('/WEBHT/help/page.do?id=2354')" class="text-underline btn-icon hidden-xs">obbligatorie</a>
							...
							<div class="row">
								<div class="form-field-input col-sm-6 col-xs-12">
									<span class="label-inline">
										<label for="utilizzoRapportoWB0">Scopo prevalente del rapporto</label>
									</span>
								</div>
								<div class="form-field-input col-sm-6 col-xs-12">
									<select id="utilizzoRapportoWB0" name="intestatario.adeguataVerificaForm.scopoRichiestaProdottoWB" class="fixed-size form-control">
										<option value="-">-</option>
...
<!-- 			TITOLARE EFFETTIVO -->
	...
	<a href="javascript:OpenHelp('/WEBHT/help/page.do?id=2355')" class="no-underline btn-icon hidden-xs"><i class="icon icon-info_fill icon-2x"></i></a>
		...
		$("body").prepend(helpDialog);
					...
					<div class="row">
						<div class="form-field-input col-xs-12">
							<label>
								<input type="checkbox" name="intestatario.adeguataVerificaForm.titolareEffettivoRapporto" value="true" id="titEff0">
								<input type="hidden" name="intestatario.adeguataVerificaForm.titolareEffettivoRapporto" value="false" id="titEffHidden0">
								Dichiaro di essere il titolare effettivo dei rapporti a me intestati e di agire esclusivamente per mio conto.
							</label>
						</div>
					</div>
				</div>
...
<!-- 			PERSONA POLITICAMENTE ESPOSTA  -->
	...
	<a href="javascript:OpenHelp('/WEBHT/help/page.do?id=2356')" class="text-underline btn-icon hidden-xs">LEGGI LA DEFINIZIONE COMPLETA</a>
		...
		$("body").prepend(helpDialog);
					...
					<div class="row">
						<div class="form-field-input col-xs-12 col-sm-2">
							<input type="radio" name="intestatario.adeguataVerificaForm.pep" value="true" class="sfondoForm" id="pepSi0">
							<label for="pepSi0">Sì </label>
						</div>
						<div class="form-field-input col-xs-12 col-sm-2">
							<input type="radio" name="intestatario.adeguataVerificaForm.pep" value="false" class="sfondoForm" id="pepNo0" checked="checked">
				...
				<div class="form-group">
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="secondaCittadinanza0">Seconda cittadinanza </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<select id="secondaCittadinanza0" name="intestatario.adeguataVerificaForm.secondaNazione" class="fixed-size form-control">
								<option value="-">-</option>
...
<!-- 				DOMANDE -->
	...
	<h3 class="titleSection titleForm">
		...
		Profilo professionale e patrimoniale
				...
				<div class="form-group">
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="professione0">Professione </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<select id="professione0" name="intestatario.adeguataVerificaForm.professione" onchange="checkProfessione(0, )" class="fixed-size professione form-control">
								<option value="-">-</option>
	...
	<a href="javascript:OpenHelp('/WEBHT/help/page.do?id=2358')" class="no-underline btn-icon hidden-xs"><i class="icon icon-info_fill icon-2x"></i></a>
		...
		$("body").prepend(helpDialog);
				...
				<div class="form-group">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="nazione0">Stato di svolgimento </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<select id="nazione0" name="intestatario.adeguataVerificaForm.nazioneAttivitaLavorativa" onchange="checkNazione(0)" class="fixed-size form-control">
								<option value="">&nbsp;</option>
				...
				<div class="form-group">
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="provincia0"> Provincia di svolgimento </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<select id="provincia0" name="intestatario.adeguataVerificaForm.provinciaAttivitaLavorativa" class="fixed-size provincia form-control">
								<option value="">&nbsp;</option>
				...
				<!-- stato estero non verrà più chiesto, va commentato -->
<!-- 				<div class="form-group"> -->
<!-- 					<div class="row"> -->
<!-- 						<div class="form-field-input col-sm-6 col-xs-12"> -->
<!-- 							<span class="label-inline"> -->
...
<!-- 				</div> -->
				...
				<div class="form-group">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="redditoAnnuoNetto0">Reddito annuo netto </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<select id="redditoAnnuoNetto0" name="intestatario.adeguataVerificaForm.codRedditoAnnuoNetto" onchange="checkReddito(0, true)" class="fixed-size reddito form-control">
								<option value="">-</option>
				...
				<div class="form-group" id="note10" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="noteRedditoAnnuoNetto0">Note Reddito annuo </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<input type="text" id="noteRedditoAnnuoNetto0" name="intestatario.adeguataVerificaForm.noteRedditoAnnuoNetto" class="fixed-size form-control" maxlength="100" value="">
						</div>
					</div>
				</div>
				...
				<div class="form-group">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="origineReddito0">Origine del reddito </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<select id="origineReddito0" name="intestatario.adeguataVerificaForm.origineReddito" onchange="checkOrigineReddito(0, true)" class="fixed-size originereddito form-control">
								<option value="">-</option>
				...
				<div class="form-group" id="note20" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="noteOrigineReddito0">Note Origine del reddito </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<input type="text" id="noteOrigineReddito0" name="intestatario.adeguataVerificaForm.noteOrigineReddito" class="fixed-size form-control" maxlength="100" value="">
						</div>
					</div>
				</div>
				<div class="form-group">				
	...
	<a href="javascript:OpenHelp('/WEBHT/help/page.do?id=2359')" class="no-underline btn-icon hidden-xs"><i class="icon icon-info_fill icon-2x"></i></a>
...
$(function() {
	if ($("#helpDialog").length==0) {
		...
		$("body").prepend(helpDialog);
						...
						<div class="form-field-input col-sm-6 col-xs-12">
							<select id="patrimonio0" name="intestatario.adeguataVerificaForm.codPatrimonio" onchange="checkPatrimonio(0, true)" class="fixed-size patrimonio form-control">
								<option value="">-</option>
				...
				<div class="form-group" id="note30" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="notePatrimonio0">Note del patrimonio </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<input type="text" id="notePatrimonio0" name="intestatario.adeguataVerificaForm.notePatrimonio" class="fixed-size form-control" maxlength="100" value="">
						</div>
					</div>
				</div>
	...
	<a href="javascript:OpenHelp('/WEBHT/help/page.do?id=2357')" class="no-underline btn-icon hidden-xs"><i class="icon icon-info_fill icon-2x"></i></a>
...
$(function() {
	if ($("#helpDialog").length==0) {
		...
		$("body").prepend(helpDialog);
						...
						<div class="form-field-input col-sm-6 col-xs-12">
							<select id="originePatrimonio0" name="intestatario.adeguataVerificaForm.origineFondi" onchange="checkOriginePatrimonio(0, true)" class="fixed-size originepatrimonio form-control">
								<option value="">-</option>
				...
				<div class="form-group" id="note40" style="display: none;">				
					<div class="row">
						<div class="form-field-input col-sm-6 col-xs-12">
							<span class="label-inline">
								<label for="noteOriginePatrimonio0">Note dell'origine del patrimonio </label>
							</span>
						</div>
						<div class="form-field-input col-sm-6 col-xs-12">
							<input type="text" id="noteOriginePatrimonio0" name="intestatario.adeguataVerificaForm.noteOriginePatrimonio" class="fixed-size form-control" maxlength="100" value="">
						</div>
					</div>
				</div>
