...
<div class="modal-body" id="mailBody">
    <div class="container-fluid">
        <div id="confermaContentEmail" class="confermaContent">
            ...
            <form class="formGenerico output" role="form" id="homeMailCoordBankForm" name="homeMailCoordBankForm"
                  action="/include/ajax/inviaMailCoordBancarie.php">
                <!--RIGA DIVISA IN TRE CAMPI -->
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12">
                            <label class="control-label" for="homeMailCBFdest">Indirizzi email</label>
                            <input id="homeMailCBFdest" type="text" name="mailDest" class="form-control clear-x"
                                   placeholder="Indirizzi email separati da virgola">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group btnWrapper" id="homeMailCBFdestLabel">
                    <div class="btn-align-center">
                        <a type="button" href="javascript:" class="btn btn-default" id="annullaInviaEmail"
                           title="Annulla">Annulla</a>
                        <a type="button" href="javascript:" class="btn btn-primary" id="btnInviaEmail"
        ...
        <section id="confermaResponseEmail" class="boxesitoWrap">
            ...
            <div id="mailEsitoKO" class="boxesito negativo errorHead">
                <div class="text">
                    <h4>Attenzione</h4>
                    <div id="invioMailWarng" class="messageResponse"></div>
                </div>
            </div>
        </section>
    </div>
...
<script>
    $(function () {
        $('#annullaInviaEmail').click(function () {
