...
<!-- Overlay Watchlist -->
<div class="modal fade" id="addToWl" tabindex="-1" role="dialog" aria-labelledby="addToWlLabel">
...
<div class="formGenerico borderFormRounded fundPanel fundPanelImg">
	<!-- Blocco descrittivo -->
	<img src="/common/fe/img/lgsoc_allianz.png" class="imgSoc" />
	<div class="row">
		<div clas="col-xs-12">
			<div class="row">
				<div class="col-sm-8">
				...
				<div id="collapseSintesi" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading1b">
					<div class="panel-body">
						<div class="tab-wrap">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-sm-4">
										<label class="control-label txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, doloremque.">Valuta di riferimento</label>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-sm-4">
										<label class="control-label txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, doloremque.">Valuta base</label>
										<span class="output">EUR</span>
									</div>

									<div class="col-sm-4">
										<label class="control-label txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, doloremque.">Valuta coperta</label>
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<h4 class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae blanditiis laborum esse aspernatur, vel incidunt! Quam perspiciatis, ea veniam eveniet, quasi nobis minus quidem voluptatem nam facere error ipsum, est?">Asset allocation %</h4>
					...
					<div class="panel-body">
						<div class="tab-wrap">
							...
							<section>
						    	<div class="row">
									<div class="col-xs-12">
										<h4 class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam, eos.">Rendimenti cumulati %</h4>
										<div class="headerContainerNoBootS">
									    	<div class="tableContainerNoBootS">
							...
							<section>
						    	<div class="row">
									<div class="col-xs-12">
										<h4 class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam, eos.">Rendimenti per anno solare</h4>
										<div class="headerContainerNoBootS">
									    	<div class="tableContainerNoBootS">
												<table class="riepilogo" cellspacing="0" cellpadding="0" border="0"  data-toggle="table">
													<thead>
							...
							<section>
						    	<div class="row">
									<div class="col-xs-12">
										<h4 class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam, eos.">Dividendi distribuiti (YEN)</h4>
										<div class="headerContainerNoBootS">
									    	<div class="tableContainerNoBootS">
												<table cellspacing="0" cellpadding="0" border="0"  data-toggle="table">
							...
							<section>
						    	<div class="row">
									<div class="col-xs-12">
										<h4 class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam, eos.">Rendimenti per quartili</h4>
										<div class="headerContainerNoBootS">
									    	<div class="tableContainerNoBootS">
												<table cellspacing="0" cellpadding="0" border="0"  data-toggle="table">
						...
						<div class="tab-wrap">
							...
							<section>
								<div class="row">
									<div class="col-sm-3 col-xs-12">
										<h4>Profilo di <span class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae blanditiis laborum esse aspernatur, vel incidunt! Quam perspiciatis, ea veniam eveniet, quasi nobis minus quidem voluptatem nam facere error ipsum, est?">rischio/rendimento</span></h4>
										...
										<div class="headerContainerNoBootS">
											<div class="tableContainerNoBootS">
												<table>
													...
													<tr>
														<td><strong><span class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo, commodi.">Rating del fondo</span></strong></td>
							...
							<div class="headerContainerNoBootS">
									...
									<table>
										...
										<tr>
											<td><strong>
												<span class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="<b>RENDIMENTO</b>: è il rendimento a 1, 3, 5 anni conseguito dal fondo.">
													Rendimento (EUR)
												</span>	</strong>
											</td>
											<td class="center">
										...
										<tr>
											<td>
												<span class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="<b>VOLATILITÀ</b>: indica la <b>variabilità</b> 
										...
										<tr>
											<td>
												<span class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="<b>INDICE DI SHARPE</b>: è un indice usato per valutare 
																					l'<b>efficienza</b> 
										...
										<tr>
											<td>
												<span class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="<b>INDICE DI SORTINO</b>: è un indice usato per valutare l'efficienza 
							...
							<div class="row">
								<div class="col-sm-6 col-xs-12">
									...
									<table>
															...
															<tr>
																<td>
																	<span class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="<b>BETA</b>: è un <b>indicatore</b> che esprime l'<b>elasticità 
															...
															<tr>
																<td>
																	<span class="txthelp"data-toggle="tooltip" data-viewport="#fesFondoWrap" title="<b>R-QUADRO</b>: è un indicatore di quanto il <b>comportamento</b> 
															...
															<tr>
																<td class="ultimo">
																	<span class="txthelp" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="<b>TRACKING ERROR VOLATILY (TEV)</b>: esprime la <b>volatilità</b> 
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-6">
										<h4 data-toggle="tooltip" data-viewport="#fesFondoWrap" class="txthelp" title="Indica la ripartizione in percentuale degli <b>strumenti finanziari</b> presenti nel portafoglio del fondo tra le principali asset class: azioni, obbligazioni, liquidit&agrave;.">Asset Allocation %</h4>
			...
			<div class="row">
				...
				<div class="col-sm-4 col-xs-12">
					<div class="fundBox">
						...
						<div class="control-label  txthelp inited" data-toggle="tooltip" data-viewport="#fesFondoWrap" title="" data-original-title="Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem voluptatibus atque nihil omnis deserunt molestiae cupiditate aperiam ipsum iste ea numquam fuga impedit itaque, adipisci iusto, optio rerum facere voluptas.">Rating FIDA</div>
