...
var links = {
    listaConti: pathLibrerie + pathRia + "/listaConti.php",
    situazioneContiVerona: pathLibrerie + pathRia + "/situazioneConti.php",
    situazioneContiMilano: pathLibrerie + pathRia + "/situazioneConti.php",
    caricaSessioneCarte: pathLibrerie + pathRia + "/inquiryCreditCards.php",
    listaDateValute: pathLibrerie + pathRia + "/listaDateValute.php",
    dataValuta: pathLibrerie + pathRia + "/dataValuta.php",
    andamentoConti: pathLibrerie + pathRia + "/andamentoConti.php",
    listaTRic: pathLibrerie + pathRia + "/listaTRic.php",
    listaLVinc: pathLibrerie + pathRia + "/listaLVinc.php",
    WsMovementsDetail: pathLibrerie + pathRia + "/WsMovementsDetail.php",
    movimentiConto: pathLibrerie + pathRia + "/movimentiConto.php",
    estrattiConto: pathLibrerie + pathRia + "/estrattiConto.php",
    aggiornaDescLVinc: pathLibrerie + pathRia + "/aggiornaDescLVinc.php",
    trasferimentoManuale: pathLibrerie + pathRia + "/trasferimentoManuale.php",
    eliminaTRic: pathLibrerie + pathRia + "/eliminaTRic.php",
    trasferimentoRicorrente: pathLibrerie + pathRia + "/trasferimentoRicorrente.php",
    getBannerRetention: pathLibrerie + pathRia + "/getBannerRetention.php",
    eliminaLVinc: pathLibrerie + pathRia + "/eliminaLVinc.php",
    creaLVinc: pathLibrerie + pathRia + "/creaLVinc.php",
    openLBcoord: pathLibrerie + pathRia + "/getCoordBancarieSimple.php",
    ...
    fpInvestimenti: cgi_script + "/wbOnetoone/fpInvestimentiWb.action?OBSCNT=FNZ_NAV&tabId=nav_priv_wbx_investimenti&OBSKEY=nav_priv_wbx_investimenti&cf=" + Math.random(),
