...
$(function () {
    ...
    var assiXml = (!librerie) ? wrp_script_direct + "/wbOnetoone/resp/wbblack/jsp/assicurazioniFlashConfig.jsp" : "/librerie/include/commons/ajax/slider_assicurazioni.xml",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (!isOneSelected) {
                $tabList.find('li').first().addClass('on');
                $contentGroup.find('.tab-content').first().show();
            }
