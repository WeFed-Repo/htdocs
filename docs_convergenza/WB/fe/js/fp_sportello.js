...
sportello = (function () {
    ...
    getContattoInfo = function (tipo) {
        ...
        if (typeof contattoSelezionato[tipo] !== 'undefined') {
            ...
            // Se non c'̬ nemmeno un preferito, prendo il primo
    ...
    goToAuthPage = function (prefix, otpType, pollingType, isContatto) {
        ...
        if (!isContatto && prefix === '#bonifico' && formOK && !check.isSepa(getIBAN())) {
            this.showCallError('Non ̬ possibile inserire in questa sezione bonifici verso Paesi non aderenti all\'area Sepa<br/><br/>' + '<a href="' + staticLinks.linkBonifico + Math.random() + '">Clicca per accedere alla funzione</a>', $('#bonificoPage1'));
            formOK = false;
        }
        if (formOK) {
    ...
    goToKoPage = function (prefix, isContatto, errorMsg, reset) {
        ...
        errorMsg = errorMsg || "Non ̬ stato possibile eseguire l'operazione.";
