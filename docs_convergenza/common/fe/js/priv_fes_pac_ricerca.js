...
var pacRicerca = (function() {
    ...
    function initFilters() {
        ...
        autoCompUrl = isLibrerieOK ? "/include/ajax/fes/fdaAutoCom.php" : wrp_script_direct + "/investimenti/SimPacAutoCom.action";
        ...
        $.each(fesConfig.codSocieta, function(key, val) {
            caseGestWrap.append(
                ...
                '<img src="' + (val.img.indexOf("common")<0?"/common":"") + val.img + '" class="img100"></a>' +
    ...
    function initTables() {
        ...
        ricLibUrl = isLibrerieOK ? "/include/ajax/fdaRicPac.php" : wrp_script_direct + "/investimenti/FesTabellaSimPac.action";
    ...
    function initForm() {
        var showFondoUrl = isLibrerieOK ? "" : wrp_script + "/wbOnetoone/2l/action/investimenti/SimPacSchedaFondo.action?OBSCNT=FNZ_NAV&tabId=nav_priv_wbx_investimenti&OBSKEY=nav_priv_wbx_pacsimulatore",
            showSimPacUrl = isLibrerieOK ? "/template/strutt_"+ libSite +".php?tpl=tpl_priv_fes_pac_simulatore.php&html=mi&liv1=investimenti&liv2=fondi_e_sicav&liv3=piani_di_accumulo_(pac)&liv4=simulatore_pac#!" : "SimulatorePAC.action?OBSCNT=FNZ_NAV&tabId=nav_priv_wbx_investimenti&OBSKEY=nav_priv_wbx_pacsimulatore";
