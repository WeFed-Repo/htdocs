...
if (typeof cgi_script != "undefined") {
    aucapJsonUrl = (!isLib) ? cgi_script + "/FMP/aucap/recuperoDirittiAucap.jsp" : "/include/ajax/spnjsonresp.php";
}
aucapJsonUrlAgenzie = (!isLib) ? "/pub/xbank/common/getCalcolatoreAucap.jsp" : "/include/ajax/spnjsonresp.php";
