...
function initializaBuyFundSelect(inputData) {

	$.ajax({
				url : wrp_script_direct + "/investimenti/BuyFundSelectJson.action" + "?cf=" + Math.random(),
				dataType : "json",
				data : inputData,
...
//								hrefNuovoFondo += "?OBSCNT=FNZ_NAV&tabId=nav_priv_wbx_investimenti&OBSKEY=nav_priv_wbx_acquisto'";
								...
								if ("true" == buyFundConfirmRequestJson.toBuy) {
									...
									hrefNuovoFondo2 += "+\"/wbOnetoone/2l/action/investimenti/BuyPacFromCartSelect.action";
