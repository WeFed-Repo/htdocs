...
function showVerPAC_IcoOpr(){
	...
	if(idxVerPac != -1){
		...
		if(datiFondi[idxVerPac].hrefVersaPac != ""){
			$("#idVerPac").attr("href", "javascript:document.location.href=wrp_script + '/wbOnetoone/2l/action/investimenti/" + datiFondi[idxVerPac].hrefVersaPac +"'");
			$("#idVerPac").parent().removeClass("linkOff").addClass("linkOn");
		}
		
		//TODO - Modal con dettaglio
//		$("#idDettPac").attr("href", "javascript:document.location.href=wrp_script + '/wbOnetoone/2l/action/investimenti/" + datiFondi[idxVerPac].hrefVersaPac +"'");
