...
//        var buyPacUrl = isLibrerieOK ? "#!" : wrp_script + "/wbOnetoone/2l/action/investimenti/BuyPacFromCartSelect.action?OBSCNT=FNZ_NAV&tabId=nav_priv_wbx_investimenti&OBSKEY=nav_priv_wbx_acquisto";
        var buyPacUrl = isLibrerieOK ? "#!" : wrp_script + "/wbOnetoone/2l/action/investywb/SimPacAcquistoFondo.action?OBSCNT=FNZ_NAV&tabId=nav_priv_wbx_investimenti&OBSKEY=nav_priv_wbx_acquisto_new";
